...
export const ENVIRONMENT = [
  ...
  ax("Meteorological Director", "relief", ["cyclone", "early-warning", "technology"],
    sx("The old storm warning alarms are breaking down. You can spend money to buy new ones, or hope the old ones keep working.",
  ...
  ax("Family Planning Director", "people", ["family-planning", "population", "women"],
    sx("Programs that help families decide how many kids to have are running out of money. You can fix them, but some strict people won't like it.",
  ...
  ax("Cancer Care Director", "doctor", ["cancer", "radiotherapy", "access"],
    sx("People with cancer are dying because there are very few special machines to help them, and they are all in the big city. Buying more for other towns costs a lot.",
  ...
  ax("Urban Open-Space Officer", "people", ["parks", "playgrounds", "children"],
    sx("Builders are paving over all the city parks so kids have nowhere to play. You can protect the parks, but the builders will be angry.",
  ...
  ax("Adolescent Girls' Health Director", "people", ["menstruation", "girls", "school"],
    sx("Girls are missing school because they don't have what they need for their periods. You can give out free supplies, but some people are too embarrassed to talk about it.",
  ...
  ax("Water Quality Director", "doctor", ["fluoride", "water", "health"],
    sx("Bad chemicals in the water are making people's bones and teeth sick in some towns. You can spend money to clean it, but it only helps a few places.",
  ...
  ax("Environmental Health Officer", "people", ["noise", "pollution", "health"],
    sx("The city is so noisy it hurts people's ears and hearts. You can make rules to keep it quiet near hospitals, but drivers will be mad.",
  ...
  ax("Emergency Services Director", "relief", ["ambulance", "emergency", "trauma"],
    sx("There are no good ambulances, so sick people don't get to the hospital in time. You can build a real 999 rescue system, but it costs a lot.",
  ...
  ax("Neglected Disease Director", "doctor", ["kala-azar", "elimination", "poverty"],
    sx("A deadly bug sickness is almost gone. You can spend a little more money to wipe it out forever, or stop now and risk it coming back.",
  ...
  ax("Eye Health Director", "doctor", ["blindness", "cataract", "access"],
    sx("Many poor people are blind, but a simple 15-minute doctor visit could fix their eyes. You can send doctors to the villages to help them.",
  ...
  ax("Disease Surveillance Director", "doctor", ["surveillance", "labs", "outbreaks"],
    sx("The country is never ready when a new sickness spreads. You can build special science labs to watch for bugs, but they are expensive.",
  ...
  ax("Pharmacy Regulation Director", "doctor", ["antibiotics", "pharmacy", "resistance"],
    sx("People are taking strong medicine like candy, which creates super-bugs. You can force stores to only sell it with a doctor's note.",
  ...
  ax("Social Welfare Director", "relief", ["elderly", "ageing", "care"],
    sx("Old people are being left alone with no one to care for them. You can build special homes to help them, but it costs money.",
  ...
  ax("Hospital Quality Director", "doctor", ["infection-control", "hospitals", "safety"],
    sx("Hospitals are so dirty that people catch new sicknesses while they are there. You can force them to be clean, but they will complain.",
  ...
  ax("Solid Waste Director", "official", ["composting", "waste", "landfill"],
    sx("Garbage is rotting in the streets. You can make a system to turn the smelly garbage into plant food, but it takes hard work.",
  ...
  ax("Public Health Nutrition Director", "doctor", ["salt", "hypertension", "diet"],
    sx("People eat way too much salt, giving them heart attacks. You can make food companies use less salt, but they will fight you.",
  ...
  ax("Disability Services Director", "relief", ["disability", "assistive-devices", "access"],
    sx("People who can't walk or hear don't have money for wheelchairs or hearing aids. You can buy them for everyone who needs them.",
  ...
  ax("Building Code Director", "official", ["green-building", "code", "developers"],
    sx("New buildings waste a lot of electricity and have no green grass. You can force builders to be eco-friendly, but it costs them more.",
  ...
  ax("Animal Welfare Officer", "relief", ["animals", "cruelty", "welfare"],
    sx("Animals are being treated very meanly on the streets and in farms. You can make a law to protect animals from bullies.",
  ...
  ax("Vector Control Director", "doctor", ["mosquitoes", "fogging", "dengue"],
    sx("The bug spray in the city isn't killing the mosquitoes anymore. You need to clean the dirty water where they live, but people just want to see the spray.",
  ...
  ax("Palliative Care Director", "doctor", ["palliative", "hospice", "dignity"],
    sx("Very sick people who are dying are in lots of pain. You can give them strong medicine to make them comfortable, but people are scared they will get addicted.",
  ...
  ax("School Health Officer", "doctor", ["screening", "children", "education"],
    sx("Kids fail school simply because they can't see the board. You can buy free glasses for kids who need them.",
  ...
  ax("Wetland Conservation Officer", "relief", ["wetland", "ramsar", "biodiversity"],
    sx("Builders want to drain a beautiful swamp where winter birds live so they can build houses. You can protect the swamp forever.",
  ...
  ax("Oral Health Director", "doctor", ["dental", "oral-cancer", "betel"],
    sx("Chewing bad tobacco is giving people mouth cancer. You can send dentists to help and teach people to stop, but the tobacco sellers will be mad.",
  ...
  ax("Air Quality Director", "official", ["air-monitoring", "data", "transparency"],
    sx("No one knows how poisonous the air really is because there are no testing machines. You can put machines up, but the factories are scared of the truth.",
  ...
  ax("Disaster Preparedness Director", "relief", ["earthquake", "buildings", "preparedness"],
    sx("The city buildings would all fall down if a big earthquake hit. You can spend money to fix them now, or just hope the earthquake never happens.",
  ...
  ax("Suicide Prevention Director", "doctor", ["suicide", "pesticide", "rural"],
    sx("People are using dangerous farm poisons to hurt themselves when they are sad. You can lock up the poisons to keep people safe.",
  ...
  ax("Immunisation Logistics Director", "doctor", ["vaccines", "cold-chain", "coverage"],
    sx("The refrigerators that keep kids' medicines safe are breaking. If you don't buy new ones, the medicine won't work.",
  ...
  ax("Renal Care Director", "doctor", ["dialysis", "kidney", "access"],
    sx("Many people have very sick kidneys and need a special cleaning machine to stay alive. You can build cheap machine centers everywhere, but it costs a lot.",
  ...
  ax("Health Facility Director", "doctor", ["wash", "hospitals", "hygiene"],
    sx("Hospitals are so dirty they don't even have clean water to wash hands. You can fix the pipes and toilets to make them clean.",
  ...
  ax("School Nutrition Director", "doctor", ["obesity", "junk-food", "children"],
    sx("Kids are eating too much junk food at school and getting unhealthy. You can ban junk food, but the kids and the snack companies will complain.",
  ...
  ax("Rural Housing Director", "relief", ["flood", "housing", "resilience"],
    sx("Floods wash away the same poor houses every single year. You can build them tall, safe houses, or just keep giving them cheap emergency food.",
  ...
  ax("Blood Services Director", "doctor", ["blood", "donation", "safety"],
    sx("People sell sick blood to hospitals for money. You can stop this and only take healthy blood from volunteers, but it takes time to set up.",
  ...
  ax("Mental Health Director", "doctor", ["suicide", "helplines", "stigma"],
    sx("Sad people who try to hurt themselves are treated like criminals and put in jail. You can change the rule and give them doctors instead.",
  ...
  ax("Road Safety Health Officer", "doctor", ["helmets", "trauma", "enforcement"],
    sx("Too many motorcycle riders are crashing without helmets and hurting their heads. You can force them to wear helmets, but they will be annoyed.",
  ...
  ax("Immunisation Policy Director", "doctor", ["vaccines", "children", "introduction"],
    sx("There are amazing new medicines to protect little kids from getting sick, but they cost a lot of money to buy for everyone.",
  ...
  ax("Climate Health Director", "doctor", ["climate", "health", "adaptation"],
    sx("Weird hot weather and floods are bringing new bugs and sicknesses. You can prepare hospitals for this, but it takes a lot of planning.",
  ...
  ax("Coastal Environment Officer", "relief", ["marine-litter", "beaches", "plastic"],
    sx("The beautiful beaches are totally covered in plastic trash. You can clean it up and ban plastic, but the tourists and stores will complain.",
  ...
  ax("Child Development Director", "doctor", ["autism", "disability", "children"],
    sx("Kids whose brains work a little differently are hidden away with no schools. You can build special classes to help them learn.",
  ...
  ax("Urban Waterways Officer", "people", ["canals", "waste", "flooding"],
    sx("City rivers are clogged with garbage, causing floods and disease. You can force people to stop throwing garbage in the water.",
  ...
  ax("Labour Welfare Director", "people", ["creches", "women", "workforce"],
    sx("Working moms have nowhere safe to leave their babies. The law says factories must have baby rooms, but bosses ignore it.",
  ...
  ax("Enteric Disease Director", "doctor", ["cholera", "typhoid", "vaccines"],
    sx("Dirty water gives people terrible stomach bugs. You can give them a special medicine shot to stop it while you fix the pipes.",
  ...
  ax("Health Information Director", "official", ["health-data", "records", "privacy"],
    sx("You can put everyone's doctor records on a giant computer so they are easy to find. But people are scared the government will spy on their secrets.",
  ...
  ax("Tobacco Control Officer", "doctor", ["vaping", "shisha", "youth"],
    sx("Kids are smoking sweet-smelling vape pens. You can tax them and make strict rules just like normal cigarettes, but sellers will be mad.",
  ...
  ax("Disaster Relief Director", "relief", ["flood", "shelter", "livestock"],
    sx("During floods, poor farmers drown because they refuse to leave their cows behind. You can build safe houses for people AND their cows.",
  ...
  ax("Green Economy Officer", "people", ["waste-pickers", "green-jobs", "informal"],
    sx("Poor people dig through the trash to recycle things for pennies. You can give them uniforms, safe tools, and real jobs.",
  ...
  ax("Health Quality Director", "doctor", ["accreditation", "hospitals", "standards"],
    sx("Some private hospitals are amazing, and some are deadly. You can test them all and put grades on the door so people know.",
  ...
  ax("Environmental Health Director", "doctor", ["indoor-air", "household", "women"],
    sx("Cooking over smoky fires inside the house is quietly killing moms and kids. You can spend money to fix their houses and stoves.",
  ...
  ax("Public Health Director", "doctor", ["sugar", "drinks", "diabetes"],
    sx("Sugary sodas are making kids very unhealthy. You can stop companies from selling soda near schools, but the companies will fight you.",
  ...
  ax("Urban Migration Director", "relief", ["climate-migrants", "slums", "services"],
    sx("Thousands of people lost their farms to floods and are moving to the city. You can build new, nice neighborhoods for them, or let them live in the dirt.",
