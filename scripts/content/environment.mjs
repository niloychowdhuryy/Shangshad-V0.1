...
export const ENVIRONMENT = [
  ...
  ax("Disaster Management Chief", "official", ["cyclone", "embankment", "coast"],
    sx("Sir, a message from the Welfare Ministry: A super-cyclone is forty-eight hours out and the coastal embankments — patched, looted, thin — will not hold the surge. The Chief wants a mass evacuation that will cost a fortune and admit the embankments failed. Or you can pray the storm turns.",
    ...
    sx("In the aftermath, relief is being looted by local officials before it reaches the shelters, and survivors are eating the seed grain meant for next season. An adviser proposes routing aid through the army instead of the civil administration. What are your orders, sir?",
  ...
  ax("Air Quality Scientist", "people", ["air", "dhaka", "kilns"],
    sx("Air Quality Scientist awaits your word. The capital's air is the most poisonous on earth this winter — brick kilns, traffic, and dust shaving years off every lung. The scientist wants the illegal kilns ringing the city shut. The kiln owners build the city's bricks and bankroll MPs.",
  ...
  ax("Director-General of Health", "doctor", ["dengue", "epidemic", "hospitals"],
    sx("Sir! Dengue has exploded past every record; the hospital corridors are lined with stretchers and the test kits are running out. The DG needs emergency procurement and a city-wide fogging blitz — fast, and without the usual tender delays.",
  ...
  ax("River Conservation Commissioner", "official", ["river", "tannery", "pollution"],
    sx("Mr. Prime Minister, sir! The river through the capital is biologically dead — black with tannery chrome and factory waste. A court ordered the tanneries relocated to a treatment estate, but its plant does not work and the owners refuse to move. Enforce the order, or excuse it?",
  ...
  ax("Urban Planning Adviser", "people", ["climate-migration", "slums", "cities"],
    sx("Your Excellency! Every drowned coastal acre sends thousands to the capital's slums — a million climate migrants a year crowding a city already past breaking. The adviser pitches secondary 'climate-resilient' towns to absorb them, a vast and unglamorous investment.",
  ...
  ax("Wetlands Inspector", "official", ["encroachment", "wetlands", "elite"],
    sx("Dear Sir — A politically connected developer is filling a protected flood-plain wetland to build a luxury enclave — destroying the natural sponge that saves the city from monsoon flooding. The paperwork is forged and he dines with your ministers.",
  ...
  ax("Rural Health Director", "doctor", ["healthcare", "rural", "doctors"],
    sx("Honourable leader! The rural clinics stand empty of doctors — every graduate wants the city or the Gulf, and the village posts go unfilled for years. The Director proposes a mandatory rural-service bond for new doctors; the medical association will fight it bitterly.",
  ...
  ax("Coastal Fisheries Officer", "people", ["plastic", "fisheries", "waste"],
    sx("Coastal Fisheries Officer reports: Plastic chokes the rivers and the catch is shrinking; the fisherfolk haul up more bags than fish. A single-use plastic ban exists on paper and is universally ignored. The officer wants real enforcement; the plastics industry warns of lost jobs.",
  ...
  ax("Food Safety Director", "official", ["food", "adulteration", "formalin"],
    sx("A note from the Welfare Ministry reads: Markets are awash with formalin-soaked fish, carbide-ripened fruit, and toxic-dyed sweets. The director wants mobile courts and lab testing in every bazaar — a war on the traders who poison the daily plate.",
  ...
  ax("Char Erosion Officer", "people", ["erosion", "rivers", "displacement"],
    sx("Word from the Welfare Ministry, sir — The great rivers swallow villages whole each monsoon, turning farmers into landless paupers overnight. The officer wants a serious river-protection and resettlement programme — vast, unglamorous, and expensive.",
  ...
  ax("Community Clinic Director", "doctor", ["healthcare", "primary-care", "rural"],
    sx("Community Clinic Director: The network of village community clinics — primary care at every doorstep — is starved of medicine and staff. The director wants a big reinvestment; the finance side wants to quietly let them wither.",
  ...
  ax("Sanitation Engineer", "official", ["sanitation", "sewage", "water"],
    sx("Sir, a message from the Welfare Ministry: The capital has almost no sewage treatment; its waste pours raw into the rivers it also drinks from. The engineer's treatment-plant plan is monumental in cost and decades overdue.",
  ...
  ax("Heatwave Response Lead", "people", ["heat", "climate", "urban"],
    sx("A record heatwave is killing the elderly and the rickshaw-pullers and buckling the power grid. The lead wants emergency cooling centres, work-hour limits, and a long-term tree-and-water plan for the baking city. What are your orders, sir?",
  ...
  ax("Maternal Health Officer", "doctor", ["maternal", "mortality", "women"],
    sx("Maternal Health Officer awaits your word. Too many mothers still die in childbirth far from any skilled hand. The officer wants midwives in every union and free emergency obstetric transport — cheap lives saved, if you fund the unglamorous plumbing of care.",
  ...
  ax("Wildlife Warden", "people", ["wildlife", "poaching", "tigers"],
    sx("Dear Sir — The mangrove tigers and the river dolphins are being poached and netted toward extinction, sometimes by the very forest-edge poor who have nothing else. The warden wants armed protection and alternative livelihoods.",
  ...
  ax("Oxygen & Pandemic Officer", "doctor", ["pandemic", "oxygen", "preparedness"],
    sx("Honourable leader! The last respiratory surge saw patients die for want of oxygen in the corridors. The officer wants a national medical-oxygen and ICU build-out before the next wave, while the danger feels far away.",
  ...
  ax("Coastal Afforestation Lead", "people", ["mangrove", "coast", "climate"],
    sx("Coastal Afforestation Lead reports: A green belt of mangroves along the cyclone coast would blunt the storm surges that drown thousands — but planting and protecting it means restraining the shrimp farms and settlers who clear the shore.",
  ...
  ax("Urban Tree Officer", "people", ["trees", "development", "city"],
    sx("A note from the Welfare Ministry reads: A road-widening scheme would fell the last great avenue of century-old trees that shade and cool the choking capital. The contractors are eager; the citizens have begun to hug the trunks.",
  ...
  ax("Char Schools Coordinator", "people", ["education", "char", "children"],
    sx("Word from the Welfare Ministry, sir — Children on the shifting river islands grow up without a school in reach, a generation written off by geography. The coordinator wants floating schools and boat-clinics; the cost per child is high and the cameras never come.",
  ...
  ax("Air Quality Commissioner", "people", ["air", "vehicles", "emissions"],
    sx("Air Quality Commissioner: Beyond the brick kilns, the capital's air is poisoned by ancient diesel buses and trucks belching black smoke. Scrapping or retrofitting them cleans the air and enrages the transport syndicates already at your throat.",
  ...
  ax("Nutrition Programme Head", "doctor", ["nutrition", "stunting", "children"],
    sx("Sir, a message from the Welfare Ministry: A third of the country's children are stunted by poor early nutrition, a quiet catastrophe for the nation's future minds. The head wants a fortified-food and maternal-nutrition drive that pays off only in twenty years.",
  ...
  ax("Waste Management Chief", "official", ["solid-waste", "city", "dumping"],
    sx("The capital generates mountains of garbage and the open dumps are overflowing into the wetlands and the air. The chief wants segregated collection and engineered landfills; the informal haulers and dump bosses resist. What are your orders, sir?",
  ...
  ax("Disability Services Advocate", "people", ["disability", "welfare", "access"],
    sx("Disability Services Advocate awaits your word. Millions live with disabilities almost wholly unserved by the state — no ramps, no allowances, no schools that will take them. The advocate wants a national disability programme; it is right, and it is a cost with no headline.",
  ...
  ax("Haor Flash-Flood Officer", "people", ["haor", "flood", "harvest"],
    sx("Sir! An early flash flood threatens to drown the entire boro rice harvest of the great wetland basin before it can be cut — a regional famine in the making. The officer needs emergency embankment repair and harvest labour now.",
  ...
  ax("Birth Registration Director", "official", ["children", "registration", "rights"],
    sx("Mr. Prime Minister, sir! Millions of children have no birth certificate and thus no legal existence — easy prey for trafficking, child marriage, and child labour. The director wants universal digital registration, opposed by those who profit from invisible children.",
  ...
  ax("Disaster Management Chief", "relief", ["cyclone", "shelters", "preparedness"],
    sx("Your Excellency! A super-cyclone is two days out and the coast has shelters for barely half its people. Order a full pre-emptive evacuation inland — chaotic, costly, unpopular if the storm veers — or trust the shelters and hope the track holds?",
    ...
    sx("Dear Sir — The storm has passed, sparing the worst, but it exposed how few and crumbling the shelters are. The chief wants a crash programme to double the shelter network; the treasury says the money is needed elsewhere now the danger is gone.",
  ...
  ax("River Erosion Officer", "people", ["erosion", "displacement", "rivers"],
    sx("Honourable leader! The great rivers are eating their banks, swallowing whole villages each monsoon and creating a tide of landless climate refugees. Fund expensive bank-protection works for a few key towns, or spread thin cash relief to the displaced everywhere?",
  ...
  ax("Nutrition Programme Director", "doctor", ["nutrition", "children", "stunting"],
    sx("Nutrition Programme Director reports: A third of the country's children are stunted, their growth and minds permanently dwarfed by early malnutrition. The director wants a national programme of school meals and fortified food — a slow, costly investment whose payoff is decades off.",
  ...
  ax("Immunisation Director", "doctor", ["vaccines", "children", "public-health"],
    sx("A note from the Welfare Ministry reads: A measles-rubella outbreak threatens a mass campaign, but anti-vaccine rumours are spreading through religious networks and social media. Push a hard mandatory drive that may provoke a backlash, or run a softer, slower voluntary campaign?",
  ...
  ax("Maternal Health Chief", "doctor", ["maternal", "midwives", "rural"],
    sx("Word from the Welfare Ministry, sir — Too many mothers still die in childbirth in the villages, far from any skilled hand. Train and deploy thousands of community midwives nationwide — a years-long, costly build — or simply fund more distant city hospitals?",
  ...
  ax("Tobacco Control Officer", "official", ["tobacco", "health", "revenue"],
    sx("Tobacco Control Officer: Tobacco kills over a hundred thousand a year here, but the industry — partly state-owned — is a major taxpayer and employer. The officer wants punitive taxes and plain packaging; the finance ministry warns of the revenue and jobs at stake.",
  ...
  ax("Road Safety Authority Head", "official", ["roads", "safety", "transport"],
    sx("Sir, a message from the Welfare Ministry: The highways are a slaughter — unlicensed drivers, killer buses racing for fares, no enforcement. After a bus killed two students and sparked a youth uprising, the head wants real licensing and a crackdown on the transport cartels who block all reform.",
  ...
  ax("Inland Waterways Director", "official", ["ferry", "safety", "disaster"],
    sx("Overloaded river launches capsize every year, drowning hundreds, because owners cram in double the passengers and inspectors are bribed to look away. The director wants strict capacity enforcement and night-sailing bans; the owners and the crowds will both resist. What are your orders, sir?",
  ...
  ax("Food Safety Chief", "doctor", ["food", "adulteration", "health"],
    sx("Food Safety Chief awaits your word. Fish are soaked in formalin, fruit force-ripened with chemicals, milk cut with detergent — the food supply is quietly poisoned for profit. The chief wants mobile courts and harsh penalties; the wholesale syndicates will fight every raid.",
  ...
  ax("Sanitation Programme Head", "people", ["sanitation", "hygiene", "disease"],
    sx("Mr. Prime Minister, sir! The country has nearly ended open defecation — a genuine triumph — but millions of latrines are unhygienic pits that contaminate the groundwater. Fund a costly upgrade to safe sanitation, or rest on the headline victory already won?",
  ...
  ax("Urban Planning Adviser", "official", ["heat", "trees", "city"],
    sx("Your Excellency! The capital is a heat island, its trees felled for roads and towers, its summers turning lethal for the poor and old. The adviser wants protected green corridors and a tree-planting mandate that would block some lucrative development.",
  ...
  ax("Disaster Management Chief", "people", ["landslide", "hill-cutting", "slums"],
    sx("Dear Sir — In the southeast, the poor build on hillsides illegally cut by land-grabbers, and every monsoon landslides bury whole settlements. Evict the hillside slums for their safety — leaving thousands homeless — or jail the grabbers and try to stabilise the slopes?",
  ...
  ax("Wetlands Director", "official", ["wetlands", "real-estate", "flooding"],
    sx("Honourable leader! Powerful developers are illegally filling the capital's flood-retention wetlands to build housing estates, destroying the city's natural drainage. The director wants the projects demolished; the developers are connected and have pre-sold thousands of plots.",
  ...
  ax("Wildlife Crime Officer", "official", ["wildlife", "trafficking", "biodiversity"],
    sx("Wildlife Crime Officer reports: The country is a transit hub for trafficked tigers, pangolins, and rare birds, with officials on the take at every airport and border. The officer wants a hard anti-trafficking unit — which means prosecuting some well-connected names.",
  ...
  ax("Social Welfare Secretary", "people", ["welfare", "elderly", "disability"],
    sx("A note from the Welfare Ministry reads: The old-age and disability allowances are tiny, riddled with ghost beneficiaries, and the real needy are often left off the lists by local touts. The secretary wants a digitised, expanded scheme — disrupting the patronage networks that skim it.",
  ...
  ax("Health Regulation Chief", "doctor", ["quacks", "clinics", "regulation"],
    sx("Word from the Welfare Ministry, sir — Unlicensed 'doctors' and filthy private clinics flourish in the villages and slums, where real care never reaches. The chief wants a crackdown — but shutting them leaves millions with no care at all.",
  ...
  ax("Health Financing Adviser", "doctor", ["health", "coverage", "poverty"],
    sx("Health Financing Adviser: A single illness bankrupts countless families, who pay for almost all care out of pocket. The adviser proposes a national health-insurance scheme starting with the poorest — transformative, but a vast permanent claim on the budget.",
  ...
  ax("Labour Welfare Officer", "people", ["heat", "workers", "outdoor"],
    sx("Sir, a message from the Welfare Ministry: Record heatwaves are killing outdoor workers — rickshaw-pullers, brick-haulers, farmhands — who cannot stop without starving. The officer wants mandated rest, shade, and water during extreme heat; employers say it will halt the work that feeds the workers.",
  ...
  ax("Hospital Services Director", "doctor", ["hospitals", "medicine", "corruption"],
    sx("Public hospitals are meant to give medicine free, but most of it is stolen and sold out the back door, forcing patients to buy their own. The director wants a tracked, audited supply chain; the rackets run deep into staff and unions. What are your orders, sir?",
  ...
  ax("Rural Health Coordinator", "doctor", ["snakebite", "rural", "antivenom"],
    sx("Rural Health Coordinator awaits your word. Snakebite kills thousands of villagers a year who reach no antivenom in time, turning to faith-healers as they die. The coordinator wants antivenom stocked in every rural clinic and a training drive — cheap in money, hard in logistics and habit.",
  ...
  ax("Meteorological Director", "official", ["lightning", "farmers", "warning"],
    sx("Sir! Lightning now kills hundreds of farmers a year in the open fields, a toll worsened by felled trees and a warming climate. The director wants warning sirens, field shelters, and replanting of tall trees — modest money, scattered impact.",
  ...
  ax("Relief Coordinator", "relief", ["cold-wave", "poverty", "relief"],
    sx("Mr. Prime Minister, sir! A severe cold wave is killing the elderly and homeless in the north, who have no blankets and no warm clothes. The coordinator wants an immediate mass blanket-and-fuel distribution; the cynics note such drives are easily turned into partisan photo-ops and skimmed.",
  ...
  ax("Hospital Services Director", "doctor", ["dengue", "hospitals", "surge"],
    sx("Your Excellency! This year's dengue epidemic is the worst on record and the hospitals are overflowing, patients on floors and in corridors. The director needs emergency field hospitals and fogging crews now; the finance ministry balks at the unbudgeted crore.",
  ...
  ax("City Drainage Engineer", "official", ["waterlogging", "drainage", "city"],
    sx("Dear Sir — The port city drowns for days after every heavy rain because its canals are choked with waste and built over. Reclaim the canals and rebuild drainage — evicting the encroachers, many politically connected — or keep pumping after each flood?",
  ...
  ax("Agricultural Health Officer", "doctor", ["pesticides", "farmers", "health"],
    sx("Honourable leader! Farmers drench their fields with banned, overstrong pesticides, poisoning themselves, the soil, and the consumers — and the agro-chemical dealers push ever more. The officer wants regulation and pest-management training; the dealers and a chemical-dependent harvest resist.",
  ...
  ax("Wildlife Conservator", "people", ["elephants", "conflict", "forest"],
    sx("Wildlife Conservator reports: As forests shrink, wild elephants raid villages for crops and trample people, and furious farmers poison and electrocute the herds in return. The conservator wants protected corridors and crop-loss compensation; the farmers want the dangerous animals gone.",
  ...
  ax("Narcotics Control Chief", "shadow", ["drugs", "yaba", "addiction"],
    sx("A note from the Welfare Ministry reads: A flood of methamphetamine pills across the border has hooked a generation of the young. Wage a brutal 'war on drugs' of extrajudicial killings that thrills the public, or build slower treatment, rehab, and border interdiction?",
  ...
  ax("Women's Affairs Secretary", "people", ["women", "violence", "shelters"],
    sx("Word from the Welfare Ministry, sir — Domestic violence, dowry abuse, and acid attacks ruin countless women's lives, while shelters are scarce and cases vanish in a hostile justice system. The secretary wants shelters, fast-track courts, and a one-stop crisis service — costly and culturally contentious.",
  ...
  ax("Women's Affairs Secretary", "people", ["child-marriage", "girls", "education"],
    sx("Women's Affairs Secretary: Child marriage remains rampant, pulling girls out of school and into early, dangerous pregnancies. A proposed law would tighten the minimum age — but a 'special provision' clause would let parents marry off younger girls 'in special cases', a loophole big enough to drive the practice through.",
  ...
  ax("Health Regulation Chief", "doctor", ["medical-waste", "blood", "safety"],
    sx("Sir, a message from the Welfare Ministry: Hospital waste — syringes, blood bags, organs — is scavenged and resold, and the commercial blood trade runs on paid, untested donors spreading hepatitis and HIV. The chief wants strict tracking and a volunteer blood system; the rackets are lucrative and entrenched.",
  ...
  ax("Health Workforce Director", "doctor", ["health-workers", "migration", "rural"],
    sx("Trained nurses and doctors leave for the Gulf and the West the moment they qualify, and almost none will serve in the villages. The director wants bonded rural-service requirements and better pay and housing for those who stay — costly, and resented by the young professionals. What are your orders, sir?",
  ...
  ax("Geological Survey Director", "official", ["subsidence", "groundwater", "city"],
    sx("Geological Survey Director awaits your word. The capital is sinking as it sucks its aquifer dry for water, raising the flood risk for millions. The director wants a hard shift to treated surface water and a cap on deep wells — a huge, slow investment — versus the cheap, fast deep-well status quo.",
  ...
  ax("Urban Development Secretary", "people", ["slums", "housing", "eviction"],
    sx("Sir! A vast slum sits on prime public land a developer covets. The secretary can clear it for a lucrative project and a fat fee to the treasury, or invest in upgrading it in place with water, sanitation, and secure tenure for the half-million who live there.",
  ...
  ax("Mental Health Coordinator", "doctor", ["mental-health", "stigma", "care"],
    sx("Mr. Prime Minister, sir! Depression, trauma, and suicide go almost entirely untreated, hidden by stigma and a near-total lack of services. The coordinator wants mental health woven into primary care and the chaining of patients in 'healing' shrines outlawed — unglamorous work, easy to deprioritise.",
  ...
  ax("Wetlands Director", "official", ["birds", "hunting", "wetlands"],
    sx("Your Excellency! Each winter, poachers net and poison the migratory birds that flock to the haors by the hundred thousand, selling them in the markets. The director wants armed wetland guards and market raids; the trade feeds poor villagers and a delicacy market alike.",
  ...
  ax("Air Quality Officer", "official", ["air", "vehicles", "emissions"],
    sx("Dear Sir — Smoke-belching old buses, trucks, and two-stroke engines are a major source of the capital's lethal air. The officer wants the worst vehicles scrapped and emissions-tested off the road; the owners and the legions of poor drivers will fight it hard.",
  ...
  ax("Aquatic Conservator", "relief", ["dolphins", "rivers", "biodiversity"],
    sx("Honourable leader! The rare freshwater river dolphins are dying in fishing nets and dredged, poisoned channels — a living symbol of the rivers' decline. The conservator wants protected sanctuary stretches; the fishers in those reaches will lose their grounds.",
  ...
  ax("Public Health Engineer", "people", ["arsenic", "water", "health"],
    sx("Public Health Engineer reports: Whole districts still drink arsenic-laced tube-well water, slowly poisoning millions toward cancer and lesions. The engineer wants a deep-well and surface-treatment programme to give them safe water; it is costly and the harm is slow and invisible.",
  ...
  ax("Solid Waste Director", "official", ["waste", "landfill", "recycling"],
    sx("A note from the Welfare Ministry reads: The capital's mountainous landfills are overflowing and toxic. A foreign firm offers a waste-to-energy incinerator — a fast fix that would undercut the informal waste-pickers and lock in decades of burning, versus a slower push for sorting and recycling.",
  ...
  ax("Education Inclusion Officer", "people", ["disability", "education", "inclusion"],
    sx("Word from the Welfare Ministry, sir — Children with disabilities are almost entirely shut out of the schools — no ramps, no trained teachers, no will. The officer wants an inclusive-education mandate and accessibility retrofits system-wide; it is costly and the demand is politically quiet.",
  ...
  ax("Climate Resilience Director", "official", ["climate", "adaptation", "funding"],
    sx("Climate Resilience Director: Foreign climate funds could go to flashy mitigation showpieces that please donors, or to gritty local adaptation — saline-tolerant seeds, raised homesteads, floating gardens — that actually shields the frontline poor. Where should the money land?",
  ...
  ax("Environment Inspector", "people", ["effluent", "rivers", "industry"],
    sx("Sir, a message from the Welfare Ministry: The dyeing and washing factories of the industrial belt pour untreated, rainbow-coloured effluent into the rivers, killing them and the villages downstream — but they drive the export boom. The inspector wants effluent-treatment plants made mandatory and enforced.",
    ...
    sx("You ordered treatment, but the factories run the plants only during inspections, switching them off to save power the rest of the time. The inspector wants live, tamper-proof monitoring wired to your office; the owners call it surveillance and overreach. What are your orders, sir?",
    ...
    sx("Environment Inspector awaits your word. With monitoring in place, the worst-offending factory — owned by a major party donor — is caught dumping for months and faces closure. He calls in his debt: a quiet pardon, or he pulls his funding and a thousand jobs with it.",
  ...
  ax("Child Nutrition Director", "doctor", ["breastfeeding", "formula", "marketing"],
    sx("Dear Sir — Aggressive infant-formula marketing is pushing mothers off breastfeeding toward costly formula often mixed with unsafe water, harming babies. The director wants hard enforcement of the formula-marketing code; the formula industry, a big advertiser and donor, resists.",
  ...
  ax("Non-Communicable Disease Director", "doctor", ["diabetes", "ncd", "prevention"],
    sx("Honourable leader! Diabetes, heart disease, and hypertension are exploding — now the country's biggest killers — yet the health system is built for infections, not chronic care. The director wants a costly pivot to NCD screening and management; the payoff is slow and diffuse.",
  ...
  ax("Food Standards Director", "doctor", ["trans-fat", "heart-disease", "food"],
    sx("Food Standards Director reports: Industrial trans-fats — in the cheap dalda and baked goods the poor eat most — drive a wave of heart disease, and a hard limit would save lives at almost no cost to the consumer. The vanaspati and bakery industries lobby hard against it.",
  ...
  ax("Hospital Capacity Director", "doctor", ["oxygen", "icu", "preparedness"],
    sx("A note from the Welfare Ministry reads: The last respiratory crisis exposed a fatal shortage of medical oxygen and ICU beds, with patients dying in corridors gasping for air. The director wants a permanent build-out of oxygen plants and critical-care beds; between crises the money is wanted elsewhere.",
  ...
  ax("Public Health Veterinary Officer", "doctor", ["rabies", "dogs", "vaccination"],
    sx("Word from the Welfare Ministry, sir — Rabies from dog bites kills hundreds a year, mostly poor children, and culling strays only scatters them and fails. The officer wants a humane mass dog-vaccination and sterilisation programme that actually ends rabies; it is costly and slow versus the cheap, futile culls.",
  ...
  ax("Women's Health Director", "doctor", ["hpv", "cancer", "girls"],
    sx("Women's Health Director: Cervical cancer is a leading cancer killer of the country's women, and an HPV vaccine given to adolescent girls would all but prevent it for a generation. The director wants a national school campaign; anti-vaccine rumours and conservative unease about a 'sex' vaccine threaten it.",
  ...
  ax("Sanitation Engineering Director", "people", ["sewage", "sludge", "cities"],
    sx("Sir, a message from the Welfare Ministry: The cities' septic tanks and latrines are emptied by informal crews who dump the raw sludge straight into drains and rivers, undoing the sanitation gains. The director wants a proper faecal-sludge treatment system; it is costly, unglamorous, and easy to ignore.",
  ...
  ax("Genetic Health Director", "doctor", ["thalassemia", "screening", "prevention"],
    sx("A staggering number of children are born each year with thalassemia, a lifelong blood disorder, because carrier parents never knew. A premarital and prenatal screening programme could prevent most cases; it is costly and touches the sensitive ground of marriage. What are your orders, sir?",
  ...
  ax("Occupational Health Director", "doctor", ["silicosis", "byssinosis", "workers"],
    sx("Occupational Health Director awaits your word. Stone-crusher and textile-mill workers are dying of silicosis and byssinosis — lungs destroyed by dust the law says employers must control but never do. The director wants enforcement, dust controls, and compensation; the industry calls it ruinous.",
  ...
  ax("Disaster Health Coordinator", "doctor", ["mental-health", "disaster", "trauma"],
    sx("Sir! Survivors of cyclones, floods, and displacement carry untreated trauma the relief system entirely ignores. The coordinator wants psychosocial support built into disaster response; the hard-nosed call it a luxury when people need rice and roofs.",
  ...
  ax("Drug Pricing Director", "doctor", ["medicines", "pricing", "access"],
    sx("Mr. Prime Minister, sir! Prices of essential, life-saving medicines have crept beyond the poor's reach, while the pharmaceutical industry — a proud export earner and donor — resists price controls. The director wants an essential-medicines price ceiling; the industry threatens to cut investment.",
  ...
  ax("Health Services Director", "people", ["doctors", "absenteeism", "rural"],
    sx("Your Excellency! The rural health clinics stand staffed on paper but empty in fact, their posted doctors absent in private city practice while villagers find locked doors. The director wants biometric attendance and real consequences; the medical lobby resists fiercely.",
  ...
  ax("Primary Health Director", "people", ["clinics", "primary-care", "access"],
    sx("Dear Sir — The network of community clinics bringing basic care to the villages is the country's quiet health triumph — but many lack medicine, staff, and repair, sliding toward uselessness. The director wants a major reinvestment; the money competes with flashier hospital projects.",
  ...
  ax("Adolescent Health Director", "doctor", ["adolescents", "substance", "harm"],
    sx("Honourable leader! A wave of cheap intoxicants and adulterated energy drinks is harming the urban young, with no honest information and only a punitive response. The director wants harm-reduction education and clean-product enforcement; moralists demand crackdowns and silence instead.",
  ...
  ax("Urban Food Safety Officer", "doctor", ["street-food", "hygiene", "disease"],
    sx("Urban Food Safety Officer reports: The street food millions rely on is often prepared with contaminated water and no hygiene, spreading typhoid and diarrhoeal disease. License and support vendors with clean water and hygiene training, or keep clearing them in futile drives?",
  ...
  ax("Industrial Health Director", "doctor", ["asbestos", "ban", "construction"],
    sx("A note from the Welfare Ministry reads: Asbestos, banned across much of the world, is still imported and used in cheap roofing and the shipbreaking yards, seeding a slow epidemic of lung cancer decades out. The director wants an import-and-use ban; the roofing and shipbreaking industries resist.",
  ...
  ax("Urban Resilience Officer", "relief", ["heat", "cities", "adaptation"],
    sx("Word from the Welfare Ministry, sir — Killer heatwaves are becoming routine, and the cities have no plan — no cooling shelters, no warnings, no protection for the outdoor poor. The officer wants a costly urban heat-action plan; between heatwaves the danger feels abstract and the budget contested.",
  ...
  ax("Marine Pollution Officer", "relief", ["oil-spill", "marine", "mangroves"],
    sx("Marine Pollution Officer: A tanker has spilled furnace oil into the mangrove rivers, coating the forest, the dolphins, and the fishers' grounds, and there is no response capacity worth the name. The officer wants a real marine-spill response system built; for now, choose how hard to scramble.",
  ...
  ax("School Health Director", "doctor", ["anaemia", "deworming", "children"],
    sx("Sir, a message from the Welfare Ministry: Anaemia and intestinal worms sap the health and minds of a huge share of the country's schoolchildren — both cheaply treatable with iron and deworming tablets through the schools. The director wants a universal programme; even this small cost faces scrutiny.",
  ...
  ax("Environmental Justice Officer", "official", ["green-court", "litigation", "enforcement"],
    sx("Polluters escape because the ordinary courts are too slow and ignorant to try them. A dedicated environmental court with real teeth would change that — and would also turn its gaze on the connected industries and the agencies that rubber-stamp their clearances. What are your orders, sir?",
  ...
  ax("Environmental Clearance Director", "shadow", ["eia", "clearance", "corruption"],
    sx("Environmental Clearance Director awaits your word. Environmental impact assessments are a rubber stamp — written by the developers, blessed for a bribe, ignoring every real harm. The director wants independent, credible assessments with public hearings; the developers and the officials who sell the stamps resist hard.",
  ...
  ax("Meteorological Director", "relief", ["cyclone", "early-warning", "technology"],
    sx("Mr. Prime Minister, sir! The old storm warning alarms are breaking down. You can spend money to buy new ones, or hope the old ones keep working.",
  ...
  ax("Family Planning Director", "people", ["family-planning", "population", "women"],
    sx("Your Excellency! Programs that help families decide how many kids to have are running out of money. You can fix them, but some strict people won't like it.",
  ...
  ax("Cancer Care Director", "doctor", ["cancer", "radiotherapy", "access"],
    sx("Dear Sir — People with cancer are dying because there are very few special machines to help them, and they are all in the big city. Buying more for other towns costs a lot.",
  ...
  ax("Urban Open-Space Officer", "people", ["parks", "playgrounds", "children"],
    sx("Honourable leader! Builders are paving over all the city parks so kids have nowhere to play. You can protect the parks, but the builders will be angry.",
  ...
  ax("Adolescent Girls' Health Director", "people", ["menstruation", "girls", "school"],
    sx("Adolescent Girls' Health Director reports: Girls are missing school because they don't have what they need for their periods. You can give out free supplies, but some people are too embarrassed to talk about it.",
  ...
  ax("Water Quality Director", "doctor", ["fluoride", "water", "health"],
    sx("A note from the Welfare Ministry reads: Bad chemicals in the water are making people's bones and teeth sick in some towns. You can spend money to clean it, but it only helps a few places.",
  ...
  ax("Environmental Health Officer", "people", ["noise", "pollution", "health"],
    sx("Word from the Welfare Ministry, sir — The city is so noisy it hurts people's ears and hearts. You can make rules to keep it quiet near hospitals, but drivers will be mad.",
  ...
  ax("Emergency Services Director", "relief", ["ambulance", "emergency", "trauma"],
    sx("Emergency Services Director: There are no good ambulances, so sick people don't get to the hospital in time. You can build a real 999 rescue system, but it costs a lot.",
  ...
  ax("Neglected Disease Director", "doctor", ["kala-azar", "elimination", "poverty"],
    sx("Sir, a message from the Welfare Ministry: A deadly bug sickness is almost gone. You can spend a little more money to wipe it out forever, or stop now and risk it coming back.",
  ...
  ax("Eye Health Director", "doctor", ["blindness", "cataract", "access"],
    sx("Many poor people are blind, but a simple 15-minute doctor visit could fix their eyes. You can send doctors to the villages to help them. What are your orders, sir?",
  ...
  ax("Disease Surveillance Director", "doctor", ["surveillance", "labs", "outbreaks"],
    sx("Disease Surveillance Director awaits your word. The country is never ready when a new sickness spreads. You can build special science labs to watch for bugs, but they are expensive.",
  ...
  ax("Pharmacy Regulation Director", "doctor", ["antibiotics", "pharmacy", "resistance"],
    sx("Sir! People are taking strong medicine like candy, which creates super-bugs. You can force stores to only sell it with a doctor's note.",
  ...
  ax("Social Welfare Director", "relief", ["elderly", "ageing", "care"],
    sx("Mr. Prime Minister, sir! Old people are being left alone with no one to care for them. You can build special homes to help them, but it costs money.",
  ...
  ax("Hospital Quality Director", "doctor", ["infection-control", "hospitals", "safety"],
    sx("Your Excellency! Hospitals are so dirty that people catch new sicknesses while they are there. You can force them to be clean, but they will complain.",
  ...
  ax("Solid Waste Director", "official", ["composting", "waste", "landfill"],
    sx("Dear Sir — Garbage is rotting in the streets. You can make a system to turn the smelly garbage into plant food, but it takes hard work.",
  ...
  ax("Public Health Nutrition Director", "doctor", ["salt", "hypertension", "diet"],
    sx("Honourable leader! People eat way too much salt, giving them heart attacks. You can make food companies use less salt, but they will fight you.",
  ...
  ax("Disability Services Director", "relief", ["disability", "assistive-devices", "access"],
    sx("Disability Services Director reports: People who can't walk or hear don't have money for wheelchairs or hearing aids. You can buy them for everyone who needs them.",
  ...
  ax("Building Code Director", "official", ["green-building", "code", "developers"],
    sx("A note from the Welfare Ministry reads: New buildings waste a lot of electricity and have no green grass. You can force builders to be eco-friendly, but it costs them more.",
  ...
  ax("Animal Welfare Officer", "relief", ["animals", "cruelty", "welfare"],
    sx("Word from the Welfare Ministry, sir — Animals are being treated very meanly on the streets and in farms. You can make a law to protect animals from bullies.",
  ...
  ax("Vector Control Director", "doctor", ["mosquitoes", "fogging", "dengue"],
    sx("Vector Control Director: The bug spray in the city isn't killing the mosquitoes anymore. You need to clean the dirty water where they live, but people just want to see the spray.",
  ...
  ax("Palliative Care Director", "doctor", ["palliative", "hospice", "dignity"],
    sx("Sir, a message from the Welfare Ministry: Very sick people who are dying are in lots of pain. You can give them strong medicine to make them comfortable, but people are scared they will get addicted.",
  ...
  ax("School Health Officer", "doctor", ["screening", "children", "education"],
    sx("Kids fail school simply because they can't see the board. You can buy free glasses for kids who need them. What are your orders, sir?",
  ...
  ax("Wetland Conservation Officer", "relief", ["wetland", "ramsar", "biodiversity"],
    sx("Wetland Conservation Officer awaits your word. Builders want to drain a beautiful swamp where winter birds live so they can build houses. You can protect the swamp forever.",
  ...
  ax("Oral Health Director", "doctor", ["dental", "oral-cancer", "betel"],
    sx("Sir! Chewing bad tobacco is giving people mouth cancer. You can send dentists to help and teach people to stop, but the tobacco sellers will be mad.",
  ...
  ax("Air Quality Director", "official", ["air-monitoring", "data", "transparency"],
    sx("Mr. Prime Minister, sir! No one knows how poisonous the air really is because there are no testing machines. You can put machines up, but the factories are scared of the truth.",
  ...
  ax("Disaster Preparedness Director", "relief", ["earthquake", "buildings", "preparedness"],
    sx("Your Excellency! The city buildings would all fall down if a big earthquake hit. You can spend money to fix them now, or just hope the earthquake never happens.",
  ...
  ax("Suicide Prevention Director", "doctor", ["suicide", "pesticide", "rural"],
    sx("Dear Sir — People are using dangerous farm poisons to hurt themselves when they are sad. You can lock up the poisons to keep people safe.",
  ...
  ax("Immunisation Logistics Director", "doctor", ["vaccines", "cold-chain", "coverage"],
    sx("Honourable leader! The refrigerators that keep kids' medicines safe are breaking. If you don't buy new ones, the medicine won't work.",
  ...
  ax("Renal Care Director", "doctor", ["dialysis", "kidney", "access"],
    sx("Renal Care Director reports: Many people have very sick kidneys and need a special cleaning machine to stay alive. You can build cheap machine centers everywhere, but it costs a lot.",
  ...
  ax("Health Facility Director", "doctor", ["wash", "hospitals", "hygiene"],
    sx("A note from the Welfare Ministry reads: Hospitals are so dirty they don't even have clean water to wash hands. You can fix the pipes and toilets to make them clean.",
  ...
  ax("School Nutrition Director", "doctor", ["obesity", "junk-food", "children"],
    sx("Word from the Welfare Ministry, sir — Kids are eating too much junk food at school and getting unhealthy. You can ban junk food, but the kids and the snack companies will complain.",
  ...
  ax("Rural Housing Director", "relief", ["flood", "housing", "resilience"],
    sx("Rural Housing Director: Floods wash away the same poor houses every single year. You can build them tall, safe houses, or just keep giving them cheap emergency food.",
  ...
  ax("Blood Services Director", "doctor", ["blood", "donation", "safety"],
    sx("Sir, a message from the Welfare Ministry: People sell sick blood to hospitals for money. You can stop this and only take healthy blood from volunteers, but it takes time to set up.",
  ...
  ax("Mental Health Director", "doctor", ["suicide", "helplines", "stigma"],
    sx("Sad people who try to hurt themselves are treated like criminals and put in jail. You can change the rule and give them doctors instead. What are your orders, sir?",
  ...
  ax("Road Safety Health Officer", "doctor", ["helmets", "trauma", "enforcement"],
    sx("Road Safety Health Officer awaits your word. Too many motorcycle riders are crashing without helmets and hurting their heads. You can force them to wear helmets, but they will be annoyed.",
  ...
  ax("Child Development Director", "doctor", ["autism", "disability", "children"],
    sx("Dear Sir — Kids whose brains work a little differently are hidden away with no schools. You can build special classes to help them learn.",
  ...
  ax("Urban Waterways Officer", "people", ["canals", "waste", "flooding"],
    sx("Honourable leader! City rivers are clogged with garbage, causing floods and disease. You can force people to stop throwing garbage in the water.",
  ...
  ax("Labour Welfare Director", "people", ["creches", "women", "workforce"],
    sx("Labour Welfare Director reports: Working moms have nowhere safe to leave their babies. The law says factories must have baby rooms, but bosses ignore it.",
  ...
  ax("Enteric Disease Director", "doctor", ["cholera", "typhoid", "vaccines"],
    sx("A note from the Welfare Ministry reads: Dirty water gives people terrible stomach bugs. You can give them a special medicine shot to stop it while you fix the pipes.",
  ...
  ax("Health Information Director", "official", ["health-data", "records", "privacy"],
    sx("Word from the Welfare Ministry, sir — You can put everyone's doctor records on a giant computer so they are easy to find. But people are scared the government will spy on their secrets.",
  ...
  ax("Tobacco Control Officer", "doctor", ["vaping", "shisha", "youth"],
    sx("Tobacco Control Officer: Kids are smoking sweet-smelling vape pens. You can tax them and make strict rules just like normal cigarettes, but sellers will be mad.",
  ...
  ax("Disaster Relief Director", "relief", ["flood", "shelter", "livestock"],
    sx("Sir, a message from the Welfare Ministry: During floods, poor farmers drown because they refuse to leave their cows behind. You can build safe houses for people AND their cows.",
  ...
  ax("Green Economy Officer", "people", ["waste-pickers", "green-jobs", "informal"],
    sx("Poor people dig through the trash to recycle things for pennies. You can give them uniforms, safe tools, and real jobs. What are your orders, sir?",
  ...
  ax("Health Quality Director", "doctor", ["accreditation", "hospitals", "standards"],
    sx("Health Quality Director awaits your word. Some private hospitals are amazing, and some are deadly. You can test them all and put grades on the door so people know.",
  ...
  ax("Environmental Health Director", "doctor", ["indoor-air", "household", "women"],
    sx("Sir! Cooking over smoky fires inside the house is quietly killing moms and kids. You can spend money to fix their houses and stoves.",
  ...
  ax("Public Health Director", "doctor", ["sugar", "drinks", "diabetes"],
    sx("Mr. Prime Minister, sir! Sugary sodas are making kids very unhealthy. You can stop companies from selling soda near schools, but the companies will fight you.",
  ...
  ax("Urban Migration Director", "relief", ["climate-migrants", "slums", "services"],
    sx("Your Excellency! Thousands of people lost their farms to floods and are moving to the city. You can build new, nice neighborhoods for them, or let them live in the dirt.",
