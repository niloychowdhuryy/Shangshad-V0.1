...
export const ENVIRONMENT = [
  ...
  ax("Disaster Management Chief", "official", ["cyclone", "embankment", "coast"],
    sx("A super-cyclone is forty-eight hours out and the coastal embankments — patched, looted, thin — will not hold the surge. The Chief wants a mass evacuation that will cost a fortune and admit the embankments failed. Or you can pray the storm turns.",
    ...
    sx("In the aftermath, relief is being looted by local officials before it reaches the shelters, and survivors are eating the seed grain meant for next season. An adviser proposes routing aid through the army instead of the civil administration.",
  ...
  ax("Air Quality Scientist", "people", ["air", "dhaka", "kilns"],
    sx("The capital's air is the most poisonous on earth this winter — brick kilns, traffic, and dust shaving years off every lung. The scientist wants the illegal kilns ringing the city shut. The kiln owners build the city's bricks and bankroll MPs.",
  ...
  ax("Director-General of Health", "doctor", ["dengue", "epidemic", "hospitals"],
    sx("Dengue has exploded past every record; the hospital corridors are lined with stretchers and the test kits are running out. The DG needs emergency procurement and a city-wide fogging blitz — fast, and without the usual tender delays.",
  ...
  ax("River Conservation Commissioner", "official", ["river", "tannery", "pollution"],
    sx("The river through the capital is biologically dead — black with tannery chrome and factory waste. A court ordered the tanneries relocated to a treatment estate, but its plant does not work and the owners refuse to move. Enforce the order, or excuse it?",
  ...
  ax("Urban Planning Adviser", "people", ["climate-migration", "slums", "cities"],
    sx("Every drowned coastal acre sends thousands to the capital's slums — a million climate migrants a year crowding a city already past breaking. The adviser pitches secondary 'climate-resilient' towns to absorb them, a vast and unglamorous investment.",
  ...
  ax("Wetlands Inspector", "official", ["encroachment", "wetlands", "elite"],
    sx("A politically connected developer is filling a protected flood-plain wetland to build a luxury enclave — destroying the natural sponge that saves the city from monsoon flooding. The paperwork is forged and he dines with your ministers.",
  ...
  ax("Rural Health Director", "doctor", ["healthcare", "rural", "doctors"],
    sx("The rural clinics stand empty of doctors — every graduate wants the city or the Gulf, and the village posts go unfilled for years. The Director proposes a mandatory rural-service bond for new doctors; the medical association will fight it bitterly.",
  ...
  ax("Coastal Fisheries Officer", "people", ["plastic", "fisheries", "waste"],
    sx("Plastic chokes the rivers and the catch is shrinking; the fisherfolk haul up more bags than fish. A single-use plastic ban exists on paper and is universally ignored. The officer wants real enforcement; the plastics industry warns of lost jobs.",
  ...
  ax("Disaster Management Chief", "relief", ["cyclone", "shelters", "preparedness"],
    sx("A super-cyclone is two days out and the coast has shelters for barely half its people. Order a full pre-emptive evacuation inland — chaotic, costly, unpopular if the storm veers — or trust the shelters and hope the track holds?",
    ...
    sx("The storm has passed, sparing the worst, but it exposed how few and crumbling the shelters are. The chief wants a crash programme to double the shelter network; the treasury says the money is needed elsewhere now the danger is gone.",
  ...
  ax("River Erosion Officer", "people", ["erosion", "displacement", "rivers"],
    sx("The great rivers are eating their banks, swallowing whole villages each monsoon and creating a tide of landless climate refugees. Fund expensive bank-protection works for a few key towns, or spread thin cash relief to the displaced everywhere?",
  ...
  ax("Nutrition Programme Director", "doctor", ["nutrition", "children", "stunting"],
    sx("A third of the country's children are stunted, their growth and minds permanently dwarfed by early malnutrition. The director wants a national programme of school meals and fortified food — a slow, costly investment whose payoff is decades off.",
  ...
  ax("Immunisation Director", "doctor", ["vaccines", "children", "public-health"],
    sx("A measles-rubella outbreak threatens a mass campaign, but anti-vaccine rumours are spreading through religious networks and social media. Push a hard mandatory drive that may provoke a backlash, or run a softer, slower voluntary campaign?",
  ...
  ax("Maternal Health Chief", "doctor", ["maternal", "midwives", "rural"],
    sx("Too many mothers still die in childbirth in the villages, far from any skilled hand. Train and deploy thousands of community midwives nationwide — a years-long, costly build — or simply fund more distant city hospitals?",
  ...
  ax("Road Safety Authority Head", "official", ["roads", "safety", "transport"],
    sx("The highways are a slaughter — unlicensed drivers, killer buses racing for fares, no enforcement. After a bus killed two students and sparked a youth uprising, the head wants real licensing and a crackdown on the transport cartels who block all reform.",
  ...
  ax("Inland Waterways Director", "official", ["ferry", "safety", "disaster"],
    sx("Overloaded river launches capsize every year, drowning hundreds, because owners cram in double the passengers and inspectors are bribed to look away. The director wants strict capacity enforcement and night-sailing bans; the owners and the crowds will both resist.",
  ...
  ax("Food Safety Chief", "doctor", ["food", "adulteration", "health"],
    sx("Fish are soaked in formalin, fruit force-ripened with chemicals, milk cut with detergent — the food supply is quietly poisoned for profit. The chief wants mobile courts and harsh penalties; the wholesale syndicates will fight every raid.",
  ...
  ax("Sanitation Programme Head", "people", ["sanitation", "hygiene", "disease"],
    sx("The country has nearly ended open defecation — a genuine triumph — but millions of latrines are unhygienic pits that contaminate the groundwater. Fund a costly upgrade to safe sanitation, or rest on the headline victory already won?",
  ...
  ax("Disaster Management Chief", "people", ["landslide", "hill-cutting", "slums"],
    sx("In the southeast, the poor build on hillsides illegally cut by land-grabbers, and every monsoon landslides bury whole settlements. Evict the hillside slums for their safety — leaving thousands homeless — or jail the grabbers and try to stabilise the slopes?",
  ...
  ax("Wetlands Director", "official", ["wetlands", "real-estate", "flooding"],
    sx("Powerful developers are illegally filling the capital's flood-retention wetlands to build housing estates, destroying the city's natural drainage. The director wants the projects demolished; the developers are connected and have pre-sold thousands of plots.",
  ...
  ax("Wildlife Crime Officer", "official", ["wildlife", "trafficking", "biodiversity"],
    sx("The country is a transit hub for trafficked tigers, pangolins, and rare birds, with officials on the take at every airport and border. The officer wants a hard anti-trafficking unit — which means prosecuting some well-connected names.",
  ...
  ax("Social Welfare Secretary", "people", ["welfare", "elderly", "disability"],
    sx("The old-age and disability allowances are tiny, riddled with ghost beneficiaries, and the real needy are often left off the lists by local touts. The secretary wants a digitised, expanded scheme — disrupting the patronage networks that skim it.",
  ...
  ax("Health Regulation Chief", "doctor", ["quacks", "clinics", "regulation"],
    sx("Unlicensed 'doctors' and filthy private clinics flourish in the villages and slums, where real care never reaches. The chief wants a crackdown — but shutting them leaves millions with no care at all.",
  ...
  ax("Health Financing Adviser", "doctor", ["health", "coverage", "poverty"],
    sx("A single illness bankrupts countless families, who pay for almost all care out of pocket. The adviser proposes a national health-insurance scheme starting with the poorest — transformative, but a vast permanent claim on the budget.",
  ...
  ax("Labour Welfare Officer", "people", ["heat", "workers", "outdoor"],
    sx("Record heatwaves are killing outdoor workers — rickshaw-pullers, brick-haulers, farmhands — who cannot stop without starving. The officer wants mandated rest, shade, and water during extreme heat; employers say it will halt the work that feeds the workers.",
  ...
  ax("Hospital Services Director", "doctor", ["hospitals", "medicine", "corruption"],
    sx("Public hospitals are meant to give medicine free, but most of it is stolen and sold out the back door, forcing patients to buy their own. The director wants a tracked, audited supply chain; the rackets run deep into staff and unions.",
  ...
  ax("Rural Health Coordinator", "doctor", ["snakebite", "rural", "antivenom"],
    sx("Snakebite kills thousands of villagers a year who reach no antivenom in time, turning to faith-healers as they die. The coordinator wants antivenom stocked in every rural clinic and a training drive — cheap in money, hard in logistics and habit.",
  ...
  ax("Meteorological Director", "official", ["lightning", "farmers", "warning"],
    sx("Lightning now kills hundreds of farmers a year in the open fields, a toll worsened by felled trees and a warming climate. The director wants warning sirens, field shelters, and replanting of tall trees — modest money, scattered impact.",
  ...
  ax("Relief Coordinator", "relief", ["cold-wave", "poverty", "relief"],
    sx("A severe cold wave is killing the elderly and homeless in the north, who have no blankets and no warm clothes. The coordinator wants an immediate mass blanket-and-fuel distribution; the cynics note such drives are easily turned into partisan photo-ops and skimmed.",
  ...
  ax("Hospital Services Director", "doctor", ["dengue", "hospitals", "surge"],
    sx("This year's dengue epidemic is the worst on record and the hospitals are overflowing, patients on floors and in corridors. The director needs emergency field hospitals and fogging crews now; the finance ministry balks at the unbudgeted crore.",
  ...
  ax("City Drainage Engineer", "official", ["waterlogging", "drainage", "city"],
    sx("The port city drowns for days after every heavy rain because its canals are choked with waste and built over. Reclaim the canals and rebuild drainage — evicting the encroachers, many politically connected — or keep pumping after each flood?",
  ...
  ax("Agricultural Health Officer", "doctor", ["pesticides", "farmers", "health"],
    sx("Farmers drench their fields with banned, overstrong pesticides, poisoning themselves, the soil, and the consumers — and the agro-chemical dealers push ever more. The officer wants regulation and pest-management training; the dealers and a chemical-dependent harvest resist.",
  ...
  ax("Wildlife Conservator", "people", ["elephants", "conflict", "forest"],
    sx("As forests shrink, wild elephants raid villages for crops and trample people, and furious farmers poison and electrocute the herds in return. The conservator wants protected corridors and crop-loss compensation; the farmers want the dangerous animals gone.",
  ...
  ax("Narcotics Control Chief", "shadow", ["drugs", "yaba", "addiction"],
    sx("A flood of methamphetamine pills across the border has hooked a generation of the young. Wage a brutal 'war on drugs' of extrajudicial killings that thrills the public, or build slower treatment, rehab, and border interdiction?",
  ...
  ax("Women's Affairs Secretary", "people", ["women", "violence", "shelters"],
    sx("Domestic violence, dowry abuse, and acid attacks ruin countless women's lives, while shelters are scarce and cases vanish in a hostile justice system. The secretary wants shelters, fast-track courts, and a one-stop crisis service — costly and culturally contentious.",
  ...
  ax("Women's Affairs Secretary", "people", ["child-marriage", "girls", "education"],
    sx("Child marriage remains rampant, pulling girls out of school and into early, dangerous pregnancies. A proposed law would tighten the minimum age — but a 'special provision' clause would let parents marry off younger girls 'in special cases', a loophole big enough to drive the practice through.",
  ...
  ax("Wetlands Director", "official", ["birds", "hunting", "wetlands"],
    sx("Each winter, poachers net and poison the migratory birds that flock to the haors by the hundred thousand, selling them in the markets. The director wants armed wetland guards and market raids; the trade feeds poor villagers and a delicacy market alike.",
  ...
  ax("Air Quality Officer", "official", ["air", "vehicles", "emissions"],
    sx("Smoke-belching old buses, trucks, and two-stroke engines are a major source of the capital's lethal air. The officer wants the worst vehicles scrapped and emissions-tested off the road; the owners and the legions of poor drivers will fight it hard.",
  ...
  ax("Aquatic Conservator", "relief", ["dolphins", "rivers", "biodiversity"],
    sx("The rare freshwater river dolphins are dying in fishing nets and dredged, poisoned channels — a living symbol of the rivers' decline. The conservator wants protected sanctuary stretches; the fishers in those reaches will lose their grounds.",
  ...
  ax("Public Health Engineer", "people", ["arsenic", "water", "health"],
    sx("Whole districts still drink arsenic-laced tube-well water, slowly poisoning millions toward cancer and lesions. The engineer wants a deep-well and surface-treatment programme to give them safe water; it is costly and the harm is slow and invisible.",
  ...
  ax("Solid Waste Director", "official", ["waste", "landfill", "recycling"],
    sx("The capital's mountainous landfills are overflowing and toxic. A foreign firm offers a waste-to-energy incinerator — a fast fix that would undercut the informal waste-pickers and lock in decades of burning, versus a slower push for sorting and recycling.",
  ...
  ax("Education Inclusion Officer", "people", ["disability", "education", "inclusion"],
    sx("Children with disabilities are almost entirely shut out of the schools — no ramps, no trained teachers, no will. The officer wants an inclusive-education mandate and accessibility retrofits system-wide; it is costly and the demand is politically quiet.",
  ...
  ax("Climate Resilience Director", "official", ["climate", "adaptation", "funding"],
    sx("Foreign climate funds could go to flashy mitigation showpieces that please donors, or to gritty local adaptation — saline-tolerant seeds, raised homesteads, floating gardens — that actually shields the frontline poor. Where should the money land?",
  ...
  ax("Environment Inspector", "people", ["effluent", "rivers", "industry"],
    sx("The dyeing and washing factories of the industrial belt pour untreated, rainbow-coloured effluent into the rivers, killing them and the villages downstream — but they drive the export boom. The inspector wants effluent-treatment plants made mandatory and enforced.",
    ...
    sx("You ordered treatment, but the factories run the plants only during inspections, switching them off to save power the rest of the time. The inspector wants live, tamper-proof monitoring wired to your office; the owners call it surveillance and overreach.",
    ...
    sx("With monitoring in place, the worst-offending factory — owned by a major party donor — is caught dumping for months and faces closure. He calls in his debt: a quiet pardon, or he pulls his funding and a thousand jobs with it.",
  ...
  ax("TB Programme Director", "doctor", ["tuberculosis", "disease", "poverty"],
    sx("Tuberculosis still kills tens of thousands a year here, and drug-resistant strains spread because patients drop their long treatment halfway. The director wants a costly nationwide detection-and-adherence push; the disease is unglamorous and the budget tight.",
  ...
  ax("Child Safety Director", "relief", ["drowning", "children", "ponds"],
    sx("Drowning is the leading killer of the country's young children, who slip into the countless ponds and ditches while parents work. The director wants community crèches, pond barriers, and swimming lessons — cheap per life saved, but a scattered, unglamorous effort.",
  ...
  ax("Zoonotic Disease Director", "doctor", ["nipah", "zoonosis", "outbreak"],
    sx("Each winter the deadly Nipah virus kills villagers who drink raw date-palm sap contaminated by bats — a small but terrifying outbreak with pandemic potential. The director wants a safe-sap campaign and bat-habitat research; the cause is niche and the budget contested.",
  ...
  ax("Child Nutrition Director", "doctor", ["breastfeeding", "formula", "marketing"],
    sx("Aggressive infant-formula marketing is pushing mothers off breastfeeding toward costly formula often mixed with unsafe water, harming babies. The director wants hard enforcement of the formula-marketing code; the formula industry, a big advertiser and donor, resists.",
  ...
  ax("Non-Communicable Disease Director", "doctor", ["diabetes", "ncd", "prevention"],
    sx("Diabetes, heart disease, and hypertension are exploding — now the country's biggest killers — yet the health system is built for infections, not chronic care. The director wants a costly pivot to NCD screening and management; the payoff is slow and diffuse.",
  ...
  ax("Food Standards Director", "doctor", ["trans-fat", "heart-disease", "food"],
    sx("Industrial trans-fats — in the cheap dalda and baked goods the poor eat most — drive a wave of heart disease, and a hard limit would save lives at almost no cost to the consumer. The vanaspati and bakery industries lobby hard against it.",
  ...
  ax("Hospital Capacity Director", "doctor", ["oxygen", "icu", "preparedness"],
    sx("The last respiratory crisis exposed a fatal shortage of medical oxygen and ICU beds, with patients dying in corridors gasping for air. The director wants a permanent build-out of oxygen plants and critical-care beds; between crises the money is wanted elsewhere.",
  ...
  ax("Public Health Veterinary Officer", "doctor", ["rabies", "dogs", "vaccination"],
    sx("Rabies from dog bites kills hundreds a year, mostly poor children, and culling strays only scatters them and fails. The officer wants a humane mass dog-vaccination and sterilisation programme that actually ends rabies; it is costly and slow versus the cheap, futile culls.",
  ...
  ax("Women's Health Director", "doctor", ["hpv", "cancer", "girls"],
    sx("Cervical cancer is a leading cancer killer of the country's women, and an HPV vaccine given to adolescent girls would all but prevent it for a generation. The director wants a national school campaign; anti-vaccine rumours and conservative unease about a 'sex' vaccine threaten it.",
  ...
  ax("Sanitation Engineering Director", "people", ["sewage", "sludge", "cities"],
    sx("The cities' septic tanks and latrines are emptied by informal crews who dump the raw sludge straight into drains and rivers, undoing the sanitation gains. The director wants a proper faecal-sludge treatment system; it is costly, unglamorous, and easy to ignore.",
  ...
  ax("Genetic Health Director", "doctor", ["thalassemia", "screening", "prevention"],
    sx("A staggering number of children are born each year with thalassemia, a lifelong blood disorder, because carrier parents never knew. A premarital and prenatal screening programme could prevent most cases; it is costly and touches the sensitive ground of marriage.",
  ...
  ax("Occupational Health Director", "doctor", ["silicosis", "byssinosis", "workers"],
    sx("Stone-crusher and textile-mill workers are dying of silicosis and byssinosis — lungs destroyed by dust the law says employers must control but never do. The director wants enforcement, dust controls, and compensation; the industry calls it ruinous.",
  ...
  ax("Disaster Health Coordinator", "doctor", ["mental-health", "disaster", "trauma"],
    sx("Survivors of cyclones, floods, and displacement carry untreated trauma the relief system entirely ignores. The coordinator wants psychosocial support built into disaster response; the hard-nosed call it a luxury when people need rice and roofs.",
  ...
  ax("Drug Pricing Director", "doctor", ["medicines", "pricing", "access"],
    sx("Prices of essential, life-saving medicines have crept beyond the poor's reach, while the pharmaceutical industry — a proud export earner and donor — resists price controls. The director wants an essential-medicines price ceiling; the industry threatens to cut investment.",
  ...
  ax("Health Services Director", "people", ["doctors", "absenteeism", "rural"],
    sx("The rural health clinics stand staffed on paper but empty in fact, their posted doctors absent in private city practice while villagers find locked doors. The director wants biometric attendance and real consequences; the medical lobby resists fiercely.",
  ...
  ax("Primary Health Director", "people", ["clinics", "primary-care", "access"],
    sx("The network of community clinics bringing basic care to the villages is the country's quiet health triumph — but many lack medicine, staff, and repair, sliding toward uselessness. The director wants a major reinvestment; the money competes with flashier hospital projects.",
  ...
  ax("Adolescent Health Director", "doctor", ["adolescents", "substance", "harm"],
    sx("A wave of cheap intoxicants and adulterated energy drinks is harming the urban young, with no honest information and only a punitive response. The director wants harm-reduction education and clean-product enforcement; moralists demand crackdowns and silence instead.",
  ...
  ax("Urban Food Safety Officer", "doctor", ["street-food", "hygiene", "disease"],
    sx("The street food millions rely on is often prepared with contaminated water and no hygiene, spreading typhoid and diarrhoeal disease. License and support vendors with clean water and hygiene training, or keep clearing them in futile drives?",
  ...
  ax("Industrial Health Director", "doctor", ["asbestos", "ban", "construction"],
    sx("Asbestos, banned across much of the world, is still imported and used in cheap roofing and the shipbreaking yards, seeding a slow epidemic of lung cancer decades out. The director wants an import-and-use ban; the roofing and shipbreaking industries resist.",
  ...
  ax("Urban Resilience Officer", "relief", ["heat", "cities", "adaptation"],
    sx("Killer heatwaves are becoming routine, and the cities have no plan — no cooling shelters, no warnings, no protection for the outdoor poor. The officer wants a costly urban heat-action plan; between heatwaves the danger feels abstract and the budget contested.",
  ...
  ax("Marine Pollution Officer", "relief", ["oil-spill", "marine", "mangroves"],
    sx("A tanker has spilled furnace oil into the mangrove rivers, coating the forest, the dolphins, and the fishers' grounds, and there is no response capacity worth the name. The officer wants a real marine-spill response system built; for now, choose how hard to scramble.",
  ...
  ax("School Health Director", "doctor", ["anaemia", "deworming", "children"],
    sx("Anaemia and intestinal worms sap the health and minds of a huge share of the country's schoolchildren — both cheaply treatable with iron and deworming tablets through the schools. The director wants a universal programme; even this small cost faces scrutiny.",
  ...
  ax("Environmental Health Officer", "people", ["noise", "pollution", "health"],
    sx("The cities are a wall of noise — hydraulic horns, loudspeakers, generators — wrecking hearing, sleep, and hearts, with laws no one enforces. The officer wants real enforcement and quiet zones around hospitals and schools; drivers and the public resent the crackdown.",
  ...
  ax("Emergency Services Director", "relief", ["ambulance", "emergency", "trauma"],
    sx("There is no real national ambulance service, so the injured and the labouring reach hospital by rickshaw, too late, and the road-trauma toll is appalling. The director wants a networked ambulance and 999 emergency-response system; it is costly to build and staff.",
  ...
  ax("Neglected Disease Director", "doctor", ["kala-azar", "elimination", "poverty"],
    sx("Kala-azar, a deadly sandfly-borne disease of the poorest districts, is close to elimination — a last push of detection, treatment, and vector control could finish it, or neglect could let it roar back as it has before. Fund the final drive?",
  ...
  ax("Eye Health Director", "doctor", ["blindness", "cataract", "access"],
    sx("Hundreds of thousands are needlessly blind from cataracts a fifteen-minute surgery would cure, but the surgeons never reach the rural poor. The director wants mass cataract-surgery camps and rural eye care; it is cheap per sight restored, but unglamorous and easily skipped.",
  ...
  ax("Pharmacy Regulation Director", "doctor", ["antibiotics", "pharmacy", "resistance"],
    sx("Antibiotics are sold over the counter like sweets, fuelling the drug resistance that will one day make infections untreatable. The director wants prescription-only enforcement and pharmacist training; the unlicensed pharmacies and the self-medicating public resist.",
  ...
  ax("Social Welfare Director", "relief", ["elderly", "ageing", "care"],
    sx("The population is ageing fast, and the old joint-family care of elders is breaking down, leaving many abandoned and destitute. The director wants to build elderly day-care, geriatric health, and support; the demographic crisis still feels far off to most.",
  ...
  ax("Hospital Quality Director", "doctor", ["infection-control", "hospitals", "safety"],
    sx("Patients catch deadly drug-resistant infections in the very hospitals meant to heal them, for want of basic infection control — hand hygiene, sterilisation, isolation. The director wants enforced standards and accreditation; the hospitals resent the cost and scrutiny.",
  ...
  ax("Solid Waste Director", "official", ["composting", "waste", "landfill"],
    sx("Most of the cities' waste is wet organic matter that rots in the streets and overflows the landfills, when it could be composted into fertiliser. The director wants a citywide source-separation and composting system; it demands habit-change and steady funding.",
  ...
  ax("Public Health Nutrition Director", "doctor", ["salt", "hypertension", "diet"],
    sx("Sky-high salt intake is driving an epidemic of hypertension, strokes, and heart attacks. A national salt-reduction push — reformulating processed food, public awareness, front-of-pack labels — would save many lives cheaply; the food industry resists.",
  ...
  ax("Disability Services Director", "relief", ["disability", "assistive-devices", "access"],
    sx("Millions who need wheelchairs, hearing aids, prosthetics, and white canes go without, shut out of work and life for want of a cheap device. The director wants a national assistive-device programme; the constituency is quiet and the budget contested.",
  ...
  ax("Vector Control Director", "doctor", ["mosquitoes", "fogging", "dengue"],
    sx("The mosquito-fogging the cities rely on against dengue is now near-useless — the mosquitoes are resistant and the larvae breed untouched. The director wants a shift to larval-source management; the public loves the visible fog and distrusts the invisible fix.",
  ...
  ax("Palliative Care Director", "doctor", ["palliative", "hospice", "dignity"],
    sx("The terminally ill die in agony for want of palliative care and the morphine that could ease them — held back by fear of addiction and a system that abandons those it cannot cure. The director wants a national palliative-care programme; it draws no votes and little notice.",
  ...
  ax("School Health Officer", "doctor", ["screening", "children", "education"],
    sx("Children fail and drop out because no one notices they cannot see the board or hear the teacher — uncorrected vision and hearing mistaken for stupidity. The director wants universal school screening and free glasses and hearing aids; the cost is small but keeps getting cut.",
  ...
  ax("Wetland Conservation Officer", "relief", ["wetland", "ramsar", "biodiversity"],
    sx("A globally important wetland — a wintering ground for migratory birds and a nursery for fish — is being drained for farmland and development. The officer wants it protected under the international wetland convention; the encroaching farmers and developers resist.",
  ...
  ax("Oral Health Director", "doctor", ["dental", "oral-cancer", "betel"],
    sx("Oral disease is rampant and oral cancer — driven by the betel-nut and tobacco quid chewed by millions — is a leading cancer killer, yet dental care barely exists outside private clinics. The director wants public oral health and a betel-quid awareness drive; the betel trade resists.",
  ...
  ax("Air Quality Director", "official", ["air-monitoring", "data", "transparency"],
    sx("The country has almost no real air-quality monitoring, so the lethal pollution is unmeasured and unaddressed. The officer wants a public network of monitors with open, real-time data; some fear the numbers will be damning and the industries fear the accountability.",
  ...
  ax("Disaster Preparedness Director", "relief", ["earthquake", "buildings", "preparedness"],
    sx("The capital sits on a fault, crammed with buildings that would pancake in a major quake, and the country has almost no urban search-and-rescue capacity. The director wants a costly retrofit, code-enforcement, and rescue drive; the threat is invisible until the ground moves.",
  ...
  ax("Suicide Prevention Director", "doctor", ["suicide", "pesticide", "rural"],
    sx("Easy access to highly toxic farm pesticides makes them the method of countless impulsive rural suicides, especially among the young and women. The director wants the most lethal banned and the rest locked in community stores — a proven, cheap lifesaver the agro-chemical lobby resists.",
  ...
  ax("Immunisation Logistics Director", "doctor", ["vaccines", "cold-chain", "coverage"],
    sx("The vaccine cold chain — the refrigeration that keeps childhood vaccines potent from factory to village — is fraying, with failing fridges that quietly render vaccines useless. The director wants a costly overhaul; the failure is invisible until outbreaks return.",
  ...
  ax("Renal Care Director", "doctor", ["dialysis", "kidney", "access"],
    sx("Chronic kidney disease — driven by diabetes, hypertension, and arsenic — is surging, and dialysis is scarce and ruinously expensive, so the poor simply die. The director wants subsidised dialysis centres across the regions; the per-patient cost is high and endless.",
  ...
  ax("Health Facility Director", "doctor", ["wash", "hospitals", "hygiene"],
    sx("A shocking share of clinics and hospitals lack clean water, functioning toilets, and hand-washing — so the places of healing spread infection and mothers give birth in filth. The director wants a WASH overhaul of every health facility; it is basic, costly, and chronically skipped.",
  ...
  ax("School Nutrition Director", "doctor", ["obesity", "junk-food", "children"],
    sx("As incomes rise, childhood obesity surges in the cities even as stunting persists in the villages — a double burden. The director wants junk food out of schools and healthy-eating standards; the snack industry and the kids resist.",
  ...
  ax("Rural Housing Director", "relief", ["flood", "housing", "resilience"],
    sx("In the flood-prone chars and haors, the poor rebuild fragile homes washed away every year. A programme of raised plinths, flood-resilient housing, and protected wells would break the cycle; the alternative is the cheaper, endless ritual of post-flood relief.",
  ...
  ax("Blood Services Director", "doctor", ["blood", "donation", "safety"],
    sx("The country runs on a commercial blood trade of paid, often-diseased donors, because the voluntary donation network is thin and the safe supply scarce. The director wants to build a real voluntary, screened blood system; it takes funding and a culture shift.",
  ...
  ax("Mental Health Director", "doctor", ["suicide", "helplines", "stigma"],
    sx("Suicide is rising, especially among the young and women, hidden by stigma and a law that still criminalises the attempt. The director wants decriminalisation, helplines, and responsible reporting; the conservatives resist 'condoning' it.",
  ...
  ax("Road Safety Health Officer", "doctor", ["helmets", "trauma", "enforcement"],
    sx("The explosion of motorcycles and ride-share bikes has filled the trauma wards with head injuries, mostly from riders without helmets. The officer wants hard helmet enforcement; riders resent it and the ride-share boom prefers fewer rules.",
  ...
  ax("Immunisation Policy Director", "doctor", ["vaccines", "children", "introduction"],
    sx("New vaccines against the rotavirus and pneumonia that kill so many small children are available but costly to add to the national schedule. The director wants them introduced now; the finance side balks at the added recurrent cost.",
  ...
  ax("Climate Health Director", "doctor", ["climate", "health", "adaptation"],
    sx("Climate change is reshaping disease — dengue spreading, heat killing, floods drowning clinics, salinity raising blood pressure in coastal women. The director wants the health system climate-proofed and climate-health surveillance built; it is a diffuse, long-horizon investment.",
  ...
  ax("Coastal Environment Officer", "relief", ["marine-litter", "beaches", "plastic"],
    sx("The beaches and coastal waters are drowning in plastic litter — washed down the rivers and dumped by the tourist towns — choking marine life and the tourist economy alike. The officer wants cleanup, river-interception, and a coastal plastic ban; the cost and the tourist trade resist.",
  ...
  ax("Child Development Director", "doctor", ["autism", "disability", "children"],
    sx("Children with autism and developmental disorders are hidden, shamed, and shut out entirely for want of any diagnosis, therapy, or schooling. The director wants a national developmental-screening and early-intervention programme; the cause is poorly understood and easily skipped.",
  ...
  ax("Urban Waterways Officer", "people", ["canals", "waste", "flooding"],
    sx("The cities' canals and riverbanks are choked with dumped solid waste, blocking drainage and breeding disease, while settlements and businesses dump with impunity. The officer wants enforced anti-dumping, regular clearing, and waste collection; it means confronting dumpers great and small.",
  ...
  ax("Labour Welfare Director", "people", ["creches", "women", "workforce"],
    sx("Working mothers, especially the garment workforce, have nowhere safe to leave their infants, so children are neglected and women forced out of work. The law mandates factory creches almost no one provides. The director wants real enforcement; employers call it unbearable.",
  ...
  ax("Enteric Disease Director", "doctor", ["cholera", "typhoid", "vaccines"],
    sx("Cholera and typhoid still sweep the slums and flood zones from filthy water, and oral vaccines now exist to blunt them. The director wants targeted vaccination in the high-risk areas alongside the slow water fixes; the vaccines are costly and the diseases familiar.",
  ...
  ax("Health Information Director", "official", ["health-data", "records", "privacy"],
    sx("A national electronic health-record system would join up fragmented care, cut duplication, and power real planning — and concentrate the population's most intimate data in a system the state has not earned trust to hold securely. How far do you build it?",
  ...
  ax("Tobacco Control Officer", "doctor", ["vaping", "shisha", "youth"],
    sx("Vaping and shisha lounges are spreading among urban youth, marketed as harmless and slipping through the tobacco laws. The officer wants them regulated and taxed like tobacco before the habit entrenches; the lounges, importers, and youth push back.",
  ...
  ax("Green Economy Officer", "people", ["waste-pickers", "green-jobs", "informal"],
    sx("An army of informal waste-pickers already recycles much of the cities' waste, unseen, unpaid fairly, and unprotected. Formalise them into the recycling system with IDs, fair pay, and gear — dignifying vital work — or leave them to the dumps and the middlemen?",
  ...
  ax("Health Quality Director", "doctor", ["accreditation", "hospitals", "standards"],
    sx("Private hospitals and diagnostic centres operate with wild variation in quality, some excellent and some lethal, with no accreditation to tell them apart. The director wants mandatory accreditation and public quality ratings; the private health industry resists.",
  ...
  ax("Environmental Health Director", "doctor", ["indoor-air", "household", "women"],
    sx("Indoor air pollution from cooking smoke, damp, and crowding quietly kills more than the outdoor smog, striking women and children worst. The director wants ventilation, clean cooking, and housing improvement; the harm is invisible, inside the home, easily ignored.",
  ...
  ax("Public Health Director", "doctor", ["sugar", "drinks", "diabetes"],
    sx("Sugary drinks are flooding the market and driving childhood obesity and diabetes, marketed hardest to the young. The director wants marketing curbs, front-of-pack warnings, and a ban on sales near schools; the beverage giants, big advertisers, resist.",
  ...
  ax("Urban Migration Director", "relief", ["climate-migrants", "slums", "services"],
    sx("Climate-displaced families from the drowning coast and eroding rivers pour into the city slums by the thousand, straining water, health, and shelter to breaking. Fund planned reception, services, and secondary-town development to absorb them, or let the slums swell untended?",
