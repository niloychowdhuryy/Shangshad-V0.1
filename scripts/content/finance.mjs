...
export const FINANCE = [
  ...
  ax("Central Bank Governor", "official", ["reserves", "forex", "imf"],
    sx("The Governor lays the reserves chart on your desk — a line sliding toward three months of imports. \"We have been counting money we do not have as reserves. The real number is worse, and the IMF will see through the trick at the next review.\"",
    ...
    sx("To defend the taka you have been burning reserves to hold the peg. The Governor says you can either let the currency float and watch prices leap, or keep bleeding dollars to defend a number you cannot hold.",
    ...
    sx("Reserves hit the red line. The IMF will release an emergency tranche — but only if you cut energy subsidies the same week. Your advisors warn that the price shock could put people on the streets within days.",
  ...
  ax("Bank Reform Commissioner", "official", ["banks", "default-loans", "cronies"],
    sx("The Commissioner names the rot: a handful of business families have looted the banks through ever-rolled 'rescheduled' loans, and several of them fund your campaigns. \"Classify the bad loans honestly and the banks look insolvent. Hide them and they rot from inside.\"",
    ...
    sx("Your honest-classification drive has cornered the country's biggest loan defaulter — who happens to own three TV channels and a slice of your party's purse. He offers a deal: a partial repayment and his media's undying loyalty, if you call off the rest.",
  ...
  ax("Expatriate Welfare Secretary", "official", ["remittances", "hundi", "diaspora"],
    sx("Migrant workers are sending their money home through the illegal hundi network instead of the banks, because hundi gives a better rate and asks no questions. Billions of dollars bypass the reserves entirely. The Secretary wants a 2.5% cash incentive to lure them back.",
  ...
  ax("Garment Buyers' Consortium", "official", ["rmg", "exports", "wages"],
    sx("The Western buyers' consortium that takes most of your garments delivers an ultimatum dressed as concern: raise the minimum wage and improve safety, or they shift orders to cheaper rivals. Your factory owners say a wage hike will close mills.",
  ...
  ax("Megaproject Coordinator", "official", ["debt", "infrastructure", "china"],
    sx("The grand projects — bridges, rail, power plants — are monuments and millstones both. A coordinator warns that the foreign loans behind them balloon next year, and one lender wants port-equity collateral if you cannot pay on time.",
  ...
  ax("Financial Intelligence Chief", "official", ["laundering", "capital-flight", "elite"],
    sx("The FIU chief shows you the outflows: the same elite that complains about the dollar shortage is quietly wiring fortunes into second homes abroad. \"They starve the reserves they then blame you for. I can name them — many are friends.\"",
  ...
  ax("Trade & Prices Adviser", "people", ["inflation", "subsidies", "food"],
    sx("Rice, oil, and onions have outrun wages and the kitchen is now a political battlefield. The adviser offers two levers: open emergency duty-free imports that hammer the budget, or hold the line and tell people to tighten belts they have already cinched.",
  ...
  ax("Sovereign Ratings Analyst", "ambassador", ["rating", "markets", "confidence"],
    sx("A ratings agency is poised to downgrade you to junk, which would spike borrowing costs across the board. The analyst hints the decision could 'go either way' with the right gestures — fiscal transparency, or a quietly arranged hospitality.",
  ...
  ax("NBR Chairman", "official", ["tax", "nbr", "informal"],
    sx("Barely 2% of the country files taxes; the chairman wants an aggressive drive to widen the net into the vast informal economy. The shopkeepers and traders who fund half your local committees are already calling.",
  ...
  ax("Budget Adviser", "official", ["black-money", "whitening", "budget"],
    sx("The adviser proposes the familiar budget clause: let undisclosed 'black money' be whitened by paying a flat low tax, no questions asked. It would pull billions into the formal economy — and reward exactly the people who hid it.",
  ...
  ax("Stock Exchange Chair", "official", ["dse", "market", "retail"],
    sx("The share index is in free-fall and small investors are burning effigies outside the exchange. The chair wants you to impose an artificial 'floor price' freezing shares from falling further.",
  ...
  ax("Debt Management Chief", "official", ["eurobond", "debt", "markets"],
    sx("Reserves are tight and the chief proposes a debut dollar Eurobond — quick foreign cash, but at a punishing coupon that locks in high interest for a decade if the markets smell desperation.",
  ...
  ax("Pension Authority Head", "official", ["pension", "welfare", "funding"],
    sx("Your flagship universal pension scheme is wildly popular — and quietly unfunded past the first few years. The head asks whether to keep enrolling millions on a promise the treasury cannot yet keep.",
  ...
  ax("Central Bank Governor", "official", ["banks", "merger", "weak-banks"],
    sx("Five insolvent banks are walking corpses, kept alive by liquidity from the central bank. The governor wants to force-merge them into stronger ones — wiping out politically-connected directors.",
  ...
  ax("Mobile Finance Regulator", "official", ["mfs", "bkash", "fintech"],
    sx("Mobile money moves the wages of the whole working class now, and the dominant operator wants to raise cash-out fees. The poorest pay those fees; the operator employs thousands and lobbies hard.",
  ...
  ax("Customs Intelligence Chief", "shadow", ["misinvoicing", "laundering", "trade"],
    sx("The chief lays out how billions leave the country through fake import invoices — over-paying foreign 'suppliers' who are really the importers' own offshore shells. The biggest offenders dine with your ministers.",
  ...
  ax("Revenue Board Chairman", "fixer", ["black-money", "tax", "whitening"],
    sx("A budget clause would let undisclosed 'black money' be legalised by paying a flat low tax, no questions asked — luring billions back into the formal economy and the property market. The chairman calls it pragmatic; honest taxpayers call it a reward for the crooked.",
  ...
  ax("Securities Regulator", "official", ["stock-market", "crash", "retail"],
    sx("The bourse has crashed after a manipulated bubble, wiping out hundreds of thousands of small investors lured in by insiders who cashed out at the top. The regulator can mount a costly retail bailout and prosecute the manipulators, or let the market clear and the losers learn.",
  ...
  ax("Privatisation Commission Chief", "official", ["soe", "privatisation", "jobs"],
    sx("Dozens of state enterprises — mills, factories, a national airline — bleed subsidy every year, kept alive for the jobs and the patronage. The chief can privatise or shut the worst, stemming the losses, or keep them on life support to protect the workers and the votes.",
  ...
  ax("Pension Authority Director", "people", ["pension", "welfare", "future"],
    sx("A national pension scheme would give the vast informal workforce security in old age — a transformative legacy — but it demands either contributions the poor can barely make or a vast permanent subsidy the budget can barely bear. The director needs your design.",
  ...
  ax("IMF Programme Negotiator", "ambassador", ["imf", "subsidy", "austerity"],
    sx("The next IMF tranche hinges on slashing fuel and electricity subsidies — a move that steadies the budget and detonates the cost of living for everyone. The negotiator says the money is vital; the street says the price rises are unbearable.",
  ...
  ax("Central Bank Governor", "official", ["currency", "float", "devaluation"],
    sx("The taka is propped up at an artificial rate the reserves can no longer defend, feeding a black market. The governor urges letting it float to its real value — ending the drain, but spiking import prices and inflation overnight — or burning more reserves to hold the peg.",
  ...
  ax("Banking Division Secretary", "official", ["banks", "merger", "npl"],
    sx("Several banks are insolvent, hollowed out by insider looting and bad loans, and one is days from collapse. The secretary can force mergers into healthier banks — protecting depositors but rewarding the looters — or let a bank fail and shock the system into discipline.",
  ...
  ax("Banking Division Secretary", "fixer", ["loans", "defaulters", "favours"],
    sx("The biggest loan defaulters — industrialists with party ties — want their bad loans rescheduled on absurdly soft terms again, kicking the reckoning down the road. The secretary says it props up the banks' books on paper; it also lets the willful defaulters off the hook forever.",
  ...
  ax("Debt Management Director", "ambassador", ["eurobond", "debt", "markets"],
    sx("You can raise a large sum fast by issuing a sovereign bond on the international markets — no IMF conditions, no neighbourly strings — but at a steep interest rate that mortgages future budgets, and exposes you to the mercy of global bond traders.",
  ...
  ax("Trading Corporation Chief", "shadow", ["inflation", "syndicate", "food"],
    sx("A cartel of wholesalers is hoarding rice, onions, and oil to spike prices at will, squeezing every household — and several cartel bosses are party financiers. The chief can break the syndicate with raids and state imports, or protect the donors and let prices ride.",
  ...
  ax("Customs Commissioner", "fixer", ["customs", "ports", "corruption"],
    sx("The ports leak billions in duty through under-invoicing and bribed clearance, with the customs houses among the most lucrative postings in the state. The commissioner can automate and audit the whole system, breaking the rackets, or leave the golden geese to lay.",
  ...
  ax("Revenue Board Chairman", "official", ["tax", "elite", "evasion"],
    sx("The country's tax-to-GDP ratio is among the world's lowest because the wealthy simply do not pay — and the board has long squeezed the salaried middle instead. The chairman can finally go after the rich evaders, who include donors and dynasts, or keep milking the easy salaried base.",
  ...
  ax("Digital Finance Adviser", "official", ["mobile-money", "remittances", "inclusion"],
    sx("Mobile money has banked the unbanked and could pull remittances out of the illegal hundi channels into the formal economy — if you incentivise it. The banks lobby against it, fearing disintermediation, and the hundi networks have their own quiet patrons.",
  ...
  ax("Pay Commission Chair", "official", ["salaries", "bureaucracy", "budget"],
    sx("A new pay commission recommends a huge salary hike for the civil service — buying the bureaucracy's loyalty and curbing petty corruption, but blowing a vast hole in the recurrent budget for years. The chair awaits your decision.",
  ...
  ax("Financial Intelligence Chief", "shadow", ["laundering", "over-invoicing", "capital-flight"],
    sx("Billions flee the country each year through over- and under-invoiced trade, spiriting wealth to second homes abroad — and the launderers include some of your biggest backers. The chief can build a real enforcement net, or keep the channel quietly open for friends.",
  ...
  ax("Investment Authority Chief", "ambassador", ["sez", "fdi", "incentives"],
    sx("To lure foreign factories into the new economic zones, investors demand decade-long tax holidays, free land, and guaranteed power. The chief says the jobs and FDI are worth it; the revenue board warns you are giving away the future tax base to win a present photo-op.",
  ...
  ax("Central Bank Governor", "official", ["deficit", "printing", "inflation"],
    sx("The government is broke and the bills are due. The easiest fix is to have the central bank simply print money to cover the deficit — quick, painless today, and a slow detonator of inflation tomorrow. The governor warns it is the road every ruined economy has walked.",
  ...
  ax("Agricultural Bank Chairman", "people", ["sme", "farmers", "credit"],
    sx("Small farmers and tiny businesses are starved of credit, locked out by banks that lend only to the big and the connected. The chairman wants a subsidised small-credit drive to the grassroots — risky, costly, and politically golden — versus keeping lending safe and concentrated.",
  ...
  ax("Treasury Operations Chief", "official", ["liquidity", "festival", "wages"],
    sx("Eid is days away and the garment factories cannot make payroll and bonuses for millions of workers, who will riot if sent home empty-handed for the holiday. The chief can extend emergency state liquidity to the owners, or let the owners face their own workers.",
  ...
  ax("Export Promotion Director", "official", ["exports", "diversification", "garments"],
    sx("The economy is dangerously dependent on garments for almost all its exports. The director wants to pour incentives into new sectors — pharma, leather, IT services, shipbuilding — a slow, uncertain bet, versus doubling down on the garment cash cow that already works.",
  ...
  ax("Digital Economy Adviser", "people", ["it", "freelancers", "youth"],
    sx("Hundreds of thousands of young freelancers earn foreign currency online, but they are taxed clumsily, blocked from easy payment channels, and ignored. The adviser wants a freelancer-friendly regime of easy payments and tax breaks to grow a new export pillar.",
  ...
  ax("Financial Intelligence Chief", "ambassador", ["capital-flight", "second-homes", "elite"],
    sx("Exposés abroad reveal your elite — ministers, MPs, tycoons — own fortunes in foreign property they could never have earned honestly. The world offers cooperation to trace and freeze it. The chief asks whether to pursue the trail or quietly let it lie.",
  ...
  ax("Central Bank Governor", "official", ["crypto", "regulation", "capital-controls"],
    sx("Cryptocurrency is spreading among the young as a hedge against the falling taka and a hole in your capital controls. The governor can ban it outright as a laundering and flight risk, or regulate and tax it as an inevitable new asset.",
  ...
  ax("PPP Authority Chief", "fixer", ["ppp", "infrastructure", "contracts"],
    sx("A private consortium offers to build and run a major toll expressway under a public-private partnership — sparing the budget the upfront cost, but locking the public into decades of toll payments and a sweetheart guarantee that the state covers any shortfall.",
  ...
  ax("Planning Commission Member", "official", ["development-budget", "spending", "quality"],
    sx("The annual development budget is chronically rushed out in the final months in a splurge of low-quality, padded projects, so the money is 'spent' on paper. The member wants a shift to fewer, well-vetted projects — slower disbursement, better roads — over the year-end dash.",
  ...
  ax("Microfinance Regulator", "people", ["microfinance", "debt", "poverty"],
    sx("The microfinance sector that the country pioneered now risks over-lending, trapping the rural poor in spirals of debt to multiple lenders at high effective rates. The regulator wants caps and a shared credit registry; the big MFIs, politically influential, resist.",
  ...
  ax("Defence Finance Secretary", "general", ["defence", "budget", "spending"],
    sx("The military, restive and powerful, wants a major budget increase for new hardware and perks — loyalty insurance for a government that needs the barracks onside. The secretary notes the money would gut the social spending you have promised the public.",
  ...
  ax("Auditor General", "official", ["reserves", "transparency", "audit"],
    sx("The true, spendable level of the foreign reserves has been quietly overstated for years by counting funds that are already committed. An honest restatement would calm no one and spook the markets; continued obfuscation buys time but compounds the eventual reckoning.",
  ...
  ax("Bank Inspection Chief", "shadow", ["fraud", "banks", "scandal"],
    sx("A colossal loan fraud has surfaced at a state bank — thousands of crores siphoned out on forged collateral by a ring with reach into the board and the regulator. The chief can mount a full, public investigation, or contain it quietly to protect confidence and connected names.",
    ...
    sx("Your handling of the first fraud set the tone, and now a second bank reports a similar hole. The chief warns that the rot is systemic and demands a sweeping regulatory overhaul with real independence — which would clip the wings of the very politicians who appoint the boards.",
  ...
  ax("Remittance Policy Director", "people", ["remittances", "incentive", "reserves"],
    sx("Remittances are slipping into the illegal hundi channel because the official rate is poor. The director proposes a cash incentive on every dollar sent home through banks — costly to the budget, but a magnet to pull billions back into the reserves.",
    ...
    sx("The incentive worked, but exporters cry foul: the same scheme that lifts remittances has effectively given migrant dollars a better rate than export dollars, and the garment lobby demands equal treatment or threatens to hold earnings offshore.",
  ...
  ax("Central Bank Governor", "official", ["imports", "lc", "reserves"],
    sx("To stem the reserve drain, the governor can choke the letters of credit that finance imports — banning 'luxury' goods and rationing dollars. It saves precious reserves, but it also starves factories of raw materials and spawns a corrupt queue for who gets a dollar.",
    ...
    sx("The import curbs hit a nerve: shortages of medicines, industrial inputs, and even some foods are biting, and the manufacturers warn of mass layoffs. The governor asks whether to keep the squeeze or selectively reopen the most essential imports.",
  ...
  ax("Statistics Bureau Chief", "shadow", ["gdp", "statistics", "credibility"],
    sx("The bureau can 'rebase' and massage the GDP figures to show a glittering growth rate that flatters your rule and tops the regional league tables. Economists already mutter that the numbers do not match the power use or the imports. The chief awaits your nod.",
  ...
  ax("Consumer Protection Director", "shadow", ["e-commerce", "ponzi", "fraud"],
    sx("A wildly popular e-commerce platform turns out to be a Ponzi scheme — taking advance payments for goods it never delivers, with hundreds of thousands of customers' money gone. The director can move now to freeze and prosecute, or hesitate while the founders flee.",
  ...
  ax("Bank Inspection Chief", "shadow", ["nbfi", "embezzlement", "regulator"],
    sx("A non-bank financial institution has been looted to its bones by a single fugitive operator who captured its board and siphoned out a fortune — with the regulator asleep or complicit. The chief asks whether to pursue the fugitive and the enablers, or quietly write it off.",
  ...
  ax("Revenue Board Chairman", "ambassador", ["digital-tax", "big-tech", "revenue"],
    sx("The global tech giants earn fortunes in advertising and services here while paying almost no tax. A digital-services tax would capture that — and risk retaliation, throttled services, and a quarrel with Washington that other files cannot afford.",
  ...
  ax("Debt Management Director", "ambassador", ["diaspora-bond", "infrastructure", "funding"],
    sx("You can raise development funds by selling a patriotic bond to the diaspora — cheaper than markets, binding the expatriates to the homeland — but a default or a scandal would betray the very people who trusted you most, and they vote and remit.",
  ...
  ax("Agriculture Finance Secretary", "people", ["diesel", "irrigation", "subsidy"],
    sx("Diesel for the irrigation pumps has spiked with world prices, threatening the boro rice crop that feeds the nation. The secretary wants an emergency diesel subsidy for farmers — costly and leak-prone — or you can let the fuel price pass through to the field.",
  ...
  ax("Revenue Board Chairman", "official", ["sin-tax", "health", "revenue"],
    sx("Steep new taxes on tobacco, sugary drinks, and processed junk would raise revenue and improve public health at once — a rare win-win — but the powerful food and tobacco lobbies, and the price-sensitive public, will both push back hard.",
  ...
  ax("Budget Secretary", "official", ["fiscal-rule", "debt", "discipline"],
    sx("A fiscal-responsibility law would cap the deficit and debt by statute, binding you and every successor to discipline — a credibility prize for the lenders, and a self-imposed straitjacket that forbids the populist splurges that win elections.",
  ...
  ax("Large Taxpayer Unit Chief", "official", ["transfer-pricing", "multinationals", "evasion"],
    sx("Multinational firms shift their local profits abroad through rigged internal pricing, paying almost no tax here. The chief wants a hard transfer-pricing crackdown to capture that revenue; the firms threaten to scale back investment and lobby their embassies.",
  ...
  ax("Agriculture Finance Secretary", "people", ["insurance", "farmers", "climate"],
    sx("Floods, cyclones, and droughts wipe out farmers' crops and push them into ruinous debt every year. A subsidised crop-insurance scheme would cushion them against the climate — a costly, complex new system, versus the cheaper status quo of ad-hoc disaster relief.",
  ...
  ax("Provident Fund Trustee", "official", ["pension-fund", "investment", "risk"],
    sx("The vast public provident and pension funds sit in low-yield government paper. A reform would let them invest in markets and infrastructure for higher returns — and expose millions of workers' retirements to risk, manipulation, and the temptation to fund pet projects.",
  ...
  ax("Stimulus Coordination Chief", "fixer", ["stimulus", "sme", "leakage"],
    sx("A huge emergency stimulus must flow fast to keep firms alive through a shock — but speed means weak controls, and the big, connected firms are already first in the queue while the small ones that need it most have no bank relationship to claim it.",
  ...
  ax("Securities Regulator", "shadow", ["ipo", "market", "manipulation"],
    sx("A wave of companies wants to list, and insiders are pricing the IPOs to enrich a favoured few before dumping on the retail crowd. The regulator can enforce fair, fundamentals-based pricing — slowing the listings — or let the lucrative game run.",
  ...
  ax("Banking Division Secretary", "official", ["banks", "exposure", "concentration"],
    sx("A few giant business groups have borrowed so heavily from the banks that the failure of any one could topple the system. The secretary wants strict single-borrower limits enforced; the groups — major donors — call it a chokehold on the engines of the economy.",
  ...
  ax("Banking Division Secretary", "fixer", ["banks", "family-control", "governance"],
    sx("A law lets a single family hold a bank's board for years through multiple directorships — a recipe for the insider looting that has hollowed banks before. A reform would break the family grip; the banking dynasties, deeply tied to your party, will fight it.",
  ...
  ax("Tariff Commission Chief", "official", ["dumping", "tariffs", "industry"],
    sx("A flood of cheap, possibly dumped, foreign goods is undercutting your domestic manufacturers. The chief can slap on protective anti-dumping duties to save the local industry and jobs — raising prices for consumers — or keep the market open and cheap.",
  ...
  ax("Budget Secretary", "official", ["soe", "losses", "transparency"],
    sx("The state enterprises' staggering losses are hidden off-budget, quietly funded by directed bank loans and never shown to parliament. The secretary can bring them onto the books for honest accounting — a shocking number — or keep them comfortably in the shadows.",
  ...
  ax("Anti-Money-Laundering Director", "ambassador", ["fatf", "compliance", "reputation"],
    sx("The global financial watchdog threatens to grey-list the country over weak money-laundering and terror-financing controls — a label that would choke correspondent banking and scare investors. Fixing it means real enforcement against laundering your own backers enjoy.",
  ...
  ax("Land Reform Commissioner", "official", ["benami", "property", "corruption"],
    sx("Vast wealth hides in 'benami' property — assets held in others' names to disguise the true, often corrupt, owner. A law to pierce these veils and seize illicit holdings would be transformative, and would expose fortunes held by the very powerful.",
  ...
  ax("Customs Commissioner", "shadow", ["gold", "smuggling", "policy"],
    sx("Tonnes of gold pass through the country's airports as smuggled transit, enriching syndicates with airport and police protection. The commissioner can legalise and tax gold imports to kill the smuggling's logic, or keep cracking down while the rackets thrive.",
  ...
  ax("Customs Commissioner", "shadow", ["vat-refund", "drawback", "fraud"],
    sx("Exporters claim duty drawbacks and VAT refunds on goods that were never made or shipped, draining the treasury through forged paperwork blessed by bribed officers. The commissioner can install a tracked, audited system, or leave the lucrative scam alone.",
  ...
  ax("Customs Commissioner", "shadow", ["bonded-warehouse", "duty", "diversion"],
    sx("Duty-free raw materials imported for export factories under the bonded-warehouse scheme are being diverted onto the local market, undercutting honest producers and dodging duty. The commissioner can audit the bonds hard, or protect the well-connected abusers.",
  ...
  ax("Revenue Board Chairman", "official", ["inheritance-tax", "wealth", "dynasty"],
    sx("Great fortunes pass untaxed from one generation to the next, entrenching a hereditary elite. An inheritance tax would raise revenue and loosen the dynastic grip on wealth — and fall hardest on the established families, your own circle among them.",
  ...
  ax("Insurance Regulator", "people", ["microinsurance", "poverty", "resilience"],
    sx("A single illness, death, or flood pushes poor families into destitution. A microinsurance push — tiny premiums, simple payouts, delivered through mobile money — would cushion them, but it needs subsidy and tight regulation to keep the insurers from cheating the poor.",
  ...
  ax("Central Bank Governor", "official", ["islamic-finance", "sukuk", "savings"],
    sx("A large, pious pool of savings sits outside the banks because it shuns interest. A proper Islamic-finance framework and sovereign sukuk could mobilise that money for development — but it demands real Sharia governance, not a cosmetic relabelling that invites scandal.",
  ...
  ax("Banking Division Secretary", "official", ["deposit-insurance", "savers", "stability"],
    sx("Small savers have almost no protection if a bank fails, and rumours of trouble trigger panicked runs. A proper deposit-insurance scheme would protect savers and calm the system — funded by a levy the banks will resist, and a public backstop in a real crisis.",
  ...
  ax("Education Finance Secretary", "people", ["stipend", "girls", "education"],
    sx("The school stipend that keeps poor children — especially girls — in class is too small and reaches too few. Expanding it would lift enrolment and delay child marriage, a proven investment, at a steep and permanent cost to the budget.",
  ...
  ax("Women's Affairs Finance Officer", "people", ["maternity", "allowance", "poverty"],
    sx("Poor pregnant and nursing women work to the day they give birth and back, harming mother and child for want of any support. A national maternity allowance would change that — a costly, permanent commitment the finance hawks call unaffordable.",
  ...
  ax("Education Finance Secretary", "fixer", ["textbooks", "printing", "graft"],
    sx("The annual free-textbook programme — hundreds of millions of books to every child — is a logistical marvel riddled with printing-contract graft and quality-skimping. The secretary can clean up the tenders, angering a cartel of party-linked printers, or keep the books flowing on the cheap and corrupt status quo.",
  ...
  ax("Revenue Board Chairman", "official", ["tax-net", "informal", "compliance"],
    sx("Only a tiny fraction of citizens file taxes, and the chairman wants a drive to pull the vast informal middle — small traders, professionals, landlords — into the net. It would broaden revenue fairly, and it would knock on a million doors that have never paid and will resent it.",
  ...
  ax("Central Bank Governor", "official", ["currency", "redenomination", "confidence"],
    sx("Years of inflation have left the currency cluttered with zeros, and a vanity proposal would lop several off to 'restore dignity' to the taka. The governor warns it is costly, disruptive, and purely cosmetic — fixing none of the inflation that caused the zeros.",
  ...
  ax("Financial Inclusion Director", "people", ["agent-banking", "rural", "inclusion"],
    sx("Agent banking — local shopkeepers acting as bank outlets — could bring real banking to villages that have never seen a branch. The director wants an aggressive rollout; the banks fear the fraud risk and the cannibalisation of their branch business.",
  ...
  ax("External Finance Secretary", "ambassador", ["world-bank", "conditions", "reform"],
    sx("The World Bank offers cheap budget support tied to governance reforms — procurement transparency, SOE discipline, subsidy reform. The secretary says the money is cheap and the reforms are sound; the catch is foreign conditions on domestic policy and the donors they annoy.",
  ...
  ax("Labour Finance Inspector", "people", ["wage-theft", "workers", "enforcement"],
    sx("Across the informal economy and even the factories, employers routinely withhold wages, overtime, and legal dues with near-total impunity. The inspector wants a real enforcement unit with teeth; the employers, many of them donors, call it harassment.",
  ...
  ax("Budget Secretary", "fixer", ["recapitalisation", "banks", "bailout"],
    sx("The state banks, looted into insolvency, need recapitalising again from the budget — public money poured into holes dug by the very managers and defaulters who looted them, with no reform attached. The secretary asks whether to pay up or attach hard conditions.",
  ...
  ax("Revenue Board Chairman", "people", ["small-business", "turnover-tax", "simplicity"],
    sx("Small businesses are crushed by complex tax paperwork and the bribes that come with assessment. A simple flat turnover tax would ease their burden and pull them into the system — at the cost of some revenue from those who would have paid more honestly.",
  ...
  ax("Central Bank Governor", "fixer", ["directed-lending", "credit", "distortion"],
    sx("The ministry wants the central bank to order the banks to pump cheap, directed credit into politically favoured sectors and firms. The governor warns it distorts the market and breeds bad loans; the politics says the favoured firms are friends who must be fed.",
  ...
  ax("Central Bank Governor", "official", ["interest-rate", "inflation", "growth"],
    sx("Inflation is biting hard, and the textbook answer is to raise interest rates and choke it — at the cost of slowing growth, raising borrowing costs, and angering the business lobby and the public both. The governor asks whether to tighten or to keep money cheap.",
  ...
  ax("Investment Authority Chief", "ambassador", ["fdi", "screening", "sovereignty"],
    sx("Foreign capital wants to buy into ports, telecoms, and banks — strategic sectors. A screening regime would protect national security and prevent a single foreign power buying influence; an open-door policy would maximise the investment you desperately need.",
  ...
  ax("Land Reform Commissioner", "people", ["land-records", "digitisation", "corruption"],
    sx("Land records are a chaos of forgeries and bribes, the single biggest source of litigation and graft in the country. Digitising them would end a century of fraud and dispossession — and gut a vast, lucrative ecosystem of clerks, touts, and forgers tied to local power.",
  ...
  ax("Ports Finance Director", "official", ["port", "efficiency", "trade"],
    sx("The main port's chronic congestion costs the economy billions in demurrage and delay, but fixing it means automating operations and breaking the entrenched labour and handling syndicates that profit from the chaos. The director asks whether to take them on.",
  ...
  ax("Digital Finance Adviser", "people", ["digital-payments", "cash", "transparency"],
    sx("The economy runs on untraceable cash, fuelling tax evasion and graft. A hard push toward digital payments — incentives, merchant mandates, interoperability — would widen the tax net and cut corruption, but it sidelines the cash-poor and the elderly and threatens the informal traders.",
  ...
  ax("Telecom Finance Director", "ambassador", ["spectrum", "auction", "revenue"],
    sx("New mobile spectrum is up for auction. You can set a punishing reserve price to milk the operators for maximum one-time revenue, or price it to spur cheap, fast data and broad coverage that grows the digital economy for years.",
  ...
  ax("Aviation Finance Secretary", "fixer", ["airline", "losses", "soe"],
    sx("The national airline bleeds money on padded leasing deals, overstaffing, and graft, kept aloft for prestige and patronage. The secretary can force a painful restructuring or privatisation, or keep subsidising the flag in the sky.",
  ...
  ax("Fiscal Climate Adviser", "official", ["carbon-tax", "climate", "revenue"],
    sx("A modest carbon levy on fuels and heavy industry would raise revenue and nudge the economy greener, and play well with climate donors. It would also raise costs across the board and hit the industries and consumers already squeezed by inflation.",
  ...
  ax("Revenue Board Chairman", "shadow", ["capital-gains", "stock-market", "elite"],
    sx("Large stock-market gains go almost entirely untaxed, a quiet gift to the wealthy and the manipulators. A capital-gains tax would be fair and raise real revenue — and the big investors and brokers, well-connected, warn it will crash the market in protest.",
  ...
  ax("External Finance Secretary", "ambassador", ["imf", "transparency", "data"],
    sx("The IMF's annual review will publish a candid assessment of the economy — the real reserves, the hidden debts, the bad loans. You can cooperate fully and let the unflattering truth out, or pressure for a softened report that protects the rosy official narrative.",
  ...
  ax("Industrial Safety Secretary", "people", ["garments", "safety", "factories"],
    sx("After a catastrophic factory collapse, a binding international safety accord requires costly retrofits — fire exits, structural fixes — that the buyers demand and the owners resist. The secretary asks whether to enforce the accord fully or help owners dodge it.",
  ...
  ax("Tariff Commission Chief", "official", ["machinery", "duty", "industry"],
    sx("Industrialists want all imported capital machinery to come in duty-free to spur investment and modernisation. It would genuinely help manufacturers re-tool — and it is also a famous loophole for importing finished goods disguised as 'machinery' to dodge duty entirely.",
  ...
  ax("ICT Investment Director", "official", ["it", "hi-tech-park", "jobs"],
    sx("A flagship hi-tech park could anchor a software and electronics industry and tens of thousands of skilled jobs — if it gets real power, connectivity, and tenants. Too many such parks have become empty monuments. The director asks whether to commit fully or modestly.",
  ...
  ax("SME Finance Director", "people", ["women", "entrepreneurs", "credit"],
    sx("Women entrepreneurs are almost entirely locked out of formal credit by collateral demands and bias. A dedicated, lightly-collateralised fund would unleash a wave of women-led small businesses — at higher default risk and the grumbling of bankers who call it charity.",
  ...
  ax("Planning Commission Member", "fixer", ["mp-fund", "patronage", "local"],
    sx("Each MP gets a large annual development fund to spend in their constituency — a patronage machine that builds loyalty and, often, the MP's own house and friends' contracts. The member asks whether to keep the fund or route the money through audited local government.",
  ...
  ax("External Finance Secretary", "ambassador", ["rating", "markets", "reform"],
    sx("The credit-rating agencies will downgrade the country unless you show real fiscal reform — but the reforms (subsidy cuts, tax rises) are politically toxic. A downgrade raises every future borrowing cost; ignoring it keeps the politics easy and the future dear.",
  ...
  ax("Budget Secretary", "fixer", ["allowance", "veterans", "spending"],
    sx("The freedom-fighter honour allowance is being expanded again, with the rolls swelling implausibly as the genuine veterans age and 'new' ones appear with forged certificates. The secretary can audit and clean the rolls, angering a sacred constituency, or keep paying all comers.",
  ...
  ax("Transport Economy Adviser", "people", ["gig-economy", "ride-share", "workers"],
    sx("Ride-share and delivery apps have created work for hundreds of thousands of young people — and stripped them of any protection, pay floor, or benefits. The adviser wants to regulate the platforms with minimum earnings and insurance; the apps and the cheap-fare public resist.",
  ...
  ax("Commerce Envoy", "ambassador", ["fta", "regional", "trade"],
    sx("A regional free-trade agreement would open big neighbouring markets to your exports — and open your own market to a flood of their cheaper goods that could swamp domestic industry. The envoy asks whether to sign the deal or protect the home market.",
  ...
  ax("Revenue Board Chairman", "people", ["stamp-duty", "property", "informality"],
    sx("Property-transfer stamp duty is so high that almost everyone under-declares the sale price, fuelling black money and starving the treasury. Cutting the rate would boost honest declarations and the property market; the hawks fear the short-term revenue dip.",
  ...
  ax("Industries Secretary", "people", ["sme", "manufacturing", "cluster"],
    sx("A gritty cluster of small workshops makes the spare parts and machines that keep industry and agriculture running — undercapitalised, unregulated, and ignored. A support push of credit, training, and standards could turn it into a real manufacturing base, or you can keep chasing flashier prizes.",
  ...
  ax("External Finance Secretary", "ambassador", ["adb", "loan", "megaproject"],
    sx("A development bank offers a large soft loan for a flagship transport corridor — cheaper than markets, but with rigorous procurement and environmental conditions that will slow the build and block the cost-padding your contractors expect.",
  ...
  ax("Central Bank Governor", "shadow", ["currency", "high-note", "black-money"],
    sx("Introducing a new high-denomination note would ease the bulk of large cash transactions — convenient, and a famous enabler of hoarding, bribery, and black money. The governor asks whether to print it or hold the line on the largest note.",
  ...
  ax("Urban Economy Officer", "people", ["vendors", "informal", "licensing"],
    sx("The cities run on hundreds of thousands of street vendors who block footpaths, pay daily bribes to police and mastans, and have no legal standing. The officer can formalise them with licences and designated zones, or keep clearing them in periodic, futile drives.",
  ...
  ax("Railway Finance Secretary", "people", ["railway", "losses", "subsidy"],
    sx("The state railway loses money on every ticket — cheap fares, overstaffing, ticketless travel, and graft — yet it is the lifeline of the poor. The secretary can hike fares and cut staff to stem the losses, or keep the cheap, bleeding service running.",
  ...
  ax("Industries Secretary", "doctor", ["pharma", "api", "self-reliance"],
    sx("The proud pharmaceutical industry imports nearly all its active ingredients, leaving it hostage to foreign supply. A dedicated API park would build self-reliance and a high-value export edge — a costly, slow industrial bet versus simply importing as before.",
  ...
  ax("Revenue Board Chairman", "people", ["sim-tax", "internet", "access"],
    sx("Taxes on SIM cards, handsets, and data are an easy, lucrative revenue stream — and a regressive tax on the very connectivity that drives the digital economy and reaches the rural poor. The chairman asks whether to raise these taxes or cut them.",
  ...
  ax("Cottage Industry Director", "people", ["handloom", "heritage", "artisans"],
    sx("The famed handloom weavers and artisans — keepers of a heritage craft — are being wiped out by cheap power-loom imitations and debt. A revival of credit, design support, and a protected 'heritage' label could save them, or you can let the market take its course.",
  ...
  ax("Export Zone Authority Chief", "people", ["epz", "wages", "investment"],
    sx("The export-processing zones, your showcase for foreign investors, run on a wage floor lower than the national minimum and a ban on unions. Raising the EPZ wage and allowing unions would be just — and might spook the investors the zones were built to attract.",
  ...
  ax("Revenue Board Chairman", "people", ["advance-tax", "compliance", "burden"],
    sx("The web of advance and source taxes deducted on imports, utilities, and transactions has become a hidden, regressive burden — easy to collect, but falling on businesses and consumers regardless of actual profit, and impossible for the small to reclaim. The chairman asks whether to rationalise it.",
  ...
  ax("Budget Secretary", "fixer", ["budget", "deficit", "populism"],
    sx("Election year, and the cabinet wants the largest budget in history — a blizzard of new schemes, subsidies, and giveaways — funded by optimistic revenue forecasts and borrowing. The secretary warns the numbers do not add up; the politics says they do not have to.",
    ...
    sx("The budget is passed, and now the chronic gap between the grand announcements and the money actually disbursed yawns wide — schemes launched with fanfare sit unfunded and half-built. The secretary asks whether to chase headline announcements or quietly fund what was already promised.",
