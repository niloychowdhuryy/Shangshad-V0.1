...
export const FINANCE = [
  ...
  ax("Central Bank Governor", "official", ["reserves", "forex", "imf"],
    sx("Dear Sir — The bank boss says the country is running out of money fast, but you have been pretending you have more. He says people will find out the truth soon.",
    ...
    sx("Honourable leader! You are spending all the country's savings to make your money look strong. The bank boss says you must stop, even if it makes things very expensive.",
    ...
    sx("Central Bank Governor reports: You are out of money. A big global bank will give you emergency money, but only if you make gas prices very high right now. Your helpers say angry people will fill the streets.",
  ...
  ax("Bank Reform Commissioner", "official", ["banks", "default-loans", "cronies"],
    sx("A note from the Finance Ministry reads: Rich families who give you money are secretly stealing from the banks. If you tell the truth, the banks will look broken. If you hide it, the banks will rot from the inside.",
    ...
    sx("Word from the Finance Ministry, sir — You caught the biggest bank thief, but he owns TV stations and helps your team. He offers to pay back a little bit and say nice things about you on TV if you let him go.",
  ...
  ax("Expatriate Welfare Secretary", "official", ["remittances", "hundi", "diaspora"],
    sx("Expatriate Welfare Secretary: Workers in other countries are sending money home secretly because it's cheaper. This means your government doesn't get to count it. You can offer them a bonus to send it legally.",
  ...
  ax("Garment Buyers' Consortium", "official", ["rmg", "exports", "wages"],
    sx("Sir, a message from the Finance Ministry: People who buy your country's clothes say you must pay workers more and make factories safer, or they will stop buying. Factory owners say paying more will ruin them.",
  ...
  ax("Megaproject Coordinator", "official", ["debt", "infrastructure", "china"],
    sx("You built giant bridges and trains using borrowed money. Now you must pay it back, but you don't have enough. One lender wants to own your boat docks if you can't pay. What are your orders, sir?",
  ...
  ax("Financial Intelligence Chief", "official", ["laundering", "capital-flight", "elite"],
    sx("Financial Intelligence Chief awaits your word. Rich people who complain about the country are secretly hiding their money in other countries. Many of them are your friends.",
  ...
  ax("Sovereign Ratings Analyst", "ambassador", ["rating", "markets", "confidence"],
    sx("Mr. Prime Minister, sir! A judge who grades your country's money is going to give you a bad grade. He hints he will give you a good grade if you secretly give him gifts.",
  ...
  ax("NBR Chairman", "official", ["tax", "nbr", "informal"],
    sx("Your Excellency! Almost nobody pays taxes. Your helper wants to force shopkeepers to pay, but those shopkeepers give you money for your campaigns.",
  ...
  ax("Budget Adviser", "official", ["black-money", "whitening", "budget"],
    sx("Dear Sir — People are hiding stolen money. You can let them keep it if they pay a tiny tax, and you won't ask any questions. This rewards bad guys but gives you some money.",
  ...
  ax("Stock Exchange Chair", "official", ["dse", "market", "retail"],
    sx("Honourable leader! The stock market is crashing and normal people are losing their money. They are very angry. Your helper wants to create a fake rule to stop prices from dropping.",
    ...
    sx("Stock Exchange Chair reports: The stock market is broken. A very rich man says he will fix it, but only if you give him a free bank and a phone company in return.",
  ...
  ax("Debt Management Chief", "official", ["eurobond", "debt", "markets"],
    sx("A note from the Finance Ministry reads: You need money fast. You can borrow a lot of money from the world, but you will have to pay back way too much extra money for ten years.",
  ...
  ax("Agriculture Secretary", "official", ["subsidy", "fertiliser", "farmers"],
    sx("Word from the Finance Ministry, sir — Plant food for farmers is very expensive now. If you don't help pay for it, the crops will die. But helping will cost almost all your money.",
  ...
  ax("Pension Authority Head", "official", ["pension", "welfare", "funding"],
    sx("Pension Authority Head: You promised to give old people money when they retire, and everyone loves it. But secretly, you don't have enough money to pay them later.",
  ...
  ax("Central Bank Governor", "official", ["banks", "merger", "weak-banks"],
    sx("Sir, a message from the Finance Ministry: Five banks are completely broken but pretending to be okay. You can force them to join good banks, but your rich friends will lose their jobs there.",
  ...
  ax("Mobile Finance Regulator", "official", ["mfs", "bkash", "fintech"],
    sx("Poor people use their phones to get their paychecks. The big phone company wants to charge them more money to get their cash. What are your orders, sir?",
  ...
  ax("Customs Intelligence Chief", "shadow", ["misinvoicing", "laundering", "trade"],
    sx("Customs Intelligence Chief awaits your word. People are sneaking billions of dollars out of the country using fake shopping bills. The worst bad guys are friends with your leaders.",
  ...
  ax("Fuel Pricing Board", "official", ["fuel", "bpc", "subsidy"],
    sx("Sir! The government sells gas for cars super cheap and loses money every day. You can make a rule so the price changes automatically, so you don't have to be the bad guy.",
  ...
  ax("Treasury Economist", "official", ["currency", "dual-rate", "taka"],
    sx("Mr. Prime Minister, sir! The official price of your country's money is fake, so people use a secret black market. You can fix the official price, but it will make everything cost more for everyone at once.",
  ...
  ax("Foreign Loans Director", "official", ["china", "debt", "geopolitics"],
    sx("Your Excellency! China wants to give you cheap money to build a cool new road. Your enemies say it is a trap to make you owe China forever.",
  ...
  ax("Pay Commission Head", "official", ["wages", "civil-service", "budget"],
    sx("Dear Sir — Millions of government workers want a big pay raise. If you pay them, they will love you, but it will use up all the money meant for building schools and hospitals.",
  ...
  ax("Export Promotion Chief", "official", ["rmg", "incentive", "exports"],
    sx("Honourable leader! You give extra money to people who sell clothes to other countries. The world bank says this is unfair and you must stop. The clothes makers will be very angry.",
  ...
  ax("Deficit Financing Officer", "official", ["printing", "inflation", "central-bank"],
    sx("Deficit Financing Officer reports: You don't have enough money to pay your bills. A helper says you can just print fake money to pay them. It feels easy now, but will make everything super expensive later.",
  ...
  ax("e-Commerce Victims' Delegation", "people", ["scam", "ecommerce", "refunds"],
    sx("A note from the Finance Ministry reads: A fake online store stole money from thousands of families. They are crying outside your office and want their money back.",
  ...
  ax("Revenue Reform Adviser", "official", ["wealth-tax", "surcharge", "elite"],
    sx("Word from the Finance Ministry, sir — A helper says you should charge very rich people a big new tax. Normal people will cheer, but your rich friends will be furious.",
  ...
  ax("Import Policy Officer", "official", ["lc", "luxury", "reserves"],
    sx("Import Policy Officer: To save money, you can stop stores from buying fancy things like cars and makeup from other countries. Rich people will be mad when the shelves are empty.",
  ...
  ax("Loan Classification Board", "official", ["rescheduling", "defaulters", "banks"],
    sx("Sir, a message from the Finance Ministry: People who borrow money and never pay it back want you to change the rules so they look like good guys again. This makes the banks look good but rewards bad behavior.",
  ...
  ax("Privatisation Commissioner", "official", ["privatisation", "jute", "state-firms"],
    sx("Old government factories lose money every single year, but they give jobs to many people. Your helper wants to close them. What are your orders, sir?",
  ...
  ax("National Savings Director", "official", ["sanchayapatra", "savings", "rates"],
    sx("National Savings Director awaits your word. You give old people a really good deal when they save money with the government. But it costs the government too much.",
  ...
  ax("Special Economic Zone Director", "official", ["sez", "tax-holiday", "investment"],
    sx("Sir! A foreign company wants to build a big factory and create jobs. But they want you to promise they don't have to pay taxes for a very long time.",
  ...
  ax("Anti-Tobacco Coalition", "people", ["tobacco", "tax", "health"],
    sx("Mr. Prime Minister, sir! Doctors want you to put a huge tax on cigarettes to stop people from getting sick. But cigarette makers pay you a lot of money and many farmers grow the plants.",
  ...
  ax("Land Registration Reformer", "official", ["real-estate", "black-money", "registration"],
    sx("Your Excellency! People lie about how much their houses cost on paper so they don't have to pay taxes. If you use computers to fix this, powerful people will be caught.",
  ...
  ax("Hajj Management Director", "cleric", ["hajj", "pilgrims", "cost"],
    sx("Dear Sir — Airplanes cost too much for poor families to take their big religious trip. You can use government money to pay for part of their tickets.",
  ...
  ax("Climate Fund Auditor", "official", ["climate", "fund", "graft"],
    sx("Honourable leader! The money meant to help save the earth from storms was stolen by your own team members. You can investigate and take it back, but it will embarrass your team.",
  ...
  ax("Sovereign Fund Proponent", "official", ["reserves", "sovereign-fund", "investment"],
    sx("Sovereign Fund Proponent reports: A helper wants to take your emergency money from the bank and spend it to build big things at home. It is brave, but if an emergency happens, you will have no money.",
  ...
  ax("VAT Online Director", "official", ["vat", "digitisation", "compliance"],
    sx("A note from the Finance Ministry reads: Shopkeepers are putting tax money in their own pockets. You can force them to use smart computers to stop this, but millions of them will be angry and vote against you.",
  ...
  ax("Garment Buyers' Auditor", "ambassador", ["rmg", "compliance", "wages"],
    sx("Word from the Finance Ministry, sir — Buyers from other countries want proof that your factories pay workers fairly. Being fair costs owners money. Faking the proof risks losing the buyers forever.",
  ...
  ax("Revenue Board Chairman", "fixer", ["black-money", "tax", "whitening"],
    sx("Revenue Board Chairman: Bad guys have hidden, stolen money. You can pass a rule that lets them keep it safely if they pay a tiny tax. Honest people think this is very unfair.",
  ...
  ax("Securities Regulator", "official", ["stock-market", "crash", "retail"],
    sx("Sir, a message from the Finance Ministry: Bad guys tricked normal people into losing all their money in the stock market. You can spend government money to pay the normal people back and punish the bad guys.",
  ...
  ax("Privatisation Commission Chief", "official", ["soe", "privatisation", "jobs"],
    sx("The government owns old factories and airplanes that lose money every day. You can shut them down, or keep them running just so workers keep their jobs. What are your orders, sir?",
  ...
  ax("Pension Authority Director", "people", ["pension", "welfare", "future"],
    sx("Pension Authority Director awaits your word. You want to help poor workers save money for when they get old. You can use government money to help them, or force them to use only their own money.",
  ...
  ax("Banking Division Secretary", "fixer", ["loans", "defaulters", "favours"],
    sx("Dear Sir — Rich people who never pay back their bank loans want you to give them a super easy deal again. It makes the banks look okay on paper, but lets the bad guys win.",
  ...
  ax("Debt Management Director", "ambassador", ["eurobond", "debt", "markets"],
    sx("Honourable leader! You can borrow a huge amount of money from the world right now. But you will owe them so much extra money that it will hurt your country for a long time.",
  ...
  ax("Trading Corporation Chief", "shadow", ["inflation", "syndicate", "food"],
    sx("Trading Corporation Chief reports: Bad sellers are hiding food to make it cost more. Some of them give you money.",
  ...
  ax("Customs Commissioner", "fixer", ["customs", "ports", "corruption"],
    sx("A note from the Finance Ministry reads: Guards at the boat docks are taking secret money instead of charging the right taxes.",
  ...
  ax("Revenue Board Chairman", "official", ["tax", "elite", "evasion"],
    sx("Word from the Finance Ministry, sir — Rich people are not paying their taxes, so normal workers have to pay more.",
  ...
  ax("Digital Finance Adviser", "official", ["mobile-money", "remittances", "inclusion"],
    sx("Digital Finance Adviser: Paying with phones can help people send money safely, but regular banks don't like it.",
  ...
  ax("Pay Commission Chair", "official", ["salaries", "bureaucracy", "budget"],
    sx("Sir, a message from the Finance Ministry: Government workers want a giant raise. If you pay them, they will be happy, but you won't have money for other things.",
  ...
  ax("Financial Intelligence Chief", "shadow", ["laundering", "over-invoicing", "capital-flight"],
    sx("Your rich friends are secretly sending their money to other countries. What are your orders, sir?",
  ...
  ax("Investment Authority Chief", "ambassador", ["sez", "fdi", "incentives"],
    sx("Investment Authority Chief awaits your word. Foreign companies want free land and no taxes for a long time to build factories here.",
  ...
  ax("Central Bank Governor", "official", ["deficit", "printing", "inflation"],
    sx("Sir! You have no money to pay bills. You can print fake money now, but it will ruin everything later.",
  ...
  ax("Agricultural Bank Chairman", "people", ["sme", "farmers", "credit"],
    sx("Mr. Prime Minister, sir! Poor farmers can't borrow money because banks only lend to rich people.",
  ...
  ax("Treasury Operations Chief", "official", ["liquidity", "festival", "wages"],
    sx("Your Excellency! A big holiday is coming and factory owners can't pay their workers. The workers will be very mad.",
  ...
  ax("Export Promotion Director", "official", ["exports", "diversification", "garments"],
    sx("Dear Sir — Your country only sells clothes to the world. You can try to sell new things like medicine and computers, but it is slow and hard.",
  ...
  ax("Digital Economy Adviser", "people", ["it", "freelancers", "youth"],
    sx("Honourable leader! Young people making money online are having a hard time getting paid because of bad rules.",
  ...
  ax("Financial Intelligence Chief", "ambassador", ["capital-flight", "second-homes", "elite"],
    sx("Financial Intelligence Chief reports: News reporters found out your leaders secretly own big houses in other countries using stolen money.",
  ...
  ax("Central Bank Governor", "official", ["crypto", "regulation", "capital-controls"],
    sx("A note from the Finance Ministry reads: Young people are using digital internet money. It might be dangerous, but everyone is doing it.",
  ...
  ax("PPP Authority Chief", "fixer", ["ppp", "infrastructure", "contracts"],
    sx("Word from the Finance Ministry, sir — A company wants to build a big road for free, but they will charge everyone to drive on it for a very long time.",
  ...
  ax("Planning Commission Member", "official", ["development-budget", "spending", "quality"],
    sx("Planning Commission Member: Every year, people rush to spend government money on badly made projects just before time runs out.",
  ...
  ax("Microfinance Regulator", "people", ["microfinance", "debt", "poverty"],
    sx("Sir, a message from the Finance Ministry: Poor people are borrowing too much money from too many places and are stuck. You can make rules to stop this, but the lenders will be mad.",
  ...
  ax("Defence Finance Secretary", "general", ["defence", "budget", "spending"],
    sx("The army wants a lot more money for cool new gear. If you give it to them, you can't build schools and hospitals. What are your orders, sir?",
  ...
  ax("Auditor General", "official", ["reserves", "transparency", "audit"],
    sx("Auditor General awaits your word. You have been counting money you already promised to others, making you look richer than you are.",
  ...
  ax("Bank Inspection Chief", "shadow", ["fraud", "banks", "scandal"],
    ...
    sx("Mr. Prime Minister, sir! A second bank was robbed the same way. The checker wants to make strong rules that would stop your friends from controlling the banks.",
  ...
  ax("Remittance Policy Director", "people", ["remittances", "incentive", "reserves"],
    sx("Your Excellency! Workers far away are using secret ways to send money home. You can pay them a bonus to use the safe banks instead.",
    ...
    sx("Dear Sir — Factory owners are jealous of the bonus you gave the workers. They demand a bonus too, or they will hide their money.",
  ...
  ax("Central Bank Governor", "official", ["imports", "lc", "reserves"],
    sx("Honourable leader! You can stop people from buying things from other countries to save money. But this will hurt factories that need parts.",
    ...
    sx("Central Bank Governor reports: Stopping buying things caused a big problem. Now there is not enough medicine or food.",
  ...
  ax("Statistics Bureau Chief", "shadow", ["gdp", "statistics", "credibility"],
    sx("A note from the Finance Ministry reads: You can change the math to make your country look super rich and successful, even if it's a lie.",
  ...
  ax("Wage Commission Chair", "people", ["wages", "labour", "cost"],
    sx("Word from the Finance Ministry, sir — You can pass a rule that all workers must be paid a fair amount. The bosses say this will cost them too much money.",
  ...
  ax("Consumer Protection Director", "shadow", ["e-commerce", "ponzi", "fraud"],
    sx("Consumer Protection Director: A famous online store is stealing everyone's money. You need to stop them quickly before they run away.",
  ...
  ax("Bank Inspection Chief", "shadow", ["nbfi", "embezzlement", "regulator"],
    sx("Sir, a message from the Finance Ministry: One bad guy stole all the money from a money-lending business and ran away.",
  ...
  ax("Central Bank Governor", "official", ["autonomy", "monetary", "independence"],
    sx("Your helpers want the bank boss to break the rules to make you look good for the election. The bank boss says this is dangerous. What are your orders, sir?",
  ...
  ax("Food Directorate Chief", "people", ["procurement", "farmers", "rice"],
    sx("Food Directorate Chief awaits your word. The farmers picked their rice. You can pay them a high price to help them, or a low price to save government money.",
  ...
  ax("Food Directorate Chief", "relief", ["oms", "inflation", "poor"],
    sx("Sir! Food is too expensive and poor people are starving. You can open the emergency food stores now, or save them just in case things get even worse.",
  ...
  ax("Social Protection Director", "people", ["cash-transfer", "education", "poverty"],
    sx("Mr. Prime Minister, sir! You can pay poor mothers money if they promise to keep their kids in school and take them to the doctor.",
  ...
  ax("Revenue Board Chairman", "official", ["property-tax", "wealth", "elite"],
    sx("Your Excellency! Rich people have giant, empty houses that they don't pay taxes on. You can tax their houses to get money for the country.",
  ...
  ax("Revenue Board Chairman", "ambassador", ["digital-tax", "big-tech", "revenue"],
    sx("Dear Sir — Big internet companies make lots of money in your country but pay no tax. You can make them pay, but they might get angry.",
  ...
  ax("Debt Management Director", "ambassador", ["diaspora-bond", "infrastructure", "funding"],
    sx("Honourable leader! You can ask people from your country living far away to lend you money to build things. But if you lose it, they will be very hurt.",
  ...
  ax("Agriculture Finance Secretary", "people", ["diesel", "irrigation", "subsidy"],
    sx("Agriculture Finance Secretary reports: The gas farmers need to water their crops is too expensive. You can help pay for the gas, or let the farmers struggle.",
  ...
  ax("Revenue Board Chairman", "official", ["sin-tax", "health", "revenue"],
    sx("A note from the Finance Ministry reads: You can put a high tax on junk food and cigarettes so people buy less and stay healthy. But the people who make them will be mad.",
  ...
  ax("Budget Secretary", "official", ["fiscal-rule", "debt", "discipline"],
    sx("Word from the Finance Ministry, sir — You can make a strict law that stops the government from borrowing too much money. This makes you safe but stops you from spending freely.",
  ...
  ax("Large Taxpayer Unit Chief", "official", ["transfer-pricing", "multinationals", "evasion"],
    sx("Large Taxpayer Unit Chief: Huge world companies are tricking the math so they don't pay taxes in your country. You can stop them, but they might leave.",
  ...
  ax("Agriculture Finance Secretary", "people", ["insurance", "farmers", "climate"],
    sx("Sir, a message from the Finance Ministry: Bad weather keeps destroying farmers' crops. You can create an insurance plan to protect them, but it costs a lot to set up.",
  ...
  ax("Provident Fund Trustee", "official", ["pension-fund", "investment", "risk"],
    sx("Workers' retirement money is safe but growing slowly. You can try to make it grow faster by investing in risky things, but they might lose it all. What are your orders, sir?",
  ...
  ax("Stimulus Coordination Chief", "fixer", ["stimulus", "sme", "leakage"],
    sx("Stimulus Coordination Chief awaits your word. You have emergency money to save businesses. If you give it out fast, rich friends will grab it all. If you are careful, it will reach small shops.",
  ...
  ax("Securities Regulator", "shadow", ["ipo", "market", "manipulation"],
    sx("Sir! Rich people are playing a game with the stock market to steal from normal people.",
  ...
  ax("Banking Division Secretary", "official", ["banks", "exposure", "concentration"],
    sx("Mr. Prime Minister, sir! A few giant businesses have borrowed almost all the money. If they fail, the country fails. You can force them to stop borrowing so much.",
  ...
  ax("Banking Division Secretary", "fixer", ["banks", "family-control", "governance"],
    sx("Your Excellency! One family is allowed to control a whole bank forever, which makes it easy for them to steal. You can change the rule, but they are your friends.",
  ...
  ax("Tariff Commission Chief", "official", ["dumping", "tariffs", "industry"],
    sx("Dear Sir — Super cheap toys and tools from other countries are hurting your own factories. You can tax them to save your jobs, but things will cost more.",
  ...
  ax("Budget Secretary", "official", ["soe", "losses", "transparency"],
    sx("Honourable leader! Government factories are losing tons of money secretly. You can tell everyone the truth, which will be shocking, or keep hiding it.",
  ...
  ax("Anti-Money-Laundering Director", "ambassador", ["fatf", "compliance", "reputation"],
    sx("Anti-Money-Laundering Director reports: The world says your country lets bad guys hide stolen money. They will punish you unless you stop them, but the bad guys are your friends.",
  ...
  ax("Land Reform Commissioner", "official", ["benami", "property", "corruption"],
    sx("A note from the Finance Ministry reads: Powerful people hide their stolen houses by putting them in other people's names. You can make a law to catch them and take the houses.",
  ...
  ax("Customs Commissioner", "shadow", ["gold", "smuggling", "policy"],
    sx("Word from the Finance Ministry, sir — People are secretly sneaking gold through your airports, and the police are helping them for money.",
  ...
  ax("Customs Commissioner", "shadow", ["vat-refund", "drawback", "fraud"],
    sx("Customs Commissioner: People are tricking the government into giving them extra money for things they never really made or sold.",
  ...
  ax("Customs Commissioner", "shadow", ["bonded-warehouse", "duty", "diversion"],
    sx("Sir, a message from the Finance Ministry: Factory owners get cheap materials to make things to sell far away, but they secretly sell them at home to get richer.",
  ...
  ax("Revenue Board Chairman", "official", ["inheritance-tax", "wealth", "dynasty"],
    sx("Very rich families pass down all their money to their kids without paying any taxes. You could tax this money to help the country. What are your orders, sir?",
  ...
  ax("Insurance Regulator", "people", ["microinsurance", "poverty", "resilience"],
    sx("Insurance Regulator awaits your word. Poor families lose everything if someone gets sick or a storm hits. You could help them buy cheap protection plans to keep them safe.",
  ...
  ax("Women's Affairs Finance Officer", "people", ["maternity", "allowance", "poverty"],
    sx("Dear Sir — Poor moms have to work very hard right until their babies are born. You can give them money so they can stay home and rest.",
  ...
  ax("Education Finance Secretary", "fixer", ["textbooks", "printing", "graft"],
    sx("Honourable leader! The people printing free school books for kids are stealing money and making bad books. They are friends with your team.",
  ...
  ax("Revenue Board Chairman", "official", ["tax-net", "informal", "compliance"],
    sx("Revenue Board Chairman reports: Very few people pay taxes. You can ask normal workers and small stores to pay, but they will be very mad because they never have before.",
  ...
  ax("Central Bank Governor", "official", ["currency", "redenomination", "confidence"],
    sx("A note from the Finance Ministry reads: Your money has too many zeros on it because prices went way up over the years. Someone wants to chop the zeros off just to make it look nicer.",
  ...
  ax("Financial Inclusion Director", "people", ["agent-banking", "rural", "inclusion"],
    sx("Word from the Finance Ministry, sir — You can let tiny village shops act like banks so poor people can easily save money. Big banks are scared they will lose money from fraud.",
  ...
  ax("External Finance Secretary", "ambassador", ["world-bank", "conditions", "reform"],
    sx("External Finance Secretary: A big world bank offers you cheap money, but only if you promise to follow their strict rules for how you run things.",
  ...
  ax("Labour Finance Inspector", "people", ["wage-theft", "workers", "enforcement"],
    sx("Sir, a message from the Finance Ministry: Bosses everywhere are tricking workers and not paying them their full money. You can create a strong police team to stop them.",
  ...
  ax("Budget Secretary", "fixer", ["recapitalisation", "banks", "bailout"],
    sx("Government banks are empty because bad managers stole the money. You need to give them more money to stay open. What are your orders, sir?",
  ...
  ax("Revenue Board Chairman", "people", ["small-business", "turnover-tax", "simplicity"],
    sx("Revenue Board Chairman awaits your word. Tiny stores have to do really hard math to pay taxes. You can make it super easy for them, but you might collect less money overall.",
  ...
  ax("Central Bank Governor", "fixer", ["directed-lending", "credit", "distortion"],
    sx("Sir! Your helpers want banks to give cheap money to businesses owned by your friends. The bank boss says this is a bad idea.",
  ...
  ax("Central Bank Governor", "official", ["interest-rate", "inflation", "growth"],
    sx("Mr. Prime Minister, sir! Everything in the stores costs too much. You can make it harder for people to borrow money to fix prices, but it slows down businesses.",
  ...
  ax("Investment Authority Chief", "ambassador", ["fdi", "screening", "sovereignty"],
    sx("Your Excellency! Other countries want to buy your boat docks and phone companies. You can check them first to stay safe, or let anyone buy to get money fast.",
  ...
  ax("Land Reform Commissioner", "people", ["land-records", "digitisation", "corruption"],
    sx("Dear Sir — The papers that show who owns land are messy and full of lies. You can use computers to fix it, but corrupt helpers will be mad.",
  ...
  ax("Ports Finance Director", "official", ["port", "efficiency", "trade"],
    sx("Honourable leader! Your big boat dock is too slow and messy. You can fix it with robots, but the bad groups who make money from the mess will fight you.",
  ...
  ax("Digital Finance Adviser", "people", ["digital-payments", "cash", "transparency"],
    sx("Digital Finance Adviser reports: Everyone uses paper money, making it easy to hide stealing. You can force people to pay with phones, but poor people might struggle.",
  ...
  ax("Telecom Finance Director", "ambassador", ["spectrum", "auction", "revenue"],
    sx("A note from the Finance Ministry reads: You are selling new invisible waves that make cell phones work. You can charge companies a lot, or sell them cheap so internet is cheaper for everyone.",
  ...
  ax("Aviation Finance Secretary", "fixer", ["airline", "losses", "soe"],
    sx("Word from the Finance Ministry, sir — Your country's airplane company loses money every day because it's run badly. You keep paying to keep it flying to look cool.",
  ...
  ax("Fiscal Climate Adviser", "official", ["carbon-tax", "climate", "revenue"],
    sx("Fiscal Climate Adviser: You can charge a tax on things that make dirty smoke. It helps the earth, but makes things more expensive for people who already don't have enough money.",
  ...
  ax("Revenue Board Chairman", "shadow", ["capital-gains", "stock-market", "elite"],
    sx("Sir, a message from the Finance Ministry: Rich people who make a lot of money in the stock market don't pay taxes on it. If you tax them, they might crash the market on purpose.",
  ...
  ax("External Finance Secretary", "ambassador", ["imf", "transparency", "data"],
    sx("The big world bank wants to tell everyone the honest, ugly truth about your country's money problems. You can try to push them to hide it. What are your orders, sir?",
  ...
  ax("Industrial Safety Secretary", "people", ["garments", "safety", "factories"],
    sx("Industrial Safety Secretary awaits your word. A factory broke and fell down. Now everyone demands factories be made safer. Owners want your help to avoid paying for safety.",
  ...
  ax("ICT Investment Director", "official", ["it", "hi-tech-park", "jobs"],
    sx("Mr. Prime Minister, sir! You can build a giant computer park to create smart jobs. If you don't spend enough money, it will just be empty buildings.",
  ...
  ax("SME Finance Director", "people", ["women", "entrepreneurs", "credit"],
    sx("Your Excellency! Women who want to start small shops can't borrow money from banks. You can create a special fund just to help them.",
  ...
  ax("Planning Commission Member", "fixer", ["mp-fund", "patronage", "local"],
    sx("Dear Sir — Your politicians get a big bag of money every year to fix their towns. Most of them use it to build their own houses or help friends.",
  ...
  ax("External Finance Secretary", "ambassador", ["rating", "markets", "reform"],
    sx("Honourable leader! The world will say your country is bad with money unless you raise taxes and cut help for the poor. People will hate you for it.",
  ...
  ax("Budget Secretary", "fixer", ["allowance", "veterans", "spending"],
    sx("Budget Secretary reports: The list of old war heroes who get free money is growing because people are lying and faking papers. You can clean the list up.",
  ...
  ax("Transport Economy Adviser", "people", ["gig-economy", "ride-share", "workers"],
    sx("A note from the Finance Ministry reads: Delivery and driving apps give young people jobs, but the bosses don't protect them or pay them enough.",
  ...
  ax("Commerce Envoy", "ambassador", ["fta", "regional", "trade"],
    sx("Word from the Finance Ministry, sir — You can make a deal to trade freely with neighbors. It helps sell your things, but cheap neighbor things might close your own shops.",
  ...
  ax("Revenue Board Chairman", "people", ["stamp-duty", "property", "informality"],
    sx("Revenue Board Chairman: The tax to buy a house is so high that everyone lies about the price. If you lower the tax, more people might be honest.",
  ...
  ax("Industries Secretary", "people", ["sme", "manufacturing", "cluster"],
    sx("Sir, a message from the Finance Ministry: Poor, tiny workshops make important parts for your machines. You can give them training and money to grow big, or ignore them for flashier things.",
  ...
  ax("External Finance Secretary", "ambassador", ["adb", "loan", "megaproject"],
    sx("A bank offers cheap money to build a road, but they demand you build it perfectly without any cheating or stealing by your builders. What are your orders, sir?",
  ...
  ax("Central Bank Governor", "shadow", ["currency", "high-note", "black-money"],
    sx("Central Bank Governor awaits your word. You can print a really big piece of money. It makes carrying cash easy, but also makes it super easy for bad guys to hide stolen money.",
  ...
  ax("Urban Economy Officer", "people", ["vendors", "informal", "licensing"],
    sx("Sir! People selling food on the street have to pay bad police officers every day to not get kicked out. You can give them real licenses.",
  ...
  ax("Railway Finance Secretary", "people", ["railway", "losses", "subsidy"],
    sx("Mr. Prime Minister, sir! Government trains lose money on every ride because tickets are so cheap. But poor people need those cheap trains.",
  ...
  ax("Industries Secretary", "doctor", ["pharma", "api", "self-reliance"],
    sx("Your Excellency! Your medicine makers buy all their magic ingredients from other countries. You can build a special park to make the ingredients at home.",
  ...
  ax("Revenue Board Chairman", "people", ["sim-tax", "internet", "access"],
    sx("Dear Sir — Phones and internet are taxed heavily to get the government money. But this makes it too expensive for poor people to use the internet.",
  ...
  ax("Cottage Industry Director", "people", ["handloom", "heritage", "artisans"],
    sx("Honourable leader! People who make beautiful clothes by hand are going out of business because machines are faster. You can step in to save their art.",
  ...
  ax("Export Zone Authority Chief", "people", ["epz", "wages", "investment"],
    sx("Export Zone Authority Chief reports: Special factory zones ban workers from grouping up to ask for better pay. If you let them group up, the foreign owners might get scared and leave.",
  ...
  ax("Revenue Board Chairman", "people", ["advance-tax", "compliance", "burden"],
    sx("A note from the Finance Ministry reads: The government secretly takes a little tax money from almost everything people do. It's easy money, but it is very unfair to poor people.",
  ...
  ax("Budget Secretary", "fixer", ["budget", "deficit", "populism"],
    sx("Word from the Finance Ministry, sir — Your friends want to promise to give away tons of free stuff right before an election to win votes, even though you don't have the money.",
    ...
    sx("Budget Secretary: You promised to build lots of things, but the money is gone. You can just announce more fake projects to look good, or quietly finish the old ones.",
