...
export const HOME = [
  ...
  ax('Nasrin, your spouse', 'spouse', ['family', 'money', 'leak'],
    sx("Nasrin says calmly that a reporter knows about the secret bank account you made in her name.",
    ...
    sx("A new story tells everyone the bank name and your kids' names. Nasrin is upset that you still got caught.",
    ...
    sx("The police want to ask Nasrin questions. She says she will lie to protect you if you ask her to.",
  ...
  ax('Rashed, your elder brother', 'sibling', ['corruption', 'contracts', 'rivalry'],
    sx("Rashed shows you a plan to build a dam. He says your cousins will get the money and no one will check if it's fair.",
    ...
    sx("The dam Rashed built broke, and water flooded many homes on live TV. Rashed tells you to blame the builders.",
    ...
    sx("Rashed holds a computer drive and says he has proof of your secrets. He will tell everyone unless you give him a big promotion.",
  ...
  ax('Tania, your daughter', 'child', ['scandal', 'press', 'succession'],
    sx("A police boss calls late at night. Tania was at a party where kids got sick from bad drugs, and her name is on the list. You can hide it before morning.",
    ...
    sx("Tania wants to be the leader of the young group. She says she has a secret video and will show everyone if you don't make her the leader.",
    ...
    sx("Tania wants to marry the son of your biggest enemy. She says it will fix the fight between your families and asks you to agree.",
  ...
  ax('Begum Sufia, your mother', 'matriarch', ['succession', 'loyalty', 'inheritance'],
    sx("At dinner, your mother says she changed the family rules. She says you only get the money if the family stays together.",
    ...
    sx("The doctor tells you privately that your mother's brain is getting sick. She still controls all the family money and people listen to her.",
    ...
    sx("Your mother is very sick in bed. She asks you to promise to take care of everyone, or she won't give you the money.",
  ...
  ax('An unsigned courier', 'shadow', ['blackmail', 'betrayal', 'security'],
    sx("You get a secret letter with photos of you meeting someone you shouldn't have. The letter says your sister wants a lot of money to give back the real photos.",
    ...
    sx("You paid your sister, but she comes back. She says she made copies of the photos and wants even more money now.",
  ...
  ax('Faisal, your son-in-law', 'inlaw', ['garments', 'labour', 'safety'],
    sx("Faisal says his factory failed a fire safety test. He can pay a bad guy to ignore it, or shut down all the machines.",
    ...
    sx("Buyers from far away want to see if your factories are safe. Faisal wants to trick them by only showing one fake safe floor.",
  ...
  ax('Imran, your son', 'child', ['money', 'overseas', 'laundering'],
    sx("Imran says people in Canada want to meet the real owner of his secret houses. He asks what to do.",
    ...
    sx("The news shows that Imran hid millions of dollars in Canada. People are very angry, but he wants to come home to fix the papers.",
  ...
  ax('Mizan, your nephew', 'sibling', ['campus', 'violence', 'party'],
    sx("Mizan's school group hurt a rival student really badly. He asks you to protect him from the police.",
    ...
    sx("People are protesting at the school because of the hurt student. They want Mizan's group to be banned completely.",
  ...
  ax('Hafiz, the household imam', 'cleric', ['religion', 'legitimacy'],
    sx("The family priest asks for a big favor. If you say no, he will tell everyone your son drinks alcohol.",
  ...
  ax('Joya, your youngest', 'child', ['love', 'class', 'image'],
    sx("Your youngest daughter wants to marry a poor driver's son. She says you can agree happily, or she will do it anyway and it will be in the news.",
  ...
  ax('Anwar, your father-in-law', 'inlaw', ['banking', 'finance'],
    sx("Your father-in-law's bank gave money to your own family's companies. He wants you to fire the bank boss, or your family will get in trouble.",
  ...
  ax('Belal, your driver of twenty years', 'servant', ['loyalty', 'people'],
    sx("Your driver's son is very sick and needs a new body part. He is far behind in the waiting line and asks for your help.",
  ...
  ax('Saima, your daughter-in-law', 'inlaw', ['dignity', 'abuse', 'press'],
    sx("Your son's wife has bruises. She says your son hit her and wants your help, or she will tell the news reporters.",
  ...
  ax('Karim, the cabinet secretary', 'official', ['nepotism', 'state'],
    sx("Your helper says you are giving almost all the government jobs to your own family and friends.",
  ...
  ax('Nasrin, your spouse', 'spouse', ['marriage', 'exit', 'love'],
    sx("Your wife packs her bags. She says she will only stay if you truly love her, not just because you need her help to look good.",
  ...
  ax('Bakar, the village headman', 'people', ['roots', 'patronage'],
    sx("Your village leader says a flood destroyed homes, and your cousin stole the help money.",
  ...
  ax("Shafiq, your son-in-law", "fixer", ["in-law", "ambition", "power"],
    sx("Your daughter's husband wants a big job in the government. He is smart but greedy. Your daughter might be sad if you say no.",
    ...
    sx("Your daughter's husband is making secret deals with your enemies. Your daughter is caught in the middle.",
  ...
  ax("Arif, your grandson", "sibling", ["wedding", "excess", "optics"],
    sx("Your grandson wants a super expensive wedding, but the country is trying to save money. People would be angry to see it.",
  ...
  ax("Kamal, your brother", "sibling", ["banking", "favour", "graft"],
    sx("Your brother wants to open his own bank with your permission.",
  ...
  ax("Imran, your son", "sibling", ["citizenship", "exposure", "hypocrisy"],
    sx("Your son secretly became a citizen of another country. A reporter is about to tell everyone.",
  ...
  ax("Roksana, your sister-in-law", "sibling", ["land", "grabbing", "family"],
    sx("Your sister-in-law is taking land from poor people and using your name to hide. People are starting to complain.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["memoir", "legacy", "secrets"],
    sx("Your sick mother is writing a book about her life. She might accidentally share big family secrets.",
  ...
  ax("Tania, your daughter", "sibling", ["ngo", "funds", "scandal"],
    sx("Your daughter's charity is actually hiding stolen money. Checkers are coming to look at the money, and she wants you to stop them.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["succession", "children", "merit"],
    sx("Your mother wants you to pick your fun but silly child to be the next leader, instead of your smart but cold child.",
  ...
  ax("Hashem, your private secretary", "fixer", ["leak", "audio", "betrayal"],
    sx("Someone shared a secret recording of you making fun of people.",
  ...
  ax("Family Physician", "doctor", ["health", "matriarch", "optics"],
    sx("Your mother needs very expensive medicine far away, but poor people in your country cannot even get basic doctors.",
  ...
  ax("Quddus, the old bodyguard", "people", ["loyalty", "pension", "memory"],
    sx("Your old guard who saved your life is dying poor. He knows lots of your secrets.",
  ...
  ax("Nadia, your niece", "sibling", ["scandal", "youth", "media"],
    sx("Your niece got drunk and crashed her fast car into a poor man. There is a video of it. Your family wants to hide the video, but people online are angry.",
  ...
  ax("Faisal, your son", "sibling", ["business", "monopoly", "favour"],
    sx("Your son Faisal wants to buy a big phone company. He says he needs it to keep things safe. Other people say your family is taking over everything.",
  ...
  ax("The Palace Chief of Staff", "official", ["household", "budget", "excess"],
    sx("It costs way too much money to run your big house. People would be angry if they knew.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["mausoleum", "legacy", "cult"],
    sx("Your sick mother wants a giant, expensive building built for her when she dies. The country would have to pay for it forever.",
  ...
  ax("Imran, your son", "sibling", ["addiction", "rehab", "secret"],
    sx("Your son Imran took too many bad drugs and got very sick. Your family hid him in a secret hospital. Some say he needs real help where everyone can see.",
  ...
  ax("Shahana, the estranged sister", "sibling", ["family", "feud", "threat"],
    sx("Your sister, who you don't talk to, comes back. She wrote a book about all the bad things your family did. She will print it unless you pay her and act like friends.",
  ...
  ax("Rashed, the fixer-cousin", "fixer", ["contracts", "kickbacks", "exposure"],
    sx("Your cousin Rashed, who helps the family make secret deals, is in trouble with the police in another country. He wants you to protect him.",
  ...
  ax("Nasrin, your spouse", "spouse", ["spouse", "politics", "ambition"],
    sx("Your wife Nasrin wants a big government job of her own. This would make her very powerful too.",
  ...
  ax("The Dynasty's Pollster", "official", ["image", "family", "strategy"],
    sx("A helper tells you that young people do not like your family anymore. They think your family acts spoiled. He says you need to change how you look, which costs money.",
  ...
  ax("Arif, your grandson", "sibling", ["succession", "youth", "abroad"],
    sx("Your grandson Arif is supposed to be the leader one day, but he doesn't want to. He wants to live far away and be normal.",
  ...
  ax("Karim, your private secretary", "fixer", ["secret", "scandal", "family"],
    sx("Your helper brings proof that you have a secret second family. The newspapers might tell everyone soon.",
  ...
  ax("The Palace Physician", "doctor", ["matriarch", "superstition", "health"],
    sx("Your sick mother is listening to a magic healer instead of her real doctor. She is getting much sicker.",
  ...
  ax("The Dynasty's Media Manager", "fixer", ["heir", "social-media", "image"],
    sx("The person who will be leader after you is posting pictures of expensive things online and making fun of poor people.",
  ...
  ax("Nasrin, your spouse", "spouse", ["marriage", "trust", "aide"],
    sx("Your wife Nasrin is angry and wants you to fire your best helper. She thinks you like the helper too much.",
  ...
  ax("Jalal, your cousin", "fixer", ["media", "family", "propaganda"],
    sx("Your cousin Jalal wants the government to pay for his own TV station. He will use it to say good things about your family.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["marriage", "alliance", "dynasty"],
    sx("Your mother set up a marriage for your grandchild with another powerful family. Your grandchild doesn't know them.",
  ...
  ax("The Palace Physician", "doctor", ["health", "mortality", "succession"],
    sx("Your doctor says your heart is sick and you don't have many years left to live. Being the boss makes it worse.",
  ...
  ax("Karim, your private secretary", "fixer", ["scandal", "justice", "family"],
    sx("A young family member drove drunk and killed someone walking. Your helper can make the police report disappear.",
  ...
  ax("Imran, your son", "sibling", ["gambling", "debt", "blackmail"],
    sx("Your son Imran played games for money and lost a lot to bad people. They will tell the news if you don't pay his debt.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["interference", "cabinet", "power"],
    sx("Your mother is acting like she is the boss of the country, telling your helpers what to do. Your helpers are very mad.",
  ...
  ax("Tania, your daughter", "sibling", ["reconciliation", "estrangement", "family"],
    sx("Your daughter Tania, who you fought with long ago, comes back. She wants to be friends again and help the family.",
  ...
  ax("The Official Biographer", "official", ["legacy", "history", "truth"],
    sx("A writer is making a book about you. They found out bad things you did as well as good things. They ask if they should write the total truth or just the good parts.",
  ...
  ax("Karim, your private secretary", "ambassador", ["assets", "foreign", "exposure"],
    sx("Another country's police locked your family's secret bank accounts because they think the money is stolen.",
  ...
  ax("The Household Steward", "people", ["servant", "loyalty", "secret"],
    sx("An old helper who knows all your family secrets is leaving. Someone offered them a lot of money to tell the secrets. They ask you for money instead.",
  ...
  ax("Faisal, your son", "sibling", ["nepotism", "seat", "politics"],
    sx("Your son Faisal wants to be a leader without doing any hard work first. The people who worked hard will be mad.",
  ...
  ax("Mizan, the security chief", "shadow", ["guards", "militia", "family"],
    sx("Mizan wants to make a giant private army just for your family.",
  ...
  ax("Arif, your grandson", "sibling", ["activism", "dissent", "family"],
    sx("Your grandson Arif is yelling at your government in public. He says you are doing bad things. Your friends want you to stop him.",
  ...
  ax("The Court Astrologer", "shadow", ["superstition", "decisions", "influence"],
    sx("A magic star-reader tells your mother when to make big government choices. The smart people are very mad about this.",
  ...
  ax("Kamal, your brother", "sibling", ["inheritance", "property", "feud"],
    sx("Your brother Kamal is suing you for the family house. If he goes to court, everyone will hear family secrets. He will stop if you give him what he wants privately.",
  ...
  ax("Nasrin, your spouse", "spouse", ["charity", "foundation", "scrutiny"],
    sx("People think your wife Nasrin is stealing money from her charity. Checkers are coming. She cries and asks you to stop the checkers.",
  ...
  ax("Jalal, your cousin", "fixer", ["election", "loss", "consolation"],
    sx("Your cousin Jalal lost his big election. Now he is sad and demands a big government job anyway to feel better.",
  ...
  ax("Karim, your private secretary", "fixer", ["diary", "secrets", "legacy"],
    sx("Someone stole a page from your secret diary where you wrote mean things about people.",
  ...
  ax("The Culture Secretary", "official", ["cult", "anniversary", "legacy"],
    sx("Someone wants to throw a giant, expensive party for your family's history, making everyone celebrate it.",
  ...
  ax("The Palace Physician", "doctor", ["children", "mental-health", "secret"],
    sx("The doctor says your youngest child is very, very sad inside. Your family thinks being sad is a weakness.",
  ...
  ax("The Family Lawyer", "official", ["matriarch", "death", "succession"],
    sx("Your mother died and her will gives all the money to one favorite child, leaving the others with nothing. They will fight over it.",
  ...
  ax("Karim, your private secretary", "shadow", ["smuggling", "family", "scandal"],
    sx("A family member is secretly stealing gold, and the police are getting close to catching them.",
  ...
  ax("Tania, your daughter", "sibling", ["divorce", "scandal", "family"],
    sx("Your daughter Tania wants to leave her mean husband. His family is powerful, and everyone will gossip. She wants your help.",
  ...
  ax("Karim, your private secretary", "fixer", ["aide", "overreach", "power"],
    sx("Your best helper is making big choices without asking you and keeping money for himself. People are scared of him.",
  ...
  ax("The Dynasty's Mentor", "official", ["heir", "grooming", "succession"],
    sx("The teacher says the child you picked to be the next leader is not smart enough and people don't like them.",
  ...
  ax("Kamal, your brother", "sibling", ["defection", "rival", "loyalty"],
    sx("Your brother Kamal is angry and says he will join the bad guys and tell your secrets unless you pay him lots of money.",
  ...
  ax("Roksana, your sister-in-law", "fixer", ["university", "family", "patronage"],
    sx("Your sister-in-law Roksana is selling fake school grades for money. People are getting mad. She wants you to protect her.",
  ...
  ax("The Palace Physician", "spouse", ["spouse", "health", "duty"],
    sx("Your wife Nasrin is very sick and might die soon. She needs you, but your big job keeps you away.",
  ...
  ax("Faisal, your son", "sibling", ["business", "bailout", "favour"],
    sx("Your son Faisal's business failed and he owes a lot of money. He wants you to make the country's bank forget about his debt.",
  ...
  ax("The Household Imam", "cleric", ["religion", "influence", "decisions"],
    sx("The family priest wants you to change the country's laws to be very strict about religion. If you say no, religious people will be mad.",
  ...
  ax("Mizan, the security chief", "shadow", ["exile", "contingency", "survival"],
    sx("Your guard says things are dangerous and you should secretly prepare an airplane to run away to another country if bad things happen.",
  ...
  ax("Karim, your private secretary", "fixer", ["grandchild", "scandal", "influence"],
    sx("Your grandchild is hanging out with bad friends who do bad things. It might be on the news soon.",
  ...
  ax("The Family Lawyer", "spouse", ["matriarch", "promise", "legacy"],
    sx("Before she died, your mother made you promise something you know is a bad idea. The lawyer asks if you will still do it.",
  ...
  ax("Mizan, the security chief", "shadow", ["betrayal", "family", "leak"],
    sx("Your guard found out a family member is secretly selling your secrets to your enemies for money.",
  ...
  ax("The Dynasty's Mentor", "official", ["succession", "heir", "backup"],
    sx("The teacher says you should secretly train a second child to be leader, just in case the first one fails. If they find out, they will fight.",
  ...
  ax("The Palace Physician", "doctor", ["burnout", "health", "judgment"],
    sx("Your doctor says you are too tired to think straight and are making mistakes.",
  ...
  ax("The Family Treasurer", "fixer", ["wealth", "gold", "exposure"],
    sx("Your family has a giant pile of secret gold and jewels. If anyone finds it, you will be in trouble.",
  ...
  ax("Nasrin, your spouse", "spouse", ["power", "legacy", "stepping-down"],
    sx("Nasrin asks if you should quit being the boss now while people still like you, instead of waiting until people hate you and force you out.",
  ...
  ax("Karim, your private secretary", "fixer", ["nepotism", "education", "favour"],
    sx("Your nephew in school far away spent too much money. You can pay for it with your own money or steal government money to pay for it.",
  ...
  ax("Tania, your daughter", "sibling", ["rivalry", "succession", "feud"],
    sx("Your two best children are fighting meanly over who gets to be the leader next.",
  ...
  ax("Karim, your private secretary", "doctor", ["scandal", "hospital", "family"],
    sx("A hospital owned by your family is very dirty and patients are dying. The checkers want to punish them.",
  ...
  ax("The Party Elders' Council", "official", ["succession", "anointment", "dynasty"],
    sx("The older leaders want you to pick the next leader right now. If you do, people might stop listening to you because they know you are leaving soon.",
  ...
  ax("The Cabinet Secretary", "official", ["inner-circle", "loyalty", "competence"],
    sx("Your friends only tell you good things and lie to make you happy. A helper says you need to listen to honest people, but your friends will be mad.",
  ...
  ax("Tania, your daughter", "sibling", ["heir", "trust", "succession"],
    sx("Tania asks you a hard question: is she supposed to help the country, or just make your family richer?",
    ...
    sx("Tania finds out your family is doing bad, secret things for money. She asks if she can stop it and punish them.",
    ...
    sx("Tania asks if you will leave your job nicely so she can take over easily, or if you will cling to it until everything is broken.",
