...
export const HOME = [
  ...
  ax('Nasrin, your spouse', 'spouse', ['family', 'money', 'leak'],
    sx("Nasrin holds up her phone, calm. 'A journalist knew about my Singapore account before I did — the one you opened in my name.'",
    ...
    sx("A second story names the bank, the dates, the children. Nasrin reads it before you can speak. 'You moved it — and still got us caught.'",
    ...
    sx("The anti-corruption commission wants Nasrin's testimony. She is ready to lie for you, calmly. 'One word from you,' she says, 'and I never opened that account.'",
  ...
  ax('Rashed, your elder brother', 'sibling', ['corruption', 'contracts', 'rivalry'],
    sx("Rashed slides the Padma embankment tender across your desk. 'Three firms, all ours through cousins. Nobody audits flood money.' The bid already carries your seal.",
    ...
    sx("The embankment Rashed built has breached — forty villages under water on live TV, a leaked memo carrying your seal. He phones, unbothered: 'Blame the contractor.'",
    ...
    sx("Cornered, Rashed waves a thumb drive in your study. 'Everything I did carried your seal, and I kept copies. Make me Deputy PM, or this goes to Delhi and Washington.'",
  ...
  ax('Tania, your daughter', 'child', ['scandal', 'press', 'succession'],
    sx("The Home Secretary calls at 3 a.m. 'Tania was at a Banani rooftop where two boys overdosed. Her name's on the hospital intake. By morning it's buried or it's a headline.'",
    ...
    sx("Tania wants the party's youth wing — and she kept footage of that scrubbed police file as insurance. 'Give it to me,' she says, 'or I wonder aloud how it vanished.'",
    ...
    sx("Tania offers to marry your fiercest rival's son. 'It neutralises his whole dynasty in one wedding. I'm offering you a treaty — don't waste it on sentiment.'",
  ...
  ax('Begum Sufia, your mother', 'matriarch', ['succession', 'loyalty', 'inheritance'],
    sx("At the Dhanmondi dinner your mother announces, without looking up, that she has rewritten the trust: your name stays only 'while the family remains whole.' The whole table heard it.",
    ...
    sx("Dr. Kabir tells you privately: your mother's tremor is early dementia, 'perhaps two lucid years.' She still controls the trust, the loyalists, and half the party's heart.",
    ...
    sx("Lucid one last evening, she calls you to her bedside. 'Swear to keep the others fed and I name you heir tonight. Or I die undecided, and you tear each other apart.'",
  ...
  ax('An unsigned courier', 'shadow', ['blackmail', 'betrayal', 'security'],
    sx("A plain envelope clears the morning sweep: three photos of you with the Defence Attaché where you should never have been. One line: 'Your sister has the originals. Choose who you fear by Friday.'",
    ...
    sx("Your sister, paid once, returns. 'The originals were copies of copies, brother. There's always one more.' She names a sum that would fund a ministry.",
  ...
  ax('Faisal, your son-in-law', 'inlaw', ['garments', 'labour', 'safety'],
    sx("Faisal runs the family garment group. 'The Ashulia unit failed its fire inspection. I can pay the inspector, or shut three thousand machines. Your name's on the gate, not mine.'",
    ...
    sx("Western buyers want a tour of the family's factories after a rival's collapse. Faisal panics: 'Half our units would fail. Show them the model floor and keep them off the rest.'",
  ...
  ax('Imran, your son', 'child', ['money', 'overseas', 'laundering'],
    sx("Imran flies in from Toronto, gripping a laptop. 'The Canadians want to meet the real owner of the condos. I told them a businessman. Now they want him in a room.'",
    ...
    sx("The leaked 'Begumpara files' name Imran's Toronto holdings on the front page. Students chant about laundered millions while reserves run thin. He wants to fly back and 'sort the paperwork.'",
  ...
  ax('Mizan, your nephew', 'sibling', ['campus', 'violence', 'party'],
    sx("Your nephew Mizan leads the party's student front at Dhaka University. Tonight his boys put a rival in the morgue. 'It was him or us, chacha. Protect me and I deliver every campus.'",
    ...
    sx("The killing has sparked a campus uprising demanding Mizan's wing be banned outright. The cantonment is watching how you handle a crowd.",
  ...
  ax('Hafiz, the household imam', 'cleric', ['religion', 'legitimacy'],
    sx("The imam who married you asks a favour after Jummah. 'The madrasa board delivers three constituencies for your endorsement — or remembers, loudly, that your son drinks.'",
  ...
  ax('Joya, your youngest', 'child', ['love', 'class', 'image'],
    sx("Joya brings home a rickshaw-puller's son — full of love for her and no fear of you. 'I am marrying him. Bless it from the dais, or read about it in the papers.'",
  ...
  ax('Anwar, your father-in-law', 'inlaw', ['banking', 'finance'],
    sx("Anwar chairs the family bank. 'We've lent eight hundred crore to companies that are, let us say, ours. Replace the central bank governor, or our bank is the next headline.'",
  ...
  ax('Belal, your driver of twenty years', 'servant', ['loyalty', 'people'],
    sx("Belal has driven you for twenty years. His son needs a kidney; the matched donor is eight hundred deep in a state queue. 'I have never asked you for anything, sir.'",
  ...
  ax('Saima, your daughter-in-law', 'inlaw', ['dignity', 'abuse', 'press'],
    sx("Saima, Imran's wife, comes to you bruised at the wrist and steady in voice. 'Your son raises his hand. Help me, or I go to the press myself.'",
  ...
  ax('Karim, the cabinet secretary', 'official', ['nepotism', 'state'],
    sx("Karim lays the posting list before you, jaw tight. 'Thirty-one of the last forty senior appointments share your village or your blood. I had to say it.'",
  ...
  ax('Nasrin, your spouse', 'spouse', ['marriage', 'exit', 'love'],
    sx("Nasrin packs a single bag, calmly. 'Thirty years your wife, your shield, your alibi. Ask me to stay because you need the marriage and I will. Ask because you love me, and I might believe it.'",
  ...
  ax('Bakar, the village headman', 'people', ['roots', 'patronage'],
    sx("A delegation from your ancestral village arrives with garlands and grievances. 'The river took forty homes; your cousin the UNO sold the relief. We want our son to remember whose soil he sprang from.'",
  ...
  ax("Shafiq, your son-in-law", "fixer", ["in-law", "ambition", "power"],
    sx("Shafiq, married into the family and hungry, asks for a cabinet seat — 'to keep power in trusted hands.' He is competent and grasping in equal measure, and your daughter's marriage may sour if you refuse.",
    ...
    sx("Shafiq is now quietly meeting your rivals, hedging his bets, and your daughter is caught between husband and father. An aide brings you the surveillance log and waits.",
  ...
  ax("Arif, your grandson", "sibling", ["wedding", "excess", "optics"],
    sx("Your grandson Arif plans a wedding of obscene splendour — foreign popstars, imported cars, a guest list of oligarchs — while the country tightens its belt. The optics would be a gift to your enemies.",
  ...
  ax("Kamal, your brother", "sibling", ["banking", "favour", "graft"],
    sx("Your brother Kamal wants a licence for a new private bank. 'Every dynasty has its bank,' he says. 'Why should ours beg from strangers?'",
  ...
  ax("Imran, your son", "sibling", ["citizenship", "exposure", "hypocrisy"],
    sx("It emerges that Imran quietly took a foreign citizenship years ago — a humiliation for a leader who preaches sovereignty. A journalist has the documents and is days from publishing.",
  ...
  ax("Roksana, your sister-in-law", "sibling", ["land", "grabbing", "family"],
    sx("Your sister-in-law Roksana has been seizing public and minority land using the family name as a shield. The dispossessed are starting to petition. She insists she is 'only developing what others wasted.'",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["memoir", "legacy", "secrets"],
    sx("The ailing matriarch is dictating her memoirs, and her failing discretion may put decades of family secrets in print. Her ghostwriter quietly asks whether to publish faithfully or sanitise.",
  ...
  ax("Tania, your daughter", "sibling", ["ngo", "funds", "scandal"],
    sx("Your daughter Tania's glittering charity foundation is quietly doubling as a slush fund. An international audit is sniffing close, and she begs you to make it go away.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["succession", "children", "merit"],
    sx("The matriarch presses you to anoint your charming, hopeless elder child over your cold, capable younger one. 'The people love the elder, the party fears the younger. A throne needs love.'",
  ...
  ax("Hashem, your private secretary", "fixer", ["leak", "audio", "betrayal"],
    sx("Hashem brings grim news: a recording of a candid family dinner — you mocking allies, dismissing the public — has leaked and is spreading. He asks how to respond before it consumes the cycle.",
  ...
  ax("Family Physician", "doctor", ["health", "matriarch", "optics"],
    sx("The matriarch needs treatment available only abroad — vast expense, a state aircraft — while ordinary citizens die in the public wards she once championed. The physician needs your decision fast.",
  ...
  ax("Quddus, the old bodyguard", "people", ["loyalty", "pension", "memory"],
    sx("Quddus, who took a bullet for you decades ago, is dying poor and forgotten — and carries, in his failing memory, secrets from your hardest years. Loyalty and liability in one frail body.",
  ...
  ax("Nadia, your niece", "sibling", ["scandal", "youth", "media"],
    sx("Your niece Nadia, drunk and filmed, has crashed her sports car into a rickshaw, injuring the puller. The video is everywhere; the family wants it buried, the internet wants blood.",
  ...
  ax("Faisal, your son", "sibling", ["business", "monopoly", "favour"],
    sx("Your son Faisal's conglomerate is bidding for a national telecom licence, and a word from you would settle it. He calls it keeping a strategic asset safe; the regulator calls it the family swallowing another sector.",
  ...
  ax("The Palace Chief of Staff", "official", ["household", "budget", "excess"],
    sx("The cost of running the residence has ballooned into a line item that, if leaked, would enrage a struggling public. The chief of staff asks whether to trim it or bury it deeper in the budget.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["mausoleum", "legacy", "cult"],
    sx("Sensing the end, the matriarch wants a grand family mausoleum and a perpetual state-funded foundation. 'Let them not forget what we built,' she says. The price: a permanent claim on the treasury.",
  ...
  ax("Imran, your son", "sibling", ["addiction", "rehab", "secret"],
    sx("Imran's drug problem has spiralled, and an overdose was hushed up at a private clinic. The family wants it sealed forever; a quieter voice says he needs real, visible help.",
  ...
  ax("Shahana, the estranged sister", "sibling", ["family", "feud", "threat"],
    sx("Your estranged sister Shahana resurfaces with a manuscript of grievances and a media deal — unless you reconcile and pay. She knows where every body in the family is buried.",
  ...
  ax("Rashed, the fixer-cousin", "fixer", ["contracts", "kickbacks", "exposure"],
    sx("Your cousin Rashed, who greased the family's deals for decades, is named in a foreign bribery indictment. He asks, with quiet menace, that you protect him as he protected you.",
  ...
  ax("Nasrin, your spouse", "spouse", ["spouse", "politics", "ambition"],
    sx("Nasrin, long your quiet shield, now wants a public political role of her own — a ministry, a legacy beyond being your wife. It would plant a second power in your own bed.",
  ...
  ax("The Dynasty's Pollster", "official", ["image", "family", "strategy"],
    sx("The pollster lays it bare: the family brand is curdling, the young see entitlement where their parents saw sacrifice. He offers a costly rebrand, or the comfort of denial.",
  ...
  ax("Arif, your grandson", "sibling", ["succession", "youth", "abroad"],
    sx("Your grandson Arif, groomed since birth as a future heir, confesses he wants none of it — he means to stay abroad and never return to the cage of the dynasty. The line of succession trembles.",
  ...
  ax("Karim, your private secretary", "fixer", ["secret", "scandal", "family"],
    sx("Karim brings the file you dreaded: proof of a second family — a woman and a child kept quietly for years — now at risk of a tabloid exposé. He waits, expressionless, for your word.",
  ...
  ax("The Palace Physician", "doctor", ["matriarch", "superstition", "health"],
    sx("The ailing matriarch has fallen under a faith healer who forbids her medicine and prescribes amulets; her health is failing fast. The physician begs you to intervene; the family fears crossing her belief.",
  ...
  ax("The Dynasty's Media Manager", "fixer", ["heir", "social-media", "image"],
    sx("Your designated heir floods social media with reckless luxury and scorn for the 'ungrateful' poor while the country tightens its belt. The manager wants the accounts seized; the heir resists fiercely.",
  ...
  ax("Nasrin, your spouse", "spouse", ["marriage", "trust", "aide"],
    sx("Nasrin, cold and certain, demands you dismiss your brilliant young chief of staff, convinced the closeness has gone beyond work. The aide is the best you have. The marriage trembles on your answer.",
  ...
  ax("Jalal, your cousin", "fixer", ["media", "family", "propaganda"],
    sx("Your cousin Jalal wants a licence and state advertising for a television channel — a family mouthpiece, he says, to defend the dynasty. A loyal megaphone funded, in effect, by the public purse.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["marriage", "alliance", "dynasty"],
    sx("The matriarch has arranged for your grandchild to marry into another political dynasty — a powerful alliance that knits two vote banks, and binds your grandchild to a stranger for the family's reach.",
  ...
  ax("The Palace Physician", "doctor", ["health", "mortality", "succession"],
    sx("The physician tells you in private that your heart is failing and the years left are few — and office is hastening the end. You can step back toward a managed succession, or burn what remains holding power.",
  ...
  ax("Karim, your private secretary", "fixer", ["scandal", "justice", "family"],
    sx("A drunk young relative has run down and killed a pedestrian. Karim has the police report before the press: he can make the case vanish, or you let the law take its course against your own blood.",
  ...
  ax("Imran, your son", "sibling", ["gambling", "debt", "blackmail"],
    sx("Imran has run up ruinous gambling debts to dangerous people abroad, who now hint they will sell the story unless quietly paid. Shamefaced, he begs you to settle it.",
  ...
  ax("Begum Sufia, the matriarch", "spouse", ["interference", "cabinet", "power"],
    sx("The matriarch, holding no office, summons your ministers and runs a shadow government from the residence. The cabinet seethes in private; to confront her is to wound the woman who built the dynasty.",
  ...
  ax("Tania, your daughter", "sibling", ["reconciliation", "estrangement", "family"],
    sx("Your daughter Tania, long estranged after a bitter falling-out, returns — older, softer, seeking reconciliation and perhaps a place in the family's future. The old wound aches; so does the empty chair.",
  ...
  ax("The Official Biographer", "official", ["legacy", "history", "truth"],
    sx("Your authorised biographer has uncovered the hard truths alongside the triumphs, and asks whether to write honestly — warts and all — or produce the burnished hagiography the family expects.",
  ...
  ax("Karim, your private secretary", "ambassador", ["assets", "foreign", "exposure"],
    sx("A foreign government investigating money-laundering has frozen a web of the family's overseas accounts. Karim asks whether to fight openly through lawyers, or quietly let the assets go before the trail leads home.",
  ...
  ax("The Household Steward", "people", ["servant", "loyalty", "secret"],
    sx("An old household servant, privy to decades of family secrets, is retiring — and a publisher has offered a fortune for a tell-all. Loyal but poor, the steward comes to you first, asking only to be looked after.",
  ...
  ax("Faisal, your son", "sibling", ["nepotism", "seat", "politics"],
    sx("Your son Faisal, with no record of service, demands a safe parliamentary seat as his due. The local party workers who earned their place resent the parachute; the family expects you to provide for your own.",
  ...
  ax("Mizan, the security chief", "shadow", ["guards", "militia", "family"],
    sx("Mizan proposes expanding the family's security into a large private force answerable only to the dynasty. It would make the family untouchable — and put a private army at the heart of the state.",
  ...
  ax("Arif, your grandson", "sibling", ["activism", "dissent", "family"],
    sx("Your grandson Arif, idealistic and furious, has begun publicly attacking your government's record on rights and corruption, delighting the opposition. He will not be silenced. The hardliners want him disowned.",
  ...
  ax("The Court Astrologer", "shadow", ["superstition", "decisions", "influence"],
    sx("An astrologer the matriarch trusts now advises on the timing of cabinet decisions and elections — and the family takes the readings seriously. The rationalists in your circle are appalled; the matriarch is adamant.",
  ...
  ax("Kamal, your brother", "sibling", ["inheritance", "property", "feud"],
    sx("Your brother Kamal is suing over the ancestral home and lands, claiming the lion's share. If it reaches open court, the family's dirty laundry airs before the nation. He offers a private settlement on his terms.",
  ...
  ax("Nasrin, your spouse", "spouse", ["charity", "foundation", "scrutiny"],
    sx("Nasrin's beloved foundation — her life's work — faces whispers that its accounts are loose and funds have strayed. An audit looms. Wounded by the suspicion, she begs you to make it go away.",
  ...
  ax("Jalal, your cousin", "fixer", ["election", "loss", "consolation"],
    sx("Your cousin Jalal, parachuted into a seat he then lost, demands a consolation prize — a ministry, a chairmanship — to soothe his wounded pride. The family expects you to provide; the merit-minded are appalled.",
  ...
  ax("Karim, your private secretary", "fixer", ["diary", "secrets", "legacy"],
    sx("Your candid private diary — decades of unguarded judgments of allies and enemies — has been copied, and a page has surfaced. Karim asks whether to hunt the leak ruthlessly or pre-empt it with a curated version of your own.",
  ...
  ax("The Culture Secretary", "official", ["cult", "anniversary", "legacy"],
    sx("A grand state spectacle is proposed for the dynasty's founding anniversary — compulsory assemblies, a holiday, portraits in every office. The family glows; critics see a personality cult cast across the calendar.",
  ...
  ax("The Palace Physician", "doctor", ["children", "mental-health", "secret"],
    sx("The physician confides that your youngest, crushed by the weight of the family name, is severely depressed and hiding it. The family treats such things as shameful weakness. The physician asks how to proceed.",
  ...
  ax("The Family Lawyer", "official", ["matriarch", "death", "succession"],
    sx("The matriarch has died, and her will divides everything unequally — naming a favourite, slighting the rest, with a clause that could ignite a succession war. The lawyer asks whether to honour it strictly or broker an even peace.",
  ...
  ax("Karim, your private secretary", "shadow", ["smuggling", "family", "scandal"],
    sx("Karim brings evidence that a relative is running a gold smuggling ring under the family's shadow, and customs investigators are circling. Shut it down and cut the relative loose, or quash the investigation?",
  ...
  ax("Tania, your daughter", "sibling", ["divorce", "scandal", "family"],
    sx("Your daughter Tania wants to divorce her abusive, well-connected husband — a step the conservative public and her powerful in-laws will turn into a scandal and a feud. She asks for your backing against the pressure to endure.",
  ...
  ax("Karim, your private secretary", "fixer", ["aide", "overreach", "power"],
    sx("Your most trusted aide now acts in your name without leave — issuing orders, taking cuts — a shadow authority ministers fear more than yours. Karim warns he has grown too large; cutting him loose costs your right hand.",
  ...
  ax("The Dynasty's Mentor", "official", ["heir", "grooming", "succession"],
    sx("The mentor reports your chosen heir is out of their depth — indecisive, unloved by the party, unready. You can keep forcing the unsuited heir forward, or reopen the succession to someone abler.",
  ...
  ax("Kamal, your brother", "sibling", ["defection", "rival", "loyalty"],
    sx("Your brother Kamal, passed over and embittered, threatens to defect to the opposition with his faction and his secrets — a betrayal that would split the family. He hints what it would take to keep him: power, money, a free hand.",
  ...
  ax("Roksana, your sister-in-law", "fixer", ["university", "family", "patronage"],
    sx("Your sister-in-law Roksana runs the family's private university as a personal fief — selling admissions and degrees, packing the faculty with cronies. A scandal is brewing. She asks for your shield.",
  ...
  ax("The Palace Physician", "spouse", ["spouse", "health", "duty"],
    sx("Nasrin, your lifelong anchor, is gravely ill and needs you at her side — but office pulls you away at every turn, and she is fading while you govern. The physician asks, gently, where you will be in the time she has left.",
  ...
  ax("Faisal, your son", "sibling", ["business", "bailout", "favour"],
    sx("Your son Faisal's grand venture has collapsed under debt, and he begs you to have a state bank quietly write off his loans — as such favours have rescued the connected before. The bankers await your word.",
  ...
  ax("The Household Imam", "cleric", ["religion", "influence", "decisions"],
    sx("The household imam is pressing you, through the devout matriarch, to shape state policy to his conservative lights — curriculum, women's rights, minority matters. To heed him pleases the pious; to refuse risks their wrath.",
  ...
  ax("Mizan, the security chief", "shadow", ["exile", "contingency", "survival"],
    sx("With unrest rising, Mizan quietly proposes an exile contingency — foreign assets, a safe haven, a plane on standby. To prepare it is prudent; to be caught preparing it would signal you expect to fall, and hasten it.",
  ...
  ax("Karim, your private secretary", "fixer", ["grandchild", "scandal", "influence"],
    sx("Your grandchild has fallen in with a fast, decadent crowd — drugs, scandal — dragging them toward the next viral embarrassment. Karim asks whether to forcibly intervene or trust the young to find their own way.",
  ...
  ax("The Family Lawyer", "spouse", ["matriarch", "promise", "legacy"],
    sx("On her deathbed the matriarch extracted a promise — to elevate a grandchild, shield a favoured relative — that now binds you against your better judgment. The lawyer asks whether to honour it or quietly set it aside.",
  ...
  ax("Mizan, the security chief", "shadow", ["betrayal", "family", "leak"],
    sx("Surveillance reveals a trusted relative has been feeding the family's secrets to the opposition for money. Mizan has the proof. You can expose and cast them out, or feed them lies and turn the leak into a weapon.",
  ...
  ax("The Dynasty's Mentor", "official", ["succession", "heir", "backup"],
    sx("With the chosen heir untested and the times dangerous, the mentor urges you to quietly groom a backup heir — insurance against the first faltering. If discovered, it will pit the two against each other and split the family.",
  ...
  ax("The Palace Physician", "doctor", ["burnout", "health", "judgment"],
    sx("The physician warns that exhaustion is eroding your judgment — sleepless, isolated, brittle, prone to error. You can take a real rest and delegate, or push on through the fog by sheer will.",
  ...
  ax("The Family Treasurer", "fixer", ["wealth", "gold", "exposure"],
    sx("The family's vast hoard of undeclared gold and jewels could be exposed by any asset-disclosure rule or investigation. The treasurer asks whether to quietly declare and regularise it, or keep it hidden and deniable.",
  ...
  ax("Nasrin, your spouse", "spouse", ["power", "legacy", "stepping-down"],
    sx("Nasrin, who has watched power hollow you out, asks the unaskable: is it time to step down with dignity while the legacy is intact, rather than cling on until you are dragged out? The dynasty's future hangs on the answer.",
  ...
  ax("Karim, your private secretary", "fixer", ["nepotism", "education", "favour"],
    sx("A nephew studying lavishly abroad has run up enormous bills the family must cover — and the easiest source is a quiet diversion of a scholarship fund or an embassy budget. Karim asks how to settle it.",
  ...
  ax("Tania, your daughter", "sibling", ["rivalry", "succession", "feud"],
    sx("Your two ablest children, Tania and Faisal, are now in open, poisonous rivalry over the succession — each building a faction, each demanding you crush the other. To choose makes an enemy of one child; to delay lets the feud consume the family.",
  ...
  ax("Karim, your private secretary", "doctor", ["scandal", "hospital", "family"],
    sx("A hospital owned by a family member is caught in a deadly negligence scandal — patients dead from filth and unqualified staff. The bodies and the outrage are mounting. Let regulators act fully, or shield the family's hospital?",
  ...
  ax("The Party Elders' Council", "official", ["succession", "anointment", "dynasty"],
    sx("The elders, anxious for certainty, press you to publicly anoint your successor now and begin the handover — ending the speculation that weakens you, at the cost of becoming, the moment you do, a lame duck whose power drains to the heir.",
  ...
  ax("The Cabinet Secretary", "official", ["inner-circle", "loyalty", "competence"],
    sx("Your inner circle has calcified into aging loyalists who tell you only what you wish to hear, while abler outsiders are frozen out. The secretary urges you to open it to candid voices; the loyalists, sensing the threat, resist.",
  ...
  ax("Tania, your daughter", "sibling", ["heir", "trust", "succession"],
    sx("Tania, the child you have settled on as heir, comes not with gratitude but a hard question: does she inherit a country to serve, or a family machine to feed? How you answer will shape what she becomes.",
    ...
    sx("Tania, now trusted with real authority, uncovers vast corruption running through the family's own enterprises and asks whether she may clean it out — even though it means turning on relatives and donors who fed the dynasty for decades.",
    ...
    sx("With your reign drawing to its end, Tania asks the last question: will you leave on your own terms and hand her a clean transition, or cling on and leave her to seize what she can from the wreckage of a contested succession?",
