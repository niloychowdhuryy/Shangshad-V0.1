...
export const INTERIOR = [
  ...
  ax("Inspector-General of Police", "general", ["protest", "students", "quota"],
    sx("Sir, a message from the Home Ministry: Students are blocking the roads peacefully to protest an unfair rule. The police chief wants to force them to leave right now.",
    ...
    sx("A video shows a police officer shooting an unarmed student. Everyone is very angry. Your strict friends want you to lock everyone inside and turn off the internet. What are your orders, sir?",
    ...
    sx("Inspector-General of Police awaits your word. The protesters want you to fire the leaders who ordered the police to hurt people. The army says they won't help you hurt students anymore.",
  ...
  ax("Rights Commission Chair", "official", ["disappearances", "rab", "torture"],
    sx("Sir! A helper brings proof that your secret police kidnapped people and hid them in secret jails. Some are still alive.",
    ...
    sx("Mr. Prime Minister, sir! The police are scared they will get in trouble for the bad things they did. They want you to promise to protect them, or they might stop listening to you.",
  ...
  ax("ICT Enforcement Director", "official", ["dsa", "press", "speech"],
    sx("Your Excellency! People are in jail just for drawing funny pictures or writing jokes about your family online. The police want to arrest more people.",
  ...
  ax("District Magistrate, riot zone", "official", ["communal", "minorities", "puja"],
    sx("Dear Sir — An untrue rumor made angry people start breaking into homes and temples. The local police are just watching and not helping.",
  ...
  ax("Cyber Intelligence Vendor", "shadow", ["surveillance", "spyware", "rights"],
    sx("Honourable leader! A salesman offers you a secret tool to hack into anyone's phone and read their messages.",
  ...
  ax("Reform-minded Police Superintendent", "official", ["police", "torture", "reform"],
    sx("Reform-minded Police Superintendent reports: A good young police boss says a bad officer hurt a poor man until he died, then lied about it.",
  ...
  ax("Camp Security Commander", "general", ["rohingya", "camps", "trafficking"],
    sx("A note from the Home Ministry reads: Bad gangs are doing illegal things in the homeless camps. The guard wants to use strong force to clean it up, but that will be very violent.",
  ...
  ax("Special Branch Director", "shadow", ["election", "opposition", "arrests"],
    sx("Word from the Home Ministry, sir — An election is coming. A spy boss wants to arrest your enemies now for fake reasons so they can't campaign against you.",
  ...
  ax("Anti-Narcotics Director", "general", ["yaba", "drug-war", "crossfire"],
    sx("Anti-Narcotics Director: Bad drugs are everywhere. The police want to fight a harsh war and might accidentally kill people they think are selling drugs.",
  ...
  ax("Road Safety Movement", "people", ["students", "road-safety", "protest"],
    sx("Sir, a message from the Home Ministry: A bad bus driver ran over two students. Now all the kids are in the streets demanding safer roads.",
  ...
  ax("District Police Super", "official", ["lynching", "rumour", "mob"],
    sx("A fake story on phones about people stealing children is making angry mobs beat up innocent strangers. What are your orders, sir?",
  ...
  ax("Hill Tracts Commander", "general", ["cht", "insurgency", "indigenous"],
    sx("Hill Tracts Commander awaits your word. People in the hills are fighting because an old peace promise is falling apart. The army wants to go in strong.",
  ...
  ax("Women's Rights Commission", "people", ["gender", "rape-law", "justice"],
    sx("Sir! A woman was hurt very badly. People are marching and demanding that the bad guys be put to death.",
  ...
  ax("Anti-Trafficking Chief", "official", ["trafficking", "migration", "mediterranean"],
    sx("Mr. Prime Minister, sir! Bad men in your country are tricking poor people onto dangerous boats to go far away. The bad men pay the police to look the other way.",
  ...
  ax("Prisons Inspector-General", "official", ["prisons", "overcrowding", "political"],
    sx("Your Excellency! The jails are way too full, mostly with your enemies who never got a fair trial. People are getting sick.",
  ...
  ax("Fire Service Director", "official", ["fire", "building-code", "safety"],
    sx("Dear Sir — A secret chemical room caught fire and many people died. The fire boss wants to shut down every unsafe building, but your rich friends own them.",
  ...
  ax("Immigration Director", "official", ["passport", "corruption", "bribery"],
    sx("Honourable leader! Getting a passport takes forever unless you pay a secret bribe. You can make a new computer system to stop the bribes, but your workers will be mad.",
  ...
  ax("VIP Protocol Officer", "official", ["vip", "convoy", "privilege"],
    sx("VIP Protocol Officer reports: A very important leader's fast car hit a poor man. The leader didn't stop, and an ambulance was stuck behind them. Everyone saw the video.",
  ...
  ax("NID Database Chief", "shadow", ["surveillance", "data", "privacy"],
    sx("A note from the Home Ministry reads: A computer expert wants to connect everyone's fingerprints and photos to cameras that watch the city. This could find bad guys, but it also spies on everyone.",
  ...
  ax("Cyber Crime Unit Head", "official", ["cybercrime", "gambling", "scams"],
    sx("Word from the Home Ministry, sir — Bad gangs online are stealing people's money using games. Some of your own young helpers are secretly part of the gangs.",
  ...
  ax("Police Recruitment Board", "official", ["police", "recruitment", "merit"],
    sx("Police Recruitment Board: People have to pay giant bribes just to get a job as a police officer. This makes them bad police officers later.",
  ...
  ax("Transport Authority Chief", "official", ["traffic", "unfit-vehicles", "gridlock"],
    sx("Sir, a message from the Home Ministry: The city is full of old, broken, dangerous buses run by mean groups. If you get rid of the bad buses, the groups might strike and stop all traffic.",
  ...
  ax("Counter-Terror Chief", "general", ["militancy", "terror", "raids"],
    sx("After a scary attack, the police want to break into homes to stop bad guys before they do anything. This might make innocent people angry. What are your orders, sir?",
  ...
  ax("Slum Eviction Magistrate", "official", ["eviction", "slum", "land"],
    sx("Slum Eviction Magistrate awaits your word. A rich builder wants to tear down a giant neighborhood where very poor people live so he can build something fancy.",
  ...
  ax("Special Branch Analyst", "shadow", ["dissent", "journalists", "watchlist"],
    sx("Sir! Your spies have a list of writers and complainers. They want to follow them and scare them so they stop complaining.",
  ...
  ax("Border Guard Sector Commander", "general", ["border", "smuggling", "haats"],
    sx("Mr. Prime Minister, sir! People sneak things over the border to make money, and guards shoot them. You could build safe, legal markets there instead.",
  ...
  ax("Riot Control Commander", "general", ["protest", "crowd", "force"],
    sx("Your Excellency! A giant crowd of your enemies is having a peaceful meeting. Your police boss wants to use sticks and gas to make them run away.",
  ...
  ax("Disappearances Liaison", "official", ["disappearances", "families", "white-vans"],
    sx("Dear Sir — Mothers of people who were kidnapped by the police are standing together crying. The world wants to send a team to investigate.",
  ...
  ax("Domestic Worker Advocate", "people", ["labour", "abuse", "children"],
    sx("Honourable leader! A little girl working as a maid in a rich house was hurt very badly. A helper wants to check all rich houses to make sure maids are safe.",
  ...
  ax("Election Security Chief", "general", ["election", "violence", "centres"],
    sx("Election Security Chief reports: Voting day is coming and people might fight. You can put the army everywhere to keep it fair, or only put them where it helps you win.",
  ...
  ax("Acid & Dowry Cell", "people", ["acid", "dowry", "women"],
    sx("A note from the Home Ministry reads: Mean people are throwing bad chemicals that burn women's faces. You can make it very hard to buy these chemicals, but store owners will complain.",
  ...
  ax("Crowd Safety Officer", "official", ["events", "stampede", "public"],
    sx("Word from the Home Ministry, sir — Two huge events are happening at the same time. Last year, a crowd pushed too hard and people died. A helper wants strict rules to keep crowds small and safe.",
  ...
  ax("Counter-Terror Commander", "general", ["terrorism", "siege", "militants"],
    sx("Counter-Terror Commander: Bad guys with weapons took over a fancy restaurant and are hurting people inside.",
    ...
    sx("Sir, a message from the Home Ministry: The bad guys from the restaurant turned out to be rich, smart kids from good families. Your friends are terrified.",
  ...
  ax("Inspector-General of Police", "official", ["lynching", "rumour", "mob"],
    sx("A fake story about strangers stealing kids for a bridge is making mobs beat innocent people to death. What are your orders, sir?",
  ...
  ax("Home Secretary", "cleric", ["islamist", "protest", "blasphemy"],
    sx("Home Secretary awaits your word. A huge group of religious people blocked the whole city. They demand you destroy a statue they don't like.",
  ...
  ax("Intelligence Procurement Chief", "shadow", ["spyware", "surveillance", "dissent"],
    sx("Sir! You can buy a super-secret tool to read everyone's phone messages. But if you buy it, everyone will eventually find out you spy on them.",
  ...
  ax("Prisons Inspector-General", "official", ["prisons", "political", "overcrowding"],
    sx("Mr. Prime Minister, sir! The jails are completely packed because you arrested so many people who don't like you. You can let the harmless ones go home.",
  ...
  ax("University Affairs Officer", "people", ["students", "campus", "torture"],
    sx("Your Excellency! Students from your own team beat another student until he died just for writing something bad about you online.",
  ...
  ax("Smart City Director", "official", ["cctv", "facial-recognition", "privacy"],
    sx("Dear Sir — You can put cameras everywhere that know exactly who everyone is and where they go. It stops crime but means no one has any privacy.",
  ...
  ax("Security Reform Adviser", "general", ["rab", "sanctions", "reform"],
    sx("Honourable leader! Your strict police stopped killing bad guys because the world was watching. But now crime is coming back. Your strict friends want the police to start killing again.",
  ...
  ax("Police Reform Commissioner", "official", ["police", "corruption", "bribery"],
    sx("Police Reform Commissioner reports: Local police stations are very mean and won't help anyone unless they pay a bribe. You can try to make them clean and nice, but the police will fight you.",
  ...
  ax("Anti-Trafficking Chief", "shadow", ["trafficking", "boats", "syndicate"],
    sx("A note from the Home Ministry reads: Bad guys are putting poor men on broken boats to go to another country, and the police are helping the bad guys.",
  ...
  ax("Religious Harmony Officer", "cleric", ["minorities", "sect", "violence"],
    sx("Word from the Home Ministry, sir — A big angry crowd is attacking a small group of people who pray differently.",
  ...
  ax("Cultural Affairs Officer", "official", ["culture", "festival", "extremism"],
    sx("Cultural Affairs Officer: People want to have a big, fun new year party with music and masks. But grumpy people say it is bad and threaten to ruin it with a bomb.",
  ...
  ax("Internal Affairs Director", "official", ["whistleblower", "police", "accountability"],
    sx("Sir, a message from the Home Ministry: An honest police officer shared secret papers proving his boss ordered the police to kill people.",
  ...
  ax("District Magistrate", "official", ["protest", "ban", "assembly"],
    sx("Your enemies are planning a giant meeting. You can use an old rule to make it illegal, but that might make them so angry they fight you. What are your orders, sir?",
  ...
  ax("Arms Licensing Officer", "fixer", ["firearms", "party", "patronage"],
    sx("Arms Licensing Officer awaits your word. Your local friends want you to give them licenses to carry guns. They say it's for safety, but they really want to scare people during elections.",
  ...
  ax("Counter-Terror Commander", "general", ["extremism", "foreign-fighters", "deradicalisation"],
    sx("Sir! Some people who left to join a bad terrorist group want to come back home with their kids.",
  ...
  ax("Information Security Officer", "official", ["press", "accreditation", "surveillance"],
    sx("Mr. Prime Minister, sir! You can secretly take away the special passes from reporters who write mean things about you, so they can't do their jobs.",
  ...
  ax("Prisons Inspector-General", "general", ["jailbreak", "militants", "security"],
    sx("Your Excellency! Very bad terrorists escaped from a super safe prison because someone inside helped them.",
  ...
  ax("Industrial Police Chief", "general", ["labour", "garments", "protest"],
    sx("Dear Sir — Thousands of factory workers blocked the road because they haven't been paid. The factory owners want you to send the police to beat them and clear the road.",
  ...
  ax("Land Records Commissioner", "people", ["minorities", "land", "grabbing"],
    sx("Honourable leader! Powerful people in your group stole land from a smaller religion using a bad, old rule. You can force them to give it back.",
  ...
  ax("NID Database Director", "official", ["nid", "database", "surveillance"],
    sx("NID Database Director reports: You can connect everyone's ID cards, phones, and bank accounts into one giant computer file. It is helpful, but lets the government know everything about everyone.",
  ...
  ax("Education-Security Liaison", "cleric", ["madrasa", "curriculum", "extremism"],
    sx("A note from the Home Ministry reads: Many religious schools are not registered, and some might be teaching kids to be angry and mean. You can force them to register and learn math and science.",
  ...
  ax("Traffic Division Chief", "official", ["traffic", "extortion", "corruption"],
    sx("Word from the Home Ministry, sir — The traffic police take a little bit of secret money from every single bus and truck on the road.",
  ...
  ax("Counter-Terror Commander", "cleric", ["shrines", "sufi", "militants"],
    sx("Counter-Terror Commander: Mean people are attacking gentle, peaceful religious places. The police want to guard the places and arrest the loud speakers who tell people to attack.",
  ...
  ax("Inspector-General of Police", "people", ["women", "rape", "justice"],
    sx("Sir, a message from the Home Ministry: A group of boys did a terrible thing to a girl and filmed it. They are friends with important people. The whole country is demanding they be punished.",
  ...
  ax("Border Guard Director", "shadow", ["border", "smuggling", "corruption"],
    sx("Your own border guards are helping bad guys sneak cows, gold, and drugs across the fence for money. What are your orders, sir?",
  ...
  ax("Home Secretary", "general", ["curfew", "unrest", "order"],
    sx("Home Secretary awaits your word. People are angry and filling the streets in every city. A helper wants you to order everyone to stay inside and tell the police to shoot anyone they see.",
  ...
  ax("Telecom Security Officer", "shadow", ["internet", "blackout", "unrest"],
    sx("Sir! Protesters are using their phones to plan things. You can completely turn off the internet and phone signals for the whole country to stop them.",
  ...
  ax("Police Reform Commissioner", "official", ["police", "accountability", "body-cameras"],
    sx("Mr. Prime Minister, sir! People hate the police because the police are mean. A helper wants to make police wear cameras to prove they are acting nice. The police really hate this idea.",
  ...
  ax("District Magistrate", "cleric", ["morality", "vigilantes", "youth"],
    sx("Your Excellency! Groups of bossy people are walking around parks and yelling at boys and girls for hanging out together or wearing normal clothes.",
  ...
  ax("Intelligence Chief", "shadow", ["disappearances", "detention", "exposure"],
    sx("Dear Sir — People found out you have a secret prison with mirrored walls where you hide people who disappear. The news is about to tell everyone.",
  ...
  ax("Hill Tracts Security Officer", "general", ["cht", "insurgency", "checkpoints"],
    sx("Honourable leader! The army is bossing around the people who live in the hills. An old promise says the army should leave, but the army wants to stay and stay strict.",
  ...
  ax("District Magistrate", "cleric", ["communal", "blasphemy", "rumour"],
    sx("District Magistrate reports: Someone made a fake picture to make it look like a boy insulted a religion. Now an angry mob is burning down the boy's village.",
  ...
  ax("Protocol Security Chief", "general", ["vip", "security", "resources"],
    sx("A note from the Home Ministry reads: Most of your police are busy guarding rich politicians, so normal neighborhoods have no protection.",
  ...
  ax("Cyber Patrol Commander", "shadow", ["online", "dissent", "speech"],
    sx("Word from the Home Ministry, sir — A special computer police team wants to arrest anyone who posts jokes or complaints about the country online. This would put many teenagers in jail.",
  ...
  ax("Inspector-General of Police", "people", ["eviction", "slums", "force"],
    sx("Inspector-General of Police: A judge said the police must use bulldozers to destroy a giant neighborhood of poor people.",
  ...
  ax("Auxiliary Forces Director", "general", ["ansar", "village", "militia"],
    sx("Sir, a message from the Home Ministry: You could give guns to normal villagers to help the police. But they might use the guns to bully their neighbors.",
  ...
  ax("Financial Crimes Chief", "shadow", ["counterfeit", "currency", "crime"],
    sx("Bad guys from another country are flooding your stores with fake, printed money. People are losing trust in their cash. What are your orders, sir?",
  ...
  ax("Women's Safety Officer", "people", ["women", "harassment", "safety"],
    sx("Women's Safety Officer awaits your word. Mean boys yell at girls on the street so much that some girls are terrified to go outside. You can make special police catch the mean boys.",
  ...
  ax("Counter-Terror Commander", "shadow", ["bloggers", "extremism", "secularism"],
    sx("Sir! Bad guys with big knives are attacking writers who don't believe in their strict rules.",
  ...
  ax("Police Reform Commissioner", "doctor", ["remand", "torture", "confession"],
    sx("Mr. Prime Minister, sir! The police solve crimes by hitting people until they confess, even if they are innocent. A helper wants to buy science tools to solve crimes the right way.",
  ...
  ax("Immigration Director", "fixer", ["passport", "immigration", "corruption"],
    sx("Your Excellency! The passport office is very corrupt. People pay secret money to get their passports faster, and bad guys use it to get fake ones.",
  ...
  ax("Law Secretary", "official", ["death-penalty", "mercy", "justice"],
    sx("Dear Sir — A man is about to be hanged for a crime, but there is proof the trial was unfair and he might be totally innocent. Angry people want him hanged anyway.",
  ...
  ax("Fire Service Director", "relief", ["fire", "safety", "capacity"],
    sx("Honourable leader! The fire trucks don't have ladders long enough to reach the tall buildings in the city. It costs a lot of money to buy new ones.",
  ...
  ax("Border Guard Director", "people", ["border", "haats", "smuggling"],
    sx("Border Guard Director reports: People on the border are secretly trading things. You can build safe, legal markets for them so they don't have to sneak around.",
  ...
  ax("Crime Investigation Chief", "general", ["kidnapping", "ransom", "crime"],
    sx("A note from the Home Ministry reads: Bad groups are kidnapping rich people for money. Some of the kidnappers are actually off-duty police officers and political friends.",
  ...
  ax("Rural Justice Officer", "cleric", ["shalish", "fatwa", "women"],
    sx("Word from the Home Ministry, sir — In small villages, unofficial judges are whipping women as a cruel punishment. You can send the real police to stop them.",
  ...
  ax("Telecom Security Director", "shadow", ["interception", "wiretap", "oversight"],
    sx("Telecom Security Director: The police want a new rule to let them read anyone's phone messages whenever they want, without asking a judge first.",
  ...
  ax("Highway Police Chief", "general", ["dacoity", "highways", "safety"],
    sx("Sir, a message from the Home Ministry: Bad guys with guns are robbing the big delivery buses at night. The police chief wants money to build special highway patrols to stop them.",
  ...
  ax("Social Crime Officer", "shadow", ["trafficking", "begging", "children"],
    sx("Terrible groups are hurting children and forcing them to beg for money on the streets. What are your orders, sir?",
  ...
  ax("Protocol Security Chief", "official", ["vip", "traffic", "public"],
    sx("Protocol Security Chief awaits your word. Every time a politician drives somewhere, the police block all the roads. It causes giant traffic jams and even traps ambulances.",
  ...
  ax("Crime Investigation Chief", "people", ["building-collapse", "liability", "developers"],
    sx("Sir! A poorly built building collapsed and killed many people. The builder paid secret money to ignore the rules, and he gives money to your team.",
  ...
  ax("Cyber Crime Chief", "shadow", ["fraud", "scams", "online"],
    sx("Mr. Prime Minister, sir! Scammers are calling people on the phone and tricking them into giving away all their money. It costs a lot to build a police team to catch them.",
  ...
  ax("Public Order Officer", "cleric", ["procession", "security", "communal"],
    sx("Your Excellency! Two different religious groups are planning big parades on the exact same street on the same day. They might fight.",
  ...
  ax("Transport Security Coordinator", "people", ["eid", "travel", "safety"],
    sx("Dear Sir — Before a big holiday, millions of people crowd onto unsafe, broken boats and buses to get home. Many die in crashes every year.",
  ...
  ax("Crime Investigation Chief", "general", ["firearms", "amnesty", "recovery"],
    sx("Honourable leader! There are too many illegal guns. You can offer a deal: if people give you their guns, you won't ask any questions or punish them. This gets rid of guns but lets bad guys off the hook.",
  ...
  ax("Diplomatic Security Chief", "general", ["foreigners", "security", "aid-workers"],
    sx("Diplomatic Security Chief reports: People from other countries are scared of being attacked. They want heavy police guards everywhere, but that makes the city look very scary.",
  ...
  ax("Social Welfare Magistrate", "doctor", ["juvenile", "justice", "children"],
    sx("A note from the Home Ministry reads: Kids who get in trouble are thrown into scary jails with adult criminals, which makes the kids worse. A helper wants to build a nice place to help kids learn to be good.",
  ...
  ax("Surveillance Technology Director", "shadow", ["drones", "surveillance", "protest"],
    sx("Word from the Home Ministry, sir — You can buy flying camera drones to watch everyone at protests from the sky. People say this is spying on them.",
  ...
  ax("Health Crime Officer", "doctor", ["organ-trafficking", "poverty", "crime"],
    sx("Health Crime Officer: A terrible group is tricking poor villagers and taking their kidneys to sell to rich people. Some doctors and rich hospitals are part of the secret group.",
  ...
  ax("Telecom Security Officer", "official", ["sim", "biometric", "privacy"],
    sx("Sir, a message from the Home Ministry: You can force everyone to give their fingerprint when they buy a phone card. This stops bad guys from using secret phones, but it tracks everyone else too.",
  ...
  ax("Internal Affairs Director", "official", ["custodial-death", "inquiry", "accountability"],
    sx("People are dying while locked in police jails, and the police always lie and say it was an accident. What are your orders, sir?",
  ...
  ax("River Police Chief", "general", ["piracy", "rivers", "fishermen"],
    sx("River Police Chief awaits your word. Bad guys with guns are attacking boats on the river and stealing things. The police boss needs money for fast boats to stop them.",
  ...
  ax("Immigration Director", "shadow", ["travel-ban", "critics", "control"],
    sx("Sir! You can secretly put the names of people who complain about you on a list at the airport so they are never allowed to leave the country.",
  ...
  ax("Education Board Chairman", "shadow", ["exams", "leaks", "fraud"],
    sx("Mr. Prime Minister, sir! Secret school tests are being stolen and sold online. You can use computers to keep them safe, but the bad guys who steal them will fight back.",
  ...
  ax("Public Service Commission Liaison", "shadow", ["recruitment", "exam", "corruption"],
    sx("Your Excellency! People are cheating and paying secret money to pass tests for government jobs.",
  ...
  ax("Narcotics Control Officer", "doctor", ["liquor", "poison", "poverty"],
    sx("Dear Sir — People are making poison drinks that are killing poor villagers. Bad police officers protect the drink makers.",
  ...
  ax("Prisons Inspector-General", "doctor", ["women", "prison", "rights"],
    sx("Honourable leader! The jails for women are too crowded and very mean. Innocent women and their children are stuck there in bad conditions.",
  ...
  ax("Cyber Crime Chief", "shadow", ["gambling", "online", "addiction"],
    sx("Cyber Crime Chief reports: Bad phone games from other countries are tricking kids into losing their money. Some of your own helpers are taking a cut of the money.",
  ...
  ax("Forensic Services Director", "doctor", ["forensics", "backlog", "justice"],
    sx("A note from the Home Ministry reads: The police science lab is too busy, so innocent people sit in jail while waiting for proof. You can spend money to build more science labs.",
  ...
  ax("Police Procurement Chief", "general", ["riot-gear", "less-lethal", "force"],
    sx("Word from the Home Ministry, sir — A seller wants to give you big, scary weapons like water cannons to use on angry crowds.",
  ...
  ax("Women's Crime Officer", "people", ["dowry", "murder", "justice"],
    sx("Women's Crime Officer: A young wife was hurt by her powerful new family, and they are paying the police to hide the crime.",
  ...
  ax("Telecom Security Director", "shadow", ["vpn", "censorship", "control"],
    sx("Sir, a message from the Home Ministry: People are using secret phone tools to read news you banned. You can block the secret tools too, but people will be mad.",
  ...
  ax("Social Welfare Director", "relief", ["street-children", "shelter", "poverty"],
    sx("Many poor children live on the city streets and are in danger. You can build safe homes for them, or just keep chasing them away. What are your orders, sir?",
  ...
  ax("Cyber Crime Chief", "doctor", ["sextortion", "women", "online"],
    sx("Cyber Crime Chief awaits your word. Bad people are using fake pictures online to bully and scare girls.",
  ...
  ax("Public Order Officer", "official", ["crowd", "concert", "safety"],
    sx("Sir! There are too many giant parties happening at once, and crowds might get squished and hurt.",
  ...
  ax("Rural Justice Officer", "people", ["superstition", "violence", "minorities"],
    sx("Mr. Prime Minister, sir! In faraway villages, angry mobs are hurting poor women by calling them witches.",
  ...
  ax("NID Database Director", "shadow", ["nid", "fraud", "citizenship"],
    sx("Your Excellency! Bad workers are secretly selling your country's official ID cards to strangers and criminals.",
  ...
  ax("Registrar General", "official", ["marriage", "registration", "child-marriage"],
    sx("Dear Sir — People are changing papers to let little girls get married illegally. You can use computers to stop this.",
  ...
  ax("Narcotics Control Chief", "doctor", ["drugs", "rehab", "addiction"],
    sx("Honourable leader! Hundreds of thousands of people are sick from bad drugs. You can build nice hospitals to help them, or keep throwing them in jail.",
  ...
  ax("District Police Superintendent", "shadow", ["sand-mafia", "extortion", "rivers"],
    sx("District Police Superintendent reports: Bad gangs with guns are digging up the rivers to sell the sand, and paying police to stay quiet.",
  ...
  ax("Anti-Encroachment Officer", "people", ["encroachment", "land", "powerful"],
    sx("A note from the Home Ministry reads: You are knocking down houses built in the wrong places. But you only knock down poor people's houses, not rich people's big buildings.",
  ...
  ax("Public Order Officer", "people", ["load-shedding", "protest", "unrest"],
    sx("Word from the Home Ministry, sir — The electricity keeps turning off in the summer, and angry people are breaking things in the street.",
  ...
  ax("Aviation Security Chief", "shadow", ["airport", "smuggling", "security"],
    sx("Aviation Security Chief: Airport workers are helping bad guys sneak gold and drugs through the airport.",
  ...
  ax("Prisons Inspector-General", "doctor", ["prison", "labour", "reform"],
    sx("Sir, a message from the Home Ministry: The jails are way too full. You can teach prisoners good skills to use when they get out, or let bad guards force them to work for free.",
  ...
  ax("Returnee Affairs Officer", "relief", ["migrants", "return", "reintegration"],
    sx("Many workers lost their jobs in other countries and came back with no money. What are your orders, sir?",
  ...
  ax("Diplomatic Security Chief", "general", ["embassy", "threat", "diplomacy"],
    sx("Diplomatic Security Chief awaits your word. Spies say bad guys want to attack a building where people from other countries work.",
  ...
  ax("Aviation Security Chief", "official", ["watchlist", "aviation", "rights"],
    sx("Sir! You can make a list of bad people who aren't allowed to fly on airplanes. But you might be tempted to put reporters and enemies on the list too.",
  ...
  ax("District Police Superintendent", "shadow", ["cybercafe", "surveillance", "youth"],
    sx("Mr. Prime Minister, sir! The police want a rule to collect the names of every kid who plays video games at the store, just to spy on them.",
  ...
  ax("Women's Crime Officer", "doctor", ["acid", "survivors", "justice"],
    sx("Your Excellency! A rich, powerful boy threw chemicals at a girl's face. His family is paying the police to drop the case.",
  ...
  ax("Crime Investigation Chief", "people", ["missing-persons", "police", "families"],
    sx("Dear Sir — People's family members are going missing, and the police refuse to even help search for them.",
  ...
  ax("Police Welfare Director", "general", ["police", "welfare", "morale"],
    sx("Honourable leader! Your normal police officers are tired, poor, and live in dirty rooms. This makes them mean and want bribes.",
  ...
  ax("Intelligence Chief", "shadow", ["disappearances", "release", "reckoning"],
    sx("Intelligence Chief reports: The world wants to know what happened to the people your secret police kidnapped.",
  ...
  ax("Hill Tracts Security Officer", "people", ["cht", "checkpoints", "abuse"],
    sx("A note from the Home Ministry reads: Soldiers are being very mean to the native people in the hills, searching them for no reason.",
  ...
  ax("Drug Administration Chief", "doctor", ["fake-medicine", "health", "crime"],
    sx("Word from the Home Ministry, sir — Stores are selling fake medicine that doesn't work and hurts sick people.",
  ...
  ax("Police Reform Commissioner", "shadow", ["arrests", "due-process", "abuse"],
    sx("Police Reform Commissioner: Secret police in normal clothes are grabbing people off the street without rules.",
  ...
  ax("District Police Superintendent", "fixer", ["extortion", "cadres", "festival"],
    sx("Sir, a message from the Home Ministry: Before big parties, your team forces store owners to give them \"donations\" of money.",
  ...
  ax("Law Secretary", "official", ["anti-terror-law", "scope", "dissent"],
    sx("You can write a new law that says anyone who complains about you is a \"terrorist.\" What are your orders, sir?",
  ...
  ax("Fire Investigation Officer", "people", ["slum-fire", "arson", "land"],
    sx("Fire Investigation Officer awaits your word. A rich builder probably started a fire to burn down poor people's houses so he can take their land.",
  ...
  ax("Public Order Officer", "cleric", ["minorities", "festival", "protection"],
    sx("Sir! Small religious groups are having parties, but they are getting threats online. You can send extra police to protect them.",
  ...
  ax("Camp Security Chief", "shadow", ["rohingya", "fencing", "confinement"],
    sx("Mr. Prime Minister, sir! You can put sharp fences and guard towers around the homeless camps like a giant prison to keep everyone inside.",
  ...
  ax("Police Reform Commissioner", "people", ["thana", "modernisation", "service"],
    sx("Your Excellency! Police stations are scary and mean to poor people and women. You can spend money to make them friendly and helpful.",
  ...
  ax("Intelligence Chief", "cleric", ["mosques", "surveillance", "radicalisation"],
    sx("Dear Sir — Spies want to sneak into places where people pray to secretly listen to what they say.",
  ...
  ax("Home Affairs Coordinator", "people", ["riot", "inquiry", "communal"],
    sx("Honourable leader! An angry mob burned a neighborhood, and the police just watched.",
  ...
  ax("Cyber Crime Chief", "shadow", ["students", "monitoring", "speech"],
    sx("Cyber Crime Chief reports: The computer police want to spy on all students' internet posts to see if they are planning protests.",
  ...
  ax("Crime Investigation Chief", "official", ["witnesses", "protection", "justice"],
    sx("A note from the Home Ministry reads: Rich criminals go free because they scare the people who saw the crime. You can spend money to protect the witnesses.",
  ...
  ax("Border Guard Director", "general", ["border", "killings", "restraint"],
    sx("Word from the Home Ministry, sir — Your border guards shot poor, unarmed villagers for crossing the line to trade.",
  ...
  ax("District Police Superintendent", "shadow", ["informants", "slums", "control"],
    sx("District Police Superintendent: The police want to pay poor people to spy on their neighbors. This will make everyone afraid of each other.",
  ...
  ax("Surveillance Technology Director", "shadow", ["facial-recognition", "gatherings", "dissent"],
    sx("Sir, a message from the Home Ministry: You can use computers to scan everyone's faces in a crowd to know exactly who went to a protest.",
  ...
  ax("Prisons Medical Officer", "doctor", ["prison", "health", "deaths"],
    sx("Prisoners are getting sick and dying because there are no doctors in the jails. What are your orders, sir?",
  ...
  ax("Rural Police Chief", "people", ["land", "violence", "powerful"],
    sx("Rural Police Chief awaits your word. A rich bully is stealing a poor family's land, and he paid the local police to ignore it.",
  ...
  ax("Hospital Liaison Officer", "doctor", ["protest", "hospitals", "neutrality"],
    sx("Sir! The police are going into hospitals and dragging hurt protesters out of their beds to arrest them.",
  ...
  ax("Internal Affairs Director", "shadow", ["disappearance", "cover-up", "accountability"],
    sx("Mr. Prime Minister, sir! A man who argued with your powerful friend was kidnapped by secret police.",
    ...
    sx("Your Excellency! A reporter found out about the kidnapped man and is going to tell the world.",
