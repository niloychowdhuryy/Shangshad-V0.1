...
export const INTERIOR = [
  ...
  ax("Inspector-General of Police", "general", ["protest", "students", "quota"],
    sx("Students have filled the streets over the civil-service quota system — peaceful, enormous, and growing by the hour. The IGP wants permission to clear the intersections before they become permanent. \"Give it a week,\" he warns, \"and a road-block becomes a movement.\"",
    ...
    sx("Despite restraint, a video of a single unarmed student shot dead has become the symbol of the movement. The protest is no longer about quotas — it is about you. Your hardliners demand a curfew and an internet blackout.",
    ...
    sx("The movement now demands the resignation of the ministers who ordered the violence — and the cantonment chief privately signals he will not order troops to fire on students again. The ground is shifting under your chair.",
  ...
  ax("Rights Commission Chair", "official", ["disappearances", "rab", "torture"],
    sx("The Commission hands you a dossier: dozens vanished into the custody of your elite battalion, families turned away at every gate. \"Some are alive in secret cells,\" the Chair says quietly. \"You could bring them home. Or you could let the file gather dust like the last one.\"",
    ...
    sx("With the cells emptying, a faction of officers — afraid of prosecution — floats a quiet warning through intermediaries: 'protect us with amnesty, or the force cannot guarantee its loyalty.' It is a polite mutiny.",
  ...
  ax("ICT Enforcement Director", "official", ["dsa", "press", "speech"],
    sx("Under the cyber law, a cartoonist and two reporters sit in jail for posts mocking the first family. The Director offers more arrests under the same statute — \"a few examples and the rest fall quiet\" — or you could let the three out and blunt the law's teeth.",
  ...
  ax("Cyber Intelligence Vendor", "shadow", ["surveillance", "spyware", "rights"],
    sx("A foreign vendor offers a phone-hacking suite that can crack any device in the country — opposition, press, your own ministers. \"Every modern state has one,\" the salesman murmurs. The price is steep and the oversight is whatever you decide it is.",
  ...
  ax("Reform-minded Police Superintendent", "official", ["police", "torture", "reform"],
    sx("A young SP requests an audience after a hawker dies in his thana's lock-up. \"My OC tortured him over forty taka and wrote it as a heart attack. I can sign the false report and rise, or report my own station and be buried. I came to you to decide which.\"",
  ...
  ax("Counter-Terror Commander", "general", ["terrorism", "siege", "militants"],
    sx("Militants have stormed an upscale café full of foreigners and taken hostages, executing those who cannot recite scripture. The world is watching live. The commander can storm it now with heavy force, or negotiate and wait, each hour risking more throats.",
    ...
    sx("The siege is over, and the attackers turn out to be not impoverished fanatics but privileged, educated young men from good families — a fact that terrifies the elite. The commander wants a sweeping crackdown on suspect youth; the alternative is a quieter de-radicalisation drive.",
  ...
  ax("Inspector-General of Police", "official", ["lynching", "rumour", "mob"],
    sx("A rumour on social media that strangers were kidnapping children for a bridge's 'human sacrifice' has triggered a wave of mob lynchings — innocent people beaten to death on suspicion. The IGP wants a hard order to fire on lynch mobs; the alternative is a rumour-control and arrest drive.",
  ...
  ax("Home Secretary", "cleric", ["islamist", "protest", "blasphemy"],
    sx("A vast Islamist movement has occupied the heart of the capital, demanding a blasphemy law and the removal of a 'pagan' sculpture, refusing to leave. The secretary offers a midnight clearance by force, or patient negotiation that concedes some symbolic ground.",
  ...
  ax("Intelligence Procurement Chief", "shadow", ["spyware", "surveillance", "dissent"],
    sx("A foreign vendor offers military-grade phone spyware that cracks any device — a tool to read every plot, journalist, and judge in the country. The chief is desperate for it; the catch is the inevitable leak that you bought a weapon to spy on your own people.",
  ...
  ax("Prisons Inspector-General", "official", ["prisons", "political", "overcrowding"],
    sx("The jails hold three times their capacity, swollen with opposition activists swept up in mass cases. Disease and deaths in custody mount. The IG can release the low-level political detainees to ease the crush, or hold them all and build more cells.",
  ...
  ax("University Affairs Officer", "people", ["students", "campus", "torture"],
    sx("Members of your party's student wing have tortured a student to death in a dorm 'guest room' for a Facebook post criticising the government. The campus and the nation are erupting. The officer asks whether to shield the cadres or hand them to justice.",
  ...
  ax("Smart City Director", "official", ["cctv", "facial-recognition", "privacy"],
    sx("A 'safe city' project would blanket the capital in cameras with live facial recognition — a genuine boon against crime and terror, and a perfect tool for tracking every protester and dissident. The director wants the full system; civil society is alarmed.",
  ...
  ax("Security Reform Adviser", "general", ["rab", "sanctions", "reform"],
    sx("Your elite battalion is under foreign sanctions for extrajudicial killings, and the crossfire deaths have all but stopped under scrutiny — but crime is creeping back and hardliners want the gloves off again. The adviser asks whether to entrench the reform or quietly revert.",
  ...
  ax("Police Reform Commissioner", "official", ["police", "corruption", "bribery"],
    sx("At the local police stations, nothing moves without a bribe — filing a case, getting bail, even reporting a crime. The commissioner wants a transparency overhaul with citizen oversight and digital records; the rank-and-file, who live on the bribes, will resist fiercely.",
  ...
  ax("Anti-Trafficking Chief", "shadow", ["trafficking", "boats", "syndicate"],
    sx("A trafficking syndicate is loading desperate young men onto death-trap boats for the sea route to Malaysia, where many drown or end in jungle camps — and the network has police and border-guard protection. The chief wants it smashed, names and all.",
  ...
  ax("Religious Harmony Officer", "cleric", ["minorities", "sect", "violence"],
    sx("A hardline movement is whipping up mobs against a small heterodox Muslim sect, attacking their mosques and demanding they be declared non-Muslim. The officer asks whether to protect the sect with force, or appease the majority by quietly conceding the demand.",
  ...
  ax("Cultural Affairs Officer", "official", ["culture", "festival", "extremism"],
    sx("The great secular new-year festival — music, masks, processions — faces a credible militant bomb threat, and hardliners are also denouncing it as 'un-Islamic'. The officer can lock it down behind a security wall, or cancel it 'for safety' and quietly please the zealots.",
  ...
  ax("Internal Affairs Director", "official", ["whistleblower", "police", "accountability"],
    sx("A serving officer has leaked documents proving a senior commander ordered a string of fake 'crossfire' killings. The director can prosecute the whistleblower for breaching secrecy and bury the revelation, or protect him and pursue the commander.",
  ...
  ax("District Magistrate", "official", ["protest", "ban", "assembly"],
    sx("The opposition has called a massive rally in the capital, and you can pre-emptively ban all gatherings under the old colonial assembly law, choking it before it starts. The magistrate warns that the ban itself may provoke exactly the confrontation you fear.",
  ...
  ax("Arms Licensing Officer", "fixer", ["firearms", "party", "patronage"],
    sx("Local party leaders are pressing for a wave of private firearms licences — ostensibly for self-defence, in truth to arm the local muscle that wins elections. The officer can approve the lot as a loyalty reward, or tighten licensing and disarm the cadres.",
  ...
  ax("Counter-Terror Commander", "general", ["extremism", "foreign-fighters", "deradicalisation"],
    sx("A handful of citizens who went abroad to fight for a terror group want to return, some with wives and children born in the war zone. The commander can bar or jail them all as a danger, or repatriate and rehabilitate under close watch.",
  ...
  ax("Information Security Officer", "official", ["press", "accreditation", "surveillance"],
    sx("You can quietly strip parliamentary and secretariat press accreditation from the most critical journalists — cutting their access without an arrest. The officer calls it clean and deniable; it is also an unmistakable signal that coverage is now conditional on loyalty.",
  ...
  ax("Prisons Inspector-General", "general", ["jailbreak", "militants", "security"],
    sx("Convicted militants have broken out of a high-security prison with apparent inside help, and are loose in the country. The IG wants a massive, disruptive nationwide manhunt with checkpoints and detentions; the alternative is a targeted, intelligence-led pursuit.",
  ...
  ax("Industrial Police Chief", "general", ["labour", "garments", "protest"],
    sx("Tens of thousands of garment workers have walked out over unpaid wages and blocked the industrial highways. The factory owners — your donors — demand the protest crushed; the chief can send the industrial police in hard, or broker a wage settlement instead.",
  ...
  ax("Land Records Commissioner", "people", ["minorities", "land", "grabbing"],
    sx("Under a notorious old law, minority Hindu families' land has been seized as 'enemy property' and grabbed by the locally powerful — often your own people. A restitution drive could return it; the grabbers, with party ties, will fight to keep their spoils.",
  ...
  ax("NID Database Director", "official", ["nid", "database", "surveillance"],
    sx("The national ID system can be linked to phones, banks, travel, and biometrics into a single all-seeing profile of every citizen — efficient government, and a surveillance dossier on the entire population. The director wants full integration; privacy advocates are aghast.",
  ...
  ax("Education-Security Liaison", "cleric", ["madrasa", "curriculum", "extremism"],
    sx("Tens of thousands of unregistered religious schools teach a curriculum the state cannot see, some shading into extremism. The liaison wants them registered and made to teach maths, science, and citizenship; the clerical establishment calls it an assault on faith.",
  ...
  ax("Traffic Division Chief", "official", ["traffic", "extortion", "corruption"],
    sx("The traffic police live off a daily tax on every bus, truck, and rickshaw, waving through the dangerous and fining the compliant. The chief can launch a clean-up with cashless fines and oversight, or leave the lucrative racket that keeps the force quietly content.",
  ...
  ax("Counter-Terror Commander", "cleric", ["shrines", "sufi", "militants"],
    sx("Militants are bombing and hacking to death the keepers of Sufi shrines — the gentle, syncretic Islam the hardliners despise. The commander wants visible armed protection at hundreds of shrines and a crackdown on the preachers who incite it; the latter means confronting powerful clerics.",
  ...
  ax("Inspector-General of Police", "people", ["women", "rape", "justice"],
    sx("A horrific gang-rape, filmed and shared by the attackers — politically connected young men — has ignited nationwide protests demanding justice and the death penalty. The IGP asks whether to let the case take its full course against the connected, or let it quietly stall.",
  ...
  ax("Border Guard Director", "shadow", ["border", "smuggling", "corruption"],
    sx("Your own border guards run a thriving smuggling trade — cattle, drugs, gold, phensedyl — in collusion with their counterparts across the wire. The director can purge the corrupt battalions, risking morale and a guarded border, or keep the lucrative status quo.",
  ...
  ax("Telecom Security Officer", "shadow", ["internet", "blackout", "unrest"],
    sx("With protests organising by phone, the officer can order a total internet and mobile blackout to blind and scatter them. It would choke the coordination — and the economy, the hospitals, and the country's last window onto what your forces are doing in the dark.",
  ...
  ax("Police Reform Commissioner", "official", ["police", "accountability", "body-cameras"],
    sx("A reform drive proposes body cameras and a real complaints commission for the police — a check on the brutality that fuels public hatred of the force. The rank-and-file and their commanders see it as a leash and a humiliation, and resist hard.",
  ...
  ax("District Magistrate", "cleric", ["morality", "vigilantes", "youth"],
    sx("Self-appointed morality squads are harassing couples in parks, attacking 'immodest' women, and beating young people for un-Islamic dress. The hardliners call them guardians of virtue. The magistrate asks whether to arrest the squads or quietly tolerate them.",
  ...
  ax("Intelligence Chief", "shadow", ["disappearances", "detention", "exposure"],
    sx("Investigators have located a secret detention site — an 'Aynaghar' of mirrored cells where the disappeared are held off the books. The story is about to break. The chief asks whether to deny everything and bury the site, or acknowledge it and free the captives.",
  ...
  ax("Hill Tracts Security Officer", "general", ["cht", "insurgency", "checkpoints"],
    sx("In the hill tracts, the army's web of checkpoints and camps controls indigenous life and feeds a low-grade insurgency, while settlers and soldiers want the grip kept tight. The officer asks whether to draw down the military presence per the peace accord, or hold it.",
  ...
  ax("District Magistrate", "cleric", ["communal", "blasphemy", "rumour"],
    sx("A doctored screenshot alleging a Hindu youth insulted the Prophet has set mobs torching a minority village. The youth may well be innocent and framed. The magistrate asks whether to protect the village and investigate the framing, or appease the mob by arresting the accused.",
  ...
  ax("Protocol Security Chief", "general", ["vip", "security", "resources"],
    sx("A huge share of the police is tied up guarding ministers, MPs, and their families, stripping protection from ordinary neighbourhoods. The chief can slash the VIP details and redeploy to the public, or keep the entourages your elite has come to expect.",
  ...
  ax("Cyber Patrol Commander", "shadow", ["online", "dissent", "speech"],
    sx("A new cyber-patrol unit can monitor social media around the clock and arrest citizens for 'anti-state' posts — memes, jokes, criticism. The commander wants a wide mandate; it would chill all online speech and fill the jails with teenagers over Facebook posts.",
  ...
  ax("Inspector-General of Police", "people", ["eviction", "slums", "force"],
    sx("A court has ordered a vast slum cleared from contested land, and the police must execute it. The IGP can carry out a brutal dawn eviction with bulldozers, or slow-walk it and push for relocation and resettlement first.",
  ...
  ax("Auxiliary Forces Director", "general", ["ansar", "village", "militia"],
    sx("The vast village auxiliary force could be armed and empowered as a rural security backbone — cheap manpower loyal to the state — or it risks becoming a politicised village militia settling local scores under colour of authority. The director awaits your call.",
  ...
  ax("Financial Crimes Chief", "shadow", ["counterfeit", "currency", "crime"],
    sx("A sophisticated counterfeit-currency ring, run from across the border, is flooding the markets with fake notes and eroding trust in the cash economy. The chief can mount a costly crackdown and currency-upgrade, or let it run and quietly manage the damage.",
  ...
  ax("Women's Safety Officer", "people", ["women", "harassment", "safety"],
    sx("Street harassment of girls and women — 'eve-teasing' that has driven some to suicide — is endemic and unpunished. The officer wants dedicated rapid-response units, mobile courts, and harassment made a real, enforced offence; the cultural pushback frames it as policing male nature.",
  ...
  ax("Counter-Terror Commander", "shadow", ["bloggers", "extremism", "secularism"],
    sx("Machete-wielding militants are hacking secular bloggers and publishers to death in the streets, and a hit-list circulates online. The commander wants the targets given protection and the cells hunted; hardliners hint the victims 'insulted faith' and deserve no sympathy.",
  ...
  ax("Police Reform Commissioner", "doctor", ["remand", "torture", "confession"],
    sx("Investigations here lean on confessions beaten out of suspects on remand, sending innocents to the gallows and letting real culprits walk. The commissioner wants forensic, evidence-based policing and an end to torture-remand; the old guard says it ties their hands.",
  ...
  ax("Immigration Director", "fixer", ["passport", "immigration", "corruption"],
    sx("The passport and immigration offices run on bribes — fast-tracking the payers, stalling the honest, and quietly issuing genuine documents to criminals and traffickers. The director can digitise and clean the system or keep the lucrative counters humming.",
  ...
  ax("Fire Service Director", "relief", ["fire", "safety", "capacity"],
    sx("The capital's fire service cannot reach half its high-rises, its hydrants are dry, and its ladders are too short for the towers that keep burning with people trapped inside. The director needs a costly modernisation; the money is wanted elsewhere until the next blaze.",
  ...
  ax("Border Guard Director", "people", ["border", "haats", "smuggling"],
    sx("Along the border, official 'haat' markets could legalise the petty cross-border trade that locals depend on and that smugglers now run. The director can expand the legal haats, undercutting the smuggling mafias, or keep the border sealed and the black trade thriving.",
  ...
  ax("Crime Investigation Chief", "general", ["kidnapping", "ransom", "crime"],
    sx("A wave of kidnappings-for-ransom is terrifying the business class, and some cases trace to off-duty police and political cadres. The chief can mount a real crackdown that reaches into your own ranks, or focus on the freelance gangs and spare the connected.",
  ...
  ax("Rural Justice Officer", "cleric", ["shalish", "fatwa", "women"],
    sx("In the villages, informal arbitration councils — shalish — increasingly issue cruel, illegal punishments: lashings, hilla marriages, and worse, mostly against women, under the colour of religion. The officer wants them reined in by the formal courts; the rural clergy resist.",
  ...
  ax("Telecom Security Director", "shadow", ["interception", "wiretap", "oversight"],
    sx("A new law would let your agencies intercept any call or message — with, or without, a judge's warrant. The director wants the warrantless version for speed; civil society demands judicial oversight to stop the inevitable abuse against critics and rivals.",
  ...
  ax("Highway Police Chief", "general", ["dacoity", "highways", "safety"],
    sx("Armed gangs are robbing night buses and trucks on the highways, sometimes killing, and the long-haul transport that moves the economy is gripped by fear. The chief wants costly highway patrols and checkpoints; others say it is a local nuisance not worth the budget.",
  ...
  ax("Social Crime Officer", "shadow", ["trafficking", "begging", "children"],
    sx("Organised syndicates maim children and traffic the disabled into forced begging rings on the city streets. The officer wants the rings smashed and the victims rehabilitated — a costly, complex rescue — or you can keep clearing beggars off the streets for the optics.",
  ...
  ax("Protocol Security Chief", "official", ["vip", "traffic", "public"],
    sx("Every ministerial movement shuts down the capital's arteries for VIP motorcades, trapping ambulances and commuters for hours in the world's worst gridlock. The chief can curb the closures and the convoys, or keep the elite gliding through a paralysed city.",
  ...
  ax("Crime Investigation Chief", "people", ["building-collapse", "liability", "developers"],
    sx("A shoddily-built tower has collapsed, killing scores, and the trail leads to a developer who bribed the building inspectors — a developer who funds the party. The chief asks whether to prosecute him fully or let the inspectors take the fall alone.",
  ...
  ax("Cyber Crime Chief", "shadow", ["fraud", "scams", "online"],
    sx("Scam operations are draining citizens' mobile wallets and bank accounts through phishing and fake-prize calls, some run from organised centres with insider help from telecom and bank staff. The chief wants a real cyber-fraud taskforce; standing it up is costly and technical.",
  ...
  ax("Public Order Officer", "cleric", ["procession", "security", "communal"],
    sx("Competing religious processions are due to cross the same route on the same day, a flashpoint that has sparked riots before. The officer can impose strict separate routes and timings — heavy-handed and resented by both — or trust the organisers and keep policing light.",
  ...
  ax("Transport Security Coordinator", "people", ["eid", "travel", "safety"],
    sx("Before Eid, millions cram onto overloaded buses, trains, and ferries to reach their villages, and every year the holiday rush kills hundreds in crashes and capsizes. The coordinator wants strict overloading and safety enforcement; the public wants cheap passage home at any cost.",
  ...
  ax("Crime Investigation Chief", "general", ["firearms", "amnesty", "recovery"],
    sx("Illegal firearms are awash in the country, fuelling political violence and crime. The chief proposes a no-questions surrender amnesty to mop them up — which also lets the guilty erase the weapons tying them to past crimes. The alternative is a hard, raid-based recovery drive.",
  ...
  ax("Diplomatic Security Chief", "general", ["foreigners", "security", "aid-workers"],
    sx("After threats against foreigners, aid agencies and embassies demand heavy protection for their staff or they will pull out, taking their programmes and goodwill with them. The chief can lock the foreign community in a security bubble, or reassure with lighter, smarter measures.",
  ...
  ax("Social Welfare Magistrate", "doctor", ["juvenile", "justice", "children"],
    sx("Children in conflict with the law are thrown into adult jails and 'correction' centres rife with abuse, emerging hardened criminals. The magistrate wants a real juvenile-justice system of diversion and rehabilitation; the law-and-order voices want them treated as the threats they'll become.",
  ...
  ax("Surveillance Technology Director", "shadow", ["drones", "surveillance", "protest"],
    sx("A fleet of surveillance drones could watch borders and crime hotspots — and hover over every protest and gathering, mapping the crowd. The director wants the full fleet with crowd-monitoring; civil society warns it is an eye in the sky over every dissenter.",
  ...
  ax("Health Crime Officer", "doctor", ["organ-trafficking", "poverty", "crime"],
    sx("A ring is buying kidneys from desperate villagers — coerced and cheated — for wealthy transplant tourists, with crooked doctors and brokers in the chain. The officer wants the whole network smashed; some of the clinics involved are powerful and well-connected.",
  ...
  ax("Telecom Security Officer", "official", ["sim", "biometric", "privacy"],
    sx("Biometric SIM registration would tie every phone to a fingerprint and ID — curbing the anonymous numbers used in crime and terror, and building a perfect map of who holds every phone in the country. The officer wants it mandatory; privacy advocates are alarmed.",
  ...
  ax("Internal Affairs Director", "official", ["custodial-death", "inquiry", "accountability"],
    sx("Deaths in police custody, always ruled 'heart attacks' or 'suicides', are mounting and the families are organising. The director can establish a genuinely independent inquiry mechanism, exposing the torture behind the deaths, or keep the in-house whitewash that protects the force.",
  ...
  ax("River Police Chief", "general", ["piracy", "rivers", "fishermen"],
    sx("Armed pirates rule stretches of the great rivers and the bay, robbing and ransoming fishermen and cargo boats, sometimes with bribed police looking on. The chief wants a real river-police push; it means costly boats and confronting the officers on the take.",
  ...
  ax("Education Board Chairman", "shadow", ["exams", "leaks", "fraud"],
    sx("National exam papers leak online before every sitting, sold by a ring reaching into the printing presses and the boards. The chairman wants a hard crackdown and a digital question system; the leak ring is lucrative and protected, and a botched reform could throw the whole exam into chaos.",
  ...
  ax("Public Service Commission Liaison", "shadow", ["recruitment", "exam", "corruption"],
    sx("Government job exams — the holy grail for millions of youth — are riddled with leaked papers, impersonators, and posts sold to the highest bidder. The liaison can mount a real anti-fraud overhaul, exposing connected beneficiaries, or keep the lucrative status quo.",
  ...
  ax("Narcotics Control Officer", "doctor", ["liquor", "poison", "poverty"],
    sx("Bootleg toxic liquor has killed dozens of the poor in a single district, and the trade — banned, so unregulated — is run by syndicates with police protection. The officer can crack down hard on the bootleggers, or push the harder path of regulating and taxing safe alcohol.",
  ...
  ax("Prisons Inspector-General", "doctor", ["women", "prison", "rights"],
    sx("The women's wings of the jails are overcrowded and abusive, holding women on petty or fabricated charges, some with their children, in degrading conditions. The IG wants reform — separate facilities, legal aid, release of the wrongly held — at real cost and effort.",
  ...
  ax("Cyber Crime Chief", "shadow", ["gambling", "online", "addiction"],
    sx("Foreign-run online betting and casino apps are hooking the young and draining money abroad through illegal channels, with local agents and some officials taking a cut. The chief can block and prosecute hard, or quietly tolerate a trade that greases many palms.",
  ...
  ax("Forensic Services Director", "doctor", ["forensics", "backlog", "justice"],
    sx("The country's one overwhelmed forensic lab has a years-long backlog, so DNA and ballistic evidence arrives long after trials end, and justice runs on confessions instead of science. The director needs heavy investment in labs and trained scientists; the payoff is slow and invisible.",
  ...
  ax("Police Procurement Chief", "general", ["riot-gear", "less-lethal", "force"],
    sx("A foreign vendor offers a large package of riot-control gear — water cannon, rubber bullets, tear gas, sound cannons. The chief wants the full arsenal for crowd control; critics note that 'less-lethal' tools, in untrained hands, still blind and kill protesters.",
  ...
  ax("Women's Crime Officer", "people", ["dowry", "murder", "justice"],
    sx("A young bride has been killed over an unpaid dowry, and the in-laws — locally powerful — are buying off the police and the witnesses as such cases routinely vanish. The officer asks whether to drive the prosecution hard or let it fade like the others.",
  ...
  ax("Telecom Security Director", "shadow", ["vpn", "censorship", "control"],
    sx("Citizens are using VPNs to slip past your website blocks and reach banned news and platforms. The director wants VPNs themselves blocked and their users tracked, sealing the information bubble; the alternative is to accept that the net cannot be fully walled.",
  ...
  ax("Social Welfare Director", "relief", ["street-children", "shelter", "poverty"],
    sx("Tens of thousands of children live on the city streets — sniffing glue, prey to gangs, traffickers, and abusive police. The director wants a real network of shelters, schooling, and family reunification; the cheaper option is the periodic round-up that just moves them on.",
  ...
  ax("Cyber Crime Chief", "doctor", ["sextortion", "women", "online"],
    sx("Intimate images — real and faked — are being weaponised to blackmail and shame women and girls, driving some to suicide, while victims who report are themselves blamed and exposed. The chief wants a dedicated, confidential unit; building it means resources and a cultural fight.",
  ...
  ax("Public Order Officer", "official", ["crowd", "concert", "safety"],
    sx("A massive open-air concert and several large public events are planned for the same weekend, with crowd-safety planning that is, as ever, an afterthought. The officer wants proper crowd management and caps imposed; the organisers and the public resent the fences and limits.",
  ...
  ax("Rural Justice Officer", "people", ["superstition", "violence", "minorities"],
    sx("In remote areas, people — usually poor women — are branded witches or sorcerers and beaten, exiled, or killed by mobs, often at a 'healer's' word. The officer wants awareness drives and hard prosecution; the local power structure shrugs it off as backward custom.",
  ...
  ax("NID Database Director", "shadow", ["nid", "fraud", "citizenship"],
    sx("Genuine national ID cards are being sold to non-citizens — including, the spies warn, to Rohingya and foreign criminals — through corrupt officials, eroding the integrity of the whole citizenship system. The director can purge and prosecute, or quietly manage the embarrassment.",
  ...
  ax("Registrar General", "official", ["marriage", "registration", "child-marriage"],
    sx("Marriage registrars routinely falsify brides' ages to legalise child marriages and forge documents for a fee, and the registry is a den of petty corruption. The registrar general wants digitised, age-verified registration; the registrars, a connected guild, will resist.",
  ...
  ax("Narcotics Control Chief", "doctor", ["drugs", "rehab", "addiction"],
    sx("Hundreds of thousands are addicted, and the few rehab centres are squalid, abusive, and out of reach of the poor. The chief wants a real, humane treatment network as the backbone of drug policy; the law-and-order voices still want jails and crossfire, not clinics.",
  ...
  ax("District Police Superintendent", "shadow", ["sand-mafia", "extortion", "rivers"],
    sx("Armed 'sand mafias' — illegally dredging riverbeds and extorting the trade — rule whole stretches of riverbank with bribed police and political cover, killing officials who interfere. The superintendent asks whether to break them or keep the uneasy, lucrative peace.",
  ...
  ax("Anti-Encroachment Officer", "people", ["encroachment", "land", "powerful"],
    sx("A drive to clear illegal encroachments from canals, railways, and public land keeps bulldozing the slums of the poor while the grand illegal buildings of the powerful stand untouched. The officer asks whether to turn the drive on the big fish or keep it pointed at the small.",
  ...
  ax("Public Order Officer", "people", ["load-shedding", "protest", "unrest"],
    sx("A brutal summer of power cuts has people pouring into the streets, smashing substations and blocking roads in the heat. The officer wants a firm dispersal of the protests; the wiser path may be to be seen sharing the pain and fixing the supply.",
  ...
  ax("Aviation Security Chief", "shadow", ["airport", "smuggling", "security"],
    sx("The main airport leaks gold, drugs, and contraband through a web of complicit ground staff, customs, and security — and a lax screening regime that also worries foreign airlines about terror risk. The chief can mount a deep clean-up or keep the comfortable rot.",
  ...
  ax("Prisons Inspector-General", "doctor", ["prison", "labour", "reform"],
    sx("The jails, packed to bursting, could ease overcrowding and idleness through a humane work-and-skills programme that prepares inmates for release — or descend into the exploitative forced labour that some officers already run for private profit.",
  ...
  ax("Returnee Affairs Officer", "relief", ["migrants", "return", "reintegration"],
    sx("A Gulf downturn has sent hundreds of thousands of jobless migrant workers home, broke and traumatised, into communities with no work for them — a security and humanitarian time bomb. The officer wants a reintegration and credit programme; the cheaper path is to let them fend for themselves.",
  ...
  ax("Diplomatic Security Chief", "general", ["embassy", "threat", "diplomacy"],
    sx("Intelligence warns of a credible plot against a foreign embassy in the diplomatic enclave. The chief can flood the zone with a heavy, visible cordon that reassures the foreigners but screams danger, or run a quiet, intelligence-led protection that risks being caught short.",
  ...
  ax("Aviation Security Chief", "official", ["watchlist", "aviation", "rights"],
    sx("A new aviation watchlist could bar suspected militants from flying — a real security tool, and, applied loosely, a way to ground journalists and activists under a terror label. The chief asks whether to build it tight and judicial, or broad and discretionary.",
  ...
  ax("District Police Superintendent", "shadow", ["cybercafe", "surveillance", "youth"],
    sx("A proposal would require every cybercafe and gaming den to log users' IDs and install monitoring software, ostensibly against online crime and radicalisation. The superintendent likes the reach; critics see another net cast over ordinary young people.",
  ...
  ax("Women's Crime Officer", "doctor", ["acid", "survivors", "justice"],
    sx("An acid attack has disfigured a young woman who spurned a powerful man's son, and the family is pressuring the police to lose the case as they have lost others. The officer asks whether to drive a hard prosecution and survivor support, or let it quietly die.",
  ...
  ax("Crime Investigation Chief", "people", ["missing-persons", "police", "families"],
    sx("Families of the missing — some lost to crime, some to your own agencies — are turned away from police stations that refuse even to file a report. The chief wants a mandatory missing-persons registry and real investigation; it would also document the disappearances the state would rather forget.",
  ...
  ax("Police Welfare Director", "general", ["police", "welfare", "morale"],
    sx("The rank-and-file police are overworked, underpaid, and crammed into squalid barracks, which feeds both their brutality and their corruption. The director wants real investment in pay, housing, and hours; the money is large and the public sees only the brutality it would soften.",
  ...
  ax("Intelligence Chief", "shadow", ["disappearances", "release", "reckoning"],
    sx("Pressure mounts — at home and from abroad — to account for the men your agencies disappeared over the years. The chief can quietly begin returning those still alive and acknowledging the dead, or keep denying that any 'enforced disappearances' ever occurred.",
  ...
  ax("Hill Tracts Security Officer", "people", ["cht", "checkpoints", "abuse"],
    sx("At the hill-district checkpoints, indigenous travellers are routinely searched, shaken down, and humiliated, while settlers pass freely — a daily grind of indignity feeding the old insurgency. The officer asks whether to reform the checkpoints' conduct or keep the hard hand.",
  ...
  ax("Drug Administration Chief", "doctor", ["fake-medicine", "health", "crime"],
    sx("Counterfeit and substandard medicines — chalk antibiotics, fake cancer drugs — are killing patients and flooding the pharmacies through a ring with reach into licensed distributors. The chief wants a hard crackdown and track-and-trace; the trade is lucrative and connected.",
  ...
  ax("Police Reform Commissioner", "shadow", ["arrests", "due-process", "abuse"],
    sx("Plainclothes officers in unmarked vehicles routinely 'pick up' suspects without warrants, identification, or any record, leaving families frantic and the line between arrest and abduction erased. The commissioner wants mandatory identification and logging; the agencies call it a fatal delay.",
  ...
  ax("District Police Superintendent", "fixer", ["extortion", "cadres", "festival"],
    sx("Before every festival, your party's local cadres run a 'collection' — extorting shopkeepers and transporters under the guise of donations, with the police looking on. The superintendent asks whether to stop the racket or let the loyal foot-soldiers feed.",
  ...
  ax("Law Secretary", "official", ["anti-terror-law", "scope", "dissent"],
    sx("A revised anti-terrorism law could define 'terrorism' so broadly that protest, strikes, and dissent fall within it — a flexible weapon — or narrowly, confined to actual violence. The secretary asks how wide to draw the net.",
  ...
  ax("Fire Investigation Officer", "people", ["slum-fire", "arson", "land"],
    sx("A massive fire has gutted a slum on land a developer covets, and the residents swear it was arson to drive them out — a pattern seen before. The officer can mount a real arson investigation reaching toward the developer, or rule it an accidental electrical fire and move on.",
  ...
  ax("Public Order Officer", "cleric", ["minorities", "festival", "protection"],
    sx("The Hindu, Buddhist, and Christian communities' festivals approach amid online threats and a recent temple attack. The officer can deploy visible, generous protection for the minority celebrations, or keep it minimal to avoid 'provoking' the hardliners.",
  ...
  ax("Camp Security Chief", "shadow", ["rohingya", "fencing", "confinement"],
    sx("To control the sprawling refugee camps, you can ring them with barbed wire and watchtowers, sealing the refugees in — easing local security fears, and drawing the agencies' charge that you have built an open-air prison for a stateless people.",
  ...
  ax("Police Reform Commissioner", "people", ["thana", "modernisation", "service"],
    sx("The local police stations are intimidating, corrupt, and hostile, especially to the poor and to women, who would sooner suffer than enter one. The commissioner proposes citizen-friendly stations — women's help desks, complaint tracking, clean reception — at real cost and against deep cultural inertia.",
  ...
  ax("Intelligence Chief", "cleric", ["mosques", "surveillance", "radicalisation"],
    sx("Intelligence wants to plant informants in mosques and religious gatherings to catch radicalisation early. It is a real counter-terror tool, and a profound intrusion that, exposed, would enrage the devout and confirm every fear of a surveillance state aimed at the faith.",
  ...
  ax("Home Affairs Coordinator", "people", ["riot", "inquiry", "communal"],
    sx("A communal riot has left a minority neighbourhood gutted and several dead, with credible claims that police stood by or joined in. The coordinator asks whether to mount an independent inquiry and full compensation, or a quiet internal review that shields the force.",
  ...
  ax("Cyber Crime Chief", "shadow", ["students", "monitoring", "speech"],
    sx("After the quota unrest organised online, the cyber unit wants to monitor student social-media networks and flag 'instigators' for pre-emptive action. The chief calls it early warning; it is also a chilling watch over a whole generation's political speech.",
  ...
  ax("Crime Investigation Chief", "official", ["witnesses", "protection", "justice"],
    sx("Cases against the powerful collapse because witnesses are bought, threatened, or killed, and there is no protection for those who dare testify. The chief wants a real witness-protection programme; it is costly, complex, and would make the untouchable suddenly prosecutable.",
  ...
  ax("Border Guard Director", "general", ["border", "killings", "restraint"],
    sx("Your own border guards have shot dead unarmed villagers crossing for petty trade, mirroring the neighbour's notorious killings. The director asks whether to enforce strict non-lethal rules of engagement, or keep the shoot-to-deter posture that the brass prefers.",
  ...
  ax("District Police Superintendent", "shadow", ["informants", "slums", "control"],
    sx("A dense informant network in the slums would give you eyes on crime and dissent alike — and turn neighbour against neighbour, breeding fear and false accusations for petty grudges. The superintendent wants it built; the cost is the social fabric of the poorest places.",
  ...
  ax("Surveillance Technology Director", "shadow", ["facial-recognition", "gatherings", "dissent"],
    sx("New software can scan and identify every face at a rally, prayer gathering, or protest in real time against the national ID database. The director wants it live at all major gatherings; civil society warns it ends the anonymity that makes public assembly safe.",
  ...
  ax("Prisons Medical Officer", "doctor", ["prison", "health", "deaths"],
    sx("Prisoners die of treatable illness for want of any real medical care in the jails, and the sick are ignored until they are corpses. The officer wants proper prison healthcare; it costs money for a constituency — convicts — that wins no votes and earns no sympathy.",
  ...
  ax("Rural Police Chief", "people", ["land", "violence", "powerful"],
    sx("A powerful local man is seizing a poor family's land by force, with hired muscle and a bought local police chief, and the family's appeals go nowhere. The chief asks whether to intervene against the powerful grabber or let the 'private dispute' run its course.",
  ...
  ax("Hospital Liaison Officer", "doctor", ["protest", "hospitals", "neutrality"],
    sx("During unrest, police have been seizing injured protesters from hospital beds and pressuring doctors to deny them treatment or report them. The officer asks whether to guarantee medical neutrality — hospitals as sanctuaries — or let the security forces pursue the wounded inside.",
  ...
  ax("Internal Affairs Director", "shadow", ["disappearance", "cover-up", "accountability"],
    sx("A businessman who fell out with a powerful minister has vanished — picked up, witnesses say, by men in plainclothes. The trail leads uncomfortably close to your own circle. The director asks whether to investigate honestly or quietly close the file.",
    ...
    sx("The case would not stay buried — a journalist has the witnesses, and the story is about to break regardless. The director asks whether to get ahead of it with a controlled admission and a scapegoat, or to crush the story and the journalist with it.",
