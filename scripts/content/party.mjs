...
export const PARTY = [
  ...
  ax("General Secretary", "fixer", ["election", "caretaker", "legitimacy"],
    sx("Dear Sir — Your helper says you must let a fair, neutral team run the election, or the other side will quit and say you cheated.",
    ...
    sx("Honourable leader! The votes are close. You can secretly change the counting to make sure you win, but people might notice.",
  ...
  ax("Election Commission Liaison", "official", ["ec", "institutions", "appointments"],
    sx("Election Commission Liaison reports: You get to pick the new voting judges. You can pick your friends who will let you win, or honest people who might rule against you.",
  ...
  ax("Street Operations Coordinator", "fixer", ["hartal", "blockade", "violence"],
    sx("A note from the Party Office reads: Your enemies are blocking the roads. You can send your own fighters to stop them, but it will be very violent.",
  ...
  ax("Chief Whip", "fixer", ["defection", "coalition", "horse-trading"],
    sx("Word from the Party Office, sir — You are losing votes. You can secretly promise bad politicians jobs and safety if they switch to your team.",
  ...
  ax("Religious Front Emissary", "cleric", ["islamist", "alliance", "secularism"],
    sx("Religious Front Emissary: A powerful religious group will help you win, but only if you make strict religious laws and take away women's rights.",
  ...
  ax("Tribunal Prosecutor", "official", ["1971", "tribunal", "justice"],
    sx("Sir, a message from the Party Office: You are putting old war criminals on trial. You can rush the trials to punish them fast, or go slowly to be totally fair.",
  ...
  ax("Student Wing President", "fixer", ["students", "campus", "extortion"],
    sx("Your student group is bullying kids at school. They want more power, but some say you need to stop their bullying. What are your orders, sir?",
  ...
  ax("Party Elders' Council", "official", ["succession", "dynasty", "loyalty"],
    sx("Party Elders' Council awaits your word. The older leaders want you to name your child as the next boss right now. Others say you should pick the smartest person, not just your family.",
  ...
  ax("Attorney General", "official", ["opposition", "courts", "lawfare"],
    ...
    sx("Mr. Prime Minister, sir! Your enemy is very sick in jail. If she dies there, everyone will hate you. Her family begs to take her to a hospital.",
  ...
  ax("Telecom Regulator", "official", ["internet", "election", "censorship"],
    sx("Your Excellency! You can turn off the internet on voting day so no one can see if you cheat.",
  ...
  ax("District Organiser", "fixer", ["vote-buying", "patronage", "money"],
    sx("Dear Sir — A helper wants to hand out secret envelopes of cash and free things to poor people the night before the vote to make them pick you.",
  ...
  ax("Electoral Roll Officer", "official", ["voter-roll", "fraud", "ghosts"],
    sx("Honourable leader! The voting list has thousands of fake names and dead people on it. You can use these fake names to cheat and get more votes.",
  ...
  ax("Nominations Board Chair", "fixer", ["tickets", "candidates", "money"],
    sx("Nominations Board Chair reports: Many people want to be on your team. You can let the richest people buy their spots, or pick the people who work the hardest.",
  ...
  ax("Media Adviser", "fixer", ["media", "propaganda", "press"],
    sx("A note from the Party Office reads: A rich friend offers to buy all the TV stations so they only say nice things about you and ignore your mistakes.",
  ...
  ax("Cyber Cell Commander", "shadow", ["trolls", "disinformation", "online"],
    sx("Word from the Party Office, sir — Your computer team wants to make thousands of fake internet accounts to spread lies about your enemies and trick people.",
  ...
  ax("Coalition Manager", "official", ["coalition", "allies", "leverage"],
    sx("Coalition Manager: Your partner team threatens to leave unless you give them big jobs. If they leave, you might lose your power.",
  ...
  ax("Chief Whip", "fixer", ["parliament", "no-confidence", "discipline"],
    sx("Sir, a message from the Party Office: Some of your own teammates might vote against you because they are angry. You can scare them into obeying, or actually fix what they are angry about.",
  ...
  ax("Constitutional Adviser", "official", ["constitution", "term-limits", "power"],
    sx("You can change the rules so you are allowed to be the boss forever. But this shows everyone you never plan to leave. What are your orders, sir?",
  ...
  ax("Home Secretary", "official", ["banning", "rivals", "repression"],
    sx("Home Secretary awaits your word. You have a sneaky excuse to completely ban the enemy team so they can't run against you at all.",
  ...
  ax("Party Treasurer", "fixer", ["funding", "patrons", "graft"],
    sx("Sir! A rich man who gave you a lot of money now wants special favors, like a free bank. You need his money for the next election.",
  ...
  ax("Ward Boss", "shadow", ["mastan", "extortion", "control"],
    sx("Mr. Prime Minister, sir! Your best helper wins lots of votes, but he does it by being a scary bully and stealing from people.",
  ...
  ax("Women's Wing Chief", "official", ["women", "representation", "reserved-seats"],
    sx("Your Excellency! You get to pick women for special government seats. You can pick hard-working leaders, or just pick the wives of your rich friends.",
  ...
  ax("Chief Whip", "fixer", ["defection", "loyalty", "betrayal"],
    sx("Dear Sir — A good guy on your team might leave to join the enemies. You can ruin his life with a fake secret, or talk to him nicely to keep him.",
  ...
  ax("Rally Coordinator", "fixer", ["rally", "spectacle", "mobilisation"],
    sx("Honourable leader! You can spend a giant amount of money to bus a million people to the city just to cheer for you and look powerful.",
  ...
  ax("Tribunal Prosecutor", "official", ["1971", "execution", "timing"],
    sx("Tribunal Prosecutor reports: You can hang a bad war criminal right before the election to make your fans cheer.",
  ...
  ax("Culture Minister", "official", ["legacy", "dynasty", "naming"],
    sx("A note from the Party Office reads: Your friends want to name the airport, schools, and bridges after your family so no one ever forgets you.",
  ...
  ax("Polling Agent Coordinator", "fixer", ["booth-capture", "election-day", "violence"],
    sx("Word from the Party Office, sir — On voting day, your team can secretly kick out the other team's checkers and stuff the boxes with fake votes for you.",
  ...
  ax("Party Elders' Council", "official", ["generations", "renewal", "loyalty"],
    sx("Party Elders' Council: The very old leaders won't give up their jobs to the younger, smarter people. If you force them out, they will be mad.",
  ...
  ax("Parliamentary Affairs Minister", "official", ["speaker", "parliament", "fairness"],
    sx("Sir, a message from the Party Office: You get to pick the referee for the big government meetings. You can pick your friend who always lets you win, or a fair person.",
  ...
  ax("Overseas Wing Secretary", "fixer", ["diaspora", "funding", "foreign"],
    sx("Your friends in other countries want to send you lots of secret money for your campaign. It is illegal to take secret foreign money. What are your orders, sir?",
  ...
  ax("Minorities Cell Convenor", "official", ["minorities", "secularism", "vote-bank"],
    sx("Minorities Cell Convenor awaits your word. Small religious groups always vote for you, but they are being attacked. They want you to protect them loudly, which might upset the big groups.",
  ...
  ax("Strategy Director", "shadow", ["dummy-candidates", "election", "manipulation"],
    sx("Sir! Your enemies are quitting the election. You can pay fake \"enemies\" to run against you so it looks like a real game.",
  ...
  ax("Cabinet Secretary", "official", ["bureaucracy", "purge", "patronage"],
    sx("Mr. Prime Minister, sir! You can fire all the government workers who used to work for the old boss and replace them with your own fans.",
  ...
  ax("Party Historian", "official", ["history", "martyrs", "narrative"],
    sx("Your Excellency! A helper wants to change the history books to make the enemy team look like killers, just to make your team look better.",
  ...
  ax("Law Minister", "official", ["judiciary", "appointments", "independence"],
    sx("Dear Sir — You get to pick two big judges before a big court case about you. You can pick your friends to make sure you win.",
  ...
  ax("District President", "people", ["grassroots", "accountability", "local"],
    sx("Honourable leader! People hate one of your politicians because he is mean and steals. You can protect him, or fire him and listen to the people.",
  ...
  ax("Establishment Minister", "official", ["jobs", "patronage", "youth"],
    sx("Establishment Minister reports: You are hiring thousands of new government workers. You can secretly give all the jobs to your fans, or give them to the smartest people.",
  ...
  ax("General Secretary", "fixer", ["reconciliation", "rivals", "unity"],
    sx("A note from the Party Office reads: An old leader who left your team angry wants to come back. He brings lots of votes but also lots of drama.",
  ...
  ax("Religious Front Emissary", "cleric", ["islamist", "blasphemy", "alliance"],
    sx("Word from the Party Office, sir — A strict religious group wants you to hang a man for his beliefs and ban a nice charity. They will help you win if you do it.",
  ...
  ax("Leader of the House", "official", ["parliament", "boycott", "legitimacy"],
    sx("Leader of the House: The enemy team is not at the meeting. You can quickly pass all your new rules without anyone arguing with you.",
  ...
  ax("Election Tech Adviser", "official", ["evm", "election", "trust"],
    sx("Sir, a message from the Party Office: You are getting new voting machines. You can make them secret so no one can check the math, which makes it easy to cheat.",
  ...
  ax("Field Security Chief", "shadow", ["intimidation", "polling", "agents"],
    sx("A guard suggests scaring the other team's checkers the night before the vote, so they don't show up and you can cheat easily. What are your orders, sir?",
  ...
  ax("Chief Whip", "fixer", ["defection", "poaching", "majority"],
    sx("Chief Whip awaits your word. You can bribe a smart, young enemy leader to join your team by offering him a big job. This makes you look powerful but unfair.",
  ...
  ax("Party Historian", "official", ["legacy", "founder", "cult"],
    sx("Dear Sir — Your friends want to build a giant, super expensive museum just to talk about how great your family is.",
  ...
  ax("Labour Wing Secretary", "people", ["labour", "garments", "wages"],
    sx("Honourable leader! Factory workers want better pay. If you help them, they will vote for you, but the rich factory owners will be furious.",
  ...
  ax("Strategy Director", "official", ["by-election", "barometer", "risk"],
    sx("Strategy Director reports: There is a small vote happening. You can cheat to win easily, or play fair and risk losing to see how people really feel.",
  ...
  ax("Law Minister", "official", ["contempt", "press", "speech"],
    sx("A note from the Party Office reads: A news writer called you a thief. You can throw him in jail to scare everyone, or just show proof that he is wrong.",
  ...
  ax("Constitutional Adviser", "official", ["floor-crossing", "discipline", "law"],
    sx("Word from the Party Office, sir — You can make a strict rule that anyone on your team who disagrees with you goes to jail. This stops all arguing.",
  ...
  ax("Coalition Manager", "fixer", ["seats", "allies", "arithmetic"],
    sx("Coalition Manager: Your smaller partner teams want to run in the election too. You can bully them into taking the worst spots, or be generous.",
  ...
  ax("Student Wing President", "fixer", ["martyr", "funeral", "mobilisation"],
    sx("Sir, a message from the Party Office: One of your young helpers died fighting the enemy. Your team wants to carry his body through the city to make everyone angry and start a huge fight.",
  ...
  ax("Foreign Liaison Officer", "ambassador", ["observers", "election", "legitimacy"],
    sx("People from other countries want to watch your election to make sure it's fair. You can hide the cheating parts from them, or let them see everything. What are your orders, sir?",
  ...
  ax("Anti-Graft Commission Chair", "official", ["acc", "lawfare", "selective"],
    sx("Anti-Graft Commission Chair awaits your word. The police who catch thieves work for you. You can tell them to only arrest your enemies, or tell them to arrest anyone who steals, even your friends.",
  ...
  ax("Constitutional Adviser", "official", ["caretaker", "constitution", "power"],
    sx("Sir! You can make a rule that your team always stays in charge during elections, which makes it super easy to win every time.",
  ...
  ax("Party Treasurer", "shadow", ["funding", "black-money", "audit"],
    sx("Mr. Prime Minister, sir! You have a giant pile of secret cash for the election. You can lie about where you got it, or only use honest money and have less to spend.",
  ...
  ax("Party Elders' Council", "official", ["dynasty", "nepotism", "nominations"],
    sx("Your Excellency! Your whole family wants to be politicians now because you are the boss. People might think you are just giving jobs to your relatives.",
  ...
  ax("Hill Affairs Convenor", "official", ["cht", "indigenous", "accord"],
    sx("Dear Sir — People in the hills want you to keep an old promise to protect them. But the army and new settlers want to take their land.",
  ...
  ax("Returning Officer Coordinator", "official", ["results", "count", "delay"],
    sx("Honourable leader! The votes are coming in. You can pause the TV news to secretly change some numbers so you win, or show the honest truth instantly.",
  ...
  ax("Personal Physician", "doctor", ["succession", "health", "dynasty"],
    sx("Personal Physician reports: You are very sick but no one knows. You can pick the next leader now, but people might stop listening to you early.",
  ...
  ax("Election Commission Liaison", "official", ["recount", "dispute", "credibility"],
    sx("A note from the Party Office reads: The enemy wants to recount the votes because they think you cheated in one town. You can say no using a silly rule, or let them recount and risk losing.",
  ...
  ax("Information Minister", "official", ["history", "national-day", "narrative"],
    sx("Word from the Party Office, sir — You can change the school books so they only talk about how amazing your family is and ignore all the other heroes.",
  ...
  ax("Inspector-General of Police", "general", ["police", "recruitment", "loyalty"],
    sx("Inspector-General of Police: You are hiring new police. You can only hire people who promise to vote for you, or hire the strongest, smartest people.",
  ...
  ax("Intelligence Chief", "shadow", ["cabinet", "plot", "loyalty"],
    sx("Sir, a message from the Party Office: Two of your friends are secretly talking to the army about taking your job. You can spy on them secretly, or yell at them right now.",
  ...
  ax("General Secretary", "fixer", ["scandal", "family", "corruption"],
    sx("Someone in your family got caught stealing. You can hide the secret, or let the police arrest them like anyone else. What are your orders, sir?",
  ...
  ax("Manifesto Committee Chair", "official", ["manifesto", "promises", "credibility"],
    sx("Manifesto Committee Chair awaits your word. You are writing your promises for the election. You can promise crazy, impossible things to get votes, or be honest about what you can actually do.",
  ...
  ax("Elder Statesman", "official", ["dialogue", "opposition", "reconciliation"],
    sx("Mr. Prime Minister, sir! Your enemies offer to stop fighting if you let their friends out of jail and make fairer rules.",
  ...
  ax("General Secretary", "fixer", ["congress", "rules", "control"],
    sx("Your Excellency! You can change your team's rules so you never have to vote for a leader again, meaning you are the boss forever.",
    ...
    sx("Dear Sir — A very popular guy on your team might win a vote against your favorite friend. You can kick him out for a fake reason so your friend wins.",
  ...
  ax("Legal Affairs Secretary", "official", ["defamation", "press", "intimidation"],
    sx("Honourable leader! You can file hundreds of fake lawsuits against reporters and enemies to keep them busy and scared in court forever.",
    ...
    sx("Legal Affairs Secretary reports: One of those fake lawsuits got a young reporter thrown in jail for a long time.",
  ...
  ax("Delimitation Commissioner", "official", ["gerrymander", "constituencies", "advantage"],
    sx("A note from the Party Office reads: You can redraw the map for the election to trap all your enemies in one area, making it super easy for you to win the rest.",
  ...
  ax("Administrative Reforms Secretary", "fixer", ["districts", "patronage", "spending"],
    sx("Word from the Party Office, sir — Local leaders want you to create brand new towns on the map just so they can get new jobs and money.",
  ...
  ax("Relief Distribution Coordinator", "fixer", ["patronage", "relief-cards", "votes"],
    sx("Relief Distribution Coordinator: Politicians are only giving free food to people who vote for them, and letting the others starve.",
  ...
  ax("City Campaign Manager", "fixer", ["city", "election", "local"],
    sx("Sir, a message from the Party Office: Small city elections are happening. You can rig them quietly to make sure you win, or let people vote freely as a test.",
  ...
  ax("Statistics Bureau Director", "official", ["census", "data", "manipulation"],
    sx("You are counting all the people in the country. A helper says you can change the math to favor your towns for more money. What are your orders, sir?",
  ...
  ax("Liberation Affairs Secretary", "official", ["quota", "freedom-fighters", "merit"],
    sx("Liberation Affairs Secretary awaits your word. A rule gives the best jobs to kids of old war heroes, making normal young people furious. You can keep the rule or change it to be fair.",
  ...
  ax("Education Affairs Secretary", "fixer", ["students", "union", "democracy"],
    sx("Sir! School groups haven't voted for their leaders in years, so your bullies run everything. You can let them vote, but your bullies might lose.",
  ...
  ax("Religious Outreach Coordinator", "cleric", ["pir", "endorsement", "rural"],
    sx("Mr. Prime Minister, sir! A famous religious leader will tell millions of people to vote for you, but only if you give his group a lot of money and ignore their secrets.",
  ...
  ax("Labour Wing Organiser", "people", ["tea-garden", "labour", "wages"],
    sx("Your Excellency! The poor people picking tea want better pay. If you help them, the rich tea farm owners who usually help you will be mad.",
  ...
  ax("Electoral Reform Adviser", "official", ["pr", "system", "reform"],
    sx("Dear Sir — People want a new voting system that is completely fair. But if it is completely fair, you won't win as easily anymore.",
  ...
  ax("General Secretary", "fixer", ["split", "faction", "discipline"],
    sx("Honourable leader! A big leader on your team is mad and wants to start his own team. You can arrest him to stop him, or give him what he wants so he stays.",
  ...
  ax("Coalition Manager", "official", ["alliance", "left", "ideology"],
    sx("Coalition Manager reports: A small, smart group wants to join you. They will help you look good, but they want you to be nicer to workers, which will anger your rich friends.",
  ...
  ax("Tribunal Prosecutor", "official", ["banning", "collaborators", "1971"],
    sx("A note from the Party Office reads: You can ban an old religious team for bad things they did in a war long ago. It is fair, but it also magically gets rid of your enemies today.",
  ...
  ax("Rural Development Coordinator", "fixer", ["rural-works", "patronage", "graft"],
    sx("Word from the Party Office, sir — Politicians are stealing the money meant for building village roads. You can take the money away and give it to honest local councils instead.",
  ...
  ax("Religious Affairs Secretary", "cleric", ["mosques", "imams", "influence"],
    sx("Religious Affairs Secretary: You can pay religious leaders to say nice things about you during their prayers. This tricks people into voting for you.",
  ...
  ax("Law Minister", "official", ["sedition", "speech", "opposition"],
    sx("Sir, a message from the Party Office: Protesters made up a funny song making fun of you. You can arrest them and put them in jail for it.",
  ...
  ax("Justice Reform Adviser", "official", ["truth-commission", "reckoning", "past"],
    sx("People want to investigate the old bosses for stealing. If you do, people might want to investigate you someday too. What are your orders, sir?",
  ...
  ax("Election Commission Liaison", "official", ["finance", "disclosure", "transparency"],
    sx("Election Commission Liaison awaits your word. A new rule would force you to tell everyone exactly where you get your campaign money. It ruins your secret cash.",
  ...
  ax("Strategy Director", "official", ["youth", "voting-age", "franchise"],
    sx("Sir! You can let young kids vote. But right now, young kids are angry at you and will probably vote for the other team.",
  ...
  ax("Parliamentary Affairs Minister", "official", ["opposition", "status", "norms"],
    sx("Mr. Prime Minister, sir! You can give the leader of the enemy team a nice office and treat them with respect, or take everything away to make them look weak.",
  ...
  ax("Reconciliation Adviser", "official", ["reconciliation", "history", "wounds"],
    sx("Your Excellency! A long time ago, your team did a very bad thing. You can say sorry and heal people's feelings, or stay quiet like always.",
  ...
  ax("Election Logistics Officer", "official", ["remote", "polling", "access"],
    sx("Dear Sir — People living far out in the hills mostly vote for your enemies. You can conveniently \"forget\" to put voting booths near them so they can't vote.",
  ...
  ax("Constitutional Adviser", "official", ["bicameral", "senate", "structure"],
    sx("Honourable leader! You can create a special new group of leaders and fill it with your friends. They will make sure no one can ever change your rules.",
  ...
  ax("Home Affairs Coordinator", "people", ["violence", "compensation", "victims"],
    sx("Home Affairs Coordinator reports: Your fans started a fight on voting day and people died. You can investigate honestly and pay the families, or secretly pay a little to hide it.",
  ...
  ax("Campaign Data Director", "shadow", ["data", "micro-targeting", "consultants"],
    sx("A note from the Party Office reads: A tricky company wants to spy on everyone's phones to figure out how to brainwash them into voting for you.",
  ...
  ax("Returning Officer Coordinator", "fixer", ["nominations", "scrutiny", "disqualification"],
    sx("Word from the Party Office, sir — You can throw away the voting papers for the enemy team just because they missed a comma or spelled a word wrong.",
  ...
  ax("Strategy Director", "official", ["snap-election", "timing", "advantage"],
    sx("Strategy Director: You just did something popular. You can call a surprise election right now to win before people realize the country is running out of money.",
  ...
  ax("Chief Whip", "fixer", ["article-70", "dissent", "expulsion"],
    sx("Sir, a message from the Party Office: One of your teammates voted against a bad rule you made. You can kick him out completely to scare everyone else into obeying.",
  ...
  ax("Party Elders' Council", "official", ["president", "ceremonial", "loyalty"],
    sx("You get to pick the President. You can pick a yes-man who does whatever you say, or a smart, fair person who might argue with you. What are your orders, sir?",
  ...
  ax("General Secretary", "fixer", ["merger", "absorption", "growth"],
    sx("General Secretary awaits your word. A small team wants to join yours. They have lots of voters, but they will demand big jobs and cause drama.",
  ...
  ax("Cabinet Secretary", "general", ["emergency", "powers", "rule"],
    sx("Dear Sir — You can declare a \"State of Emergency.\" This pauses all rules and lets you do whatever you want forever, but everyone will know you are a dictator.",
  ...
  ax("Professional Wing Coordinator", "fixer", ["bar-association", "professionals", "capture"],
    sx("Honourable leader! Doctors and lawyers have their own groups. You can rig their votes so your friends are in charge of them too.",
  ...
  ax("Constitutional Adviser", "official", ["caretaker", "judiciary", "poll"],
    sx("Constitutional Adviser reports: You can make sure a friendly judge is the one watching the election so you can't lose.",
  ...
  ax("Media Adviser", "fixer", ["celebrity", "endorsement", "image"],
    sx("A note from the Party Office reads: A super famous movie star wants to run on your team. He is clueless about laws, but everyone will vote for him because he's famous.",
  ...
  ax("Coalition Manager", "official", ["coalition", "programme", "compromise"],
    sx("Word from the Party Office, sir — Your partner teams want opposite things. You can lie to both of them to keep them happy, or pick a side and make one team very angry.",
  ...
  ax("Reconciliation Adviser", "official", ["banning", "restoration", "inclusion"],
    sx("Reconciliation Adviser: A group that was banned a long time ago wants to come back and promises to be good.",
  ...
  ax("Field Mobilisation Officer", "people", ["turnout", "gotv", "organisation"],
    sx("Sir, a message from the Party Office: You can try to get everyone in the country to vote, or only wake up the people who like you and let the others sleep.",
  ...
  ax("Local Government Secretary", "official", ["devolution", "decentralisation", "power"],
    sx("You can give small towns the money and power to fix their own problems. It helps them, but makes you less powerful. What are your orders, sir?",
  ...
  ax("Culture Minister", "official", ["nationalism", "law", "speech"],
    sx("Culture Minister awaits your word. You can make a law that anyone who doesn't salute the flag perfectly goes to jail. This is a great excuse to arrest complainers.",
  ...
  ax("Election Tech Adviser", "official", ["results", "transmission", "transparency"],
    sx("Sir! A new app lets everyone see the votes being counted instantly on their phones. This makes it impossible for you to cheat.",
  ...
  ax("Education Affairs Secretary", "cleric", ["madrasa", "recognition", "votes"],
    sx("Mr. Prime Minister, sir! Religious schools want their easy tests to count the same as hard college tests for getting jobs. If you say yes, they will vote for you.",
  ...
  ax("Campaign Data Director", "fixer", ["canvassing", "data", "privacy"],
    sx("Your Excellency! Your helpers can secretly knock on doors and make lists of everyone's secrets and religion to figure out how to trick them.",
  ...
  ax("Constitutional Adviser", "official", ["dissolution", "parliament", "tactic"],
    sx("Dear Sir — You can cancel the government early to trick your enemies before they are ready for the election.",
  ...
  ax("Chief Whip", "people", ["backbench", "rebellion", "policy"],
    sx("Honourable leader! Your own team is refusing to vote for a terrible rule you made. You can bully them into voting yes, or listen to them and fix the rule.",
  ...
  ax("Party Treasurer", "official", ["donations", "corporate", "influence"],
    sx("Party Treasurer reports: A new rule will limit how much money rich people can give you. This makes things fairer, but you will be much poorer for the election.",
  ...
  ax("Information Commissioner", "official", ["rti", "transparency", "accountability"],
    sx("A note from the Party Office reads: A new rule lets any normal person read the government's secret papers. This stops stealing, but means people will see your mistakes.",
  ...
  ax("Parliamentary Affairs Minister", "official", ["oversight", "committee", "audit"],
    sx("Word from the Party Office, sir — The team checking the government's spending is usually run by your enemies to keep things honest. You can put your friends in charge to hide your stealing.",
  ...
  ax("Returning Officer Coordinator", "fixer", ["postal", "service-voters", "fraud"],
    sx("Returning Officer Coordinator: Soldiers voting by mail are easy to trick. You can secretly change all their votes to be for you.",
  ...
  ax("Coalition Manager", "fixer", ["hung-parliament", "kingmaker", "deals"],
    sx("Sir, a message from the Party Office: No one won the election entirely. You can buy a few small teams with giant bags of money to win, or try to run the country carefully with less power.",
  ...
  ax("Women's Wing Chief", "people", ["women", "reserved-seats", "reform"],
    sx("Women want to actually be voted into the special seats, instead of you just picking them. If you let them, you can't control who gets the seats. What are your orders, sir?",
  ...
  ax("Election Logistics Officer", "shadow", ["polling-station", "relocation", "suppression"],
    sx("Election Logistics Officer awaits your word. You can secretly move the voting boxes in the enemy's towns far away right before the vote, so they can't walk there in time.",
  ...
  ax("Cyber Cell Commander", "shadow", ["deepfake", "disinformation", "smear"],
    sx("Mr. Prime Minister, sir! Your computer team made a fake, realistic video of your enemy saying something terrible. You can show it to everyone to ruin her, but it is a lie.",
  ...
  ax("Strategy Director", "official", ["by-poll", "succession", "seat"],
    sx("Your Excellency! An old politician died. You can give his job to his very smart daughter, or to a mindless helper who will just do whatever you say.",
  ...
  ax("Digital Government Adviser", "people", ["e-governance", "services", "corruption"],
    sx("Dear Sir — You can use computers so people don't have to pay bribes to government workers anymore. The workers will be very mad they lost their extra money.",
  ...
  ax("Leader of the House", "official", ["parliament", "accountability", "norms"],
    sx("Honourable leader! In meetings, people only ask you fake, easy questions to make you look smart. You can let them ask real, hard questions to prove you are a good leader.",
  ...
  ax("Labour Wing Secretary", "people", ["unions", "affiliation", "leverage"],
    sx("Labour Wing Secretary reports: You can make the big worker groups join your team. They will vote for you, but you will have to actually give them what they want later.",
  ...
  ax("Civic Education Director", "people", ["voter-education", "awareness", "turnout"],
    sx("A note from the Party Office reads: You can pay to teach people how to spot election cheating. But if they learn, they might catch you cheating.",
  ...
  ax("General Secretary", "fixer", ["cadres", "violence", "amnesty"],
    sx("Word from the Party Office, sir — Many of your helpers beat people up in the past. You can magically erase all their crimes to thank them for helping you.",
  ...
  ax("Overseas Wing Secretary", "shadow", ["overseas", "voting", "fraud"],
    sx("Overseas Wing Secretary: Your people in other countries are voting. Since no one is watching, you can easily sneak a bunch of fake votes in for yourself.",
  ...
  ax("Strategy Director", "fixer", ["independents", "spoilers", "tactics"],
    sx("Sir, a message from the Party Office: You can secretly pay fake politicians to run in the election just to confuse people and steal votes from your real enemy.",
  ...
  ax("Constitutional Adviser", "official", ["ombudsman", "accountability", "graft"],
    sx("The rules say there should be a special policeman who arrests government leaders who steal. No one has ever hired him. You can hire him now. What are your orders, sir?",
  ...
  ax("Home Affairs Coordinator", "official", ["magistrates", "election-day", "neutrality"],
    sx("Home Affairs Coordinator awaits your word. Special judges are driving around on voting day. You can tell them to bully your enemies, or tell them to just keep everyone safe.",
  ...
  ax("Electoral Roll Officer", "shadow", ["nid", "purge", "disenfranchisement"],
    sx("Sir! You can use computers to erase poor people and minorities from the voting list so they can't vote against you.",
  ...
  ax("Youth Wing Coordinator", "people", ["youth", "outreach", "spending"],
    sx("Mr. Prime Minister, sir! Young people are very angry at you. You can throw a giant, expensive festival with concerts to trick them into liking you again.",
  ...
  ax("Parliamentary Affairs Minister", "official", ["privilege", "press", "intimidation"],
    sx("Your Excellency! Your friend wants to drag a news reporter into a scary government meeting to yell at him for writing a mean story.",
  ...
  ax("Cabinet Secretary", "official", ["ministers", "conduct", "accountability"],
    sx("Dear Sir — Your leaders are obviously stealing money. You can force them to show their bank accounts and fire the thieves.",
  ...
  ax("Chief Whip", "fixer", ["president", "cross-voting", "discipline"],
    sx("Honourable leader! You are voting for the President. Some of your friends want to vote for the wrong person as a joke. You can threaten them so they don't.",
  ...
  ax("General Secretary", "official", ["reshuffle", "cabinet", "balance"],
    sx("General Secretary reports: You have to switch your helpers around. You can pick the helpers who are dumb but loyal, or the very smart ones who might try to take your job.",
  ...
  ax("Strategy Director", "official", ["referendum", "legitimacy", "gamble"],
    sx("A note from the Party Office reads: People don't believe you won fairly. You can ask the whole country to vote \"Yes\" or \"No\" on if they want you to stay. It's a huge gamble.",
    ...
    sx("Word from the Party Office, sir — You did the \"Yes\" or \"No\" vote, but hardly anyone showed up, and the numbers are obviously fake.",
    ...
    sx("Strategy Director: Because of the messy vote, your enemies demand a totally fair, watched election. If you say yes, you might lose your job.",
