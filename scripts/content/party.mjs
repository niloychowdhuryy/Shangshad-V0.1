...
export const PARTY = [
  ...
  ax("General Secretary", "fixer", ["election", "caretaker", "legitimacy"],
    sx("The opposition will boycott unless you hand the election to a neutral caretaker administration, as the old custom demanded. \"Concede the caretaker,\" the Secretary warns, \"and you might lose. Refuse, and you win a vote the world calls a sham.\"",
  ...
  ax("Street Operations Coordinator", "fixer", ["hartal", "blockade", "violence"],
    sx("The opposition has called a week of hartals and transport blockades; petrol bombs are landing on buses and the economy is freezing by the day. The coordinator wants to flood the streets with your own cadres to 'break' the blockade by force.",
  ...
  ax("Religious Front Emissary", "cleric", ["islamist", "alliance", "secularism"],
    sx("A powerful religious movement offers its street power and its voters — in exchange for a blasphemy law, control of textbook content, and a quiet end to certain women's-rights reforms. The emissary smiles: \"We can fill any square in the country.\"",
  ...
  ax("Tribunal Prosecutor", "official", ["1971", "tribunal", "justice"],
    sx("The tribunal trying the 1971 war criminals is both a genuine reckoning and a useful weapon against today's opposition. The prosecutor asks how far to push — strict evidence and slow justice, or fast verdicts that thrill the base and decimate your rivals.",
  ...
  ax("Student Wing President", "fixer", ["students", "campus", "extortion"],
    sx("Your student wing controls the campuses through guest-room torture, tender extortion, and seat-control of the halls. The president wants more autonomy and more money. A reformist faction inside the party wants the wing reined in before it becomes a scandal.",
  ...
  ax("Party Elders' Council", "official", ["succession", "dynasty", "loyalty"],
    sx("The grey-haired council that has run the party for decades wants you to anoint your child as heir-apparent now, to 'preserve unity'. The reformers warn that a dynastic coronation will hollow the party of every talent who is not your blood.",
  ...
  ax("Attorney General", "official", ["opposition", "courts", "lawfare"],
    sx("A graft case decades old has finally ripened against the opposition leader. Convict her and she is barred from the next election; the bench will rule whichever way you nod. \"One judgment,\" the Attorney General murmurs, \"and your only rival watches the vote from a cell.\"",
    ...
    sx("With the leader jailed, her elderly frame ailing in custody, the prison doctor warns that a death behind your bars would make her a martyr forever. Her family begs for hospital release; your hardliners call it weakness.",
  ...
  ax("Cyber Cell Commander", "shadow", ["trolls", "disinformation", "online"],
    sx("Your party's online cell wants a budget to flood the networks with fake personas — smearing critics, manufacturing trends, and burying inconvenient news under coordinated noise. The commander promises 'we win the feed before they wake up.'",
  ...
  ax("Coalition Manager", "official", ["coalition", "allies", "leverage"],
    sx("Your largest junior partner threatens to walk unless it gets a deputy-premiership and three more ministries — a price that would let its leader posture as co-ruler. Lose them and your majority cracks; keep them and you feed a rival under your roof.",
  ...
  ax("Chief Whip", "fixer", ["parliament", "no-confidence", "discipline"],
    sx("A no-confidence motion is on the order paper, and a dozen of your backbenchers are wavering. The Whip can break it with a mix of threats, frozen contracts, and midnight visits — or you can win the floor by actually answering the grievance behind the revolt.",
  ...
  ax("Constitutional Adviser", "official", ["constitution", "term-limits", "power"],
    sx("Your jurists can draft an amendment scrapping term limits altogether, clearing the way for indefinite rule. The two-thirds majority is within reach. The adviser notes the obvious: it is also the clearest possible signal that you intend never to leave.",
  ...
  ax("Home Secretary", "official", ["banning", "rivals", "repression"],
    sx("You have the legal pretext to ban a troublesome rival party outright — dissolve it, seize its offices, bar its symbol. It would erase a threat in a stroke. It would also tell every other party that the law is just your hammer.",
  ...
  ax("Party Treasurer", "fixer", ["funding", "patrons", "graft"],
    sx("The industrialist who has bankrolled three of your campaigns now wants his return: a state bank licence, a tax holiday, and a port concession. The treasurer reminds you the next campaign cannot be fought without him.",
  ...
  ax("Ward Boss", "shadow", ["mastan", "extortion", "control"],
    sx("Your most effective ward boss runs his neighbourhood through extortion, land-grabbing, and a leash on the local police. He delivers turnout like clockwork. A rival within the party says he is a scandal waiting to detonate.",
  ...
  ax("Women's Wing Chief", "official", ["women", "representation", "reserved-seats"],
    sx("The reserved women's seats are yours to fill. The wing chief urges you to seat genuine grassroots women organisers; the fixers want them handed to wives and daughters of male donors as a courtesy. The seats are a signal either way.",
  ...
  ax("Chief Whip", "fixer", ["defection", "loyalty", "betrayal"],
    sx("One of your own MPs — popular, principled, and increasingly loud about corruption — is being courted by the opposition. The Whip offers two routes: ruin him pre-emptively with a leaked file, or win him back with a real hearing for his complaints.",
  ...
  ax("Rally Coordinator", "fixer", ["rally", "spectacle", "mobilisation"],
    sx("The party's national council is your chance for a million-strong show of force in the capital. The coordinator wants every district to bus in cadres — paid, fed, and housed at the party's cost — to fill the maidan and overawe rivals.",
  ...
  ax("Tribunal Prosecutor", "official", ["1971", "execution", "timing"],
    sx("A war-criminal's final appeal is exhausted and the gallows wait. Carrying out the sentence on the eve of the election would electrify your base and dare the opposition to defend a collaborator. The prosecutor asks: justice on its own clock, or yours?",
  ...
  ax("Culture Minister", "official", ["legacy", "dynasty", "naming"],
    sx("A proposal lands to rename the largest airport, a university, and a string of bridges after your family's founding figures. It would stamp the dynasty on the map for generations. Critics call it the cult swallowing the state.",
  ...
  ax("Polling Agent Coordinator", "fixer", ["booth-capture", "election-day", "violence"],
    sx("On polling day, your cadres in a contested district can seize the booths in the last hour, eject the rival's agents, and stuff the boxes. The coordinator says it locks twelve seats. It also produces twelve seats no one will believe.",
  ...
  ax("Parliamentary Affairs Minister", "official", ["speaker", "parliament", "fairness"],
    sx("The Speaker's chair is yours to fill. A partisan Speaker would gag the opposition, ram bills through, and rule every point of order your way. A genuinely neutral one would let the house breathe — and occasionally let your rivals land a blow.",
  ...
  ax("Overseas Wing Secretary", "fixer", ["diaspora", "funding", "foreign"],
    sx("Your overseas chapters can funnel large, lightly-documented donations home through hundi channels. The secretary calls it patriotic generosity; the law calls it illegal foreign funding. It would fatten the chest and tie you to money you cannot explain.",
  ...
  ax("Minorities Cell Convenor", "official", ["minorities", "secularism", "vote-bank"],
    sx("The Hindu and minority vote has long been a reliable bloc for you against the religious right — but only if you protect it. After a spate of temple attacks, the convenor warns that token sympathy will not hold them; visible protection will, at a cost with the majority bloc.",
  ...
  ax("Strategy Director", "shadow", ["dummy-candidates", "election", "manipulation"],
    sx("To make an uncontested vote look competitive, the director proposes fielding 'independent' dummy candidates loyal to you — fake opposition to manufacture the appearance of a real race after the true opposition boycotts.",
  ...
  ax("Cabinet Secretary", "official", ["bureaucracy", "purge", "patronage"],
    sx("The bureaucracy is full of officers who served the last government. The secretary offers a sweeping reshuffle — sideline the suspect, promote the loyal — to make the machine answer to you alone. It would be efficient, and it would gut the service's neutrality.",
  ...
  ax("Party Historian", "official", ["history", "martyrs", "narrative"],
    sx("The anniversary of the party's founding massacre approaches. The historian wants the commemoration weaponised — every speech aimed at branding today's opposition as the heirs of the killers. It rouses the faithful and poisons the well further.",
  ...
  ax("Law Minister", "official", ["judiciary", "appointments", "independence"],
    sx("Two seats on the apex court are vacant and a major case on your government's legality is pending. The minister can elevate two reliable judges in time to hear it — or appoint on seniority and merit and let the case fall where it may.",
  ...
  ax("District President", "people", ["grassroots", "accountability", "local"],
    sx("The grassroots of a key district are in open revolt against their sitting MP — your man — for years of arrogance and graft. They threaten to sit out the campaign. You can back the incumbent and his machine, or back the workers and dump him.",
  ...
  ax("Establishment Minister", "official", ["jobs", "patronage", "youth"],
    sx("Tens of thousands of government jobs are about to be advertised. The minister can quietly reserve a large share for party families and youth-wing cadres — buying a generation of loyalty — or run them on open merit and let the chips fall.",
  ...
  ax("General Secretary", "fixer", ["reconciliation", "rivals", "unity"],
    sx("A senior leader who broke with you years ago — taking a faction with him — now seeks to return. He brings votes and organisers, but also ambition and a grudge. The Secretary asks whether to welcome him or let him rot outside.",
  ...
  ax("Leader of the House", "official", ["parliament", "boycott", "legitimacy"],
    sx("With the opposition boycotting parliament entirely, you can ram through a year's worth of contentious bills against empty benches — no debate, no scrutiny. The leader of the house calls it efficient; the press calls it one-party rule by another name.",
  ...
  ax("Election Tech Adviser", "official", ["evm", "election", "trust"],
    sx("The Commission wants to roll out electronic voting machines nationwide. Your technicians can configure them to be auditable and transparent — or quietly opaque, with no paper trail to contradict the reported count. The opposition already distrusts the boxes.",
  ...
  ax("Field Security Chief", "shadow", ["intimidation", "polling", "agents"],
    sx("The chief proposes a quiet campaign of pressure on the opposition's polling agents in the marginals — late-night visits, false cases filed, families warned — so their booths go unwatched on the day. No watcher, no challenge.",
  ...
  ax("Chief Whip", "fixer", ["defection", "poaching", "majority"],
    sx("A charismatic opposition MP — clean, articulate, a future leader on their side — is privately willing to cross to you, for a ministry and a free hand in his district. Poaching him weakens them and strengthens you, but signals that everything is for sale.",
  ...
  ax("Election Commission Liaison", "official", ["ballot", "symbol", "advantage"],
    sx("The liaison can rig the small things that move the illiterate vote: your symbol first on every ballot, the opposition's buried, your candidates listed at the top. Tiny thumbs on the scale, individually deniable, collectively decisive.",
  ...
  ax("City Campaign Manager", "fixer", ["mayor", "dhaka", "election"],
    sx("The capital's mayoral race is a referendum on your rule, and your candidate is a lacklustre loyalist. The manager can pour state resources into rigging it safe, or you can swap in a genuinely popular outsider who might owe you less.",
  ...
  ax("Street Operations Coordinator", "fixer", ["hartal", "arson", "escalation"],
    sx("A renewed blockade has turned lethal — buses torched with passengers inside, a child among the dead. The coordinator wants to answer fire with fire and send your cadres to torch the opposition's offices in return. The cycle would consume the season.",
  ...
  ax("Party Historian", "official", ["legacy", "founder", "cult"],
    sx("A grand mausoleum-museum complex for the party's founder is proposed at vast expense, to be the obligatory pilgrimage of every schoolchild and official. The historian calls it national memory; critics call it the cult cast in marble.",
  ...
  ax("Labour Wing Secretary", "people", ["labour", "garments", "wages"],
    sx("Your party's labour wing wants to lead the garment workers' wage agitation — a million votes if you deliver, but a collision with the factory owners who fund you. The secretary asks whose side the party is really on.",
  ...
  ax("Strategy Director", "official", ["by-election", "barometer", "risk"],
    sx("A by-election in a swing seat is a live test of your standing. The director can sandbag it with the usual machinery for a safe win that tells you nothing, or let it run clean as an honest barometer — and risk a humiliating loss that emboldens the opposition.",
  ...
  ax("Law Minister", "official", ["contempt", "press", "speech"],
    sx("A prominent editor has accused your government of corruption in print. The minister can have him hauled up for contempt and sedition, jailing him and chilling the rest — or you can answer the charge with evidence and let him print.",
  ...
  ax("Constitutional Adviser", "official", ["floor-crossing", "discipline", "law"],
    sx("Article 70 already lets you expel any MP who votes against the party line, making your benches utterly obedient. The adviser proposes tightening it further, criminalising even abstention. It would end dissent — and end parliament as anything but a chorus.",
  ...
  ax("Coalition Manager", "fixer", ["seats", "allies", "arithmetic"],
    sx("Seat-sharing talks with your allies are deadlocked. You can bully the small partners into accepting scraps — keeping the lion's share for your own candidates — or share generously to keep the alliance genuinely broad and grateful.",
  ...
  ax("Foreign Liaison Officer", "ambassador", ["observers", "election", "legitimacy"],
    sx("Foreign and domestic election observers have applied for accreditation. You can stall and restrict them — limiting where they go, what they see — to keep the managed parts of the vote out of frame, or accredit them fully and run a vote that can bear watching.",
  ...
  ax("Anti-Graft Commission Chair", "official", ["acc", "lawfare", "selective"],
    sx("The graft watchdog is yours to aim. The chair awaits a target list: pursue only the opposition and your own clean rivals, or let the Commission investigate without fear or favour — including, inevitably, your own ministers.",
  ...
  ax("Constitutional Adviser", "official", ["caretaker", "constitution", "power"],
    sx("You can amend away the caretaker-government provision permanently, ensuring every future election is held under a sitting government — yours, for now. It locks in a structural advantage forever, and locks in the grievance that fuels every boycott.",
  ...
  ax("Personal Physician", "doctor", ["succession", "health", "dynasty"],
    sx("Your own health is failing faster than the public knows. The physician urges you to name and groom a successor now, while you can shape the transition — but doing so makes you a lame duck the moment it is announced, and the vultures will gather.",
  ...
  ax("Election Commission Liaison", "official", ["recount", "dispute", "credibility"],
    sx("The opposition demands a recount in a flagship seat your candidate narrowly 'won'. The liaison can refuse on a technicality and let the result stand, or grant a transparent recount — which might overturn the seat and dent your majority.",
  ...
  ax("Information Minister", "official", ["history", "national-day", "narrative"],
    sx("The national-day broadcasts are yours to script. You can rewrite the founding story to centre your family and erase rivals' contributions — cementing the dynasty as the nation's sole author — or tell an inclusive history that shares the credit.",
  ...
  ax("Intelligence Chief", "shadow", ["cabinet", "plot", "loyalty"],
    sx("Whispers reach you that two senior ministers are quietly sounding out the army and the opposition about a post-you future. The chief offers proof through surveillance — or you can confront them in the open and force their hand.",
  ...
  ax("General Secretary", "fixer", ["scandal", "family", "corruption"],
    sx("A corruption scandal has surfaced that leads, unmistakably, to a member of your own family. The Secretary can bury it with the usual machinery, or you can let an inquiry proceed and accept the wound to the dynasty's image.",
  ...
  ax("Manifesto Committee Chair", "official", ["manifesto", "promises", "credibility"],
    sx("The next manifesto is being drafted. The chair can load it with extravagant, undeliverable promises that thrill crowds and win the cycle — or write a sober, costed platform that under-promises and can actually be kept.",
  ...
  ax("Student Wing President", "fixer", ["students", "protest", "blame"],
    sx("Your student wing attacked a peaceful protest on campus, and the footage is everywhere. The president wants you to back the cadres and blame 'outside agitators'; the reformers want the attackers disciplined and an apology issued.",
  ...
  ax("Elder Statesman", "official", ["dialogue", "opposition", "reconciliation"],
    sx("Through a respected intermediary, the opposition offers talks: end the boycott, accept your term, in exchange for electoral reforms and the release of jailed activists. The hardliners call it a trap; the statesman calls it the only exit from a deepening crisis.",
  ...
  ax("General Secretary", "fixer", ["congress", "rules", "control"],
    ...
    sx("With the rules settled, a charismatic provincial leader has won a groundswell of delegates and could challenge your chosen slate on the congress floor. You can disqualify him on a procedural pretext, or let the floor decide.",
  ...
  ax("Legal Affairs Secretary", "official", ["defamation", "press", "intimidation"],
    sx("The secretary proposes blanketing critical journalists and opposition figures with dozens of defamation suits across distant districts — not to win them, but to bury the targets in travel, lawyers, and fear. It is harassment dressed as law.",
    ...
    sx("One suit went ahead anyway, filed by an overzealous local leader, and a young reporter now sits in jail awaiting a hearing months away. The case is a national embarrassment. You can let it grind on, or intervene to free her.",
  ...
  ax("Delimitation Commissioner", "official", ["gerrymander", "constituencies", "advantage"],
    sx("The constituency boundaries are due for redrawing, and the commissioner can carve them to pack your opponents into a few seats and spread your voters thinly across many — a quiet, permanent advantage few will notice and none can easily prove.",
  ...
  ax("General Secretary", "fixer", ["split", "faction", "discipline"],
    sx("A heavyweight regional leader threatens to break away and form a rival party, taking a chunk of your organisation with him. The Secretary can crush him pre-emptively with expulsions and cases, or accommodate his demands to keep the tent whole.",
  ...
  ax("Coalition Manager", "official", ["alliance", "left", "ideology"],
    sx("A small but disciplined leftist party offers an alliance — useful street muscle and intellectual credibility — but its price is a swing left on labour, land, and privatisation that would spook your business donors. The manager weighs muscle against money.",
  ...
  ax("Tribunal Prosecutor", "official", ["banning", "collaborators", "1971"],
    sx("You can move to ban outright the religious party whose leaders collaborated in the 1971 atrocities — a genuine reckoning that also conveniently removes an opposition ally. The prosecutor notes the line between justice and political weapon is thin here.",
  ...
  ax("Rural Development Coordinator", "fixer", ["rural-works", "patronage", "graft"],
    sx("The rural food-for-work and infrastructure funds are channelled through MPs who skim them and steer the projects to their own villages. The coordinator can keep the lucrative system or route the funds through transparent local government instead.",
  ...
  ax("Religious Affairs Secretary", "cleric", ["mosques", "imams", "influence"],
    sx("The state can fund imam allowances and pack the mosque management committees with your loyalists — turning the Friday pulpit into a quiet ally — or keep the mosques independent of the party's reach. The secretary says the pulpit moves more votes than any rally.",
  ...
  ax("Justice Reform Adviser", "official", ["truth-commission", "reckoning", "past"],
    sx("Pressure mounts for a truth commission into the abuses of the previous government — a genuine reckoning that would also, inconveniently, set a precedent for examining yours one day. The adviser asks how far to let it look.",
  ...
  ax("Election Commission Liaison", "official", ["finance", "disclosure", "transparency"],
    sx("A proposed law would force every party and candidate to disclose donors and spending — sunlight that cleans the system and exposes your own opaque, oversized war chest. The liaison asks whether to back it or quietly bury it.",
  ...
  ax("Parliamentary Affairs Minister", "official", ["opposition", "status", "norms"],
    sx("With a real opposition finally in parliament, you can either grant its leader the traditional status, perks, and consultative role — a sign of a maturing democracy — or strip the position bare to keep your rival small and dependent.",
  ...
  ax("Reconciliation Adviser", "official", ["reconciliation", "history", "wounds"],
    sx("The anniversary of a dark episode your party once perpetrated approaches. The adviser offers two paths: a genuine acknowledgment and apology that could begin to heal an old wound, or the usual silence that lets sleeping guilt lie.",
  ...
  ax("Election Logistics Officer", "official", ["remote", "polling", "access"],
    sx("In the far chars, haors, and hills, reaching every voter with a polling station is costly and slow — and the officer notes those remote areas lean against you. He can fund full access for all, or quietly let the awkward, hostile pockets go under-served.",
  ...
  ax("Manifesto Committee Chair", "official", ["manifesto", "leak", "damage"],
    sx("A draft of the manifesto has leaked, exposing an unpopular plan to cut a beloved subsidy that you meant to bury in the fine print. The chair asks whether to brazen it out and keep the plan, or disown the draft and reverse course.",
  ...
  ax("Field Mobilisation Officer", "fixer", ["turnout", "transport", "poll-day"],
    sx("Your machine can lay on free transport to ferry your voters to the booths on polling day — legal turnout muscle in your strongholds — while quietly ensuring the buses never reach the opposition's wards. The officer asks how clean to keep it.",
  ...
  ax("Chief Whip", "official", ["confidence", "majority", "coalition"],
    sx("Your new majority is wafer-thin and a confidence vote looms in the first week. The Whip can secure it by buying a few independents with quiet promises, or you can win it on your genuine numbers and govern honestly from a fragile base.",
  ...
  ax("Cabinet Secretary", "general", ["emergency", "powers", "rule"],
    sx("Amid unrest, the secretary lays out the nuclear option: declare a state of emergency, suspend rights, rule by decree, and postpone the election. It would give you total control — and brand you, at home and abroad, as a ruler who tore up the rules to keep power.",
  ...
  ax("Professional Wing Coordinator", "fixer", ["bar-association", "professionals", "capture"],
    sx("The bar association, medical council, and engineers' bodies hold prestigious elections that shape professional opinion. The coordinator wants to capture them with party panels and patronage; the alternative is to let the professionals govern themselves.",
  ...
  ax("Constitutional Adviser", "official", ["caretaker", "judiciary", "poll"],
    sx("If a neutral poll-time authority is to oversee the election, its chief would likely be the most recently retired chief justice. The adviser notes you could engineer the retirement timeline so that a pliable judge sits in that chair when it matters.",
  ...
  ax("Coalition Manager", "official", ["coalition", "programme", "compromise"],
    sx("Your alliance must agree a common minimum programme, and the partners' wish-lists pull in opposite directions — secular reformers against the religious bloc, labour against business. The manager asks whether to paper over the cracks or force a coherent platform.",
  ...
  ax("Reconciliation Adviser", "official", ["banning", "restoration", "inclusion"],
    sx("A party banned years ago — its grievance now a rallying cry — petitions to be restored to legal politics, promising to renounce violence. The adviser says readmitting it drains the poison of exclusion; the hardliners say it legitimises old enemies.",
  ...
  ax("Field Mobilisation Officer", "people", ["turnout", "gotv", "organisation"],
    sx("Turnout is your friend where you are strong and your enemy where you are weak. The officer can run a blanket national get-out-the-vote drive that lifts everyone's turnout, or a surgical one that wakes your wards and lets the opposition's sleep.",
  ...
  ax("Local Government Secretary", "official", ["devolution", "decentralisation", "power"],
    sx("Real devolution — money and power pushed down to elected local councils — would transform governance and accountability, but it would also loosen your central grip and empower local leaders, some of them rivals. The secretary asks how far to let go.",
  ...
  ax("Election Tech Adviser", "official", ["results", "transmission", "transparency"],
    sx("A new app would transmit every polling station's count straight to a public dashboard in real time — radical transparency that makes tampering nearly impossible, and equally makes any managed result impossible to manage. The adviser awaits your verdict.",
  ...
  ax("Education Affairs Secretary", "cleric", ["madrasa", "recognition", "votes"],
    sx("The vast network of independent religious schools wants its degrees recognised as equal to university qualifications for government jobs — a huge bloc's long-held demand. The secretary says granting it wins the bloc; the secular establishment is appalled.",
  ...
  ax("Chief Whip", "people", ["backbench", "rebellion", "policy"],
    sx("A bloc of your own backbenchers, closer to the public mood than the cabinet, is in open revolt over a deeply unpopular bill. The Whip can break them with threats and patronage, or you can heed them and amend the bill they say is poison on the doorstep.",
  ...
  ax("Party Treasurer", "official", ["donations", "corporate", "influence"],
    sx("A reform would cap corporate donations and require their disclosure — curbing the oligarchs' grip on policy, and choking the single biggest stream into your war chest. The treasurer warns the cut would hurt; the reformers say the influence is rotting the state.",
  ...
  ax("Information Commissioner", "official", ["rti", "transparency", "accountability"],
    sx("A strengthened Right to Information law would force every office to open its files to any citizen who asks — a powerful anti-corruption tool, and a window into the very deals and decisions your government would rather keep dark. The commissioner awaits your stance.",
  ...
  ax("Parliamentary Affairs Minister", "official", ["oversight", "committee", "audit"],
    sx("The parliamentary committee that scrutinises government spending is traditionally chaired by the opposition. You can deny them the chair and pack it with loyalists, neutering oversight, or honour the convention and let your own spending be examined.",
  ...
  ax("Returning Officer Coordinator", "fixer", ["postal", "service-voters", "fraud"],
    sx("The postal ballots of soldiers, police, and officials posted away from home are easy to bundle and steer. The coordinator can quietly manage these service votes as a reliable bloc, or process them transparently like any other ballot.",
  ...
  ax("Coalition Manager", "fixer", ["hung-parliament", "kingmaker", "deals"],
    sx("The election has produced no majority, and a handful of independents and tiny parties now hold the balance. The manager can assemble a government by lavishing them with ministries and money, or attempt a leaner minority government on issue-by-issue support.",
  ...
  ax("Women's Wing Chief", "people", ["women", "reserved-seats", "reform"],
    sx("Women's groups demand that the reserved parliamentary seats be filled by direct election rather than party nomination, giving women real mandates instead of appointed tokens. It empowers women — and strips you of dozens of safe, controllable seats.",
  ...
  ax("Election Logistics Officer", "shadow", ["polling-station", "relocation", "suppression"],
    sx("On the quiet, the officer can relocate polling stations in opposition strongholds to distant, hard-to-reach venues announced at the last minute — depressing their turnout without a single ballot touched. It is deniable, surgical voter suppression.",
  ...
  ax("Law Minister", "official", ["election-petition", "courts", "result"],
    sx("The opposition has filed election petitions challenging results in dozens of seats, with real evidence in some. The minister can have the captured courts dismiss them all en masse, or let the genuine cases be heard, risking the loss of a few seats.",
  ...
  ax("Cyber Cell Commander", "shadow", ["deepfake", "disinformation", "smear"],
    sx("The cyber cell has produced a convincing deepfake of the opposition leader saying something inflammatory and disqualifying. Released days before the vote, it could end her — until, perhaps, it is debunked, and the forgery is traced back to you.",
  ...
  ax("Strategy Director", "official", ["by-poll", "succession", "seat"],
    sx("A veteran MP from a safe seat has died, triggering a by-poll. His capable but independent-minded daughter wants the nomination on her own merit; the local fixer wants a pliable outsider who will owe you everything. The director needs the nominee.",
  ...
  ax("Digital Government Adviser", "people", ["e-governance", "services", "corruption"],
    sx("A digital one-stop service portal could let citizens get licences, certificates, and payments online — slashing the petty bribery that infests every counter. The clerks who live on those bribes, a vast and connected workforce, will quietly sabotage it.",
  ...
  ax("Leader of the House", "official", ["parliament", "accountability", "norms"],
    sx("Question hour, where ministers answer the house, has decayed into scripted softballs from your own backbenchers. You can revive it as real, unscripted scrutiny — sharpening your ministers but exposing their failings — or keep it the comfortable theatre it is.",
  ...
  ax("Labour Wing Secretary", "people", ["unions", "affiliation", "leverage"],
    sx("You can bring the major trade unions under your party's wing — disciplined turnout and industrial muscle — at the price of either delivering on their wage demands or being seen to betray them. The secretary asks whether to court or keep your distance.",
  ...
  ax("Civic Education Director", "people", ["voter-education", "awareness", "turnout"],
    sx("A neutral, state-funded voter-education drive would teach citizens their rights, how to spot fraud, and how to vote — strengthening democracy, and arming the very voters most likely to catch your machine cutting corners. The director asks whether to fund it.",
  ...
  ax("Overseas Wing Secretary", "shadow", ["overseas", "voting", "fraud"],
    sx("If overseas voting is introduced at embassies, the thin oversight abroad makes the ballots ripe for manufacturing. The secretary can quietly pad the diaspora vote at friendly missions, or insist the overseas count be observed as rigorously as any at home.",
  ...
  ax("Strategy Director", "fixer", ["independents", "spoilers", "tactics"],
    sx("In seats where your candidate is weak, the director proposes secretly funding 'independent' spoilers to split the opposition vote. It is cynical and effective, and a leak would expose you as manufacturing fake candidates to game the result.",
  ...
  ax("Constitutional Adviser", "official", ["ombudsman", "accountability", "graft"],
    sx("The constitution provides for an ombudsman to investigate official corruption and maladministration — an office every government since independence has conveniently left unfilled. The adviser asks whether to finally appoint a real one, or keep the chair empty.",
  ...
  ax("Home Affairs Coordinator", "official", ["magistrates", "election-day", "neutrality"],
    sx("Executive magistrates with mobile courts roam the polls on election day, and the coordinator can deploy them as a partisan instrument — harassing opposition agents, waving through your irregularities — or as genuinely neutral keepers of the peace.",
  ...
  ax("Electoral Roll Officer", "shadow", ["nid", "purge", "disenfranchisement"],
    sx("Tying the voter roll to the national ID database lets you purge 'unverifiable' voters — a clean-up that, applied selectively, can quietly strike opposition-leaning groups (the poor, migrants, minorities) off the list. The officer awaits your aim.",
  ...
  ax("Youth Wing Coordinator", "people", ["youth", "outreach", "spending"],
    sx("To win back the youth alienated by the quota unrest, the coordinator proposes a vast national youth festival — concerts, job fairs, sports — at considerable cost. The cynics call it a bribe; the optimists call it the only bridge left to a hostile generation.",
  ...
  ax("Parliamentary Affairs Minister", "official", ["privilege", "press", "intimidation"],
    sx("An MP wants to haul a journalist before the house on a 'breach of privilege' for an unflattering report — a quasi-judicial summons that intimidates the whole press gallery. The minister asks whether to back the motion or quash it.",
  ...
  ax("Cabinet Secretary", "official", ["ministers", "conduct", "accountability"],
    sx("Several ministers are visibly enriching themselves and their families on the public dime. The secretary proposes a real, enforced code of conduct with asset declarations and resignations for breaches — a clean-up that would gut some of your most loyal grandees.",
  ...
  ax("Chief Whip", "fixer", ["president", "cross-voting", "discipline"],
    sx("The president is elected by parliament, and a faction of your MPs is flirting with backing a rival candidate to send you a message. The Whip can crush the cross-voting with threats, or let the secret ballot speak and read the result as a warning.",
  ...
  ax("General Secretary", "official", ["reshuffle", "cabinet", "balance"],
    sx("A reshuffle looms, and you can either reward raw loyalty — keeping the faithful incompetents who will never plot — or promote on competence, building a cabinet that governs well but contains ambitious talents who might one day eclipse you.",
  ...
  ax("Strategy Director", "official", ["referendum", "legitimacy", "gamble"],
    ...
    sx("You called it, and the referendum is tainted by a low, suspicious turnout and a result too lopsided to believe. The director asks whether to trumpet the landslide as vindication or admit the obvious and temper your claims.",
    ...
    sx("The referendum gambit, whatever its result, has emboldened the opposition to demand a real, internationally-observed election as the only true test. The director asks whether to concede the clean election or dig in behind the referendum's verdict.",
