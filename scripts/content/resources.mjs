...
export const RESOURCES = [
  ...
  ax("Petroleum Refining Director", "official", ["refinery", "fuel", "self-reliance"],
    sx("The country's lone, ancient oil refinery meets a fraction of fuel demand, so most fuel is imported already-refined at a premium. Build a costly second refinery for self-reliance, or keep importing refined product and skip the capital?",
  ...
  ax("Water Resources Officer", "people", ["recharge", "rainwater", "aquifer"],
    sx("As aquifers fall, a programme of managed recharge — capturing monsoon rain to refill the groundwater — could slow the decline. The officer wants mandatory rainwater harvesting and recharge structures; it is cheap per site but vast in scale and easy to neglect.",
  ...
  ax("Agriculture Policy Director", "people", ["crops", "diversification", "water"],
    sx("The obsession with thirsty rice drains the aquifers and leaves diets and incomes undiversified. The director wants incentives to shift toward less-thirsty, higher-value crops — pulses, oilseeds, vegetables — against the grain of habit and rice-first policy.",
  ...
  ax("Marine Conservation Officer", "relief", ["turtles", "marine", "tourism"],
    sx("The coast's sea-turtle nesting beaches are being lost to lights, nets, and development. A protected hatchery-and-beach programme would save them and draw eco-tourism, at the cost of restricting the fishing and building the coastal economy leans on.",
  ...
  ax("Grid Modernisation Director", "official", ["storage", "battery", "renewables"],
    sx("Solar and wind are useless after dark and in calm without storage, and the grid cannot absorb them. Invest in a costly grid-scale battery programme to make renewables dispatchable, or keep leaning on fossil plants for reliable power?",
  ...
  ax("Gas Distribution Chief", "shadow", ["gas", "system-loss", "theft"],
    sx("A fifth of the piped gas vanishes through illegal connections, tampered meters, and bribed staff, much of it serving captive industrial and elite users. Mount a hard anti-theft drive that hits connected beneficiaries, or keep absorbing the loss?",
  ...
  ax("Forest Department Chief", "people", ["forestry", "communities", "livelihoods"],
    sx("A social-forestry scheme would let poor villagers grow and harvest trees on degraded state land — income for them, green cover for the country — but done carelessly it becomes a backdoor to clear-felling and grabbing the very forest it should grow. How do you design it?",
  ...
  ax("Renewable Research Director", "official", ["tidal", "pilot", "innovation"],
    sx("The strong tidal range of the estuaries could, in theory, drive tidal power — a clean, novel source. A pilot would be a costly, unproven gamble on innovation; the safe path is to stick with proven solar and wind and let others pioneer the tides.",
  ...
  ax("Agriculture Policy Director", "people", ["edible-oil", "oilseed", "imports"],
    sx("The country imports almost all its cooking oil, draining dollars and leaving prices hostage to world markets. A push for domestic mustard, sunflower, and soy oilseed would build self-reliance — slow, and competing for the scarce land that grows food grains.",
  ...
  ax("Sugar Corporation Chief", "people", ["sugar-mills", "soe", "farmers"],
    sx("The state sugar mills lose money every year on obsolete machinery and graft, but tens of thousands of cane farmers and mill workers depend on them. Shut or privatise the worst to stem the losses, or pour in another bailout and modernisation gamble?",
  ...
  ax("Agriculture Marketing Director", "people", ["post-harvest", "cold-chain", "waste"],
    sx("A third of the fruit and vegetables rot between farm and market for want of storage, cold chain, and roads — a staggering waste that beggars farmers and inflates prices. The director wants a costly cold-chain build; the capital is large and the gain diffuse.",
  ...
  ax("Industries Resource Officer", "official", ["fly-ash", "bricks", "topsoil"],
    sx("The coal plants pile up fly-ash as toxic waste, while the brick kilns devour the country's topsoil. Mandating fly-ash bricks would solve both — using the waste, sparing the soil — but it disrupts the entrenched clay-brick industry and its workers.",
  ...
  ax("Marine Resources Director", "relief", ["marine", "protected-area", "fisheries"],
    sx("Declaring a large marine protected area in the bay would let the overfished stocks recover and safeguard biodiversity — a long-term gift to the fishery — but it locks both trawlers and artisanal fishers out of rich grounds in the short term.",
  ...
  ax("Grid Expansion Director", "people", ["transmission", "land", "evacuation"],
    sx("New power plants sit idle for want of transmission lines, and the lines are stalled by land disputes and farmers refusing the towers across their fields. Force the right-of-way through with compulsory acquisition, or negotiate slow and fair?",
  ...
  ax("Plantation Affairs Officer", "fixer", ["tea", "forest", "expansion"],
    sx("Tea companies want to expand their estates into adjoining reserve forest and indigenous land — more export tea, at the cost of felled forest and displaced hill communities. Grant the leases, or protect the forest and the people on it?",
  ...
  ax("Irrigation Technology Director", "people", ["solar-pumps", "irrigation", "diesel"],
    sx("Replacing the diesel and grid pumps that irrigate the fields with solar ones would slash the fuel bill and emissions and free farmers from fuel-price shocks — a large upfront cost, against the cheap, familiar diesel status quo.",
  ...
  ax("Coastal Fisheries Officer", "people", ["dried-fish", "pesticides", "exports"],
    sx("The dried-fish trade — a coastal staple and growing export — is rife with illegal pesticide use to keep flies off the racks, poisoning consumers and threatening the export market. The officer wants enforcement and clean drying tech; the traders resist the cost.",
  ...
  ax("Geological Survey Director", "official", ["minerals", "survey", "sovereignty"],
    sx("A thorough national mineral survey could reveal coal, gas, hard rock, and rare minerals worth fortunes — knowledge that is power, and a magnet for foreign extractors and the conflicts that follow discovery. Survey aggressively, or tread lightly?",
  ...
  ax("Coastal Afforestation Officer", "relief", ["char", "afforestation", "land"],
    sx("Planting forests on the new coastal chars would stabilise the silt islands, buffer storms, and eventually create land for the landless — slow, unglamorous work, easily neglected against the rush to hand the chars to shrimp farms and grabbers.",
  ...
  ax("Land Reform Commissioner", "people", ["land-ceiling", "landless", "elite"],
    sx("Land-ceiling laws meant to cap how much one family can own are flouted wholesale through benami holdings, while millions are landless. The commissioner wants real enforcement and redistribution of the surplus; the great landholders, many connected, will fight hard.",
  ...
  ax("Farm Mechanisation Director", "people", ["mechanisation", "labour", "yields"],
    sx("Mechanising the farms — harvesters, tillers, transplanters — would raise yields and ease the brutal labour as workers leave for the cities. But it would also throw landless farm labourers, who have nothing else, out of their only work. How hard do you push?",
  ...
  ax("Industrial Waste Officer", "official", ["recycling", "used-oil", "pollution"],
    sx("Used engine oil and scrap tyres are dumped or burned in toxic backyard operations that poison soil and air. A formal recycling and pyrolysis industry could turn the waste to value cleanly — at a cost the informal burners will resist.",
  ...
  ax("Energy Regulator", "official", ["feed-in-tariff", "solar", "investment"],
    sx("A generous feed-in tariff guaranteeing a good price for renewable power fed to the grid would unleash private solar and wind investment — at a cost locked in for years that the utility, and ultimately the consumer, must bear. How generous do you set it?",
  ...
  ax("Maritime Resources Envoy", "ambassador", ["continental-shelf", "seabed", "claim"],
    sx("With the maritime boundary settled, you can press an extended continental-shelf claim to the seabed beyond — a potential bonanza of gas and minerals, and a costly, years-long legal and survey effort that may antagonise neighbours with overlapping claims.",
  ...
  ax("Forest Tourism Officer", "fixer", ["eco-park", "tourism", "conservation"],
    sx("A grand safari park and eco-resort carved out of a forest reserve would draw tourists and revenue — and fragment the habitat, cage wildlife for show, and hand prime forest to resort developers. Build the attraction, or protect the reserve intact?",
  ...
  ax("Biofuel Policy Officer", "official", ["biofuel", "ethanol", "food"],
    sx("Molasses from the sugar mills could be turned into ethanol to blend with petrol, cutting fuel imports and using a waste stream — or that same feedstock could feed the food and drink industries. Mandate biofuel blending?",
  ...
  ax("Power Planning Director", "official", ["pumped-storage", "hydro", "storage"],
    sx("With little room for big dams, the engineers propose a pumped-storage scheme in the hills — a giant battery using water and gravity to store surplus power. It is costly, geologically risky, and would flood a hill valley, displacing its communities.",
  ...
  ax("Food Fortification Officer", "doctor", ["salt", "iodine", "health"],
    sx("Iodine deficiency still stunts minds in the regions where un-iodised salt slips through, and enforcement of universal salt iodisation is lax. The officer wants a hard enforcement drive; the small, scattered salt producers resist the cost and oversight.",
  ...
  ax("Food Storage Director", "official", ["grain", "silos", "food-security"],
    sx("The country's grain reserve rots in damp, rat-infested warehouses, losing a fortune and leaving the buffer unreliable in a crisis. The director wants modern steel silos; the capital is large and the warehouse rackets that profit from the chaos resist.",
  ...
  ax("Livestock Health Director", "doctor", ["poultry", "bird-flu", "biosecurity"],
    sx("The booming poultry industry — cheap protein for millions — is a tinderbox for bird flu, with poor biosecurity and culling-compensation too stingy to stop farmers hiding outbreaks. The director wants real biosecurity and fair compensation; it is costly.",
  ...
  ax("Land Reform Officer", "people", ["sharecroppers", "tenancy", "rights"],
    sx("Millions of sharecroppers till others' land for a punishing share of the crop, with no security and no recourse when a landlord evicts them at whim. The officer wants enforceable tenancy rights and a fairer share; the landlord class resists fiercely.",
  ...
  ax("Energy Efficiency Director", "official", ["efficiency", "standards", "demand"],
    sx("The cheapest power is the power not used, and mandatory energy-efficiency standards for buildings, motors, and appliances would cut demand more cheaply than any new plant. The director wants hard standards; manufacturers and developers resist the cost.",
  ...
  ax("Marine Fisheries Director", "official", ["deep-sea", "fleet", "sovereignty"],
    sx("Your fishers work only the crowded coastal waters while the rich deep-sea zone of your own maritime territory is fished by licensed foreign trawlers. The director wants a national deep-sea fleet to claim that catch; it is costly and the fishers lack the vessels and skills.",
  ...
  ax("Agriculture Export Director", "people", ["horticulture", "fruit", "exports"],
    sx("The country's mangoes, jackfruit, and vegetables could earn real export money, but they rot for want of cold chain, fail foreign pesticide tests, and lack branding. Invest in a costly push for export-grade horticulture, or keep them a domestic crop?",
  ...
  ax("Cottage Resources Officer", "people", ["bamboo", "craft", "livelihoods"],
    sx("Bamboo and cane sustain vast craft and construction livelihoods and could anchor a sustainable green industry — but the resource is being stripped bare and the artisans are sliding into poverty. Build a managed-cultivation and value-chain push, or let it dwindle?",
  ...
  ax("Aquaculture Director", "doctor", ["shrimp", "disease", "hatchery"],
    sx("Disease keeps wiping out the shrimp farms — a major export — because the hatcheries sell weak, virus-laden post-larvae and farmers lack any quality control. The director wants certified disease-free hatcheries and training; the cheap-PL hatchery trade resists.",
  ...
  ax("Urban Energy Officer", "official", ["cooling", "efficiency", "demand"],
    sx("Air-conditioning is exploding with the heat and the middle class, spiking peak demand and grid strain. A district-cooling and efficiency push could blunt it; the developers and the AC-importing lobby prefer the cheap, wasteful status quo.",
  ...
  ax("Food Standards Director", "people", ["organic", "certification", "exports"],
    sx("A credible safe-food and organic certification scheme would let farmers earn premiums and reassure consumers poisoned by adulteration — a costly system to build and police, easily faked into a meaningless sticker if done on the cheap.",
  ...
  ax("Utility Modernisation Director", "people", ["smart-meters", "billing", "losses"],
    sx("Smart meters would end the bribed meter-readers, estimated bills, and theft that plague the utilities — and let you bill accurately and cut losses. They are costly to roll out, and consumers fear higher, harder-to-dodge bills.",
  ...
  ax("Biodiversity Resources Officer", "doctor", ["medicinal-plants", "biopiracy", "communities"],
    sx("The country's forests hold medicinal plants and genetic resources that foreign firms quietly harvest and patent — biopiracy of a heritage worth fortunes. The officer wants a benefit-sharing and protection regime; it is complex and could deter research investment too.",
  ...
  ax("Inland Fisheries Director", "people", ["fisheries", "co-management", "commons"],
    sx("The open-water fisheries — the beels and floodplains feeding millions — are being plundered by leaseholders and gear that wipe out the stocks. The director wants community co-management handing the waters to the fishers; the connected leaseholders resist.",
  ...
  ax("Renewable Energy Officer", "people", ["biogas", "waste", "rural"],
    sx("Rural cattle dung and farm waste could fuel village-scale biogas plants — clean cooking gas and fertiliser slurry from waste — cutting woodsmoke and firewood demand. The officer wants a national biogas push; uptake has always stalled on cost and habit.",
  ...
  ax("Livestock Feed Director", "people", ["feed", "import", "livestock"],
    sx("Livestock and dairy are throttled by costly imported feed, and the maize and fodder to grow it at home compete for land with food grains. The director wants a feed-crop push to cut the import bill; the land is scarce and the food-first lobby resists.",
  ...
  ax("Petroleum Resources Officer", "shadow", ["condensate", "refining", "graft"],
    sx("Condensate — a valuable liquid byproduct of gas extraction — is being siphoned to private 'fractionation' plants owned by connected operators at giveaway prices, robbing the state. Reclaim and properly auction it, or leave the cosy arrangement?",
  ...
  ax("Irrigation Efficiency Director", "people", ["drip", "irrigation", "water"],
    sx("The flood-irrigation that waters the fields wastes most of the water it draws, draining the aquifers faster than need demands. Drip and sprinkler systems would slash that waste; they are costly upfront, and water and power are cheap enough that few farmers bother.",
  ...
  ax("Industrial Energy Officer", "official", ["industry", "efficiency", "cogeneration"],
    sx("Factories waste vast energy through old motors, leaky steam, and dumped waste-heat. Mandating energy audits and cogeneration would cut industry's energy bill and the grid's load; the manufacturers resist the audits and the retrofit cost.",
  ...
  ax("Fisheries Infrastructure Officer", "people", ["fish-landing", "ice", "waste"],
    sx("A huge share of the marine catch spoils for want of ice, landing centres, and cold storage at the coast, beggaring fishers and wasting protein. The director wants a coastal cold-chain and landing-centre build; the capital is large and the gain spread thin.",
  ...
  ax("Mineral Resources Officer", "official", ["granite", "quarrying", "environment"],
    sx("A granite deposit could supply valuable dimension stone and cut imports, but quarrying it means blasting a forested hill that buffers a watershed and shelters indigenous hamlets. Open the quarry, or leave the hill standing?",
  ...
  ax("Grid Demand Manager", "official", ["demand", "peak", "tariff"],
    sx("Peak evening demand strains the grid to breaking, forcing costly, dirty peaker plants to fire up. Time-of-use tariffs and demand-management could shave the peak cheaply; consumers resent paying more at peak hours and the populist instinct is one flat, low price.",
  ...
  ax("Commerce Resources Officer", "people", ["palm-oil", "import", "health"],
    sx("Cheap imported palm oil dominates the cooking-oil market — affordable, but linked to poorer health and to rainforest destruction your imports fund. Tax and curb it in favour of domestic, healthier oils, or keep the cheap staple flowing?",
  ...
  ax("Energy Planning Chairman", "official", ["energy-mix", "strategy", "future"],
    sx("The decades-long power master plan must be set, and the chairman lays out the fork: double down on cheap, reliable imported coal and LNG for the growth the economy demands, or stake the future on a costlier, slower pivot to renewables?",
    ...
    sx("Years into the plan you chose, the bills are coming due — fuel-price shocks battering the fossil bet, or intermittency and cost straining the green one. Stay the course, or hedge with a costly mid-stream correction?",
    ...
    sx("The energy strategy has become a political symbol — the opposition hammers every blackout or price rise as proof of your folly, while your base defends the plan as visionary. Defend it loudly, or quietly let the next plan correct it?",
