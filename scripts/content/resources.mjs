...
export const RESOURCES = [
  ...
  ax("Power Development Chairman", "official", ["coal", "sundarbans", "energy"],
    sx("Honourable leader! A giant, dirty power plant is ready to turn on right next to a famous, beautiful forest. People are protesting.",
    ...
    sx("Sir, urgent news. The dirty power plant is killing the fish and the forest. You can buy expensive filters to stop the pollution.",
  ...
  ax("Cross-Border Power Negotiator", "official", ["adani-style", "import", "tariff"],
    sx("Sir, forgive me — A big company from another country wants to sell you electricity, but the rules are very unfair and will trap you for 25 years.",
  ...
  ax("Independent Power Producers' Lobby", "fixer", ["capacity-charge", "rental", "subsidy"],
    sx("A word, sir! The government is paying rich friends billions of dollars for power plants that don't even make electricity.",
  ...
  ax("Petrobangla Exploration Chief", "official", ["gas", "offshore", "maritime"],
    sx("Sir, we have a problem. There might be valuable gas deep in your ocean. You can let big foreign companies try to find it fast, but neighbors might get mad.",
  ...
  ax("Sitakunda Yard Owner", "fixer", ["shipbreaking", "labour", "toxic"],
    sx("Sir! The beaches where workers break old ships are very dangerous and toxic. You can force them to be safe, but it costs a lot.",
  ...
  ax("Public Health Hydrologist", "people", ["arsenic", "water", "wells"],
    sx("Mr. Prime Minister, sir! The water wells people drink from have natural poison in them, slowly making millions sick. Fixing it costs a lot of money.",
  ...
  ax("Riverbank Erosion Officer", "official", ["sand-mining", "rivers", "erosion"],
    sx("Your Excellency! Bad gangs are digging up too much sand from the river, which makes the land collapse and destroys villages.",
  ...
  ax("Renewables Director", "official", ["solar", "transition", "land"],
    sx("Prime Minister! You can get cheap money to build giant solar panels, but they take up the good dirt needed to grow food.",
  ...
  ax("LNG Terminal Operator", "official", ["lng", "gas", "spot-market"],
    sx("Honourable leader! The gas you buy from other countries just got super expensive. You can keep buying it, or let the lights go out sometimes.",
  ...
  ax("Power Grid Chief", "official", ["grid", "system-loss", "theft"],
    sx("Sir, urgent news. People are stealing a lot of the country's electricity, and the meter checkers are helping them.",
  ...
  ax("Industrial Gas Board", "fixer", ["gas", "tariff", "industry"],
    sx("Sir, forgive me — Rich factory owners pay almost nothing for their gas. You can make them pay full price, but they will be angry.",
  ...
  ax("Hilsa Fishery Officer", "people", ["fishery", "hilsa", "ban"],
    sx("A word, sir! The country's favorite fish are almost all gone. You need to stop people from fishing for two months so the babies can grow, but the fishers will be hungry.",
  ...
  ax("Bhola Gas Survey Lead", "official", ["gas", "onshore", "exploration"],
    sx("Sir, we have a problem. There is gas under a beautiful nature island. Big companies want to dig it up fast, but it might ruin the island.",
  ...
  ax("Heavy Minerals Concessionaire", "fixer", ["minerals", "sand", "coast"],
    sx("Sir! A company will pay you to dig up the beautiful tourist beaches to find rare rocks. It will ruin the beach for turtles and tourists.",
  ...
  ax("Urea Plant Manager", "official", ["fertiliser", "gas-allocation", "agriculture"],
    sx("Mr. Prime Minister, sir! You only have enough gas to make plant food for farmers OR to keep the lights on in the city. You must choose one.",
  ...
  ax("Irrigation Power Officer", "official", ["irrigation", "subsidy", "groundwater"],
    sx("Your Excellency! Farmers get nearly free electricity to pump water, but they are wasting the water and costing you money.",
  ...
  ax("Waste-to-Energy Promoter", "official", ["waste", "incineration", "power"],
    sx("Prime Minister! A company wants to burn the city's trash to make power, but the smoke is bad and it takes jobs from poor trash-sorters.",
  ...
  ax("Rooppur Waste Officer", "official", ["nuclear", "waste", "rooppur"],
    sx("Sir — Your new power plant makes dangerous, glowing trash. Russia will take it away if you pay them, or you can try to store it safely yourself.",
  ...
  ax("Tea Estate Labour Commissioner", "people", ["tea", "labour", "wages"],
    sx("Honourable leader! The poor people who pick tea leaves want to be paid a fair amount. The rich owners say paying more will ruin their business.",
  ...
  ax("EV Transition Lead", "official", ["ev", "transport", "grid"],
    sx("Sir, urgent news. Many people are driving electric bikes, which saves gas but breaks the electric grid because it can't handle them all.",
  ...
  ax("Forest Conservator", "official", ["forest", "logging", "sundarbans"],
    sx("Sir, forgive me — Bad gangs are chopping down the protected forests to sell the wood. You need to give park rangers guns to stop them.",
  ...
  ax("Household Gas Connection Board", "people", ["gas", "household", "moratorium"],
    sx("A word, sir! There isn't enough gas for new homes, but angry people are demanding it because they already paid bribes to get it.",
  ...
  ax("Renewables Target Auditor", "official", ["renewables", "targets", "credibility"],
    sx("Sir, we have a problem. You promised the world you would use clean energy, but you lied and didn't build any.",
  ...
  ax("Stone Quarry Inspector", "official", ["quarry", "stone", "rivers"],
    sx("Sir! People are illegally breaking stones from the rivers, destroying nature, to build cities.",
  ...
  ax("Cross-Border Power Renegotiator", "official", ["import-power", "tariff", "india"],
    sx("Mr. Prime Minister, sir! The price of electricity you buy from a neighbor has gotten crazy high because of a bad contract.",
  ...
  ax("Coastal Salinity Officer", "people", ["salinity", "agriculture", "shrimp"],
    sx("Your Excellency! Shrimp farms make a lot of money, but the salty water they use is destroying the land where poor farmers grow rice.",
  ...
  ax("Atomic Energy Chairman", "official", ["nuclear", "rooppur", "debt"],
    sx("Prime Minister! Your big power plant from Russia is almost ready, but the rest of the world says you shouldn't work with Russia right now.",
  ...
  ax("Mining Concession Director", "official", ["coal", "phulbari", "displacement"],
    sx("Sir — A big company wants to dig a massive hole to find coal. It will ruin the water for farmers and make people very angry.",
  ...
  ax("Distribution Utility Chief", "official", ["electricity", "theft", "losses"],
    sx("Honourable leader! People are stealing electricity. You can force everyone to use prepaid cards to stop it, but poor people will struggle.",
  ...
  ax("Energy Regulator", "official", ["tariff", "subsidy", "cost"],
    sx("Sir, urgent news. Gas is too expensive. You have to raise the price of electricity for your people, or the government will run out of money.",
  ...
  ax("Petrobangla Chairman", "official", ["lng", "import", "dependence"],
    sx("Sir, forgive me — You can buy a giant floating gas tank from other countries to keep the lights on, but the price might jump wildly.",
  ...
  ax("Bapex Managing Director", "official", ["exploration", "gas", "sovereignty"],
    sx("A word, sir! Your own workers say they can find gas for cheap. Or you can hire foreign companies, who are faster but keep most of the money.",
  ...
  ax("Irrigation Authority Head", "official", ["groundwater", "irrigation", "drought"],
    sx("Sir, we have a problem. Farmers are pumping too much water out of the ground to grow rice. Soon the land will turn into a desert.",
  ...
  ax("Environment Inspector", "official", ["tanneries", "pollution", "leather"],
    sx("Sir! Leather factories are dumping poison chemicals right into the river because they didn't finish building their cleaner.",
  ...
  ax("Ports Development Chairman", "official", ["port", "infrastructure", "debt"],
    sx("Mr. Prime Minister, sir! Big countries want to build a deep ocean dock for you, but they will want to control you if they do.",
  ...
  ax("District Mineral Officer", "official", ["quarrying", "stone", "rivers"],
    sx("Your Excellency! People are illegally breaking stones from the hillsides to build cities. It destroys nature and kills workers when rocks fall.",
  ...
  ax("Fisheries Director", "people", ["hilsa", "fishing", "livelihoods"],
    sx("Prime Minister! You have to ban fishing while the fish have babies, but this means poor fishing families will have no food for weeks.",
  ...
  ax("Renewable Energy Adviser", "official", ["solar", "net-metering", "transition"],
    sx("Sir — You can let people put solar panels on their roofs and sell extra power back to the government. Power companies hate this.",
  ...
  ax("Grid Interconnection Officer", "ambassador", ["grid", "import", "regional"],
    sx("Honourable leader! You can buy cheap, clean power from a neighbor, but they could shut your lights off easily if they get mad at you.",
  ...
  ax("Agriculture Minister", "official", ["fertilizer", "gas", "food"],
    sx("Sir, urgent news. You only have enough gas to make plant food for the farms OR to keep the city's power on.",
  ...
  ax("Power Cell Director", "fixer", ["capacity-charge", "indemnity", "rentals"],
    sx("Sir, forgive me — There is a bad rule that lets you give big contracts to your rich friends without checking if it's a fair price.",
  ...
  ax("Environment Inspector", "people", ["brick-kilns", "topsoil", "air"],
    sx("A word, sir! Dirty brick factories are making the city air poisonous. You can shut them down, but thousands of poor workers will lose their jobs.",
  ...
  ax("Coast Guard Commander", "general", ["fishing", "trawlers", "maritime"],
    sx("Sir, we have a problem. Giant ships from other countries are stealing all the fish from your ocean.",
  ...
  ax("Coal Import Coordinator", "official", ["coal", "import", "logistics"],
    sx("Prime Minister! Your power plants need dirty coal to run. You can build a giant dock just for coal, which means you'll be stuck using dirty coal for years.",
  ...
  ax("WASA Managing Director", "people", ["water", "dhaka", "pollution"],
    sx("Sir — The city's water is so dirty everyone has to boil it before drinking. Fixing the pipes will cost a huge amount of money.",
  ...
  ax("Petrobangla Chairman", "official", ["gas", "blowout", "compensation"],
    sx("Honourable leader! A foreign company's gas well blew up, burning a forest and lots of gas. They offer a tiny bit of money and say it's not their fault.",
  ...
  ax("Energy Secretary", "people", ["gas", "households", "rationing"],
    sx("Sir, urgent news. Gas is running out, so you stopped giving gas pipes to new homes. Millions of angry people are waiting.",
  ...
  ax("Bridges Authority Chairman", "official", ["infrastructure", "toll", "debt"],
    sx("Sir, forgive me — A cool new river tunnel was built with borrowed money, but hardly anyone drives through it.",
  ...
  ax("Transport Electrification Adviser", "official", ["ev", "transport", "imports"],
    sx("A word, sir! Buying gas from other countries costs too much money. You can help people buy electric cars instead, but it will upset the gas stations and use a lot of electricity.",
  ...
  ax("Renewable Energy Adviser", "official", ["wind", "coast", "renewables"],
    sx("Sir, we have a problem. A foreign company wants to build giant windmills on the beach for clean power. But this will take up the land where fishermen and farmers work.",
  ...
  ax("Land Reform Commissioner", "people", ["char-land", "landless", "grabbing"],
    sx("Sir! New mud islands just popped up in the river, and they belong to the government.",
  ...
  ax("Wetlands Director", "relief", ["haor", "wetland", "flash-flood"],
    sx("Mr. Prime Minister, sir! Farmers are building walls in the big wetlands to grow more food. But the walls destroy nature and hurt the birds and fish.",
  ...
  ax("Tourism Board Chair", "official", ["coral", "tourism", "island"],
    sx("Your Excellency! Your beautiful coral island is being ruined by too many tourists and their trash.",
  ...
  ax("Environment Secretary", "official", ["plastic", "pollution", "ban"],
    sx("Prime Minister! Plastic trash is clogging up all the rivers and making the city flood. A helper wants to ban plastic bags completely, but plastic makers will be very angry.",
  ...
  ax("Geological Survey Director", "official", ["minerals", "sands", "mining"],
    sx("Sir — The beaches have special sand that a company wants to dig up for money. But digging it up will destroy the beach and the turtle nests.",
  ...
  ax("Water Development Chief", "people", ["embankment", "polder", "flood"],
    sx("Honourable leader! The walls holding the ocean back are old and breaking. A big storm could drown everyone.",
  ...
  ax("Industries Secretary", "official", ["cement", "limestone", "import"],
    sx("Sir, urgent news. Builders are buying rocks from other countries. You can blast your own hills to get rocks instead, but those hills are sacred to native people.",
  ...
  ax("Fisheries Director", "doctor", ["aquaculture", "antibiotics", "exports"],
    sx("Sir, forgive me — Fish farmers are giving their fish illegal medicine. Other countries won't buy the fish if they find out.",
  ...
  ax("Water Development Chief", "official", ["dredging", "rivers", "navigation"],
    sx("A word, sir! The rivers are full of mud and big boats are getting stuck. You can dig the mud out fast and dump it anywhere, or do it carefully so it doesn't hurt the fish.",
  ...
  ax("Petrobangla Chairman", "ambassador", ["offshore", "gas", "bidding"],
    sx("Sir, we have a problem. Big companies want to dig for gas deep in your ocean. They want an easy deal where they keep most of the money.",
  ...
  ax("Commerce Secretary", "people", ["salt", "farmers", "import"],
    sx("Sir! The price of salt is too low, and your poor salt farmers are going broke. Other countries sell it even cheaper.",
  ...
  ax("Forest Conservator", "official", ["forest", "plantation", "biodiversity"],
    sx("Mr. Prime Minister, sir! You need to plant more trees. You can plant cheap, fast-growing trees that hurt the soil, or slow, natural trees that help animals.",
  ...
  ax("Petrobangla Chairman", "official", ["gas", "discovery", "windfall"],
    sx("Your Excellency! You found a lot of extra gas under the ground. Use it all up fast so things are cheap right now, or save it for the future?",
  ...
  ax("Power Development Chairman", "official", ["coal", "sundarbans", "expansion"],
    sx("Prime Minister! The dirty power plant next to the beautiful forest wants to build a second, bigger plant right next to it. Scientists say this is a terrible idea.",
  ...
  ax("Irrigation Authority Head", "people", ["irrigation", "water", "metering"],
    sx("Honourable leader! Farmers pump water for free, but they waste a lot. You can make them pay for it using prepaid cards, but they might go broke if it's a bad year.",
  ...
  ax("Labour Inspector", "doctor", ["ship-breaking", "safety", "workers"],
    sx("Sir, urgent news. The places where men take apart old ships are deadly. People get hurt or die. Bosses say making it safe costs too much money.",
  ...
  ax("Water Development Chief", "official", ["rivers", "canal", "mega-project"],
    sx("Sir, forgive me — Engineers want to dig a giant ditch to move water from wet places to dry places. It costs a fortune and might ruin the rivers.",
    ...
    sx("A word, sir! The giant ditch is taking too much water. The wet places are now drying out, and angry people want you to turn the water down.",
    ...
    sx("Sir, we have a problem. The builders of the ditch are mad because you slowed them down. They threaten to quit unless you pay them all the money anyway.",
  ...
  ax("Grid Operations Chief", "official", ["grid", "blackout", "resilience"],
    sx("Sir! The country's power wires are so weak that one mistake could turn off the lights for everyone at once. Fixing it costs a ton of money.",
  ...
  ax("Rural Electrification Chief", "people", ["solar", "off-grid", "rural"],
    sx("Mr. Prime Minister, sir! Faraway villages don't have electricity. You can give them small solar panels now, or make them wait years for big power lines to be built.",
  ...
  ax("Power Transition Adviser", "people", ["coal", "retirement", "workers"],
    sx("Your Excellency! People want you to shut down old, dirty coal plants early to clean the air. But shutting them down will leave thousands of workers without jobs.",
  ...
  ax("Energy Security Director", "official", ["fuel", "reserve", "resilience"],
    sx("Prime Minister! The country only has enough gas for a few days if there is an emergency. Building a giant tank to save extra gas costs a lot.",
  ...
  ax("Energy Access Director", "people", ["lpg", "cooking", "health"],
    sx("Sir — People in villages cook over smoky fires that hurt their lungs and chop down too many trees. You can pay to help them buy clean cooking gas.",
  ...
  ax("Energy Diplomacy Director", "ambassador", ["pipeline", "gas", "dependence"],
    sx("Honourable leader! You can share a big gas pipe with a neighbor for cheap energy. But if you get in a fight, they could turn off your gas.",
  ...
  ax("Atomic Energy Chairman", "official", ["nuclear", "waste", "safety"],
    sx("Sir, urgent news. The nuclear plant will make dangerous glowing trash. You can spend money to build a safe hiding spot, or trust the builders who pinky-promised to take it back later.",
  ...
  ax("Power Regulator", "official", ["captive-power", "industry", "grid"],
    sx("Sir, forgive me — Big factories are building their own private power plants because the city's power breaks too much. This makes the city's power even worse for normal people.",
  ...
  ax("Agriculture Research Director", "doctor", ["gm-crops", "seeds", "farmers"],
    sx("A word, sir! Scientists made special seeds that bugs won't eat. It helps grow more food, but people are scared it's unnatural and gives too much power to the seed company.",
  ...
  ax("Coastal Afforestation Chief", "relief", ["mangroves", "greenbelt", "cyclone"],
    sx("Sir, we have a problem. Planting a wall of trees by the ocean will stop big waves from killing people during storms. But rich guys want that land for shrimp farms.",
  ...
  ax("Forest Conservator", "shadow", ["forest", "encroachment", "powerful"],
    sx("Sir! Powerful people are sneaking into the protected forest and building hotels. You can kick them out, or pretend you didn't see.",
  ...
  ax("Renewable Energy Adviser", "official", ["solar", "floating", "land"],
    sx("Mr. Prime Minister, sir! You can force big factories to put solar panels on their roofs and over canals to make clean power. The factory bosses will complain about the cost.",
  ...
  ax("Mining Bureau Director", "fixer", ["hard-rock", "mining", "contracts"],
    sx("Your Excellency! The only rock mine in the country loses money because of a bad contract with a foreign company. If you change it, the rich middlemen will be angry.",
  ...
  ax("Fertilizer Supply Director", "official", ["fertilizer", "phosphate", "import"],
    sx("Prime Minister! Farmers need plant food from other countries. You can sign a long, expensive contract to be safe, or just buy it when you need it and hope the price is low.",
  ...
  ax("Energy Access Director", "people", ["cookstoves", "health", "forests"],
    sx("Sir — You can give village moms special new stoves that don't make deadly smoke. But they cost money and people are used to their old smoky fires.",
  ...
  ax("Power Cell Director", "fixer", ["ipp", "contracts", "renegotiation"],
    sx("Honourable leader! The government pays crazy high prices for power from factories owned by your friends. You can force them to lower the prices, but they will be mad.",
  ...
  ax("Water Supply Director", "official", ["water", "surface", "groundwater"],
    sx("Sir, urgent news. The city is drinking all the underground water. You can build a giant system to clean river water instead, but it costs a lot and the rivers are gross.",
  ...
  ax("Livestock Development Director", "people", ["dairy", "livestock", "imports"],
    sx("Sir, forgive me — You buy almost all your milk powder from other countries. You can spend a lot of money to help your own farmers make milk, or just keep buying it cheap from away.",
  ...
  ax("Water Development Officer", "people", ["ponds", "canals", "irrigation"],
    sx("A word, sir! The old village ponds are full of mud. You can pay people to dig them out so fish can live there again, but local bosses might steal some of the money.",
  ...
  ax("Agriculture Research Director", "people", ["seeds", "monopoly", "sovereignty"],
    sx("Sir, we have a problem. A few companies sell seeds that farmers have to buy brand new every year. You can help farmers save their own seeds, but the seed companies will be angry.",
  ...
  ax("Petroleum Refining Director", "official", ["refinery", "fuel", "self-reliance"],
    sx("Sir! The country's lone, ancient oil refinery meets a fraction of fuel demand, so most fuel is imported already-refined at a premium. Build a costly second refinery for self-reliance, or keep importing refined product and skip the capital?",
  ...
  ax("Water Resources Officer", "people", ["recharge", "rainwater", "aquifer"],
    sx("Mr. Prime Minister, sir! As aquifers fall, a programme of managed recharge — capturing monsoon rain to refill the groundwater — could slow the decline. The officer wants mandatory rainwater harvesting and recharge structures; it is cheap per site but vast in scale and easy to neglect.",
  ...
  ax("Agriculture Policy Director", "people", ["crops", "diversification", "water"],
    sx("Your Excellency! The obsession with thirsty rice drains the aquifers and leaves diets and incomes undiversified. The director wants incentives to shift toward less-thirsty, higher-value crops — pulses, oilseeds, vegetables — against the grain of habit and rice-first policy.",
  ...
  ax("Marine Conservation Officer", "relief", ["turtles", "marine", "tourism"],
    sx("Prime Minister! The coast's sea-turtle nesting beaches are being lost to lights, nets, and development. A protected hatchery-and-beach programme would save them and draw eco-tourism, at the cost of restricting the fishing and building the coastal economy leans on.",
  ...
  ax("Grid Modernisation Director", "official", ["storage", "battery", "renewables"],
    sx("Sir — Solar and wind are useless after dark and in calm without storage, and the grid cannot absorb them. Invest in a costly grid-scale battery programme to make renewables dispatchable, or keep leaning on fossil plants for reliable power?",
  ...
  ax("Gas Distribution Chief", "shadow", ["gas", "system-loss", "theft"],
    sx("Honourable leader! A fifth of the piped gas vanishes through illegal connections, tampered meters, and bribed staff, much of it serving captive industrial and elite users. Mount a hard anti-theft drive that hits connected beneficiaries, or keep absorbing the loss?",
  ...
  ax("Forest Department Chief", "people", ["forestry", "communities", "livelihoods"],
    sx("Sir, urgent news. A social-forestry scheme would let poor villagers grow and harvest trees on degraded state land — income for them, green cover for the country — but done carelessly it becomes a backdoor to clear-felling and grabbing the very forest it should grow. How do you design it?",
  ...
  ax("Renewable Research Director", "official", ["tidal", "pilot", "innovation"],
    sx("Sir, forgive me — The strong tidal range of the estuaries could, in theory, drive tidal power — a clean, novel source. A pilot would be a costly, unproven gamble on innovation; the safe path is to stick with proven solar and wind and let others pioneer the tides.",
  ...
  ax("Agriculture Policy Director", "people", ["edible-oil", "oilseed", "imports"],
    sx("A word, sir! The country imports almost all its cooking oil, draining dollars and leaving prices hostage to world markets. A push for domestic mustard, sunflower, and soy oilseed would build self-reliance — slow, and competing for the scarce land that grows food grains.",
  ...
  ax("Sugar Corporation Chief", "people", ["sugar-mills", "soe", "farmers"],
    sx("Sir, we have a problem. The state sugar mills lose money every year on obsolete machinery and graft, but tens of thousands of cane farmers and mill workers depend on them. Shut or privatise the worst to stem the losses, or pour in another bailout and modernisation gamble?",
  ...
  ax("Grid Expansion Director", "people", ["transmission", "land", "evacuation"],
    sx("Prime Minister! New power plants sit idle for want of transmission lines, and the lines are stalled by land disputes and farmers refusing the towers across their fields. Force the right-of-way through with compulsory acquisition, or negotiate slow and fair?",
  ...
  ax("Plantation Affairs Officer", "fixer", ["tea", "forest", "expansion"],
    sx("Sir — Tea companies want to expand their estates into adjoining reserve forest and indigenous land — more export tea, at the cost of felled forest and displaced hill communities. Grant the leases, or protect the forest and the people on it?",
  ...
  ax("Irrigation Technology Director", "people", ["solar-pumps", "irrigation", "diesel"],
    sx("Honourable leader! Replacing the diesel and grid pumps that irrigate the fields with solar ones would slash the fuel bill and emissions and free farmers from fuel-price shocks — a large upfront cost, against the cheap, familiar diesel status quo.",
  ...
  ax("Coastal Fisheries Officer", "people", ["dried-fish", "pesticides", "exports"],
    sx("Sir, urgent news. The dried-fish trade — a coastal staple and growing export — is rife with illegal pesticide use to keep flies off the racks, poisoning consumers and threatening the export market. The officer wants enforcement and clean drying tech; the traders resist the cost.",
  ...
  ax("Geological Survey Director", "official", ["minerals", "survey", "sovereignty"],
    sx("Sir, forgive me — A thorough national mineral survey could reveal coal, gas, hard rock, and rare minerals worth fortunes — knowledge that is power, and a magnet for foreign extractors and the conflicts that follow discovery. Survey aggressively, or tread lightly?",
  ...
  ax("Coastal Afforestation Officer", "relief", ["char", "afforestation", "land"],
    sx("A word, sir! Planting forests on the new coastal chars would stabilise the silt islands, buffer storms, and eventually create land for the landless — slow, unglamorous work, easily neglected against the rush to hand the chars to shrimp farms and grabbers.",
  ...
  ax("Land Reform Commissioner", "people", ["land-ceiling", "landless", "elite"],
    sx("Sir, we have a problem. Land-ceiling laws meant to cap how much one family can own are flouted wholesale through benami holdings, while millions are landless. The commissioner wants real enforcement and redistribution of the surplus; the great landholders, many connected, will fight hard.",
  ...
  ax("Farm Mechanisation Director", "people", ["mechanisation", "labour", "yields"],
    sx("Sir! Mechanising the farms — harvesters, tillers, transplanters — would raise yields and ease the brutal labour as workers leave for the cities. But it would also throw landless farm labourers, who have nothing else, out of their only work. How hard do you push?",
  ...
  ax("Industrial Waste Officer", "official", ["recycling", "used-oil", "pollution"],
    sx("Mr. Prime Minister, sir! Used engine oil and scrap tyres are dumped or burned in toxic backyard operations that poison soil and air. A formal recycling and pyrolysis industry could turn the waste to value cleanly — at a cost the informal burners will resist.",
  ...
  ax("Energy Regulator", "official", ["feed-in-tariff", "solar", "investment"],
    sx("Your Excellency! A generous feed-in tariff guaranteeing a good price for renewable power fed to the grid would unleash private solar and wind investment — at a cost locked in for years that the utility, and ultimately the consumer, must bear. How generous do you set it?",
  ...
  ax("Maritime Resources Envoy", "ambassador", ["continental-shelf", "seabed", "claim"],
    sx("Prime Minister! With the maritime boundary settled, you can press an extended continental-shelf claim to the seabed beyond — a potential bonanza of gas and minerals, and a costly, years-long legal and survey effort that may antagonise neighbours with overlapping claims.",
  ...
  ax("Forest Tourism Officer", "fixer", ["eco-park", "tourism", "conservation"],
    sx("Sir — A grand safari park and eco-resort carved out of a forest reserve would draw tourists and revenue — and fragment the habitat, cage wildlife for show, and hand prime forest to resort developers. Build the attraction, or protect the reserve intact?",
  ...
  ax("Biofuel Policy Officer", "official", ["biofuel", "ethanol", "food"],
    sx("Honourable leader! Molasses from the sugar mills could be turned into ethanol to blend with petrol, cutting fuel imports and using a waste stream — or that same feedstock could feed the food and drink industries. Mandate biofuel blending?",
  ...
  ax("Power Planning Director", "official", ["pumped-storage", "hydro", "storage"],
    sx("Sir, urgent news. With little room for big dams, the engineers propose a pumped-storage scheme in the hills — a giant battery using water and gravity to store surplus power. It is costly, geologically risky, and would flood a hill valley, displacing its communities.",
  ...
  ax("Food Fortification Officer", "doctor", ["salt", "iodine", "health"],
    sx("Sir, forgive me — Iodine deficiency still stunts minds in the regions where un-iodised salt slips through, and enforcement of universal salt iodisation is lax. The officer wants a hard enforcement drive; the small, scattered salt producers resist the cost and oversight.",
  ...
  ax("Food Storage Director", "official", ["grain", "silos", "food-security"],
    sx("A word, sir! The country's grain reserve rots in damp, rat-infested warehouses, losing a fortune and leaving the buffer unreliable in a crisis. The director wants modern steel silos; the capital is large and the warehouse rackets that profit from the chaos resist.",
  ...
  ax("Livestock Health Director", "doctor", ["poultry", "bird-flu", "biosecurity"],
    sx("Sir, we have a problem. The booming poultry industry — cheap protein for millions — is a tinderbox for bird flu, with poor biosecurity and culling-compensation too stingy to stop farmers hiding outbreaks. The director wants real biosecurity and fair compensation; it is costly.",
  ...
  ax("Land Reform Officer", "people", ["sharecroppers", "tenancy", "rights"],
    sx("Sir! Millions of sharecroppers till others' land for a punishing share of the crop, with no security and no recourse when a landlord evicts them at whim. The officer wants enforceable tenancy rights and a fairer share; the landlord class resists fiercely.",
  ...
  ax("Energy Efficiency Director", "official", ["efficiency", "standards", "demand"],
    sx("Mr. Prime Minister, sir! The cheapest power is the power not used, and mandatory energy-efficiency standards for buildings, motors, and appliances would cut demand more cheaply than any new plant. The director wants hard standards; manufacturers and developers resist the cost.",
  ...
  ax("Marine Fisheries Director", "official", ["deep-sea", "fleet", "sovereignty"],
    sx("Your Excellency! Your fishers work only the crowded coastal waters while the rich deep-sea zone of your own maritime territory is fished by licensed foreign trawlers. The director wants a national deep-sea fleet to claim that catch; it is costly and the fishers lack the vessels and skills.",
  ...
  ax("Agriculture Export Director", "people", ["horticulture", "fruit", "exports"],
    sx("Prime Minister! The country's mangoes, jackfruit, and vegetables could earn real export money, but they rot for want of cold chain, fail foreign pesticide tests, and lack branding. Invest in a costly push for export-grade horticulture, or keep them a domestic crop?",
  ...
  ax("Aquaculture Director", "doctor", ["shrimp", "disease", "hatchery"],
    sx("Honourable leader! Disease keeps wiping out the shrimp farms — a major export — because the hatcheries sell weak, virus-laden post-larvae and farmers lack any quality control. The director wants certified disease-free hatcheries and training; the cheap-PL hatchery trade resists.",
  ...
  ax("Urban Energy Officer", "official", ["cooling", "efficiency", "demand"],
    sx("Sir, urgent news. Air-conditioning is exploding with the heat and the middle class, spiking peak demand and grid strain. A district-cooling and efficiency push could blunt it; the developers and the AC-importing lobby prefer the cheap, wasteful status quo.",
  ...
  ax("Water Development Engineer", "official", ["river-training", "erosion", "megaproject"],
    sx("Sir, forgive me — A vast river-training scheme could tame the great river's wandering, stop the erosion swallowing districts, and reclaim land — a mega-project of guide bunds and revetments, hugely costly, technically fraught, and a magnet for contractor padding.",
  ...
  ax("Food Standards Director", "people", ["organic", "certification", "exports"],
    sx("A word, sir! A credible safe-food and organic certification scheme would let farmers earn premiums and reassure consumers poisoned by adulteration — a costly system to build and police, easily faked into a meaningless sticker if done on the cheap.",
  ...
  ax("Utility Modernisation Director", "people", ["smart-meters", "billing", "losses"],
    sx("Sir, we have a problem. Smart meters would end the bribed meter-readers, estimated bills, and theft that plague the utilities — and let you bill accurately and cut losses. They are costly to roll out, and consumers fear higher, harder-to-dodge bills.",
  ...
  ax("Biodiversity Resources Officer", "doctor", ["medicinal-plants", "biopiracy", "communities"],
    sx("Sir! The country's forests hold medicinal plants and genetic resources that foreign firms quietly harvest and patent — biopiracy of a heritage worth fortunes. The officer wants a benefit-sharing and protection regime; it is complex and could deter research investment too.",
  ...
  ax("Inland Fisheries Director", "people", ["fisheries", "co-management", "commons"],
    sx("Mr. Prime Minister, sir! The open-water fisheries — the beels and floodplains feeding millions — are being plundered by leaseholders and gear that wipe out the stocks. The director wants community co-management handing the waters to the fishers; the connected leaseholders resist.",
  ...
  ax("Renewable Energy Officer", "people", ["biogas", "waste", "rural"],
    sx("Your Excellency! Rural cattle dung and farm waste could fuel village-scale biogas plants — clean cooking gas and fertiliser slurry from waste — cutting woodsmoke and firewood demand. The officer wants a national biogas push; uptake has always stalled on cost and habit.",
  ...
  ax("Livestock Feed Director", "people", ["feed", "import", "livestock"],
    sx("Prime Minister! Livestock and dairy are throttled by costly imported feed, and the maize and fodder to grow it at home compete for land with food grains. The director wants a feed-crop push to cut the import bill; the land is scarce and the food-first lobby resists.",
  ...
  ax("Petroleum Resources Officer", "shadow", ["condensate", "refining", "graft"],
    sx("Sir — Condensate — a valuable liquid byproduct of gas extraction — is being siphoned to private 'fractionation' plants owned by connected operators at giveaway prices, robbing the state. Reclaim and properly auction it, or leave the cosy arrangement?",
  ...
  ax("Climate Agriculture Officer", "relief", ["floating-agriculture", "wetlands", "adaptation"],
    sx("Honourable leader! In the flood-prone wetlands, the old craft of floating gardens — crops grown on rafts of water hyacinth — could feed communities as the waters rise. The officer wants to revive and scale it as climate adaptation; it is labour-intensive and unfamiliar to most.",
  ...
  ax("Irrigation Efficiency Director", "people", ["drip", "irrigation", "water"],
    sx("Sir, urgent news. The flood-irrigation that waters the fields wastes most of the water it draws, draining the aquifers faster than need demands. Drip and sprinkler systems would slash that waste; they are costly upfront, and water and power are cheap enough that few farmers bother.",
  ...
  ax("Industrial Energy Officer", "official", ["industry", "efficiency", "cogeneration"],
    sx("Sir, forgive me — Factories waste vast energy through old motors, leaky steam, and dumped waste-heat. Mandating energy audits and cogeneration would cut industry's energy bill and the grid's load; the manufacturers resist the audits and the retrofit cost.",
  ...
  ax("Fisheries Infrastructure Officer", "people", ["fish-landing", "ice", "waste"],
    sx("A word, sir! A huge share of the marine catch spoils for want of ice, landing centres, and cold storage at the coast, beggaring fishers and wasting protein. The director wants a coastal cold-chain and landing-centre build; the capital is large and the gain spread thin.",
  ...
  ax("Mineral Resources Officer", "official", ["granite", "quarrying", "environment"],
    sx("Sir, we have a problem. A granite deposit could supply valuable dimension stone and cut imports, but quarrying it means blasting a forested hill that buffers a watershed and shelters indigenous hamlets. Open the quarry, or leave the hill standing?",
  ...
  ax("Grid Demand Manager", "official", ["demand", "peak", "tariff"],
    sx("Sir! Peak evening demand strains the grid to breaking, forcing costly, dirty peaker plants to fire up. Time-of-use tariffs and demand-management could shave the peak cheaply; consumers resent paying more at peak hours and the populist instinct is one flat, low price.",
  ...
  ax("Commerce Resources Officer", "people", ["palm-oil", "import", "health"],
    sx("Mr. Prime Minister, sir! Cheap imported palm oil dominates the cooking-oil market — affordable, but linked to poorer health and to rainforest destruction your imports fund. Tax and curb it in favour of domestic, healthier oils, or keep the cheap staple flowing?",
  ...
  ax("Energy Planning Chairman", "official", ["energy-mix", "strategy", "future"],
    sx("Your Excellency! The decades-long power master plan must be set, and the chairman lays out the fork: double down on cheap, reliable imported coal and LNG for the growth the economy demands, or stake the future on a costlier, slower pivot to renewables?",
    ...
    sx("Prime Minister! Years into the plan you chose, the bills are coming due — fuel-price shocks battering the fossil bet, or intermittency and cost straining the green one. Stay the course, or hedge with a costly mid-stream correction?",
    ...
    sx("Sir — The energy strategy has become a political symbol — the opposition hammers every blackout or price rise as proof of your folly, while your base defends the plan as visionary. Defend it loudly, or quietly let the next plan correct it?",
