...
export const UN = [
  ...
  ax("India's High Commissioner", "ambassador", ["water", "india", "teesta"],
    sx("The High Commissioner is all warmth, no commitment. \"The Teesta treaty is so close — Delhi just needs another season.\" It is the seventh season, and your northern farmers watch the river run dry.",
    ...
    sx("With the treaty stalled, Beijing offers to fund and dredge the entire Teesta basin — a billion-dollar project on India's doorstep. Delhi calls it a red line; your engineers call it the only plan on the table.",
    ...
    sx("Both giants now demand a choice. The American envoy adds his: \"Distance yourself from Beijing and the GSP and defence partnership are yours.\" Three patrons, one small country, one chair.",
  ...
  ax("UN Refugee Commissioner", "relief", ["rohingya", "myanmar", "refugees"],
    sx("A million Rohingya are packed into the Cox's Bazar camps and the cameras have moved on. The Commissioner is blunt: \"Funding is down forty percent. Feed them, or the camps become something no fence can hold.\"",
    ...
    sx("Myanmar's junta offers a repatriation deal: take back the Rohingya in stages, into 'reception centres' the UN cannot inspect. Beijing brokered it and wants your yes; the refugees are terrified to go.",
    ...
    sx("A camp-based militancy is growing — armed groups recruiting among the stateless. Your generals want a hard security cordon; the aid agencies warn it will collapse humanitarian access entirely.",
  ...
  ax("IMF Mission Chief", "official", ["imf", "subsidies", "reserves"],
    sx("The IMF Mission Chief slides the memorandum across. \"Loan approved — conditional on cutting fuel and power subsidies, raising tariffs, floating the taka. Your reserves cannot hold without us, and you know it.\"",
  ...
  ax("Saudi Labour Attaché", "ambassador", ["migrants", "gulf", "remittances"],
    sx("The Gulf attaché is apologetic but firm: a new 'localisation' policy will deport two hundred thousand of your workers this year. Their remittances are a tenth of what keeps your taka standing.",
  ...
  ax("US Under-Secretary", "ambassador", ["sanctions", "rights", "trade"],
    sx("Washington has sanctioned your elite security battalion over disappearances and 'crossfire' deaths. The Under-Secretary is plain: \"Reform it visibly, or the next list hits your trade preferences and your generals' visas.\"",
  ...
  ax("COP Summit President", "official", ["climate", "loss-damage", "delta"],
    sx("At the climate summit you hold the moral high card: a delta nation drowning for emissions it never produced. Make a loud, confrontational demand for loss-and-damage cash, or take a quiet seat in the 'constructive' bloc?",
  ...
  ax("Border Guard Director-General", "general", ["border", "india", "killings"],
    sx("Another teenager is shot dead at the border fence by the neighbour's force — the fourteenth this year, all 'cattle smugglers'. Your DG wants to retaliate in kind, and the footage is already trending.",
  ...
  ax("Connectivity Negotiator", "official", ["transit", "india", "sovereignty"],
    sx("India wants transit: trucks and goods from its mainland to its landlocked northeast, straight through your territory and ports. The economics are real; the opposition calls it selling the country's spine.",
  ...
  ax("Pakistani Envoy", "ambassador", ["pakistan", "1971", "history"],
    sx("A Pakistani envoy proposes a reset: trade, visas, cricket. But he will not utter 'apology' for 1971, and your war veterans will accept nothing less. \"Let history rest,\" he says. Your fathers' generation cannot.",
  ...
  ax("UN Peace Operations Chief", "official", ["peacekeeping", "scandal", "prestige"],
    sx("Your soldiers are among the world's largest peacekeeping contributors — prestige and hard currency both. Now a misconduct allegation against your contingent in Africa threatens to pull the whole deployment, and the income with it.",
  ...
  ax("Joint Rivers Commissioner", "official", ["farakka", "water", "india"],
    sx("The dry-season flow at the Farakka barrage has been cut again upstream; the southwest is turning saline and the fisheries are dying. The Commissioner offers two roads: a decades-long joint study, or international arbitration that humiliates a neighbour.",
  ...
  ax("Chinese Belt-and-Road Envoy", "ambassador", ["china", "bri", "port"],
    sx("Beijing offers to build and operate a deep-sea port on your coast — a jewel of the Belt and Road. India calls it a pearl in a hostile string; the West warns of debt and naval bases.",
  ...
  ax("Russian Nuclear Delegation", "ambassador", ["russia", "rooppur", "sanctions"],
    sx("Your Russian-built nuclear plant needs a billion-dollar payment Moscow wants in roubles or yuan — but the dollar banking world sanctions exactly such transfers. Pay and risk secondary sanctions; refuse and stall the reactor.",
  ...
  ax("US Indo-Pacific Coordinator", "ambassador", ["usa", "indo-pacific", "quad"],
    sx("Washington wants you inside its Indo-Pacific architecture — naval access, intelligence sharing, a tilt away from Beijing. Saying yes is choosing a side in a cold war on your doorstep.",
  ...
  ax("Rohingya Prosecution Counsel", "official", ["rohingya", "icj", "genocide"],
    sx("The genocide case against the junta grinds on at The Hague, your camps central to it. Pressing hard wins global moral standing but enrages a junta that controls your border and the repatriation you crave.",
  ...
  ax("Refugee Relocation Director", "official", ["rohingya", "bhasan-char", "island"],
    sx("You have built a flood-prone silt island to move a hundred thousand Rohingya off the strained mainland camps. The UN questions its safety; locals near the camps demand the relocation proceed.",
  ...
  ax("Vaccine Diplomacy Envoy", "ambassador", ["health", "vaccines", "india-china"],
    sx("A pandemic surge leaves you short of vaccines. India offers doses but throttles exports when its own crisis bites; China offers a steady supply with strings. Lives hinge on whom you thank.",
  ...
  ax("Indian Citizenship Envoy", "ambassador", ["india", "nrc", "pushback"],
    sx("Across the border, a citizenship register is branding Bengali-speaking Muslims 'infiltrators', with murmurs of pushing them into your territory. The envoy in Delhi waits on your line.",
  ...
  ax("OIC Solidarity Delegate", "cleric", ["oic", "islamic-bloc", "rights"],
    sx("As the West sanctions your security forces, the Islamic bloc offers solidarity, investment, and cover at the UN — in exchange for louder alignment on their causes and quieter talk of pluralism.",
  ...
  ax("Maritime Boundary Commissioner", "official", ["bay-of-bengal", "blue-economy", "maritime"],
    sx("Your hard-won sea territory holds gas, fish, and shipping lanes, but the 'blue economy' means surveys near contested waters and partnerships with powers your neighbours distrust.",
  ...
  ax("Diaspora Affairs Minister", "people", ["diaspora", "remittances", "votes"],
    sx("Ten million citizens abroad send home the dollars that keep you solvent — and want a say: voting rights, dual citizenship. Granting it courts a powerful constituency you cannot fully control.",
  ...
  ax("Surveillance Tech Vendor", "shadow", ["china", "safe-city", "surveillance"],
    sx("A Chinese firm offers a 'Safe City' package — cameras, facial recognition, a command centre — wiring your capital into a single all-seeing grid run on their software.",
  ...
  ax("Climate Migration Envoy", "official", ["climate", "migration", "recognition"],
    sx("At the climate talks you can champion legal recognition for 'climate refugees' — millions your delta will produce — pressing the rich world to share the burden, but admitting your own coming displacement.",
  ...
  ax("Regional Debt Watcher", "official", ["regional", "default", "contagion"],
    sx("A near neighbour has defaulted and another teeters; markets are lumping the whole region together and eyeing your reserves. The watcher wants a loud public separation from the basket cases.",
  ...
  ax("Gulf Labour Reform Attaché", "ambassador", ["migrants", "gulf", "amnesty"],
    sx("A Gulf state offers an amnesty to regularise tens of thousands of your undocumented workers — if you accept stricter, costlier recruitment rules and a cap. Their wages are a pillar of your reserves.",
  ...
  ax("Japanese Megaproject Lead", "ambassador", ["japan", "matarbari", "infrastructure"],
    sx("Tokyo offers patient, low-interest finance for a deep port and industrial belt — clean money, high standards, but slow disbursement and a quiet expectation that you tilt away from Beijing.",
  ...
  ax("UN Rights Council Delegate", "official", ["unhrc", "resolution", "scrutiny"],
    sx("A draft resolution at the Human Rights Council would put your record on disappearances and press freedom under formal monitoring. Lobby allies to bury it, or accept scrutiny and promise reform?",
  ...
  ax("Naval Base Suitor", "general", ["base", "great-power", "sovereignty"],
    sx("Two great powers quietly ask the same thing: a foothold for their navy on your strategic coast — lavish aid for a berth. Granting either makes your shore a chess square in their rivalry.",
  ...
  ax("Hydropower Transit Negotiator", "official", ["nepal", "hydropower", "transit"],
    sx("Nepal and Bhutan have clean hydropower to sell and you need it — but every megawatt must cross India, which controls the wires. A trilateral deal needs Delhi's blessing you cannot take for granted.",
  ...
  ax("Peacekeeping Expansion Officer", "general", ["peacekeeping", "un", "prestige"],
    sx("The UN wants more of your soldiers for a dangerous new mission — prestige, hard currency, and influence, but also flag-draped coffins from a war that is not yours.",
  ...
  ax("Belt-and-Road Negotiator", "ambassador", ["china", "bri", "debt"],
    sx("Beijing offers to finance a glittering raft of mega-projects — bridges, rails, power — on opaque dollar terms, the kind that left a neighbour handing over a port when the bills came due. The steel is real; the catch is later.",
  ...
  ax("Commerce Envoy to Delhi", "ambassador", ["india", "trade", "deficit"],
    sx("The trade gap with India is vast and lopsided — their goods flood in while barriers block yours. The envoy can press hard for market access and risk Delhi's irritation, or keep things smooth and the deficit yawning.",
  ...
  ax("Washington Trade Liaison", "ambassador", ["usa", "gsp", "labour"],
    sx("Washington has suspended your trade preferences over factory safety and union-busting, and will restore them only with real labour reforms — reforms that anger your factory-owner donors but reopen a vital market.",
  ...
  ax("Brussels Trade Envoy", "ambassador", ["eu", "garments", "rights"],
    sx("Your duty-free access to Europe — the garment sector's lifeline — is under review, Brussels citing jailed activists and curbed press freedom. The envoy says a few high-profile releases could save billions in exports.",
  ...
  ax("Strategic Affairs Adviser", "official", ["indo-pacific", "quad", "china"],
    sx("Washington presses you to join its Indo-Pacific framework as a counterweight to China; Beijing warns that signing means choosing sides against it. Your prized non-alignment is getting harder to hold.",
  ...
  ax("Expatriate Welfare Director", "people", ["migrants", "gulf", "kafala"],
    sx("Coffins of your migrant workers arrive from the Gulf by the planeload — heatstroke, 'natural causes', suicides under abusive sponsors. The director wants you to confront the host governments over kafala, risking the markets that send home billions.",
  ...
  ax("Manpower Bureau Chief", "fixer", ["migrants", "recruitment", "syndicate"],
    sx("A cartel of recruiting agencies — with patrons in your own party — gouges would-be migrants with crushing fees and sells them into debt bondage abroad. Break the syndicate and cap fees, or keep the donor-linked racket running?",
  ...
  ax("Refugee Relief Commissioner", "relief", ["rohingya", "bhasan-char", "relocation"],
    sx("To ease the overcrowded mainland camps, you have built a settlement on a raw silt island in the cyclone-prone bay. Press ahead relocating refugees over UN safety objections, or pause until the agencies sign off?",
  ...
  ax("International Law Counsel", "ambassador", ["rohingya", "icj", "justice"],
    sx("The world court is hearing a genocide case against Myanmar over the Rohingya, and you are urged to formally join it. Doing so champions the refugees — and slams the door on the repatriation talks the generals still dangle.",
  ...
  ax("Border Security Commander", "general", ["myanmar", "border", "spillover"],
    sx("Myanmar's civil war is spilling over — mortar shells in your villages, fighters and refugees crossing, a junta that ignores your protests. The commander wants a firm military posture; the diplomats fear provoking a wider clash.",
  ...
  ax("UN Mission Ambassador", "ambassador", ["russia", "ukraine", "vote"],
    sx("A General Assembly vote condemning Russia's invasion is coming. The West wants your condemnation; Moscow — your friend on energy, grain, and the nuclear plant — wants your abstention. The ambassador awaits your instruction.",
  ...
  ax("Energy Procurement Envoy", "fixer", ["russia", "sanctions", "energy"],
    sx("Russia offers oil and fertiliser at a steep discount, payable in rupees or yuan to dodge the dollar sanctions. A lifeline for the reserves — but it risks the wrath of Washington and the banks that clear your trade.",
  ...
  ax("Development Economist", "official", ["ldc", "graduation", "trade"],
    sx("The country is on track to 'graduate' from least-developed status — a point of pride that also strips the trade preferences and cheap-loan access the economy leans on. Embrace the timeline, or seek to delay it?",
  ...
  ax("Central Bank Governor", "official", ["reserves", "swap", "dependence"],
    sx("With reserves dwindling, a giant neighbour offers a large currency swap — a genuine lifeline that also hands them quiet leverage over your finances. The governor needs an answer before the next import bill.",
  ...
  ax("NGO Affairs Director", "official", ["ngos", "foreign-funding", "civil-society"],
    sx("A new law lets you choke foreign funding to the human-rights NGOs that needle you, branding them foreign agents. It silences the critics; the donors and Western capitals call it a death sentence for civil society.",
  ...
  ax("Religious Affairs Envoy", "cleric", ["hajj", "saudi", "pilgrims"],
    sx("Saudi Arabia controls your Hajj quota and hints it could expand it — for a price in alignment on a regional quarrel you would rather avoid. The envoy says more pilgrim slots would delight the faithful at home.",
  ...
  ax("Defence Procurement Chief", "general", ["arms", "china", "alignment"],
    sx("Your military needs submarines, jets, and missiles. China offers a full cheap package on soft loans; the West offers superior kit at a steep price with human-rights strings. The choice sets your alignment for decades.",
  ...
  ax("Foreign Secretary", "ambassador", ["sanctions", "elites", "visas"],
    sx("Washington has slapped visa bans on senior officials and their families over election rigging — hitting the elite where it hurts, in their foreign homes and children's schools. Retaliate, or quietly reform?",
  ...
  ax("Climate Diplomacy Envoy", "ambassador", ["climate", "cop", "leadership"],
    sx("At the climate summit you can lead the vulnerable nations in a fierce demand for loss-and-damage cash from the big emitters — winning moral leadership but antagonising the very powers whose investment you court.",
  ...
  ax("Expatriate Affairs Secretary", "official", ["diaspora", "voting", "remittances"],
    sx("The millions-strong diaspora — who send home the remittances that prop up the economy — demand the right to vote from abroad. They lean against you; enfranchising them is democratic, and electorally risky.",
  ...
  ax("Manpower Bureau Chief", "fixer", ["malaysia", "migrants", "syndicate"],
    sx("Malaysia will reopen to your migrant workers — but only through a closed cartel of favoured agencies that will gouge workers and enrich a few well-connected brokers. Taking the deal as-is restarts the flow fastest.",
  ...
  ax("Camp Security Chief", "shadow", ["rohingya", "militancy", "drugs"],
    sx("The sprawling refugee camps have bred armed gangs, militant cells, and a meth pipeline, with killings now nightly. The chief wants a hard security sweep that punishes the many for the few; the agencies prefer slow community policing.",
  ...
  ax("Health Diplomacy Envoy", "doctor", ["vaccines", "china", "west"],
    sx("In a health emergency, the West hoards its vaccines while China offers millions of doses fast — with the unspoken expectation of gratitude and alignment. The doses save lives now, but tilt you toward Beijing for all to see.",
  ...
  ax("UN Mission Ambassador", "ambassador", ["unsc", "prestige", "campaign"],
    sx("A non-permanent Security Council seat is winnable — a huge prize of prestige — but the campaign costs a fortune in favours, and the seat would force you to take public sides on quarrels you have spent years dodging.",
  ...
  ax("Defence Cooperation Envoy", "general", ["india", "defence", "credit"],
    sx("Delhi offers a billion-dollar defence line of credit to buy Indian-made equipment — cementing the partnership and tying your forces to Indian kit. The envoy notes the gear is mediocre and the strings are real.",
  ...
  ax("Digital Sovereignty Adviser", "official", ["data", "big-tech", "sovereignty"],
    sx("You can force the global tech platforms to store citizens' data on local servers and open it to your agencies — 'digital sovereignty', and a surveillance windfall. The platforms threaten to cut services; the West calls it authoritarian overreach.",
  ...
  ax("Connectivity Negotiator", "ambassador", ["india", "transit", "port"],
    sx("Delhi wants transit rights through your ports and roads to reach its landlocked northeast — a windfall in fees that nationalists call selling strategic access for a pittance. The negotiator needs your terms.",
  ...
  ax("Cyber Security Chief", "shadow", ["cyber", "attack", "attribution"],
    sx("A devastating hack has drained the central bank's reserves through the global payments system, and the trail points to a hostile state. Name and shame the culprit publicly, or pursue quiet recovery and avoid a rupture?",
  ...
  ax("Debt Sustainability Adviser", "official", ["debt", "default", "imf"],
    sx("A neighbour's spectacular debt default has spooked your lenders, who eye your own swelling foreign loans. The adviser urges a pre-emptive belt-tightening and debt audit now — painful and unpopular — versus borrowing on to keep the showpieces rolling.",
  ...
  ax("Regional Affairs Envoy", "ambassador", ["bimstec", "saarc", "leadership"],
    sx("With the old South Asian bloc paralysed by the India–Pakistan freeze, you can throw your weight behind the Bay-of-Bengal grouping instead — claiming regional leadership, but accepting India's framing and sidelining Pakistan.",
  ...
  ax("Trade and Health Envoy", "doctor", ["pharma", "patents", "exports"],
    sx("Your generic-drug industry — a lifeline for cheap medicine across the global south — depends on a patent waiver the rich nations want ended. You can lead the fight to extend it, antagonising the Western pharma giants and their governments.",
  ...
  ax("Foreign Secretary", "ambassador", ["election", "demarche", "legitimacy"],
    sx("A bloc of Western ambassadors has jointly demanded credible elections and warned of 'consequences' for a managed vote. Treat it as intolerable interference and rebuff them, or quietly accept some monitoring to keep relations intact?",
  ...
  ax("River Basin Negotiator", "ambassador", ["teesta", "china", "india"],
    sx("Delhi has stalled the Teesta treaty for years. Now Beijing offers to fund a massive river-management project on the Teesta itself — solving the water problem, and planting China on a river India calls its strategic backyard.",
  ...
  ax("Border Affairs Secretary", "ambassador", ["india", "citizenship", "pushback"],
    sx("India's citizenship drive has branded huge numbers illegal 'Bangladeshis' and is pushing people across the wire into your territory, calling them yours. Accept them quietly, or make a loud international stand?",
  ...
  ax("Maritime Diplomacy Envoy", "ambassador", ["indian-ocean", "small-states", "balance"],
    sx("A small Indian Ocean island nation, squeezed between the same giants you balance, seeks your solidarity in a bloc of small maritime states to resist great-power basing. It builds leverage — and irritates the very powers you also need.",
  ...
  ax("Connectivity Negotiator", "ambassador", ["india", "rail", "integration"],
    sx("A new cross-border rail link would knit your economy to India's and unlock trade — but deepen an integration nationalists fear makes you a satellite. Fast-track the rail diplomacy, or slow-walk it?",
  ...
  ax("Counter-Terror Liaison", "general", ["terrorism", "intelligence", "cooperation"],
    sx("After a deadly attack, Western and Indian agencies offer deep counter-terror cooperation — intelligence, training, kit. Invaluable — but it would let foreign services deep inside your security apparatus and your secrets.",
  ...
  ax("River Basin Negotiator", "ambassador", ["rivers", "india", "treaty"],
    sx("Dozens of rivers cross from India ungoverned by any treaty, leaving you at the mercy of upstream dams. Push for a comprehensive all-rivers framework — ambitious, likely to stall — or pick off one or two winnable deals?",
  ...
  ax("Summit Diplomacy Adviser", "ambassador", ["g20", "outreach", "prestige"],
    sx("You have a coveted invitation to a great-power summit as a guest — a chance to be seen among the world's deciders. The platform is golden, but attending means muting your criticism of the host on a cause you have long championed.",
  ...
  ax("Blue Economy Envoy", "ambassador", ["maritime", "blue-economy", "investment"],
    sx("With the maritime boundary settled, foreign powers compete to fund a 'blue economy' — fishing fleets, seabed survey, offshore wind — each wanting exclusive zones and data rights in return. How widely do you open the waters?",
  ...
  ax("Foreign Secretary", "ambassador", ["pakistan", "1971", "reconciliation"],
    sx("Islamabad seeks to warm relations and revive trade, but the wounds of 1971 are unhealed and it has never apologised for the genocide. Demand the apology as the price of normalisation, or let bygones serve commerce?",
  ...
  ax("Refugee Affairs Secretary", "relief", ["biharis", "stateless", "1971"],
    sx("Generations of stranded Urdu-speaking 'Biharis' still live in squalid camps, neither citizens here nor accepted by Pakistan — a stateless legacy of 1971. Grant them full citizenship and integration, or leave the limbo as it is?",
  ...
  ax("Expatriate Welfare Director", "ambassador", ["gulf", "corruption", "trafficking"],
    sx("A sitting MP of yours has been convicted abroad for human trafficking and jailed in a Gulf state — a humiliation splashed across the world's press. Disown and prosecute him at home, or quietly shield a party colleague?",
  ...
  ax("Migration Affairs Envoy", "relief", ["migrants", "mediterranean", "trafficking"],
    sx("A boat has sunk off Libya with scores of your citizens aboard, lured by traffickers toward Europe and drowned in the dark. Mount a costly campaign against the trafficking pipelines and for safe migration, or issue condolences and move on?",
  ...
  ax("Transboundary Water Envoy", "ambassador", ["china", "brahmaputra", "water"],
    sx("China is building a colossal dam on the upper Brahmaputra, with power to throttle or surge the river that feeds your north. Press Beijing hard for a water-sharing treaty — risking the relationship — or trust to quiet diplomacy?",
  ...
  ax("Tax Treaty Negotiator", "ambassador", ["oecd", "tax", "sovereignty"],
    sx("The rich nations' club wants you to sign onto a global minimum corporate tax that would end the tax-holiday incentives you use to lure investors. Joining wins legitimacy and a slice of multinational tax; staying out keeps your incentive tools.",
  ...
  ax("Cultural Diplomacy Envoy", "ambassador", ["language", "unesco", "soft-power"],
    sx("The country's gift to the world — International Mother Language Day — is a rare soft-power jewel. The envoy proposes a costly global campaign of language institutes to cement it; the finance hawks call it vanity the budget cannot spare.",
  ...
  ax("Labour Diplomacy Officer", "ambassador", ["ilo", "labour", "trade"],
    sx("Western buyers and the labour body press you to ratify core labour conventions — freedom of association, an end to child labour — as the price of market access. The owners who fund you call it surrendering the factory floor.",
  ...
  ax("Climate Diplomacy Envoy", "ambassador", ["climate-migration", "compact", "recognition"],
    sx("As the seas rise, millions here will be displaced. The envoy wants you to lead a global push for legal recognition and resettlement pathways for climate refugees — a moral cause that also admits your own coast is being lost.",
  ...
  ax("Commerce Envoy to Delhi", "ambassador", ["india", "onions", "food-security"],
    sx("India has abruptly banned onion exports again, and prices have quadrupled overnight, igniting public fury. Plead with Delhi for an exemption — owing them a favour — or pivot hard to other suppliers and self-sufficiency?",
  ...
  ax("Security Cooperation Envoy", "general", ["india", "insurgents", "extradition"],
    sx("India accuses you of harbouring separatist insurgents from its northeast and demands you hand them over and raze their camps. Cooperating buys huge goodwill in Delhi — and means doing a neighbour's dirty work and stirring sympathies at home.",
  ...
  ax("Expatriate Welfare Director", "people", ["gulf", "housemaids", "abuse"],
    sx("Reports flood in of housemaids sent to the Gulf returning broken, abused, or in coffins. Suspend female domestic-worker migration until protections improve — losing remittances and angering recruiters — or keep the flow and the suffering?",
  ...
  ax("Manpower Bureau Chief", "ambassador", ["migration", "recruitment-cost", "reform"],
    sx("Workers here pay among the world's highest fees for a foreign job, mortgaging everything to brokers. A 'zero-cost', employer-pays model would free them — and gut the lucrative broker industry tied to your party.",
  ...
  ax("Trade Negotiator", "ambassador", ["wto", "fisheries", "subsidies"],
    sx("A global deal would curb the fishing subsidies that empty the seas — good for your overfished waters and your standing — but limits the support you give your own small fishers. Sign, or defend the carve-out for artisanal fleets?",
  ...
  ax("Space Programme Director", "official", ["satellite", "technology", "prestige"],
    sx("A second communications satellite would project technological prestige and serve broadcasting — but it is enormously costly, of marginal return, and dependent on a foreign launch partner who gains leverage. The director awaits your call.",
  ...
  ax("Refugee Affairs Secretary", "ambassador", ["rohingya", "repatriation", "myanmar"],
    sx("Myanmar agrees to take back a token batch of refugees under conditions guaranteeing neither safety nor citizenship — a hollow gesture that lets you claim progress. The refugees refuse to go. Push the pilot, or hold out for real guarantees?",
  ...
  ax("Multilateral Affairs Envoy", "ambassador", ["non-aligned", "blocs", "positioning"],
    sx("In a polarising world, where do you plant your flag: deepen the old non-aligned blocs as a champion of the global south, or pivot toward the richer Western-led groupings that hold the capital and markets?",
  ...
  ax("Health Diplomacy Envoy", "doctor", ["amr", "health", "global"],
    sx("Rampant antibiotic misuse — in clinics, farms, and pharmacies — makes the country a breeding ground for drug-resistant superbugs. Lead a costly national stewardship drive that wins global credit, or treat it as a distant abstraction?",
  ...
  ax("Religious Affairs Envoy", "cleric", ["saudi", "funding", "ideology"],
    sx("Gulf donors offer lavish funding for mosques and madrasas — and with it a stricter, imported strain of the faith that unsettles the country's gentler traditions. The money and warmth come at an ideological price.",
  ...
  ax("River Basin Negotiator", "ambassador", ["india", "rivers", "commission"],
    sx("The joint river commission with India has been moribund for years while the shared rivers run dry or flood unmanaged. Invest heavily in reviving real, data-driven joint management — slow, dependent on Delhi's goodwill — or let it stay a formality?",
  ...
  ax("Migration Affairs Envoy", "ambassador", ["deportation", "europe", "returns"],
    sx("Europe will deepen legal-migration quotas and aid only if you accept the swift return of nationals it deems illegal — including some it cannot properly identify, who may not be yours. Sign the readmission deal?",
  ...
  ax("Disaster Diplomacy Officer", "ambassador", ["disaster", "regional", "warning"],
    sx("A regional disaster pact would share cyclone data, relief, and rescue across the bay — saving lives — but it requires hosting foreign assets and sharing sensitive coastal data with neighbours and rivals alike.",
  ...
  ax("Health Diplomacy Envoy", "doctor", ["pandemic", "data-sharing", "sovereignty"],
    sx("A new global pandemic treaty asks you to share pathogen samples and genomic data promptly in exchange for guaranteed access to vaccines. The access is vital; the catch is handing your biological data to a system the rich have gamed before.",
  ...
  ax("Religious Affairs Envoy", "cleric", ["hajj", "management", "corruption"],
    sx("The Hajj system is riddled with fraud — fake agencies stranding pilgrims, gouged fares, lost deposits — humiliating the country before the Saudis and the faithful. The envoy wants a clean state-run digital system; the agency cartel resists.",
  ...
  ax("Foreign Secretary", "ambassador", ["india", "extradition", "fugitives"],
    sx("Delhi wants a broad extradition treaty, both ways. It would let you reclaim economic criminals who fled with looted billions — and oblige you to return people Delhi labels criminals who may be dissidents or refugees.",
  ...
  ax("Connectivity Negotiator", "ambassador", ["india", "river-transit", "fees"],
    sx("India wants to ship cargo through your rivers to its northeast. Charge proper fees and use it as leverage on water and trade, or grant it cheaply for goodwill? The rivers are yours to price.",
  ...
  ax("Climate Finance Envoy", "ambassador", ["climate-fund", "access", "capacity"],
    sx("Billions in global climate funds sit available, but accessing them demands rigorous project design, fiduciary standards, and transparency your system lacks. Invest in the costly capacity to unlock the money, or keep relying on bilateral handouts?",
  ...
  ax("Climate Markets Officer", "ambassador", ["carbon-credits", "forests", "revenue"],
    sx("You can sell carbon credits for your mangroves and forests to rich-world polluters — real revenue for conservation — but it limits your own future use of that land and risks accusations of selling the right to pollute.",
  ...
  ax("Energy Diplomacy Envoy", "ambassador", ["solar", "alliance", "technology"],
    sx("Joining a global solar alliance would bring cheap finance, technology transfer, and clean-energy standing — but align you closely with the rival giant that leads it, a tilt your other great-power partner will resent.",
  ...
  ax("Maritime Affairs Envoy", "ambassador", ["shipping", "emissions", "industry"],
    sx("New global rules would force your shipping and shipbreaking industries toward costly green standards — clean for the world, brutal for an industry built on cheap, dirty practices. Embrace the rules early, or fight for a developing-nation exemption?",
  ...
  ax("Skilled Migration Envoy", "ambassador", ["nurses", "skilled-migration", "brain-drain"],
    sx("Rich nations short of nurses offer a managed migration pact — good jobs abroad for your nurses, and remittances home — but it would drain the very health workers your own under-staffed hospitals desperately need.",
  ...
  ax("Expatriate Welfare Director", "relief", ["migrants", "death", "insurance"],
    sx("Migrant workers' bodies come home by the thousands, and grieving families bear the crushing cost of repatriation and burial alone. The director wants a state-funded repatriation and death-insurance scheme; the hawks call it an open-ended cost.",
  ...
  ax("Transboundary Water Envoy", "ambassador", ["india", "dam", "downstream"],
    sx("India is building a large dam upstream on a shared river, which could wreck the downstream flow, fisheries, and farms of a whole region. Mount a hard campaign against it, or seek a quiet share of its benefits?",
  ...
  ax("International Law Counsel", "ambassador", ["pakistan", "reparations", "1971"],
    sx("Legal scholars urge a formal international claim against Pakistan for the 1971 genocide and the undivided assets never settled. It would be just and rally the survivors — and enrage Islamabad and complicate every regional forum.",
  ...
  ax("Trade Strategy Envoy", "ambassador", ["rcep", "trade-bloc", "competition"],
    sx("The vast Asian trade bloc invites you to join — tariff-free access to enormous markets, and a flood of cheap imports that could swamp domestic industry not ready to compete. Join now, or protect industry and wait?",
  ...
  ax("Disarmament Envoy", "ambassador", ["cyber", "autonomous-weapons", "norms"],
    sx("At the UN, small states are pushing norms against cyber-attacks on civilian infrastructure and against killer autonomous weapons. Lead this moral cause and win standing, or stay quiet to keep open your own option to acquire them one day?",
  ...
  ax("Indian Ocean Envoy", "ambassador", ["maldives", "neighbours", "influence"],
    sx("A small island neighbour, courted by the rival giant, offers a partnership to balance against it — ports, fisheries, solidarity. It builds your regional weight and quietly annoys the giant whose backyard you would step into.",
  ...
  ax("Aviation Diplomacy Officer", "ambassador", ["aviation", "safety-rating", "flights"],
    sx("Aviation regulators have flagged your safety oversight, threatening to bar your national carrier from lucrative Western routes unless you overhaul the regulator. The fix is costly and steps on aviation cronies; the alternative is losing the routes.",
  ...
  ax("Cultural Diplomacy Envoy", "ambassador", ["diaspora", "soft-power", "culture"],
    sx("A network of cultural centres abroad would showcase the country's heritage, bind the diaspora, and build soft power — a costly long-term investment the finance hawks call vanity while wards and roads stand unbuilt at home.",
  ...
  ax("Maritime Trade Negotiator", "ambassador", ["india", "coastal-shipping", "trade"],
    sx("A coastal-shipping agreement with India would cut freight costs by letting ships ply directly between your ports and theirs — efficient, and a deeper enmeshment nationalists fear hands your coastal trade to a giant's fleets.",
  ...
  ax("Multilateral Affairs Envoy", "ambassador", ["d8", "developing-nations", "leadership"],
    sx("A grouping of developing Muslim-majority economies offers you a leadership role — prestige and south-south trade, but also entanglement in the bloc's rivalries and a tilt toward members your Western partners eye warily.",
  ...
  ax("Religious Affairs Envoy", "cleric", ["preachers", "visas", "ideology"],
    sx("Charismatic foreign preachers draw vast crowds and please the devout — and some carry hardline ideologies that unsettle the country's pluralist faith and rattle minorities. Keep welcoming them freely, or vet and restrict?",
  ...
  ax("River Basin Negotiator", "ambassador", ["india", "ganges", "treaty"],
    sx("The decades-old Ganges water-sharing treaty is up for renewal, and dry-season flows have dwindled below even its guaranteed minimums. Fight hard for a better, enforceable deal — straining ties — or renew the old terms to keep Delhi content?",
  ...
  ax("Investment Diplomacy Officer", "shadow", ["citizenship", "investment", "security"],
    sx("A scheme selling citizenship to wealthy foreigners would raise quick capital — and risk laundering fugitives, criminals, and sanctioned money into the country under a passport. The officer asks whether to launch it.",
  ...
  ax("Border Diplomacy Envoy", "ambassador", ["india", "border-killings", "diplomacy"],
    sx("India's border force keeps shooting your unarmed citizens dead along the frontier, and each killing inflames the public. Make it a loud, public diplomatic confrontation — straining ties — or pursue quiet protests that change nothing?",
  ...
  ax("Climate Finance Envoy", "ambassador", ["redd", "forests", "communities"],
    sx("A REDD+ scheme would pay you to protect your forests against deforestation — real money, if you can police the protection and cut in the forest-dwelling communities rather than evict them to satisfy distant auditors.",
  ...
  ax("Disarmament Envoy", "ambassador", ["arms-trade", "treaty", "standing"],
    sx("Acceding to the global Arms Trade Treaty would burnish your standing and commit you to controls on weapons transfers — and constrain some murky procurement and re-export arrangements your security establishment values. Sign?",
  ...
  ax("Maritime Diplomacy Envoy", "ambassador", ["iora", "chairmanship", "prestige"],
    sx("You are offered the rotating chairmanship of the Indian Ocean rim body — a platform to drive the blue economy and maritime security. Prestigious and costly to host well, it thrusts you into the middle of the great powers' Indian Ocean contest.",
  ...
  ax("International Law Counsel", "ambassador", ["1971", "genocide", "recognition"],
    sx("A global campaign to win formal recognition of the 1971 genocide would honour the three million dead and cement the national narrative — a costly, years-long effort that would also reopen wounds and antagonise Pakistan and its friends.",
  ...
  ax("Refugee Affairs Secretary", "relief", ["rohingya", "rations", "donors"],
    sx("Donor fatigue has cut the world food agency's funding for the refugee camps, and rations are being slashed toward starvation. Mount a loud global appeal and dip into your own strained budget, or let the cuts fall?",
  ...
  ax("Refugee Affairs Secretary", "ambassador", ["rohingya", "resettlement", "burden"],
    sx("A handful of rich nations offer to resettle a small share of the refugees abroad — easing your burden, but a token number that lets them claim virtue while leaving you the million. Welcome it gratefully, or press for far more?",
  ...
  ax("Peacekeeping Affairs Officer", "general", ["peacekeeping", "scandal", "discipline"],
    sx("Your blue helmets on a UN mission are accused of abuse and exploitation of the local population — a scandal that threatens the lucrative peacekeeping role and the nation's proud record. Investigate transparently, or quietly protect the troops?",
  ...
  ax("Sanctions Policy Envoy", "ambassador", ["myanmar", "sanctions", "trade"],
    sx("The world is sanctioning Myanmar's junta, and you are pressed to join — cutting the quiet border trade in jade, timber, and goods that some of your own businessmen profit from. Enforce the sanctions, or keep the trade flowing?",
  ...
  ax("Connectivity Negotiator", "ambassador", ["nepal", "transit", "trade"],
    sx("Landlocked Nepal seeks transit through your territory and ports to the sea, building south-south solidarity and trade — but every route crosses India, whose cooperation you cannot assume, and who may read it as encirclement.",
  ...
  ax("Central Bank Diplomacy Officer", "ambassador", ["currency", "de-dollarisation", "trade"],
    sx("To ease the dollar crunch, you can settle trade with big neighbours in rupees and yuan — saving scarce hard currency, but deepening dependence on those currencies and the powers behind them, and drawing Washington's unease.",
  ...
  ax("Ocean Affairs Envoy", "ambassador", ["high-seas", "biodiversity", "treaty"],
    sx("A landmark treaty to protect biodiversity on the high seas is open for signature. Joining wins green standing and a voice in governing the global ocean — and commits you to limits on distant-water fishing you might one day want.",
  ...
  ax("Environment Diplomacy Officer", "ambassador", ["basel", "shipbreaking", "waste"],
    sx("Global hazardous-waste rules would force your shipbreaking yards to meet strict toxic-handling standards before importing end-of-life ships — cleaner and safer, but a blow to an industry built on cheap, dirty dismantling. Comply early?",
  ...
  ax("Regional Affairs Envoy", "ambassador", ["asean", "dialogue-partner", "engagement"],
    sx("You can pursue dialogue-partner status with the Southeast Asian bloc — a gateway to its markets and a louder voice on Myanmar — through a long, demanding effort, or stay focused on your immediate South Asian neighbourhood.",
  ...
  ax("Wildlife Diplomacy Officer", "ambassador", ["cites", "trafficking", "enforcement"],
    sx("International monitors threaten to sanction your wildlife trade unless you crack down on your role as a trafficking transit hub for tigers, pangolins, and rare timber. Real enforcement means confronting connected smuggling networks.",
  ...
  ax("Regional Trade Envoy", "ambassador", ["bhutan", "trade", "hydropower"],
    sx("Tiny Bhutan offers a friendly trade and hydropower partnership — clean energy and warm ties — but, like all your northern links, it runs through India's grid and goodwill, deepening the very dependence you seek to dilute.",
  ...
  ax("External Finance Secretary", "ambassador", ["imf", "sdr", "reserves"],
    sx("A global allocation of the IMF's reserve asset has handed you a windfall of unconditional reserves. Bank it quietly as a buffer against the dollar crunch, or spend it fast on visible development and relief?",
  ...
  ax("Multilateral Affairs Envoy", "ambassador", ["myanmar", "un", "diplomacy"],
    sx("A UN special envoy seeks to broker the Rohingya's safe return and Myanmar's accountability, and asks you to host talks and lend your weight. It would centre you in the world's gratitude — and entangle you in a process that may fail and consume capital.",
  ...
  ax("International Law Counsel", "ambassador", ["statelessness", "convention", "rights"],
    sx("Acceding to the global conventions on statelessness would commit you to protecting and eventually integrating the stateless on your soil — a humanitarian and reputational gain that also ties your hands on a politically fraught question.",
  ...
  ax("Environment Diplomacy Officer", "ambassador", ["plastics", "treaty", "industry"],
    sx("A global treaty to cap plastic production is being negotiated. Join the ambitious bloc demanding hard limits and win green standing, or side with the producers resisting caps to protect your own growing plastics industry?",
  ...
  ax("Climate Diplomacy Envoy", "ambassador", ["loss-and-damage", "fund", "leadership"],
    sx("The new global loss-and-damage fund is forming its board. Fight for a frontline-nation seat to shape who gets the money — a prize of influence and a chance to steer funds home — at the cost of time, capital, and rivalries?",
  ...
  ax("Maritime Labour Officer", "people", ["seafarers", "labour", "shipping"],
    sx("Your seafarers crew the world's merchant fleets, often abandoned, unpaid, or stranded on flag-of-convenience ships with no protection. The officer wants to ratify the maritime labour convention; the shipping agents resist the cost and oversight.",
  ...
  ax("External Finance Secretary", "ambassador", ["debt", "climate-swap", "conservation"],
    sx("A creditor offers to forgive a chunk of your foreign debt if you commit to spend the freed money protecting your forests and coasts. The swap eases the debt and funds conservation — and hands a foreign creditor a say over your environmental spending.",
  ...
  ax("Labour Diplomacy Officer", "ambassador", ["child-labour", "convention", "exports"],
    sx("Global scrutiny falls on child labour in your supply chains — leather, fish-drying, brickfields — threatening export bans. Drive hard enforcement and rehabilitation, at real cost to families who rely on the children's wages, or manage the optics and hope?",
  ...
  ax("Border Affairs Secretary", "people", ["enclaves", "border", "integration"],
    sx("Years after the historic enclave exchange with India, the former enclave-dwellers who chose your citizenship still lack roads, schools, and services, languishing in limbo. Fund their full integration, or let them wait?",
  ...
  ax("Environment Diplomacy Officer", "ambassador", ["mercury", "treaty", "health"],
    sx("The global mercury convention would force you to phase out mercury in gold-refining, batteries, and small industry — protecting health and waterways, at real cost to informal operators who poison themselves and their rivers for a living. Commit fully?",
  ...
  ax("Food Diplomacy Envoy", "ambassador", ["india", "rice", "food-security"],
    sx("A poor harvest leaves you needing emergency rice imports. India can supply fast and cheap — deepening dependence on a neighbour who has banned exports on a whim before — or pay more to source from distant suppliers for independence?",
  ...
  ax("Biodiversity Diplomacy Officer", "ambassador", ["biodiversity", "cop", "targets"],
    sx("At the global biodiversity summit you can pledge to protect a third of your land and waters — winning green acclaim and funding — but the protected areas would constrain fishing, farming, and building your crowded population demands.",
  ...
  ax("Central Bank Diplomacy Officer", "ambassador", ["reserves", "regional-pool", "stability"],
    sx("A regional reserve-pooling arrangement would let member states lend each other reserves in a crisis — a mutual safety net — but it requires contributing your own scarce reserves and accepting collective oversight of your monetary affairs.",
  ...
  ax("Disarmament Envoy", "ambassador", ["landmines", "ban", "standing"],
    sx("Joining the global bans on landmines and cluster munitions would burnish your humanitarian standing and commit you to forswearing such weapons — constraining your military's options along tense borders the brass would rather keep mineable.",
  ...
  ax("Refugee Affairs Secretary", "ambassador", ["rohingya", "donors", "burden-sharing"],
    sx("You can convene a major international donor conference to fund the refugee response and pressure the world to share the burden — a showpiece that could raise real money, or fall flat amid donor fatigue and leave you exposed as unable to rally support.",
