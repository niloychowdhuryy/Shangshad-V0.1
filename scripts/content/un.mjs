...
export const UN = [
  ...
  ax("India's High Commissioner", "ambassador", ["water", "india", "teesta"],
    sx("Sir, a message from the Foreign Ministry: A neighboring country keeps making you wait for a deal to share river water. Your farmers really need the water right now to grow their food.",
    ...
    sx("China offers a lot of money to fix your big river. Your neighbor says they will be very angry if you let China build things so close to them. What are your orders, sir?",
    ...
    sx("India's High Commissioner awaits your word. Three big, powerful countries all want you to pick their side and be their best friend. You only have one country to run.",
  ...
  ax("UN Refugee Commissioner", "relief", ["rohingya", "myanmar", "refugees"],
    sx("Sir! The camps for homeless people from another country are running out of food money. They will get very angry and might escape if they starve.",
    ...
    sx("Mr. Prime Minister, sir! The mean leaders of the country the homeless people ran away from say they can come back. But the people are very scared to go back there.",
    ...
    sx("Your Excellency! Bad guys with weapons are hiding inside the homeless camps. Your army wants to lock the camps down, but helpers say that will stop food from getting in.",
  ...
  ax("IMF Mission Chief", "official", ["imf", "subsidies", "reserves"],
    sx("Dear Sir — A giant bank will lend you money to save your country, but only if you make gas and electricity very expensive for your people right now.",
  ...
  ax("Saudi Labour Attaché", "ambassador", ["migrants", "gulf", "remittances"],
    sx("Honourable leader! Another country wants to send many of your workers back home to make room for their own people. Those workers send a lot of money to help your country survive.",
  ...
  ax("US Under-Secretary", "ambassador", ["sanctions", "rights", "trade"],
    sx("US Under-Secretary reports: America is punishing your special police for hurting people. They say you must fix your police or they will punish your businesses too.",
  ...
  ax("COP Summit President", "official", ["climate", "loss-damage", "delta"],
    sx("A note from the Foreign Ministry reads: Your country is flooding because of pollution from bigger countries. At a big world meeting, you can yell for them to pay you for the damage, or sit quietly.",
  ...
  ax("Border Guard Director-General", "general", ["border", "india", "killings"],
    sx("Word from the Foreign Ministry, sir — The guards from the country next door keep shooting people crossing the border. Your guards want to start shooting back.",
  ...
  ax("Connectivity Negotiator", "official", ["transit", "india", "sovereignty"],
    sx("Connectivity Negotiator: Your neighbor wants to drive their delivery trucks straight through your country to save time. Some people think this gives them too much power over your roads.",
  ...
  ax("Pakistani Envoy", "ambassador", ["pakistan", "1971", "history"],
    sx("Sir, a message from the Foreign Ministry: An old enemy wants to be friends and play sports with you. But they refuse to say sorry for a very bad war from a long time ago, and older people are mad.",
  ...
  ax("UN Peace Operations Chief", "official", ["peacekeeping", "scandal", "prestige"],
    sx("Your soldiers who are helping in another country are accused of doing bad things. You could lose a lot of money if they are sent home in disgrace. What are your orders, sir?",
  ...
  ax("Joint Rivers Commissioner", "official", ["farakka", "water", "india"],
    sx("Joint Rivers Commissioner awaits your word. A neighbor stopped a river from flowing into your country, causing your fish to die. You can study it for a long time, or take them to a big global court and embarrass them.",
  ...
  ax("Rohingya Prosecution Counsel", "official", ["rohingya", "icj", "genocide"],
    sx("Dear Sir — There is a big court case to punish the bad leaders next door for hurting people. If you yell at them in court, they will definitely refuse to take the homeless people back.",
  ...
  ax("Refugee Relocation Director", "official", ["rohingya", "bhasan-char", "island"],
    sx("Honourable leader! You built a new mud island to move some homeless people there. The world says it might flood, but your local people want the homeless moved right now.",
  ...
  ax("Vaccine Diplomacy Envoy", "ambassador", ["health", "vaccines", "india-china"],
    sx("Vaccine Diplomacy Envoy reports: You need medicine for a sickness fast. One neighbor gives it slowly, but China will give it fast if you act like they are your best friend.",
  ...
  ax("Trade Preferences Negotiator", "official", ["ldc-graduation", "gsp", "exports"],
    sx("A note from the Foreign Ministry reads: Your country is getting richer, so other places won't give you special cheap prices for your clothes anymore.",
  ...
  ax("Indian Citizenship Envoy", "ambassador", ["india", "nrc", "pushback"],
    sx("Word from the Foreign Ministry, sir — Your neighbor is calling some of their people illegal and might push them over the fence into your country.",
  ...
  ax("OIC Solidarity Delegate", "cleric", ["oic", "islamic-bloc", "rights"],
    sx("OIC Solidarity Delegate: A group of religious countries offers you money and help, but only if you agree with their strict rules and support their fights.",
  ...
  ax("Maritime Boundary Commissioner", "official", ["bay-of-bengal", "blue-economy", "maritime"],
    sx("Sir, a message from the Foreign Ministry: You own ocean water that has gas and fish. Powerful countries want to help you get it quickly, but your neighbors don't trust those powerful countries.",
  ...
  ax("Diaspora Affairs Minister", "people", ["diaspora", "remittances", "votes"],
    sx("Millions of your people live far away but send you money to help the country. Now they want to vote in your elections, which is risky for you. What are your orders, sir?",
  ...
  ax("Surveillance Tech Vendor", "shadow", ["china", "safe-city", "surveillance"],
    sx("Surveillance Tech Vendor awaits your word. A company wants to sell you magic cameras that watch everyone in the city at all times and know their faces.",
  ...
  ax("Climate Migration Envoy", "official", ["climate", "migration", "recognition"],
    sx("Sir! The oceans are rising. You can ask big countries to let your people move there as \"climate refugees,\" but this means admitting your land will sink.",
  ...
  ax("Regional Debt Watcher", "official", ["regional", "default", "contagion"],
    sx("Mr. Prime Minister, sir! A nearby country completely ran out of money. Banks are scared your country will run out too.",
  ...
  ax("Gulf Labour Reform Attaché", "ambassador", ["migrants", "gulf", "amnesty"],
    sx("Your Excellency! A faraway country says your illegal workers can stay safely, but only if you follow strict new rules that cost a lot of money.",
  ...
  ax("Japanese Megaproject Lead", "ambassador", ["japan", "matarbari", "infrastructure"],
    sx("Dear Sir — A rich country offers cheap money to build a giant dock, but they secretly expect you to stop being friends with China.",
  ...
  ax("UN Rights Council Delegate", "official", ["unhrc", "resolution", "scrutiny"],
    sx("Honourable leader! A group wants to put a team in your country to officially watch if you are being mean to reporters and citizens.",
  ...
  ax("Naval Base Suitor", "general", ["base", "great-power", "sovereignty"],
    sx("Naval Base Suitor reports: Two huge countries want to park their army boats on your beaches and will pay you lots of money to do it.",
  ...
  ax("Hydropower Transit Negotiator", "official", ["nepal", "hydropower", "transit"],
    sx("A note from the Foreign Ministry reads: You want to buy clean electricity from a country far away, but the wires have to go right through a grumpy neighbor's land.",
  ...
  ax("Peacekeeping Expansion Officer", "general", ["peacekeeping", "un", "prestige"],
    sx("Word from the Foreign Ministry, sir — The world wants your soldiers to go fight in a very dangerous war that isn't yours. They will pay you, but soldiers might die.",
  ...
  ax("Belt-and-Road Negotiator", "ambassador", ["china", "bri", "debt"],
    sx("Belt-and-Road Negotiator: A huge country offers to build bridges and trains, but the rules are secret and you might owe them too much money later and lose your things.",
  ...
  ax("Commerce Envoy to Delhi", "ambassador", ["india", "trade", "deficit"],
    sx("Sir, a message from the Foreign Ministry: Your big neighbor sells you lots of things, but won't let you sell your things to them.",
  ...
  ax("Washington Trade Liaison", "ambassador", ["usa", "gsp", "labour"],
    sx("A faraway country stopped buying your clothes because they say you treat workers badly. Your factory owners will be very angry if you change the rules. What are your orders, sir?",
  ...
  ax("Brussels Trade Envoy", "ambassador", ["eu", "garments", "rights"],
    sx("Brussels Trade Envoy awaits your word. Another country says they will stop giving you good deals unless you let some protesters out of jail and allow free news.",
  ...
  ax("Expatriate Welfare Director", "people", ["migrants", "gulf", "kafala"],
    sx("Mr. Prime Minister, sir! Your workers in other countries are dying because their bosses treat them terribly. If you yell at the bosses, they might fire everyone from your country.",
  ...
  ax("Manpower Bureau Chief", "fixer", ["migrants", "recruitment", "syndicate"],
    sx("Your Excellency! Bad groups charge poor people way too much money to find jobs far away. These bad groups are friends with your own government helpers.",
  ...
  ax("Refugee Relief Commissioner", "relief", ["rohingya", "bhasan-char", "relocation"],
    sx("Dear Sir — You built a new mud island for homeless people, but experts say it's not safe from storms.",
  ...
  ax("International Law Counsel", "ambassador", ["rohingya", "icj", "justice"],
    sx("Honourable leader! The world court wants to punish the bad leaders next door for hurting people. If you join the court, the bad leaders will never take the homeless people back.",
  ...
  ax("Border Security Commander", "general", ["myanmar", "border", "spillover"],
    sx("Border Security Commander reports: Your neighbor's war is coming across your borders with bombs and fighters. Your army wants to stand strong and fight back.",
  ...
  ax("UN Mission Ambassador", "ambassador", ["russia", "ukraine", "vote"],
    sx("A note from the Foreign Ministry reads: The whole world is voting to tell Russia they are bad for starting a war. Russia is your friend and helps you with energy and food.",
  ...
  ax("Energy Procurement Envoy", "fixer", ["russia", "sanctions", "energy"],
    sx("Word from the Foreign Ministry, sir — Russia offers you super cheap oil, but powerful countries say you are absolutely not allowed to buy it.",
  ...
  ax("Development Economist", "official", ["ldc", "graduation", "trade"],
    sx("Development Economist: Your country is growing up and won't be called \"very poor\" anymore. This is proud, but it means you lose free help and cheap loans.",
  ...
  ax("Central Bank Governor", "official", ["reserves", "swap", "dependence"],
    sx("Sir, a message from the Foreign Ministry: You are running out of money. India offers to trade a huge amount of money with you, but they will have secret power over you.",
  ...
  ax("NGO Affairs Director", "official", ["ngos", "foreign-funding", "civil-society"],
    sx("A new rule lets you block money from going to groups that complain about you. It makes them quiet, but the world thinks this is very mean. What are your orders, sir?",
  ...
  ax("Religious Affairs Envoy", "cleric", ["hajj", "saudi", "pilgrims"],
    sx("Religious Affairs Envoy awaits your word. A faraway country says more of your people can come pray, but you have to pick their side in a fight.",
  ...
  ax("Defence Procurement Chief", "general", ["arms", "china", "alignment"],
    sx("Sir! You need weapons for your army. China sells them cheap, but America sells better ones with strict rules about being nice to people.",
  ...
  ax("Foreign Secretary", "ambassador", ["sanctions", "elites", "visas"],
    sx("Mr. Prime Minister, sir! America is punishing your helpers because they think you cheated in an election.",
  ...
  ax("Climate Diplomacy Envoy", "ambassador", ["climate", "cop", "leadership"],
    sx("Your Excellency! You are at a big meeting about the earth getting too hot. You can demand big countries pay for the damage, but they might get mad.",
  ...
  ax("Expatriate Affairs Secretary", "official", ["diaspora", "voting", "remittances"],
    sx("Dear Sir — Millions of your people live far away and send money home. They want to vote, but they might vote against you.",
  ...
  ax("Manpower Bureau Chief", "fixer", ["malaysia", "migrants", "syndicate"],
    sx("Honourable leader! Another country will let your workers in, but only if you use a bad group that charges workers too much money.",
  ...
  ax("Camp Security Chief", "shadow", ["rohingya", "militancy", "drugs"],
    sx("Camp Security Chief reports: There are bad gangs and danger in the homeless camps. A guard wants to sweep the camps with force, but helpers want to do it nicely.",
  ...
  ax("Health Diplomacy Envoy", "doctor", ["vaccines", "china", "west"],
    sx("A note from the Foreign Ministry reads: You need medicine fast. China will give it now if you act like their best friend, but other countries will take longer.",
  ...
  ax("UN Mission Ambassador", "ambassador", ["unsc", "prestige", "campaign"],
    sx("Word from the Foreign Ministry, sir — You can get a special, famous seat at a big world meeting. It costs a lot of money and forces you to pick sides in fights.",
  ...
  ax("Defence Cooperation Envoy", "general", ["india", "defence", "credit"],
    sx("Defence Cooperation Envoy: Your neighbor offers a lot of money to buy their army gear. The gear is just okay, and they will control you more.",
  ...
  ax("Digital Sovereignty Adviser", "official", ["data", "big-tech", "sovereignty"],
    sx("Sir, a message from the Foreign Ministry: You can force big internet companies to keep people's data in your country so you can see it. They might leave if you do.",
  ...
  ax("Connectivity Negotiator", "ambassador", ["india", "transit", "port"],
    sx("Your neighbor wants to drive their delivery trucks through your land. You can charge them money, but people will say you sold your country. What are your orders, sir?",
  ...
  ax("Cyber Security Chief", "shadow", ["cyber", "attack", "attribution"],
    sx("Cyber Security Chief awaits your word. A bad country stole your country's money using computers. You know who did it.",
  ...
  ax("Debt Sustainability Adviser", "official", ["debt", "default", "imf"],
    sx("Sir! A nearby country ran out of money. Banks want you to stop spending so much to prove you are safe, but people like your big projects.",
  ...
  ax("Regional Affairs Envoy", "ambassador", ["bimstec", "saarc", "leadership"],
    sx("Mr. Prime Minister, sir! You can join a new group of neighbor countries and be the leader, but it means leaving out an old enemy.",
  ...
  ax("Trade and Health Envoy", "doctor", ["pharma", "patents", "exports"],
    sx("Your Excellency! Your country makes cheap medicine for poor people. Rich countries want to stop this.",
  ...
  ax("Foreign Secretary", "ambassador", ["election", "demarche", "legitimacy"],
    sx("Dear Sir — Other countries warn you to have a fair election, or they will punish you.",
  ...
  ax("River Basin Negotiator", "ambassador", ["teesta", "china", "india"],
    sx("Honourable leader! China offers to fix a big river. India will be very angry if you let China build things near their border.",
  ...
  ax("Border Affairs Secretary", "ambassador", ["india", "citizenship", "pushback"],
    sx("Border Affairs Secretary reports: Your neighbor is pushing poor people over the border into your land, calling them your people.",
  ...
  ax("Maritime Diplomacy Envoy", "ambassador", ["indian-ocean", "small-states", "balance"],
    sx("A note from the Foreign Ministry reads: A tiny island country asks you to team up to stop big countries from bossing you both around. This might make the big countries mad.",
  ...
  ax("Connectivity Negotiator", "ambassador", ["india", "rail", "integration"],
    sx("Word from the Foreign Ministry, sir — You can build a train track to connect to a giant neighbor. It helps business but makes you need them more.",
  ...
  ax("Counter-Terror Liaison", "general", ["terrorism", "intelligence", "cooperation"],
    sx("Counter-Terror Liaison: After a scary attack, big countries want to train your police and share secrets. This lets them see how your police work.",
  ...
  ax("River Basin Negotiator", "ambassador", ["rivers", "india", "treaty"],
    sx("Sir, a message from the Foreign Ministry: Many rivers come from your neighbor, and they control the water. You can ask for one giant deal for all rivers, or just fix one river at a time.",
  ...
  ax("Summit Diplomacy Adviser", "ambassador", ["g20", "outreach", "prestige"],
    sx("You are invited to a giant world party with powerful leaders. But you have to promise not to complain about the host's bad rules. What are your orders, sir?",
  ...
  ax("Blue Economy Envoy", "ambassador", ["maritime", "blue-economy", "investment"],
    sx("Blue Economy Envoy awaits your word. You own ocean water. Many big countries want to explore it. You can pick just one to do everything, or let many of them try.",
  ...
  ax("Migration Affairs Envoy", "relief", ["migrants", "mediterranean", "trafficking"],
    sx("Dear Sir — A boat sank far away, and many of your people died trying to sneak into rich countries.",
  ...
  ax("Transboundary Water Envoy", "ambassador", ["china", "brahmaputra", "water"],
    sx("Honourable leader! A big country is building a giant dam that could stop your river's water. You can yell at them, or talk to them nicely.",
  ...
  ax("Tax Treaty Negotiator", "ambassador", ["oecd", "tax", "sovereignty"],
    sx("Tax Treaty Negotiator reports: Rich countries want everyone to make businesses pay the same amount of tax. If you agree, you can't offer cheap taxes to invite new businesses anymore.",
  ...
  ax("Cultural Diplomacy Envoy", "ambassador", ["language", "unesco", "soft-power"],
    sx("A note from the Foreign Ministry reads: You can spend a lot of money to teach the world about your country's language day, but some say you should save the money.",
  ...
  ax("Labour Diplomacy Officer", "ambassador", ["ilo", "labour", "trade"],
    sx("Word from the Foreign Ministry, sir — Buyers want you to promise that kids won't work in factories and workers can complain. Factory owners say this will ruin them.",
  ...
  ax("Climate Diplomacy Envoy", "ambassador", ["climate-migration", "compact", "recognition"],
    sx("Climate Diplomacy Envoy: The ocean is rising, and people will lose their homes. You can lead a team asking for help for \"climate refugees,\" but it sounds like you are giving up your land.",
  ...
  ax("Commerce Envoy to Delhi", "ambassador", ["india", "onions", "food-security"],
    sx("Sir, a message from the Foreign Ministry: Your neighbor stopped selling you onions, and now they are too expensive. People are very mad.",
  ...
  ax("Security Cooperation Envoy", "general", ["india", "insurgents", "extradition"],
    sx("Your neighbor says bad guys who attack them are hiding in your country. They want you to catch them. What are your orders, sir?",
  ...
  ax("Expatriate Welfare Director", "people", ["gulf", "housemaids", "abuse"],
    sx("Expatriate Welfare Director awaits your word. Maids who work in other countries are getting hurt. You can stop women from going there, but they won't make money.",
  ...
  ax("Manpower Bureau Chief", "ambassador", ["migration", "recruitment-cost", "reform"],
    sx("Sir! Poor workers have to pay bad bosses a lot of money just to get a job in another country. You can make rules so the company pays instead.",
  ...
  ax("Trade Negotiator", "ambassador", ["wto", "fisheries", "subsidies"],
    sx("Mr. Prime Minister, sir! The world wants to stop giving money to fishers, to save the fish in the ocean. But your poor fishers need that money.",
  ...
  ax("Space Programme Director", "official", ["satellite", "technology", "prestige"],
    sx("Your Excellency! You can buy a second satellite for space. It looks cool but costs tons of money and gives power to the country that launches it.",
  ...
  ax("Refugee Affairs Secretary", "ambassador", ["rohingya", "repatriation", "myanmar"],
    sx("Dear Sir — Another country will take a few homeless people back, but won't promise to keep them safe. The people are too scared to go.",
  ...
  ax("Multilateral Affairs Envoy", "ambassador", ["non-aligned", "blocs", "positioning"],
    sx("Honourable leader! Do you want to be friends with poorer countries and be their hero, or be friends with rich countries who have all the money?",
  ...
  ax("Health Diplomacy Envoy", "doctor", ["amr", "health", "global"],
    sx("Health Diplomacy Envoy reports: People take too much medicine when they aren't sick, making super-bugs that can't be stopped. You can spend money to teach people to stop.",
  ...
  ax("Religious Affairs Envoy", "cleric", ["saudi", "funding", "ideology"],
    sx("A note from the Foreign Ministry reads: Rich countries offer to build schools and places to pray, but they will teach very strict, scary rules.",
  ...
  ax("River Basin Negotiator", "ambassador", ["india", "rivers", "commission"],
    sx("Word from the Foreign Ministry, sir — The rivers you share with a neighbor are drying up. You can spend money to study the rivers together, but it takes a long time.",
  ...
  ax("Migration Affairs Envoy", "ambassador", ["deportation", "europe", "returns"],
    sx("Migration Affairs Envoy: Faraway countries will let more of your people work there, but only if you agree to take back anyone they kick out quickly.",
  ...
  ax("Disaster Diplomacy Officer", "ambassador", ["disaster", "regional", "warning"],
    sx("Sir, a message from the Foreign Ministry: You can make a deal to share storm warnings and help with neighbors. But this means sharing your secrets with them.",
  ...
  ax("Health Diplomacy Envoy", "doctor", ["pandemic", "data-sharing", "sovereignty"],
    sx("A new rule asks you to share your sickness secrets so the world can make medicine. But rich countries might keep the medicine for themselves. What are your orders, sir?",
  ...
  ax("Religious Affairs Envoy", "cleric", ["hajj", "management", "corruption"],
    sx("Religious Affairs Envoy awaits your word. Bad travel agents are stealing money from people going on big religious trips. You can make a new government computer system to stop them.",
  ...
  ax("Connectivity Negotiator", "ambassador", ["india", "river-transit", "fees"],
    sx("Mr. Prime Minister, sir! A neighbor wants to ship boxes on your rivers. You can charge them a lot of money, or let them do it cheap to be nice.",
  ...
  ax("Climate Finance Envoy", "ambassador", ["climate-fund", "access", "capacity"],
    sx("Your Excellency! There is free money for the environment, but you have to do hard paperwork and show you are honest to get it.",
  ...
  ax("Climate Markets Officer", "ambassador", ["carbon-credits", "forests", "revenue"],
    sx("Dear Sir — You can sell the clean air from your forests to dirty countries for money. But people might say you are letting them pollute.",
  ...
  ax("Energy Diplomacy Envoy", "ambassador", ["solar", "alliance", "technology"],
    sx("Honourable leader! You can join a solar power team for cheap energy, but you have to be best friends with the giant country running it.",
  ...
  ax("Maritime Affairs Envoy", "ambassador", ["shipping", "emissions", "industry"],
    sx("Maritime Affairs Envoy reports: New rules say boats must be super clean. It is good for the world, but it will cost your boat builders a lot of money.",
  ...
  ax("Skilled Migration Envoy", "ambassador", ["nurses", "skilled-migration", "brain-drain"],
    sx("A note from the Foreign Ministry reads: Rich countries want to take your nurses to work for them. The nurses will make money, but your own sick people will have no one to help them.",
  ...
  ax("Expatriate Welfare Director", "relief", ["migrants", "death", "insurance"],
    sx("Word from the Foreign Ministry, sir — When workers die far away, their families have to pay to bring them home. You can use the country's money to pay for this instead.",
  ...
  ax("Transboundary Water Envoy", "ambassador", ["india", "dam", "downstream"],
    sx("Transboundary Water Envoy: A neighbor is building a dam that will dry up your river and kill your fish. You can fight them loudly, or try to get a little bit of the water quietly.",
  ...
  ax("International Law Counsel", "ambassador", ["pakistan", "reparations", "1971"],
    sx("Sir, a message from the Foreign Ministry: You can ask a big court to make an old enemy pay for a war from long ago. It is fair, but it will make them very angry.",
  ...
  ax("Trade Strategy Envoy", "ambassador", ["rcep", "trade-bloc", "competition"],
    sx("You can join a giant club where countries sell things to each other for free. It could ruin your own small stores because foreign things are cheaper. What are your orders, sir?",
  ...
  ax("Disarmament Envoy", "ambassador", ["cyber", "autonomous-weapons", "norms"],
    sx("Disarmament Envoy awaits your word. Small countries want to stop bad robot weapons. You can help lead them, or stay quiet just in case you want to buy those weapons later.",
  ...
  ax("Indian Ocean Envoy", "ambassador", ["maldives", "neighbours", "influence"],
    sx("Sir! A tiny island country wants to be friends to protect themselves from big countries. The big countries won't like it.",
  ...
  ax("Aviation Diplomacy Officer", "ambassador", ["aviation", "safety-rating", "flights"],
    sx("Mr. Prime Minister, sir! Experts say your airplanes aren't safe. They will ban them unless you fire the bad safety bosses and fix the rules.",
  ...
  ax("Cultural Diplomacy Envoy", "ambassador", ["diaspora", "soft-power", "culture"],
    sx("Your Excellency! You can spend money to build places in other countries to show off your art and songs. Some people say you should spend that money on roads instead.",
  ...
  ax("Maritime Trade Negotiator", "ambassador", ["india", "coastal-shipping", "trade"],
    sx("Dear Sir — You can make a deal to let your neighbor's ships deliver things right to your docks to save money, but they might take over your ocean jobs.",
  ...
  ax("Multilateral Affairs Envoy", "ambassador", ["d8", "developing-nations", "leadership"],
    sx("Honourable leader! A group of countries wants you to be their leader. It makes you look strong, but you will have to deal with all their fights.",
  ...
  ax("Religious Affairs Envoy", "cleric", ["preachers", "visas", "ideology"],
    sx("Religious Affairs Envoy reports: Famous speakers are coming from far away to talk to big crowds. Some of them teach scary, mean rules that scare your people.",
  ...
  ax("River Basin Negotiator", "ambassador", ["india", "ganges", "treaty"],
    sx("A note from the Foreign Ministry reads: An old deal about sharing river water is almost over, and your neighbor isn't giving you enough water. You can fight for a better deal or just keep the bad one.",
  ...
  ax("Investment Diplomacy Officer", "shadow", ["citizenship", "investment", "security"],
    sx("Word from the Foreign Ministry, sir — You can sell passports to rich foreigners for a lot of money. But bad criminals might buy them to hide in your country.",
  ...
  ax("Border Diplomacy Envoy", "ambassador", ["india", "border-killings", "diplomacy"],
    sx("Border Diplomacy Envoy: Your neighbor's guards keep shooting your people at the border. You can yell at them loudly, or send quiet letters that don't do much.",
  ...
  ax("Climate Finance Envoy", "ambassador", ["redd", "forests", "communities"],
    sx("Sir, a message from the Foreign Ministry: A group will pay you money if you promise not to chop down your forests. You can share the money with the people living there, or keep it for the government.",
  ...
  ax("Disarmament Envoy", "ambassador", ["arms-trade", "treaty", "standing"],
    sx("You can sign a rule to stop selling bad weapons, which makes you look good. But it means your army can't make secret weapon deals anymore. What are your orders, sir?",
  ...
  ax("Maritime Diplomacy Envoy", "ambassador", ["iora", "chairmanship", "prestige"],
    sx("Maritime Diplomacy Envoy awaits your word. You are asked to host a huge, expensive party for countries near the ocean. It makes you look important, but it puts you right in the middle of big fights.",
  ...
  ax("International Law Counsel", "ambassador", ["1971", "genocide", "recognition"],
    sx("Sir! You can start a big campaign to make the world remember a terrible war from long ago. It will cost a lot of money and make your old enemy very mad.",
  ...
  ax("Refugee Affairs Secretary", "relief", ["rohingya", "rations", "donors"],
    sx("Mr. Prime Minister, sir! The world is running out of money to feed the homeless people in your camps. You can use your own money to feed them, or let them go hungry.",
  ...
  ax("Refugee Affairs Secretary", "ambassador", ["rohingya", "resettlement", "burden"],
    sx("Your Excellency! Rich countries say they will take a tiny handful of the homeless people. They want to look like heroes, leaving you with the rest.",
  ...
  ax("Peacekeeping Affairs Officer", "general", ["peacekeeping", "scandal", "discipline"],
    sx("Dear Sir — Your soldiers acting as peacekeepers in another country did very bad things to the people there.",
  ...
  ax("Sanctions Policy Envoy", "ambassador", ["myanmar", "sanctions", "trade"],
    sx("Honourable leader! The world is blocking your bad neighbor from trading. You can join the block, or let your businessmen sneak stuff over the border to make money.",
  ...
  ax("Connectivity Negotiator", "ambassador", ["nepal", "transit", "trade"],
    sx("Connectivity Negotiator reports: A country with no oceans wants to use your docks to ship things. But they have to cross through a grumpy giant neighbor's land first to get to you.",
  ...
  ax("Central Bank Diplomacy Officer", "ambassador", ["currency", "de-dollarisation", "trade"],
    sx("A note from the Foreign Ministry reads: To save money, you can start paying big neighbors with their own special coins instead of standard world dollars. This makes them more powerful over you.",
  ...
  ax("Ocean Affairs Envoy", "ambassador", ["high-seas", "biodiversity", "treaty"],
    sx("Word from the Foreign Ministry, sir — There is a new rule to keep the deep ocean clean and safe. If you sign it, you can't fish out there if you ever want to.",
  ...
  ax("Environment Diplomacy Officer", "ambassador", ["basel", "shipbreaking", "waste"],
    sx("Environment Diplomacy Officer: New rules say you have to handle old, broken ships safely because they are toxic. Your ship breakers don't want to spend the money to be safe.",
  ...
  ax("Regional Affairs Envoy", "ambassador", ["asean", "dialogue-partner", "engagement"],
    sx("Sir, a message from the Foreign Ministry: You can try to join a rich group of countries far away, which takes a lot of hard work, or just stick to your normal neighbors.",
  ...
  ax("Wildlife Diplomacy Officer", "ambassador", ["cites", "trafficking", "enforcement"],
    sx("Bad guys are sneaking rare animals like tigers through your country. The world will punish you unless you stop the bad guys, who have powerful friends. What are your orders, sir?",
  ...
  ax("Regional Trade Envoy", "ambassador", ["bhutan", "trade", "hydropower"],
    sx("Regional Trade Envoy awaits your word. A tiny, friendly country wants to share clean electricity with you. But the wires have to cross the grumpy giant neighbor's land.",
  ...
  ax("Environment Diplomacy Officer", "ambassador", ["plastics", "treaty", "industry"],
    sx("Dear Sir — The world is making a rule to stop making so much plastic trash. You can join the group stopping plastic, or help the plastic makers in your country.",
  ...
  ax("Climate Diplomacy Envoy", "ambassador", ["loss-and-damage", "fund", "leadership"],
    sx("Honourable leader! There is a new bank that gives money for climate damage. You can fight hard to be on the board that controls the money, or just wait in line to ask for some.",
  ...
  ax("Maritime Labour Officer", "people", ["seafarers", "labour", "shipping"],
    sx("Maritime Labour Officer reports: Your sailors on big ships get treated terribly by bad captains. You can sign a rule to protect them, but the ship owners will complain it costs too much.",
  ...
  ax("External Finance Secretary", "ambassador", ["debt", "climate-swap", "conservation"],
    sx("A note from the Foreign Ministry reads: A bank will forget about money you owe them, but only if you spend money planting trees instead. It means they tell you what to do with your money.",
  ...
  ax("Labour Diplomacy Officer", "ambassador", ["child-labour", "convention", "exports"],
    sx("Word from the Foreign Ministry, sir — The world sees kids working in your dirty factories and wants you to stop it. If you do, those poor kids won't have any money for food.",
  ...
  ax("Border Affairs Secretary", "people", ["enclaves", "border", "integration"],
    sx("Border Affairs Secretary: Years ago, some people traded land with a neighbor and became your citizens. They still have no roads or schools.",
  ...
  ax("Environment Diplomacy Officer", "ambassador", ["mercury", "treaty", "health"],
    sx("Sir, a message from the Foreign Ministry: The world wants to ban a poisonous silver liquid called mercury. It hurts rivers and people, but poor workers use it to find gold.",
  ...
  ax("Food Diplomacy Envoy", "ambassador", ["india", "rice", "food-security"],
    sx("You need to buy rice fast. Your tricky neighbor sells it cheap, or you can pay a lot more to buy it from far away so your neighbor doesn't trick you again. What are your orders, sir?",
  ...
  ax("Biodiversity Diplomacy Officer", "ambassador", ["biodiversity", "cop", "targets"],
    sx("Biodiversity Diplomacy Officer awaits your word. You can promise the world you will save a lot of land and water for nature. It looks great, but your people won't be able to build or farm there.",
  ...
  ax("Central Bank Diplomacy Officer", "ambassador", ["reserves", "regional-pool", "stability"],
    sx("Sir! You can put your money in a giant shared piggy bank with other countries. They will help you if you run out, but they get to check your spending.",
  ...
  ax("Disarmament Envoy", "ambassador", ["landmines", "ban", "standing"],
    sx("Mr. Prime Minister, sir! You can promise never to use hidden bomb traps in the ground. It is the nice thing to do, but your army wants to keep them just in case.",
  ...
  ax("Refugee Affairs Secretary", "ambassador", ["rohingya", "donors", "burden-sharing"],
    sx("Your Excellency! You can throw a giant world party to ask for money for the homeless people. You might get a lot of money, or nobody might show up and you'll look silly.",
